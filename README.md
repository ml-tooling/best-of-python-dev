...
- [GitHub](https://github.com/python/mypy) (👨‍💻 460 · 🔀 1.7K · 📦 35K · 📋 6.3K - 27% open · ⏱️ 25.05.2021):
...
- [PyPi](https://pypi.org/project/mypy) (📥 6.6M / month · 📦 6.1K · ⏱️ 19.02.2021):
	...
	pip install mypy
	```
- [Conda](https://anaconda.org/conda-forge/mypy) (📥 940K · ⏱️ 02.04.2021):
	```
...
- [GitHub](https://github.com/PyCQA/flake8) (👨‍💻 160 · 🔀 180 · 📦 170K · 📋 1.3K - 2% open · ⏱️ 24.05.2021):
...
- [GitHub](https://github.com/PyCQA/pylint) (👨‍💻 390 · 🔀 700 · 📋 3.4K - 20% open · ⏱️ 26.05.2021):
...
- [GitHub](https://github.com/PyCQA/pyflakes) (👨‍💻 77 · 🔀 140 · 📦 89K · 📋 420 - 19% open · ⏱️ 22.05.2021):
...
- [GitHub](https://github.com/davidhalter/parso) (👨‍💻 40 · 🔀 68 · 📦 130K · 📋 97 - 8% open · ⏱️ 15.05.2021):
...
- [PyPi](https://pypi.org/project/parso) (📥 13M / month · 📦 11K · ⏱️ 30.03.2021):
	...
	pip install parso
	```
- [Conda](https://anaconda.org/conda-forge/parso) (📥 4M · ⏱️ 31.03.2021):
	```
...
- [GitHub](https://github.com/PyCQA/pydocstyle) (👨‍💻 72 · 🔀 150 · 📥 51 · 📦 16K · 📋 270 - 27% open · ⏱️ 17.05.2021):
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 160 · 🔀 320 · 📋 260 - 25% open · ⏱️ 27.05.2021):
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 140 · 🔀 270 · 📦 340 · 📋 950 - 8% open · ⏱️ 27.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 73K / month · 📦 14 · ⏱️ 27.02.2021):
	```
...
- [GitHub](https://github.com/PyCQA/flake8-bugbear) (👨‍💻 37 · 🔀 41 · 📦 3.6K · 📋 89 - 40% open · ⏱️ 01.04.2021):
...
- [PyPi](https://pypi.org/project/flake8-bugbear) (📥 810K / month · 📦 1K · ⏱️ 01.04.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flake8-bugbear) (📥 290K · ⏱️ 02.04.2021):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 61 · 🔀 190 · 📋 420 - 24% open · ⏱️ 25.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytype) (📥 99K / month · 📦 88 · ⏱️ 25.05.2021):
	```
	pip install pytype
	```
...
- [GitHub](https://github.com/coala/coala) (👨‍💻 480 · 🔀 1.4K · 📥 140 · 📦 10 · 📋 3.2K - 26% open · ⏱️ 16.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/coala-bears) (📥 2K / month · 📦 210 · ⏱️ 10.11.2017):
	```
...
- [GitHub](https://github.com/terrencepreilly/darglint) (👨‍💻 21 · 🔀 24 · 📦 420 · 📋 130 - 28% open · ⏱️ 04.04.2021):
...
- [GitHub](https://github.com/microsoft/pyright) (👨‍💻 55 · 🔀 330 · 📦 77 · 📋 1.6K - 0% open · ⏱️ 26.05.2021):

	```
	git clone https://github.com/Microsoft/pyright
	```
- [NPM](https://www.npmjs.com/package/pyright) (📥 84K / month · 📦 4 · ⏱️ 26.05.2021):
	```
	npm install pyright
	```
</details>
...
- [GitHub](https://github.com/PyCQA/flake8-import-order) (👨‍💻 40 · 🔀 61 · 📋 96 - 11% open · ⏱️ 04.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/flake8-import-order) (📥 390K / month · 📦 1.9K · ⏱️ 04.03.2019):
	```
...
- [GitHub](https://github.com/mgedmin/check-manifest) (👨‍💻 19 · 🔀 30 · 📦 5.2K · 📋 85 - 17% open · ⏱️ 22.04.2021):
...
- [GitHub](https://github.com/zheller/flake8-quotes) (👨‍💻 28 · 🔀 33 · 📦 3.1K · 📋 42 - 7% open · ⏱️ 12.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/flake8-quotes) (📥 640K / month · 📦 1.4K · ⏱️ 12.05.2020):
	```
	pip install flake8-quotes
	```
- [Conda](https://anaconda.org/conda-forge/flake8-quotes) (📥 560K · ⏱️ 13.05.2020):
	```
	conda install -c conda-forge flake8-quotes
	```
</details>
<details><summary><b><a href="https://github.com/dropbox/mypy-protobuf">mypy-protobuf</a></b> (🥉24 ·  ⭐ 350 · 📉) - open source tools to generate mypy stubs from protobufs. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/dropbox/mypy-protobuf) (👨‍💻 27 · 🔀 54 · 📦 220 · 📋 71 - 16% open · ⏱️ 25.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/mypy-protobuf) (📥 410K / month · 📦 24 · ⏱️ 04.02.2021):
	```
...
- [GitHub](https://github.com/adamchainz/flake8-comprehensions) (👨‍💻 10 · 🔀 13 · 📋 37 - 18% open · ⏱️ 22.05.2021):
...
- [GitHub](https://github.com/wemake-services/flake8-eradicate) (👨‍💻 9 · 🔀 7 · 📋 26 - 7% open · ⏱️ 17.05.2021):
...
- [GitHub](https://github.com/Instagram/Fixit) (👨‍💻 25 · 🔀 37 · 📦 6 · 📋 58 - 58% open · ⏱️ 26.05.2021):
...
<details><summary><b><a href="https://github.com/peterjc/flake8-black">flake8-black</a></b> (🥉21 ·  ⭐ 87) - flake8 plugin to run black for checking Python coding style. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://cdn.iconscout.com/icon/free/png-256/8-eight-digital-number-numerical-numbers-36025.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/peterjc/flake8-black) (👨‍💻 4 · 🔀 7 · 📦 730 · 📋 18 - 22% open · ⏱️ 15.04.2021):
...
- [GitHub](https://github.com/ambv/flake8-mypy) (👨‍💻 8 · 🔀 15 · 📦 690 · 📋 22 - 86% open · ⏱️ 19.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/flake8-mypy) (📥 36K / month · 📦 200 · ⏱️ 31.08.2017):
	```
...
- [GitHub](https://github.com/andreoliwa/nitpick) (👨‍💻 10 · 🔀 9 · 📥 3 · 📋 84 - 36% open · ⏱️ 18.05.2021):

	```
	git clone https://github.com/andreoliwa/nitpick
	```
- [PyPi](https://pypi.org/project/nitpick) (📥 11K / month · ⏱️ 16.03.2021):
	```
	pip install nitpick
	```
</details>
...
- [GitHub](https://github.com/deppen8/pandas-vet) (👨‍💻 10 · 🔀 14 · 📥 33 · 📦 37 · 📋 49 - 42% open · ⏱️ 03.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pandas-vet) (📥 6.6K / month · ⏱️ 01.02.2020):
	```
...
- [GitHub](https://github.com/beartype/beartype) (👨‍💻 4 · 🔀 6 · 📋 24 - 12% open · ⏱️ 27.05.2021):
...
- [PyPi](https://pypi.org/project/beartype) (📥 11K / month · ⏱️ 25.05.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/beartype) (📥 4.1K · ⏱️ 25.05.2021):
	```
...
- [GitHub](https://github.com/hchasestevens/bellybutton) (👨‍💻 4 · 🔀 7 · 📦 4 · 📋 13 - 53% open · ⏱️ 27.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/bellybutton) (📥 7.5K / month · ⏱️ 27.11.2020):
	```
...
- [GitHub](https://github.com/hhatto/autopep8) (👨‍💻 50 · 🔀 240 · 📦 76K · 📋 420 - 20% open · ⏱️ 30.04.2021):
...
- [GitHub](https://github.com/psf/black) (👨‍💻 250 · 🔀 1.3K · 📥 14K · 📦 59K · 📋 1.5K - 24% open · ⏱️ 27.05.2021):

	```
	git clone https://github.com/psf/black
	```
- [PyPi](https://pypi.org/project/black) (📥 7.6M / month · 📦 6.2K · ⏱️ 10.05.2021):
	```
	pip install black
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 130 · 🔀 790 · 📦 20K · 📋 680 - 45% open · ⏱️ 04.05.2021):
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 63 · 🔀 120 · 📦 29K · 📋 190 - 39% open · ⏱️ 20.05.2021):
...
- [PyPi](https://pypi.org/project/autoflake) (📥 950K / month · 📦 580 · ⏱️ 04.08.2019):
	...
	```
- [Conda](https://anaconda.org/conda-forge/autoflake) (📥 110K · ⏱️ 26.05.2021):
	```
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 36 · 🔀 130 · 📦 120 · 📋 140 - 26% open · ⏱️ 24.05.2021):

	```
	git clone https://github.com/Instagram/MonkeyType
	```
- [PyPi](https://pypi.org/project/monkeytype) (📥 47K / month · 📦 34 · ⏱️ 21.05.2021):
	```
...
- [GitHub](https://github.com/facebookincubator/Bowler) (👨‍💻 26 · 🔀 85 · 📋 80 - 57% open · ⏱️ 21.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/bowler) (📥 50K / month · 📦 10 · ⏱️ 17.09.2020):
	```
	pip install bowler
	```
...
<details><summary><b><a href="https://github.com/asottile/pyupgrade">pyupgrade</a></b> (🥈23 ·  ⭐ 980) - A tool (and pre-commit hook) to automatically upgrade syntax for newer.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/asottile/pyupgrade) (👨‍💻 18 · 🔀 65 · 📋 180 - 8% open · ⏱️ 25.05.2021):

	```
	git clone https://github.com/asottile/pyupgrade
	```
- [PyPi](https://pypi.org/project/pyupgrade) (📥 140K / month · 📦 10 · ⏱️ 25.05.2021):
	```
	pip install pyupgrade
	```
- [Conda](https://anaconda.org/conda-forge/pyupgrade) (📥 210K · ⏱️ 25.05.2021):
	```
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 16 · 🔀 46 · 📦 59 · 📋 58 - 43% open · ⏱️ 19.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyannotate) (📥 4.5K / month · 📦 26 · ⏱️ 16.09.2019):
	```
...
- [GitHub](https://github.com/asottile/add-trailing-comma) (👨‍💻 9 · 🔀 13 · 📋 35 - 5% open · ⏱️ 24.05.2021):
...
<details><summary><b><a href="https://github.com/elmotec/massedit">massedit</a></b> (🥉18 ·  ⭐ 90) - Programmatically edit text files with Python. Useful for source to source.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/ilevkivskyi/com2ann">com2ann</a></b> (🥉14 ·  ⭐ 89) - Tool for translation type comments to type annotations in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/PyCQA/bandit) (👨‍💻 130 · 🔀 320 · 📥 46 · 📦 6.7K · 📋 530 - 31% open · ⏱️ 12.04.2021):
...
- [PyPi](https://pypi.org/project/bandit) (📥 1.5M / month · 📦 2.4K · ⏱️ 13.12.2020):
	...
	pip install bandit
	```
- [Conda](https://anaconda.org/conda-forge/bandit) (📥 68K · ⏱️ 10.03.2021):
	```
...
- [GitHub](https://github.com/pyupio/safety) (👨‍💻 35 · 🔀 85 · 📥 46K · 📦 1.9K · 📋 110 - 39% open · ⏱️ 28.04.2021):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.3K · 📋 4.3K - 1% open · ⏱️ 27.05.2021):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 8K / month · 📦 8 · ⏱️ 01.05.2021):
	```
	pip install sqlmap
	```
</details>
<details><summary><b><a href="https://github.com/landscapeio/dodgy">dodgy</a></b> (🥉22 ·  ⭐ 89) - Looks at Python code to search for things which look dodgy such as passwords.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- <b><a href="https://github.com/dashingsoft/pyarmor">pyarmor</a></b> (🥉25 ·  ⭐ 950) - A tool used to obfuscate python scripts, bind obfuscated scripts.. <code><a href="https://tldrlegal.com/search?q=SGI-B-2.0">❗️SGI-B-2.0</a></code>
...
<details><summary><b><a href="https://github.com/pypa/pipenv">pipenv</a></b> (🥇35 ·  ⭐ 22K · 📉) - Python Development Workflow for Humans. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/pypa/pipenv) (👨‍💻 380 · 🔀 1.6K · 📦 19K · 📋 3.4K - 14% open · ⏱️ 10.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pipenv) (📥 3.2M / month · 📦 2.3K · ⏱️ 15.11.2020):
	```
	pip install pipenv
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 320 · 🔀 2K · 📋 1.4K - 9% open · ⏱️ 26.05.2021):
...
- [GitHub](https://github.com/pyenv/pyenv-installer) (👨‍💻 31 · 🔀 290 · 📋 62 - 9% open · ⏱️ 09.05.2021):
...
- [GitHub](https://github.com/pypa/pip) (👨‍💻 610 · 🔀 2.2K · 📦 50K · 📋 5.8K - 17% open · ⏱️ 25.05.2021):

	```
	git clone https://github.com/pypa/pip
	```
- [PyPi](https://pypi.org/project/pip) (📥 95M / month · 📦 19K · ⏱️ 23.05.2021):
	```
	pip install pip
	```
- [Conda](https://anaconda.org/conda-forge/pip) (📥 20M · ⏱️ 23.05.2021):
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 280 · 🔀 1.2K · 📥 6.5M · 📋 3K - 37% open · ⏱️ 21.05.2021):

	```
	git clone https://github.com/python-poetry/poetry
	```
- [PyPi](https://pypi.org/project/poetry) (📥 2.2M / month · 📦 64 · ⏱️ 21.05.2021):
	```
	pip install poetry
	```
...
- [GitHub](https://github.com/conda/conda) (👨‍💻 360 · 🔀 1K · 📋 8K - 24% open · ⏱️ 26.05.2021):
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 150 · 🔀 430 · 📋 730 - 16% open · ⏱️ 18.05.2021):
...
- [GitHub](https://github.com/bndr/pipreqs) (👨‍💻 50 · 🔀 220 · 📦 5.3K · 📋 170 - 48% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/mamba-org/mamba) (👨‍💻 50 · 🔀 89 · 📦 320 · 📋 450 - 30% open · ⏱️ 26.05.2021):

	```
	git clone https://github.com/mamba-org/mamba
	```
- [Conda](https://anaconda.org/conda-forge/mamba) (📥 830K · ⏱️ 12.05.2021):
	```
...
- [GitHub](https://github.com/dephell/dephell) (👨‍💻 37 · 🔀 98 · 📥 130 · 📦 190 · 📋 260 - 38% open · ⏱️ 11.01.2021):
...
<details><summary><b><a href="https://github.com/pypa/pipx">pipx</a></b> (🥉23 ·  ⭐ 3.6K) - Install and Run Python Applications in Isolated Environments. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pypa/pipx) (👨‍💻 56 · 🔀 160 · 📋 390 - 17% open · ⏱️ 27.05.2021):

	```
	git clone https://github.com/pipxproject/pipx
	```
- [PyPi](https://pypi.org/project/pipx) (📥 55K / month · 📦 4 · ⏱️ 29.04.2021):
	```
	pip install pipx
	```
</details>
<details><summary><b><a href="https://github.com/David-OConnor/pyflow">pyflow</a></b> (🥉18 ·  ⭐ 760) - An installation and dependency system for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/David-OConnor/pyflow) (👨‍💻 22 · 🔀 27 · 📥 3K · 📋 86 - 47% open · ⏱️ 24.05.2021):
...
- [GitHub](https://github.com/jaraco/pip-run) (👨‍💻 9 · 🔀 10 · 📋 41 - 9% open · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pip-run) (📥 2.8K / month · ⏱️ 21.02.2021):
	```
	pip install pip-run
	```
</details>
...
<details><summary><b><a href="https://github.com/rubik/xenon">xenon</a></b> (🥉22 ·  ⭐ 190 · 📈) - Monitoring tool based on radon. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/rubik/xenon) (👨‍💻 7 · 🔀 14 · 📦 210 · 📋 30 - 20% open · ⏱️ 26.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/xenon) (📥 58K / month · 📦 120 · ⏱️ 26.05.2021):
	```
	pip install xenon
	```
...
- [GitHub](https://github.com/tonybaloney/wily) (👨‍💻 15 · 🔀 43 · 📋 76 - 36% open · ⏱️ 02.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/wily) (📥 6.9K / month · 📦 8 · ⏱️ 02.09.2020):
	```
	pip install wily
	```
</details>
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 100 · 🔀 950 · 📥 7.9K · 📦 180K · 📋 790 - 35% open · ⏱️ 24.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/tqdm) (📥 19M / month · 📦 26K · ⏱️ 24.05.2021):
	```
	pip install tqdm
	```
...
<details><summary><b><a href="https://github.com/getsentry/sentry-python">sentry-sdk</a></b> (🥈32 ·  ⭐ 930) - The new Python SDK for Sentry.io. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 94 · 🔀 210 · 📥 4.5K · 📦 11K · 📋 540 - 31% open · ⏱️ 17.05.2021):
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 29 · 🔀 400 · 📦 7.2K · 📋 400 - 12% open · ⏱️ 19.03.2021):
...
<details><summary><b><a href="https://github.com/astanin/python-tabulate">tabulate</a></b> (🥈31 ·  ⭐ 830) - Pretty-print tabular data in Python, a library and a command-line.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/astanin/python-tabulate) (👨‍💻 67 · 🔀 62 · 📦 44K · 📋 83 - 32% open · ⏱️ 04.03.2021):
...
- [GitHub](https://github.com/hynek/structlog) (👨‍💻 72 · 🔀 140 · 📦 3.2K · 📋 180 - 18% open · ⏱️ 19.05.2021):
...
- [PyPi](https://pypi.org/project/python-json-logger) (📥 3.1M / month · 📦 920 · ⏱️ 12.10.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-json-logger) (📥 660K · ⏱️ 12.10.2020):
	```
...
- [GitHub](https://github.com/WoLpH/python-progressbar) (👨‍💻 38 · 🔀 91 · 📥 1.6K · 📦 9.3K · 📋 190 - 4% open · ⏱️ 15.03.2021):
...
- [GitHub](https://github.com/borntyping/python-colorlog) (👨‍💻 29 · 🔀 72 · 📦 9.9K · 📋 64 - 3% open · ⏱️ 27.05.2021):
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 1 · 🔀 94 · 📦 300 · 📋 68 - 32% open · ⏱️ 08.01.2021):
...
- [GitHub](https://github.com/Qix-/better-exceptions) (👨‍💻 14 · 🔀 200 · 📋 70 - 41% open · ⏱️ 29.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/better-exceptions) (📥 35K / month · 📦 74 · ⏱️ 29.01.2021):
	```
...
- [GitHub](https://github.com/shobrook/rebound) (👨‍💻 16 · 🔀 330 · 📥 160 · 📦 19 · 📋 58 - 34% open · ⏱️ 04.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/rebound) (📥 1.5K / month · 📦 14 · ⏱️ 21.04.2021):
	```
	pip install rebound
	```
...
- [GitHub](https://github.com/cknd/stackprinter) (👨‍💻 6 · 🔀 31 · 📦 54 · 📋 22 - 40% open · ⏱️ 01.01.2021):
...
- [GitHub](https://github.com/onelivesleft/PrettyErrors) (👨‍💻 4 · 🔀 65 · ⏱️ 23.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pretty_errors) (📥 20K / month · ⏱️ 23.05.2021):
	```
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (👨‍💻 640 · 🔀 1.5K · 📦 140K · 📋 5.4K - 14% open · ⏱️ 23.05.2021):
...
- [GitHub](https://github.com/mkdocs/mkdocs) (👨‍💻 190 · 🔀 1.7K · 📦 12K · 📋 1.5K - 9% open · ⏱️ 25.05.2021):
...
<details><summary><b><a href="https://github.com/squidfunk/mkdocs-material">mkdocs-material</a></b> (🥇33 ·  ⭐ 6.5K) - A Material Design theme for MkDocs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 120 · 🔀 1.6K · 📦 6.7K · 📋 1K - 0% open · ⏱️ 27.05.2021):

	```
	git clone https://github.com/squidfunk/mkdocs-material
	```
- [PyPi](https://pypi.org/project/mkdocs-material) (📥 460K / month · 📦 1.5K · ⏱️ 19.05.2021):
	```
	pip install mkdocs-material
	```
- [Conda](https://anaconda.org/conda-forge/mkdocs-material) (📥 43K · ⏱️ 19.05.2021):
	```
...
- [GitHub](https://github.com/michaeljones/breathe) (👨‍💻 94 · 🔀 140 · 📥 65 · 📦 4.5K · 📋 440 - 22% open · ⏱️ 18.05.2021):
...
- [PyPi](https://pypi.org/project/sphinx-autobuild) (📥 160K / month · 📦 4.7K · ⏱️ 14.03.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sphinx-autobuild) (📥 55K · ⏱️ 14.03.2021):
	```
	conda install -c conda-forge sphinx-autobuild
	```
</details>
<details><summary><b><a href="https://github.com/mitmproxy/pdoc">pdoc</a></b> (🥉23 ·  ⭐ 910) - API Documentation for Python Projects. <code><a href="http://bit.ly/3rvuUlR">Unlicense</a></code></summary>

- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 29 · 🔀 100 · 📦 320 · 📋 160 - 1% open · ⏱️ 21.05.2021):

	```
	git clone https://github.com/mitmproxy/pdoc
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 51K / month · 📦 290 · ⏱️ 21.05.2021):
	```
	pip install pdoc
	```
</details>
<details><summary><b><a href="https://github.com/econchick/interrogate">interrogate</a></b> (🥉22 ·  ⭐ 260) - Explain yourself! Interrogate a codebase for docstring coverage. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/econchick/interrogate) (👨‍💻 9 · 🔀 20 · 📦 580 · 📋 30 - 36% open · ⏱️ 15.05.2021):
...
- [GitHub](https://github.com/mkdocstrings/mkdocstrings) (👨‍💻 19 · 🔀 42 · 📋 170 - 25% open · ⏱️ 16.05.2021):
...
- [GitHub](https://github.com/asottile/blacken-docs) (👨‍💻 12 · 🔀 17 · 📋 28 - 7% open · ⏱️ 24.05.2021):
...
<details><summary><b><a href="https://github.com/orzih/mkdocs-with-pdf">mkdocs-with-pdf</a></b> (🥉19 ·  ⭐ 58) - Generate a single PDF file from MkDocs repository. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/orzih/mkdocs-with-pdf) (👨‍💻 5 · 🔀 9 · 📦 21 · 📋 41 - 29% open · ⏱️ 08.04.2021):

	```
	git clone https://github.com/orzih/mkdocs-with-pdf
	```
- [PyPi](https://pypi.org/project/mkdocs-with-pdf) (📥 3.3K / month · ⏱️ 11.01.2021):
	```
...
- [GitHub](https://github.com/timothycrosley/portray) (👨‍💻 15 · 🔀 56 · 📋 47 - 40% open · ⏱️ 21.05.2021):
...
<details><summary><b><a href="https://github.com/ml-tooling/lazydocs">lazydocs</a></b> (🥉15 ·  ⭐ 22 · 🐣) - Generate markdown API documentation from Google-style Python.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/ml-tooling/lazydocs) (👨‍💻 4 · 🔀 5 · 📦 22 · ⏱️ 15.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/lazydocs) (📥 140 / month · ⏱️ 15.03.2021):
	```
...
- <b><a href="https://github.com/timvink/mkdocs-print-site-plugin">mkdocs-print-site-plugin</a></b> (🥉17 ·  ⭐ 17) - MkDocs Plugin allowing your visitors to *File Print.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
- [GitHub](https://github.com/gotcha/ipdb) (👨‍💻 48 · 🔀 130 · 📦 26K · 📋 160 - 31% open · ⏱️ 26.05.2021):

	```
	git clone https://github.com/gotcha/ipdb
	```
- [PyPi](https://pypi.org/project/ipdb) (📥 1.6M / month · 📦 17K · ⏱️ 26.05.2021):
	```
	pip install ipdb
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 75 · 🔀 390 · 📦 2.1K · 📋 170 - 32% open · ⏱️ 27.05.2021):

	```
	git clone https://github.com/eliben/pyelftools
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 670K / month · 📦 880 · ⏱️ 27.10.2020):
	```
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 76 · 🔀 180 · 📦 2.3K · 📋 270 - 51% open · ⏱️ 26.05.2021):

	```
	git clone https://github.com/inducer/pudb
	```
- [PyPi](https://pypi.org/project/pudb) (📥 670K / month · 📦 1.4K · ⏱️ 08.05.2021):
	```
	pip install pudb
	```
...
- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 39 · 🔀 41 · 📦 2.1K · 📋 160 - 34% open · ⏱️ 30.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/pdbpp) (📥 350K / month · 📦 1K · ⏱️ 04.10.2019):
	```
	pip install pdbpp
	```
...
- [GitHub](https://github.com/cs01/gdbgui) (👨‍💻 35 · 🔀 470 · 📥 3.7K · 📦 89 · 📋 270 - 41% open · ⏱️ 21.12.2020):

	```
	git clone https://github.com/cs01/gdbgui
	```
- [PyPi](https://pypi.org/project/gdbgui) (📥 83K / month · 📦 2 · ⏱️ 20.05.2021):
	```
	pip install gdbgui
	```
</details>
...
- [GitHub](https://github.com/agronholm/typeguard) (👨‍💻 17 · 🔀 57 · 📋 150 - 23% open · ⏱️ 01.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/typeguard) (📥 3M / month · 📦 160 · ⏱️ 01.04.2021):
	```
	pip install typeguard
	```
- [Conda](https://anaconda.org/conda-forge/typeguard) (📥 40K · ⏱️ 01.04.2021):
	```
...
- [GitHub](https://github.com/gruns/icecream) (👨‍💻 13 · 🔀 91 · 📋 66 - 27% open · ⏱️ 13.05.2021):

	```
	git clone https://github.com/gruns/icecream
	```
- [PyPi](https://pypi.org/project/icecream) (📥 57K / month · 📦 6 · ⏱️ 27.01.2021):
	```
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 8 · 🔀 31 · 📦 59 · 📋 83 - 44% open · ⏱️ 16.05.2021):

	```
	git clone https://github.com/ionelmc/python-hunter
	```
- [PyPi](https://pypi.org/project/hunter) (📥 6.2K / month · 📦 34 · ⏱️ 04.05.2021):
	```
	pip install hunter
	```
</details>
<details><summary><b><a href="https://github.com/alexmojaki/snoop">snoop</a></b> (🥉22 ·  ⭐ 550) - A powerful set of Python debugging tools, based on PySnooper. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/alexmojaki/snoop) (👨‍💻 20 · 🔀 19 · 📦 43 · 📋 29 - 44% open · ⏱️ 26.03.2021):
...
- [GitHub](https://github.com/alexmojaki/birdseye) (👨‍💻 9 · 🔀 70 · 📋 48 - 35% open · ⏱️ 26.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/birdseye) (📥 1.4K / month · ⏱️ 25.08.2020):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest) (👨‍💻 720 · 🔀 1.7K · 📦 320K · 📋 4.5K - 14% open · ⏱️ 26.05.2021):
...
- [PyPi](https://pypi.org/project/pytest) (📥 28M / month · 📦 130K · ⏱️ 04.05.2021):
	...
	pip install pytest
	```
- [Conda](https://anaconda.org/conda-forge/pytest) (📥 7.9M · ⏱️ 27.05.2021):
	```
...
- [GitHub](https://github.com/tox-dev/tox) (👨‍💻 240 · 🔀 370 · 📦 44K · 📋 1.2K - 11% open · ⏱️ 25.05.2021):
...
- [PyPi](https://pypi.org/project/tox) (📥 4.2M / month · 📦 36K · ⏱️ 05.05.2021):
	...
	pip install tox
	```
- [Conda](https://anaconda.org/conda-forge/tox) (📥 280K · ⏱️ 05.05.2021):
	```
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 250 · 🔀 460 · 📦 8.7K · 📋 1.1K - 5% open · ⏱️ 27.05.2021):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 2M / month · 📦 2.6K · ⏱️ 27.05.2021):
	```
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 94 · 🔀 200 · 📦 8K · 📋 230 - 28% open · ⏱️ 20.01.2021):
...
- [GitHub](https://github.com/pytest-dev/pytest-cov) (👨‍💻 64 · 🔀 140 · 📦 87K · 📋 290 - 34% open · ⏱️ 14.05.2021):

	```
	git clone https://github.com/pytest-dev/pytest-cov
	```
- [PyPi](https://pypi.org/project/pytest-cov) (📥 11M / month · 📦 43K · ⏱️ 14.05.2021):
	```
	pip install pytest-cov
	```
- [Conda](https://anaconda.org/conda-forge/pytest-cov) (📥 2.8M · ⏱️ 14.05.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-xdist) (👨‍💻 73 · 🔀 150 · 📦 18K · 📋 420 - 45% open · ⏱️ 17.05.2021):
...
- [GitHub](https://github.com/TheKevJames/coveralls-python) (👨‍💻 57 · 🔀 170 · 📦 18K · 📋 140 - 3% open · ⏱️ 25.05.2021):
...
- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 50 · 🔀 690 · 📦 7.9K · 📋 470 - 64% open · ⏱️ 18.04.2021):
...
- [GitHub](https://github.com/pytest-dev/pytest-mock) (👨‍💻 54 · 🔀 95 · 📦 16K · 📋 99 - 10% open · ⏱️ 18.05.2021):
...
- [PyPi](https://pypi.org/project/pytest-mock) (📥 4.1M / month · 📦 6.2K · ⏱️ 06.05.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-mock) (📥 920K · ⏱️ 07.05.2021):
	```
...
- [PyPi](https://pypi.org/project/pytest-asyncio) (📥 1.6M / month · 📦 2K · ⏱️ 21.04.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-asyncio) (📥 420K · ⏱️ 21.05.2021):
	```
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 71 · 🔀 130 · 📦 3.7K · 📋 250 - 21% open · ⏱️ 10.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/nose2) (📥 340K / month · 📦 1.9K · ⏱️ 27.01.2021):
	```
	pip install nose2
	```
...
- [PyPi](https://pypi.org/project/pytest-benchmark) (📥 320K / month · 📦 730 · ⏱️ 17.04.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-benchmark) (📥 570K · ⏱️ 18.04.2021):
	```
...
- [GitHub](https://github.com/Teemu/pytest-sugar) (👨‍💻 36 · 🔀 51 · 📦 7.3K · 📋 100 - 33% open · ⏱️ 24.10.2020):
...
- [PyPi](https://pypi.org/project/pytest-sugar) (📥 490K / month · 📦 4.6K · ⏱️ 06.07.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-sugar) (📥 98K · ⏱️ 18.09.2020):
	```
	conda install -c conda-forge pytest-sugar
	```
</details>
<details><summary><b><a href="https://github.com/microsoft/playwright-python">playwright-python</a></b> (🥉26 ·  ⭐ 4.6K) - Python version of the Playwright testing and automation.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/microsoft/playwright-python) (👨‍💻 20 · 🔀 390 · 📦 220 · 📋 340 - 4% open · ⏱️ 26.05.2021):

	```
	git clone https://github.com/microsoft/playwright-python
	```
- [PyPi](https://pypi.org/project/playwright) (📥 58K / month · ⏱️ 20.05.2021):
	```
	pip install playwright
	```
</details>
<details><summary><b><a href="https://github.com/pytest-dev/pytest-bdd">pytest-bdd</a></b> (🥉26 ·  ⭐ 820) - BDD library for the py.test runner. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [PyPi](https://pypi.org/project/pytest-bdd) (📥 180K / month · 📦 270 · ⏱️ 07.12.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-bdd) (📥 27K · ⏱️ 03.02.2020):
	```
...
- [GitHub](https://github.com/CleanCut/green) (👨‍💻 37 · 🔀 74 · 📦 580 · 📋 160 - 2% open · ⏱️ 28.04.2021):
...
- [GitHub](https://github.com/dbader/pytest-mypy) (👨‍💻 15 · 🔀 31 · 📦 1.1K · 📋 43 - 20% open · ⏱️ 21.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-mypy) (📥 300K / month · 📦 270 · ⏱️ 21.03.2021):
	```
	pip install pytest-mypy
	```
- [Conda](https://anaconda.org/conda-forge/pytest-mypy) (📥 9.3K · ⏱️ 24.11.2020):
	```
	conda install -c conda-forge pytest-mypy
	```
</details>
<details><summary><b><a href="https://github.com/airspeed-velocity/asv">asv</a></b> (🥉25 ·  ⭐ 590) - Airspeed Velocity: A simple Python benchmarking tool with web-based reporting. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [PyPi](https://pypi.org/project/asv) (📥 15K / month · 📦 88 · ⏱️ 16.05.2020):
	...
	pip install asv
	```
- [Conda](https://anaconda.org/conda-forge/asv) (📥 440K · ⏱️ 16.02.2021):
	```
	conda install -c conda-forge asv
	```
</details>
<details><summary><b><a href="https://github.com/hamcrest/PyHamcrest">PyHamcrest</a></b> (🥉25 ·  ⭐ 550) - Hamcrest matchers for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/pytest-dev/pytest-testinfra) (👨‍💻 100 · 🔀 270 · 📋 310 - 36% open · ⏱️ 11.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-testinfra) (📥 97K / month · ⏱️ 18.03.2021):
	```
...
- [GitHub](https://github.com/theacodes/nox) (👨‍💻 57 · 🔀 90 · 📦 550 · 📋 220 - 22% open · ⏱️ 27.05.2021):

	```
	git clone https://github.com/theacodes/nox
	```
- [PyPi](https://pypi.org/project/nox) (📥 310K / month · 📦 56 · ⏱️ 01.01.2021):
	```
	pip install nox
	```
- [Conda](https://anaconda.org/conda-forge/nox) (📥 28K · ⏱️ 06.01.2021):
	```
...
- [GitHub](https://github.com/tarpas/pytest-testmon) (👨‍💻 16 · 🔀 28 · 📦 300 · 📋 110 - 25% open · ⏱️ 30.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-testmon) (📥 87K / month · 📦 98 · ⏱️ 28.04.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-randomly) (👨‍💻 15 · 🔀 22 · 📋 41 - 17% open · ⏱️ 22.05.2021):
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 400 · 🔀 1.6K · 📥 700K · 📦 17K · 📋 4.2K - 8% open · ⏱️ 26.05.2021):
...
- [GitHub](https://github.com/pypa/packaging) (👨‍💻 69 · 🔀 150 · 📥 83 · 📦 210K · 📋 200 - 26% open · ⏱️ 06.05.2021):
...
- [PyPi](https://pypi.org/project/packaging) (📥 54M / month · 📦 29K · ⏱️ 29.01.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/packaging) (📥 7.5M · ⏱️ 04.02.2021):
	```
...
- [GitHub](https://github.com/Nuitka/Nuitka) (👨‍💻 94 · 🔀 290 · 📋 920 - 21% open · ⏱️ 25.05.2021):

	```
	git clone https://github.com/Nuitka/Nuitka
	```
- [PyPi](https://pypi.org/project/nuitka) (📥 22K / month · 📦 54 · ⏱️ 24.05.2021):
	```
	pip install nuitka
	```
- [Conda](https://anaconda.org/conda-forge/nuitka) (📥 280K · ⏱️ 24.05.2021):
	```
...
- [GitHub](https://github.com/pantsbuild/pex) (👨‍💻 99 · 🔀 190 · 📥 310K · 📋 690 - 19% open · ⏱️ 08.05.2021):
...
<details><summary><b><a href="https://github.com/py2exe/py2exe">py2exe</a></b> (🥈24 ·  ⭐ 230) - A distutils extension to create standalone Windows programs from Python code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/py2exe/py2exe) (👨‍💻 14 · 🔀 34 · 📥 9.3K · 📦 1.1K · 📋 73 - 6% open · ⏱️ 24.04.2021):

	```
	git clone https://github.com/py2exe/py2exe
	```
- [PyPi](https://pypi.org/project/py2exe) (📥 31K / month · 📦 350 · ⏱️ 24.04.2021):
	```
	pip install py2exe
	```
</details>
...
- [GitHub](https://github.com/ronaldoussoren/py2app) (👨‍💻 24 · 🔀 8 · 📦 3.7K · 📋 340 - 43% open · ⏱️ 06.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/py2app) (📥 15K / month · 📦 1.6K · ⏱️ 06.04.2021):
	```
	pip install py2app
	```
</details>
...
- [GitHub](https://github.com/marcelotduarte/cx_Freeze) (👨‍💻 90 · 🔀 160 · 📋 650 - 9% open · ⏱️ 27.05.2021):
...
- [PyPi](https://pypi.org/project/cx_freeze) (📥 35K / month · 📦 150 · ⏱️ 16.12.2017):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cx_freeze) (📥 71K · ⏱️ 17.04.2021):
	```
...
- [GitHub](https://github.com/takluyver/pynsist) (👨‍💻 27 · 🔀 100 · 📋 150 - 16% open · ⏱️ 28.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pynsist) (📥 1.7K / month · 📦 88 · ⏱️ 28.03.2021):
	```
	pip install pynsist
	```
</details>
...
- [GitHub](https://github.com/conda/constructor) (👨‍💻 46 · 🔀 120 · 📥 220 · 📦 9 · 📋 230 - 17% open · ⏱️ 24.05.2021):
...
- [GitHub](https://github.com/indygreg/PyOxidizer) (👨‍💻 34 · 🔀 110 · 📥 240 · 📋 340 - 58% open · ⏱️ 16.05.2021):
...
- <b><a href="https://github.com/jamesabel/pyship">pyship</a></b> (🥉10 ·  ⭐ 11) - freezer, installer and updater for Python applications. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
</details>
<br>
...
- [GitHub](https://github.com/pypa/setuptools) (👨‍💻 440 · 🔀 730 · 📥 110 · 📦 100K · 📋 1.8K - 30% open · ⏱️ 23.05.2021):

	```
	git clone https://github.com/pypa/setuptools
	```
- [PyPi](https://pypi.org/project/setuptools) (📥 110M / month · 📦 58K · ⏱️ 23.05.2021):
	```
...
<details><summary><b><a href="https://github.com/buildbot/buildbot">buildbot</a></b> (🥇32 ·  ⭐ 4.6K · 📈) - Python-based continuous integration testing framework; your.. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>
...
- [GitHub](https://github.com/buildbot/buildbot) (👨‍💻 790 · 🔀 1.5K · 📥 15K · 📦 250 · 📋 1.3K - 48% open · ⏱️ 26.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/buildbot) (📥 58K / month · 📦 890 · ⏱️ 28.04.2021):
	```
...
- [GitHub](https://github.com/pyinvoke/invoke) (👨‍💻 54 · 🔀 280 · 📦 7.8K · 📋 660 - 45% open · ⏱️ 31.12.2020):
...
- [GitHub](https://github.com/pypa/twine) (👨‍💻 100 · 🔀 240 · 📦 40K · 📋 350 - 11% open · ⏱️ 10.04.2021):
...
- [GitHub](https://github.com/pypa/wheel) (👨‍💻 61 · 🔀 90 · 📋 310 - 7% open · ⏱️ 23.05.2021):

	```
	git clone https://github.com/pypa/wheel
	```
- [PyPi](https://pypi.org/project/wheel) (📥 73M / month · 📦 63K · ⏱️ 13.12.2020):
	```
	pip install wheel
	```
...
- [GitHub](https://github.com/takluyver/flit) (👨‍💻 42 · 🔀 70 · 📋 240 - 34% open · ⏱️ 02.04.2021):

	```
	git clone https://github.com/takluyver/flit
	```
- [PyPi](https://pypi.org/project/flit) (📥 98K / month · 📦 230 · ⏱️ 01.03.2021):
	```
	pip install flit
	```
- [Conda](https://anaconda.org/conda-forge/flit) (📥 82K · ⏱️ 22.03.2021):
	```
...
- [GitHub](https://github.com/pydoit/doit) (👨‍💻 56 · 🔀 120 · 📦 700 · 📋 260 - 25% open · ⏱️ 14.05.2021):
...
- [PyPi](https://pypi.org/project/doit) (📥 210K / month · 📦 470 · ⏱️ 04.09.2020):
	...
	pip install doit
	```
- [Conda](https://anaconda.org/conda-forge/doit) (📥 54K · ⏱️ 11.10.2020):
	```
...
- [GitHub](https://github.com/pypa/setuptools_scm) (👨‍💻 84 · 🔀 140 · 📋 330 - 21% open · ⏱️ 24.05.2021):
...
- [PyPi](https://pypi.org/project/setuptools_scm) (📥 13M / month · 📦 690 · ⏱️ 09.08.2018):
	...
	```
- [Conda](https://anaconda.org/conda-forge/setuptools_scm) (📥 650K · ⏱️ 17.03.2021):
	```
...
- [GitHub](https://github.com/paver/paver) (👨‍💻 44 · 🔀 76 · 📋 130 - 28% open · ⏱️ 30.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/paver) (📥 38K / month · 📦 1.9K · ⏱️ 31.12.2017):
	```
	pip install paver
	```
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 160 · 🔀 1.1K · 📦 87K · 📋 1.5K - 12% open · ⏱️ 14.05.2021):
...
- [GitHub](https://github.com/nicolargo/glances) (👨‍💻 140 · 🔀 1.2K · 📥 430 · 📦 300 · 📋 1.4K - 14% open · ⏱️ 27.05.2021):
...
<details><summary><b><a href="https://github.com/benfred/py-spy">py-spy</a></b> (🥇30 ·  ⭐ 6.9K · 📈) - Sampling profiler for Python programs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 25 · 🔀 250 · 📥 5.1K · 📦 830 · 📋 200 - 30% open · ⏱️ 16.05.2021):

	```
	git clone https://github.com/benfred/py-spy
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 510K / month · 📦 50 · ⏱️ 16.05.2021):
	```
	pip install py-spy
	```
</details>
...
- [GitHub](https://github.com/pyutils/line_profiler) (👨‍💻 24 · 🔀 250 · 📋 41 - 75% open · ⏱️ 24.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/line_profiler) (📥 460K / month · 📦 690 · ⏱️ 20.12.2017):
	```
...
- [PyPi](https://pypi.org/project/pyinstrument) (📥 150K / month · 📦 140 · ⏱️ 03.05.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyinstrument) (📥 70K · ⏱️ 03.05.2021):
	```
	conda install -c conda-forge pyinstrument
	```
</details>
<details><summary><b><a href="https://github.com/pympler/pympler">pympler</a></b> (🥉26 ·  ⭐ 770 · 💤) - Development tool to measure, monitor and analyze the memory.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/pympler/pympler) (👨‍💻 26 · 🔀 67 · 📋 78 - 41% open · ⏱️ 15.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/pympler) (📥 440K / month · 📦 480 · ⏱️ 14.10.2020):
	```
	pip install pympler
	```
...
- [GitHub](https://github.com/sumerc/yappi) (👨‍💻 22 · 🔀 44 · 📦 410 · 📋 44 - 27% open · ⏱️ 23.03.2021):
...
- [PyPi](https://pypi.org/project/yappi) (📥 150K / month · 📦 640 · ⏱️ 27.11.2020):
	...
	pip install yappi
	```
- [Conda](https://anaconda.org/conda-forge/yappi) (📥 77K · ⏱️ 28.11.2020):
	```
...
- [GitHub](https://github.com/plasma-umass/scalene) (👨‍💻 19 · 🔀 140 · 📦 43 · 📋 100 - 20% open · ⏱️ 27.05.2021):
...
- [GitHub](https://github.com/aristocratos/bpytop) (👨‍💻 28 · 🔀 250 · 📋 240 - 16% open · ⏱️ 02.05.2021):

	```
	git clone https://github.com/aristocratos/bpytop
	```
- [PyPi](https://pypi.org/project/bpytop) (📥 11K / month · ⏱️ 02.05.2021):
	```
	pip install bpytop
	```
</details>
...
- [GitHub](https://github.com/nvdv/vprof) (👨‍💻 17 · 🔀 160 · 📦 73 · 📋 79 - 29% open · ⏱️ 20.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/vprof) (📥 2.3K / month · 📦 18 · ⏱️ 29.02.2020):
	```
	pip install vprof
	```
</details>
...
- [GitHub](https://github.com/what-studio/profiling) (👨‍💻 18 · 🔀 110 · 📦 32 · 📋 35 - 42% open · ⏱️ 24.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/profiling) (📥 3.6K / month · 📦 5 · ⏱️ 28.06.2017):
	```
...
- [GitHub](https://github.com/serge-sans-paille/gast) (👨‍💻 10 · 🔀 22 · 📦 56K · 📋 25 - 16% open · ⏱️ 26.11.2020):
...
- [GitHub](https://github.com/newville/asteval) (👨‍💻 17 · 🔀 28 · 📦 550 · 📋 47 - 10% open · ⏱️ 19.05.2021):
...
- [GitHub](https://github.com/pre-commit/pre-commit) (👨‍💻 120 · 🔀 450 · 📥 5.8K · 📋 1.1K - 2% open · ⏱️ 24.05.2021):
...
- [PyPi](https://pypi.org/project/pre-commit) (📥 3.2M / month · 📦 2.1K · ⏱️ 21.05.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pre-commit) (📥 550K · ⏱️ 27.05.2021):
	```
