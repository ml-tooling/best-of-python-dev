...
- [GitHub](https://github.com/python/mypy) (👨‍💻 460 · 🔀 1.7K · 📦 32K · 📋 6.2K - 26% open · ⏱️ 13.04.2021):

	```
	git clone https://github.com/python/mypy
	```
- [PyPi](https://pypi.org/project/mypy) (📥 6M / month · 📦 6.1K · ⏱️ 19.02.2021):
	```
	pip install mypy
	```
- [Conda](https://anaconda.org/conda-forge/mypy) (📥 840K · ⏱️ 02.04.2021):
	```
...
- [GitHub](https://github.com/PyCQA/flake8) (👨‍💻 150 · 🔀 180 · 📦 160K · 📋 1.3K - 2% open · ⏱️ 12.04.2021):

	```
	git clone https://github.com/PyCQA/flake8
	```
- [PyPi](https://pypi.org/project/flake8) (📥 11M / month · 📦 71K · ⏱️ 14.03.2021):
	```
	pip install flake8
	```
- [Conda](https://anaconda.org/conda-forge/flake8) (📥 2.3M · ⏱️ 15.03.2021):
	```
...
- [GitHub](https://github.com/PyCQA/pylint) (👨‍💻 380 · 🔀 690 · 📋 3.4K - 20% open · ⏱️ 12.04.2021):

	```
	git clone https://github.com/PyCQA/pylint
	```
- [PyPi](https://pypi.org/project/pylint) (📥 9.7M / month · 📦 38K · ⏱️ 30.03.2021):
	```
	pip install pylint
	```
...
- [GitHub](https://github.com/PyCQA/pyflakes) (👨‍💻 76 · 🔀 140 · 📦 84K · 📋 420 - 19% open · ⏱️ 24.03.2021):
...
- [GitHub](https://github.com/davidhalter/parso) (👨‍💻 40 · 🔀 67 · 📦 120K · 📋 97 - 8% open · ⏱️ 07.04.2021):
...
- [PyPi](https://pypi.org/project/parso) (📥 14M / month · 📦 11K · ⏱️ 30.03.2021):
	...
	pip install parso
	```
- [Conda](https://anaconda.org/conda-forge/parso) (📥 3.7M · ⏱️ 31.03.2021):
	```
...
- [GitHub](https://github.com/PyCQA/pydocstyle) (👨‍💻 71 · 🔀 150 · 📥 51 · 📦 16K · 📋 260 - 27% open · ⏱️ 18.03.2021):

	```
	git clone https://github.com/PyCQA/pydocstyle
	```
- [PyPi](https://pypi.org/project/pydocstyle) (📥 1.8M / month · 📦 3.9K · ⏱️ 18.03.2021):
	```
...
- [GitHub](https://github.com/openstack/hacking) (👨‍💻 180 · 🔀 68 · ⏱️ 01.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/hacking) (📥 450K / month · 📦 8.7K · ⏱️ 12.11.2020):
	```
	pip install hacking
	```
</details>
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 150 · 🔀 310 · 📋 250 - 25% open · ⏱️ 15.04.2021):
...
- [GitHub](https://github.com/PyCQA/flake8-bugbear) (👨‍💻 37 · 🔀 41 · 📦 3.4K · 📋 89 - 40% open · ⏱️ 01.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-bugbear) (📥 750K / month · 📦 1K · ⏱️ 01.04.2021):
	```
...
- [GitHub](https://github.com/microsoft/pyright) (👨‍💻 55 · 🔀 300 · 📦 65 · 📋 1.5K - 0% open · ⏱️ 14.04.2021):
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 60 · 🔀 190 · 📋 410 - 23% open · ⏱️ 14.04.2021):

	```
	git clone https://github.com/google/pytype
	```
- [PyPi](https://pypi.org/project/pytype) (📥 91K / month · 📦 88 · ⏱️ 09.04.2021):
	```
	pip install pytype
	```
- [Conda](https://anaconda.org/conda-forge/pytype) (📥 40K · ⏱️ 13.10.2020):
	```
...
- [GitHub](https://github.com/coala/coala) (👨‍💻 480 · 🔀 1.4K · 📥 140 · 📦 10 · 📋 3.2K - 26% open · ⏱️ 29.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/coala-bears) (📥 22K / month · 📦 210 · ⏱️ 10.11.2017):
	```
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 140 · 🔀 270 · 📦 300 · 📋 950 - 8% open · ⏱️ 15.04.2021):

	```
	git clone https://github.com/wemake-services/wemake-python-styleguide
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 60K / month · 📦 14 · ⏱️ 27.02.2021):
	```
...
- [GitHub](https://github.com/PyCQA/pylint-django) (👨‍💻 58 · 🔀 97 · 📥 180 · 📦 13K · 📋 170 - 14% open · ⏱️ 09.04.2021):

	```
	git clone https://github.com/PyCQA/pylint-django
	```
- [PyPi](https://pypi.org/project/pylint-django) (📥 600K / month · 📦 2.2K · ⏱️ 10.01.2021):
	```
	pip install pylint-django
	```
- [Conda](https://anaconda.org/conda-forge/pylint-django) (📥 76K · ⏱️ 12.01.2021):
	```
...
- [GitHub](https://github.com/terrencepreilly/darglint) (👨‍💻 21 · 🔀 24 · 📦 370 · 📋 120 - 28% open · ⏱️ 04.04.2021):

	```
	git clone https://github.com/terrencepreilly/darglint
	```
- [PyPi](https://pypi.org/project/darglint) (📥 140K / month · 📦 20 · ⏱️ 22.02.2021):
	```
...
- [GitHub](https://github.com/dropbox/mypy-protobuf) (👨‍💻 27 · 🔀 53 · 📦 210 · 📋 70 - 17% open · ⏱️ 25.02.2021):

	```
	git clone https://github.com/dropbox/mypy-protobuf
	```
- [PyPi](https://pypi.org/project/mypy-protobuf) (📥 710K / month · 📦 24 · ⏱️ 04.02.2021):
	```
...
- [GitHub](https://github.com/mgedmin/check-manifest) (👨‍💻 19 · 🔀 29 · 📦 4.7K · 📋 85 - 17% open · ⏱️ 08.04.2021):

	```
	git clone https://github.com/mgedmin/check-manifest
	```
- [PyPi](https://pypi.org/project/check-manifest) (📥 230K / month · 📦 1.8K · ⏱️ 04.01.2021):
	```
...
- [GitHub](https://github.com/zheller/flake8-quotes) (👨‍💻 28 · 🔀 33 · 📦 3K · 📋 42 - 7% open · ⏱️ 12.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/flake8-quotes) (📥 500K / month · 📦 1.4K · ⏱️ 12.05.2020):
	```
	pip install flake8-quotes
	```
- [Conda](https://anaconda.org/conda-forge/flake8-quotes) (📥 270K · ⏱️ 13.05.2020):
	```
...
- [GitHub](https://github.com/gforcada/flake8-isort) (👨‍💻 28 · 🔀 35 · 📦 2.7K · 📋 46 - 19% open · ⏱️ 11.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/flake8-isort) (📥 390K / month · 📦 930 · ⏱️ 11.08.2020):
	```
...
- [GitHub](https://github.com/adamchainz/flake8-comprehensions) (👨‍💻 10 · 🔀 13 · 📋 37 - 18% open · ⏱️ 10.04.2021):

	```
	git clone https://github.com/adamchainz/flake8-comprehensions
	```
- [PyPi](https://pypi.org/project/flake8-comprehensions) (📥 500K / month · 📦 710 · ⏱️ 18.03.2021):
	```
...
- [GitHub](https://github.com/wemake-services/flake8-eradicate) (👨‍💻 9 · 🔀 6 · 📋 26 - 7% open · ⏱️ 12.04.2021):

	```
	git clone https://github.com/wemake-services/flake8-eradicate
	```
- [PyPi](https://pypi.org/project/flake8-eradicate) (📥 190K / month · 📦 72 · ⏱️ 12.10.2020):
	```
	pip install flake8-eradicate
	```
</details>
<details><summary><b><a href="https://github.com/gforcada/flake8-builtins">flake8-builtins</a></b> (🥉22 ·  ⭐ 62) - Check for python builtins being used as variables or.. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code> <code><img src="https://cdn.iconscout.com/icon/free/png-256/8-eight-digital-number-numerical-numbers-36025.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/Instagram/Fixit) (👨‍💻 24 · 🔀 36 · 📦 5 · 📋 42 - 54% open · ⏱️ 31.03.2021):
...
- [GitHub](https://github.com/predictive-analytics-lab/data-science-types) (👨‍💻 44 · 🔀 59 · 📋 62 - 62% open · ⏱️ 16.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/data-science-types) (📥 15K / month · ⏱️ 16.02.2021):
	```
...
- [GitHub](https://github.com/ambv/flake8-mypy) (👨‍💻 8 · 🔀 15 · 📦 660 · 📋 22 - 86% open · ⏱️ 19.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/flake8-mypy) (📥 50K / month · 📦 200 · ⏱️ 31.08.2017):
	```
...
- [PyPi](https://pypi.org/project/flake8-black) (📥 170K / month · 📦 36 · ⏱️ 25.07.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flake8-black) (📥 89K · ⏱️ 25.07.2020):
	```
...
- [GitHub](https://github.com/life4/flakehell) (👨‍💻 15 · 🔀 32 · 📥 50 · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/flakehell) (📥 31K / month · ⏱️ 11.01.2021):
	```
...
- [GitHub](https://github.com/tylerwince/flake8-bandit) (👨‍💻 5 · 🔀 15 · 📋 10 - 30% open · ⏱️ 29.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/flake8-bandit) (📥 180K / month · 📦 160 · ⏱️ 08.10.2019):
	```
	pip install flake8-bandit
	```
</details>
<details><summary><b><a href="https://github.com/andreoliwa/nitpick">nitpick</a></b> (🥉18 ·  ⭐ 140) - Enforce the same settings across multiple language-independent.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://cdn.iconscout.com/icon/free/png-256/8-eight-digital-number-numerical-numbers-36025.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/andreoliwa/nitpick) (👨‍💻 9 · 🔀 9 · 📥 3 · 📋 82 - 36% open · ⏱️ 13.04.2021):

	```
	git clone https://github.com/andreoliwa/nitpick
	```
- [PyPi](https://pypi.org/project/nitpick) (📥 8.6K / month · ⏱️ 16.03.2021):
	```
	pip install nitpick
	```
</details>
...
- [GitHub](https://github.com/deppen8/pandas-vet) (👨‍💻 10 · 🔀 14 · 📥 31 · 📦 36 · 📋 49 - 42% open · ⏱️ 03.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pandas-vet) (📥 6.2K / month · ⏱️ 01.02.2020):
	```
	pip install pandas-vet
	```
- [Conda](https://anaconda.org/conda-forge/pandas-vet) (📥 6.2K · ⏱️ 01.02.2020):
	```
	conda install -c conda-forge pandas-vet
	```
</details>
<details><summary><b><a href="https://github.com/beartype/beartype">beartype</a></b> (🥉17 ·  ⭐ 210) - Unbearably fast O(1) runtime type-checking in pure Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/beartype/beartype) (👨‍💻 4 · 🔀 6 · 📋 23 - 17% open · ⏱️ 14.04.2021):

	```
	git clone https://github.com/beartype/beartype
	```
- [PyPi](https://pypi.org/project/beartype) (📥 8.8K / month · ⏱️ 04.03.2021):
	```
	pip install beartype
	```
- [Conda](https://anaconda.org/conda-forge/beartype) (📥 3.5K · ⏱️ 04.03.2021):
	```
...
- [GitHub](https://github.com/hchasestevens/bellybutton) (👨‍💻 4 · 🔀 7 · 📦 4 · 📋 13 - 53% open · ⏱️ 27.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/bellybutton) (📥 6.5K / month · ⏱️ 27.11.2020):
	```
...
- [GitHub](https://github.com/lyft/linty_fresh) (👨‍💻 17 · 🔀 21 · 📋 9 - 88% open · ⏱️ 30.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/linty-fresh) (📥 120 / month · ⏱️ 12.12.2018):
	```
...
- [GitHub](https://github.com/psf/black) (👨‍💻 240 · 🔀 1.3K · 📥 12K · 📦 54K · 📋 1.5K - 30% open · ⏱️ 12.04.2021):

	```
	git clone https://github.com/psf/black
	```
- [PyPi](https://pypi.org/project/black) (📥 6.2M / month · 📦 6.2K · ⏱️ 26.08.2020):
	```
	pip install black
	```
...
- [GitHub](https://github.com/hhatto/autopep8) (👨‍💻 50 · 🔀 240 · 📦 71K · 📋 420 - 20% open · ⏱️ 12.04.2021):
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 230 · 🔀 390 · 📦 170K · 📋 930 - 2% open · ⏱️ 03.04.2021):
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 120 · 🔀 790 · 📦 19K · 📋 680 - 45% open · ⏱️ 12.03.2021):
...
- [PyPi](https://pypi.org/project/yapf) (📥 1.4M / month · 📦 3.4K · ⏱️ 23.04.2020):
	...
	pip install yapf
	```
- [Conda](https://anaconda.org/conda-forge/yapf) (📥 600K · ⏱️ 28.07.2020):
	```
...
- [GitHub](https://github.com/myint/docformatter) (👨‍💻 15 · 🔀 30 · 📦 550 · 📋 49 - 55% open · ⏱️ 27.12.2020):

	```
	git clone https://github.com/myint/docformatter
	```
- [PyPi](https://pypi.org/project/docformatter) (📥 78K / month · 📦 110 · ⏱️ 27.12.2020):
	```
...
- [PyPi](https://pypi.org/project/jedi) (📥 14M / month · 📦 16K · ⏱️ 25.12.2020):
	...
	pip install jedi
	```
- [Conda](https://anaconda.org/conda-forge/jedi) (📥 4.6M · ⏱️ 14.01.2021):
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 63 · 🔀 120 · 📦 27K · 📋 190 - 40% open · ⏱️ 20.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/rope) (📥 340K / month · 📦 2.9K · ⏱️ 07.10.2020):
	```
	pip install rope
	```
- [Conda](https://anaconda.org/conda-forge/rope) (📥 510K · ⏱️ 07.10.2020):
	```
...
- [GitHub](https://github.com/myint/autoflake) (👨‍💻 17 · 🔀 40 · 📦 2.1K · 📋 55 - 41% open · ⏱️ 27.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/autoflake) (📥 720K / month · 📦 580 · ⏱️ 04.08.2019):
	```
	pip install autoflake
	```
- [Conda](https://anaconda.org/conda-forge/autoflake) (📥 96K · ⏱️ 25.04.2019):
	```
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 36 · 🔀 130 · 📦 110 · 📋 140 - 25% open · ⏱️ 08.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/monkeytype) (📥 22K / month · 📦 34 · ⏱️ 18.05.2020):
	```
...
<details><summary><b><a href="https://github.com/facebookincubator/Bowler">Bowler</a></b> (🥈24 ·  ⭐ 1.3K) - Safe code refactoring for modern Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/facebookincubator/Bowler) (👨‍💻 26 · 🔀 85 · 📋 80 - 57% open · ⏱️ 21.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/bowler) (📥 61K / month · 📦 10 · ⏱️ 17.09.2020):
	```
	pip install bowler
	```
- [Conda](https://anaconda.org/conda-forge/bowler) (📥 9.3K · ⏱️ 12.06.2019):
	```
...
- [GitHub](https://github.com/asottile/pyupgrade) (👨‍💻 15 · 🔀 61 · 📋 170 - 10% open · ⏱️ 09.04.2021):

	```
	git clone https://github.com/asottile/pyupgrade
	```
- [PyPi](https://pypi.org/project/pyupgrade) (📥 99K / month · 📦 10 · ⏱️ 20.03.2021):
	```
	pip install pyupgrade
	```
- [Conda](https://anaconda.org/conda-forge/pyupgrade) (📥 190K · ⏱️ 09.04.2021):
	```
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 16 · 🔀 45 · 📦 58 · 📋 58 - 43% open · ⏱️ 19.03.2021):

	```
	git clone https://github.com/dropbox/pyannotate
	```
- [PyPi](https://pypi.org/project/pyannotate) (📥 3.8K / month · 📦 26 · ⏱️ 16.09.2019):
	```
	pip install pyannotate
	```
</details>
<details><summary><b><a href="https://github.com/asottile/add-trailing-comma">add-trailing-comma</a></b> (🥉21 ·  ⭐ 170) - A tool (and pre-commit hook) to automatically add trailing.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/asottile/add-trailing-comma) (👨‍💻 9 · 🔀 13 · 📋 34 - 2% open · ⏱️ 12.04.2021):

	```
	git clone https://github.com/asottile/add-trailing-comma
	```
- [PyPi](https://pypi.org/project/add-trailing-comma) (📥 8.5K / month · 📦 14 · ⏱️ 24.01.2021):
	```
	pip install add-trailing-comma
	```
</details>
<details><summary><b><a href="https://github.com/hakancelik96/unimport">unimport</a></b> (🥉18 ·  ⭐ 98) - A linter, formatter for finding and removing unused import statements. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/hakancelik96/unimport) (👨‍💻 11 · 🔀 16 · 📦 5 · 📋 69 - 10% open · ⏱️ 12.04.2021):

	```
	git clone https://github.com/hakancelik96/unimport
	```
- [PyPi](https://pypi.org/project/unimport) (📥 3.2K / month · ⏱️ 10.03.2021):
	```
...
- [GitHub](https://github.com/ilevkivskyi/com2ann) (👨‍💻 3 · 🔀 4 · 📦 2 · 📋 18 - 22% open · ⏱️ 07.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/com2ann) (📥 1.1K / month · ⏱️ 17.06.2019):
	```
	pip install com2ann
	```
</details>
...
- [GitHub](https://github.com/PyCQA/bandit) (👨‍💻 130 · 🔀 320 · 📥 34 · 📦 6.4K · 📋 530 - 31% open · ⏱️ 12.04.2021):
...
- [PyPi](https://pypi.org/project/bandit) (📥 1.4M / month · 📦 2.4K · ⏱️ 13.12.2020):
	...
	pip install bandit
	```
- [Conda](https://anaconda.org/conda-forge/bandit) (📥 57K · ⏱️ 10.03.2021):
	```
...
- [GitHub](https://github.com/pyupio/safety) (👨‍💻 35 · 🔀 82 · 📥 36K · 📦 1.8K · 📋 110 - 39% open · ⏱️ 19.02.2021):

	```
	git clone https://github.com/pyupio/safety
	```
- [PyPi](https://pypi.org/project/safety) (📥 500K / month · 📦 540 · ⏱️ 15.01.2021):
	```
	pip install safety
	```
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 100 · 🔀 4.2K · 📋 4.3K - 1% open · ⏱️ 13.04.2021):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 6.4K / month · 📦 8 · ⏱️ 03.03.2021):
	```
	pip install sqlmap
	```
</details>
...
- [GitHub](https://github.com/landscapeio/dodgy) (👨‍💻 14 · 🔀 17 · 📦 1.3K · 📋 11 - 72% open · ⏱️ 21.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/dodgy) (📥 160K / month · 📦 520 · ⏱️ 31.12.2019):
	```
	pip install dodgy
	```
...
- [GitHub](https://github.com/dlint-py/dlint) (👨‍💻 7 · 🔀 13 · 📋 32 - 62% open · ⏱️ 08.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/dlint) (📥 24K / month · 📦 18 · ⏱️ 30.10.2020):
	```
	pip install dlint
	```
</details>
...
- [GitHub](https://github.com/pypa/pipenv) (👨‍💻 380 · 🔀 1.6K · 📦 18K · 📋 3.4K - 14% open · ⏱️ 07.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/pipenv) (📥 3.5M / month · 📦 2.3K · ⏱️ 15.11.2020):
	```
	pip install pipenv
	```
...
- [PyPi](https://pypi.org/project/virtualenv) (📥 19M / month · 📦 34K · ⏱️ 16.03.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/virtualenv) (📥 780K · ⏱️ 16.03.2021):
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 310 · 🔀 2K · 📋 1.3K - 21% open · ⏱️ 09.04.2021):
...
- [GitHub](https://github.com/pypa/pip) (👨‍💻 600 · 🔀 2.2K · 📦 47K · 📋 5.6K - 16% open · ⏱️ 15.04.2021):

	```
	git clone https://github.com/pypa/pip
	```
- [PyPi](https://pypi.org/project/pip) (📥 84M / month · 📦 19K · ⏱️ 30.01.2021):
	```
	pip install pip
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 270 · 🔀 1.2K · 📥 5.8M · 📋 2.9K - 36% open · ⏱️ 14.04.2021):
...
- [PyPi](https://pypi.org/project/poetry) (📥 2.3M / month · 📦 64 · ⏱️ 14.04.2021):
	...
	pip install poetry
	```
- [Conda](https://anaconda.org/conda-forge/poetry) (📥 190K · ⏱️ 15.04.2021):
	```
...
- [GitHub](https://github.com/conda/conda) (👨‍💻 350 · 🔀 1K · 📋 7.9K - 24% open · ⏱️ 14.04.2021):
...
- [PyPi](https://pypi.org/project/conda) (📥 53K / month · 📦 2.1K · ⏱️ 22.04.2017):
	...
	pip install conda
	```
- [Conda](https://anaconda.org/conda-forge/conda) (📥 17M · ⏱️ 14.04.2021):
	```
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 150 · 🔀 430 · 📋 730 - 16% open · ⏱️ 14.04.2021):

	```
	git clone https://github.com/jazzband/pip-tools
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 3.2M / month · 📦 3.3K · ⏱️ 16.03.2021):
	```
	pip install pip-tools
	```
- [Conda](https://anaconda.org/conda-forge/pip-tools) (📥 9.5K · ⏱️ 14.04.2021):
	```
...
- [GitHub](https://github.com/bndr/pipreqs) (👨‍💻 46 · 🔀 220 · 📦 4.8K · 📋 160 - 50% open · ⏱️ 29.03.2021):
...
- [GitHub](https://github.com/mamba-org/mamba) (👨‍💻 43 · 🔀 76 · 📦 310 · 📋 410 - 27% open · ⏱️ 15.04.2021):

	```
	git clone https://github.com/mamba-org/mamba
	```
- [Conda](https://anaconda.org/conda-forge/mamba) (📥 680K · ⏱️ 01.04.2021):
	```
...
- [GitHub](https://github.com/pipxproject/pipx) (👨‍💻 55 · 🔀 150 · 📋 370 - 17% open · ⏱️ 13.04.2021):

	```
	git clone https://github.com/pipxproject/pipx
	```
- [PyPi](https://pypi.org/project/pipx) (📥 44K / month · 📦 4 · ⏱️ 16.01.2021):
	```
	pip install pipx
	```
</details>
...
- [GitHub](https://github.com/dephell/dephell) (👨‍💻 37 · 🔀 97 · 📥 120 · 📦 140 · 📋 260 - 38% open · ⏱️ 11.01.2021):

	```
	git clone https://github.com/dephell/dephell
	```
- [PyPi](https://pypi.org/project/dephell) (📥 22K / month · 📦 8 · ⏱️ 28.04.2020):
	```
	pip install dephell
	```
</details>
...
- [GitHub](https://github.com/David-OConnor/pyflow) (👨‍💻 21 · 🔀 27 · 📥 2.9K · 📋 83 - 51% open · ⏱️ 21.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyflow) (📥 270 / month · ⏱️ 21.11.2020):
	```
	pip install pyflow
	```
</details>
...
- [GitHub](https://github.com/jaraco/pip-run) (👨‍💻 9 · 🔀 10 · 📋 41 - 9% open · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pip-run) (📥 4.4K / month · ⏱️ 21.02.2021):
	```
	pip install pip-run
	```
</details>
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 67 · 🔀 120 · 📦 2.2K · 📋 260 - 19% open · ⏱️ 21.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/prospector) (📥 510K / month · 📦 1.1K · ⏱️ 21.10.2020):
	```
...
- [GitHub](https://github.com/rubik/xenon) (👨‍💻 7 · 🔀 14 · 📦 200 · 📋 29 - 20% open · ⏱️ 16.09.2020):
	...
	```
- [PyPi](https://pypi.org/project/xenon) (📥 43K / month · 📦 120 · ⏱️ 16.09.2020):
	```
	pip install xenon
	```
...
- [GitHub](https://github.com/tonybaloney/wily) (👨‍💻 15 · 🔀 41 · 📋 76 - 36% open · ⏱️ 02.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/wily) (📥 7.2K / month · 📦 8 · ⏱️ 02.09.2020):
	```
	pip install wily
	```
</details>
...
<details><summary><b><a href="https://github.com/getsentry/sentry-python">sentry-sdk</a></b> (🥇32 ·  ⭐ 900) - The new Python SDK for Sentry.io. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 92 · 🔀 200 · 📥 4.4K · 📦 10K · 📋 510 - 27% open · ⏱️ 14.04.2021):

	```
	git clone https://github.com/getsentry/sentry-python
	```
- [PyPi](https://pypi.org/project/sentry-sdk) (📥 6.6M / month · 📦 990 · ⏱️ 18.02.2021):
	```
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 29 · 🔀 390 · 📦 6.4K · 📋 380 - 8% open · ⏱️ 19.03.2021):

	```
	git clone https://github.com/Delgan/loguru
	```
- [PyPi](https://pypi.org/project/loguru) (📥 1M / month · 📦 340 · ⏱️ 20.09.2020):
	```
	pip install loguru
	```
...
<details><summary><b><a href="https://github.com/astanin/python-tabulate">tabulate</a></b> (🥈31 ·  ⭐ 780) - Pretty-print tabular data in Python, a library and a command-line.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/astanin/python-tabulate) (👨‍💻 67 · 🔀 61 · 📦 41K · 📋 82 - 32% open · ⏱️ 04.03.2021):
...
- [PyPi](https://pypi.org/project/tabulate) (📥 16M / month · 📦 8.1K · ⏱️ 22.02.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tabulate) (📥 940K · ⏱️ 22.02.2021):
	```
...
- [GitHub](https://github.com/hynek/structlog) (👨‍💻 71 · 🔀 130 · 📦 3.1K · 📋 180 - 18% open · ⏱️ 09.04.2021):

	```
	git clone https://github.com/hynek/structlog
	```
- [PyPi](https://pypi.org/project/structlog) (📥 1.7M / month · 📦 1.2K · ⏱️ 18.02.2021):
	```
...
- [GitHub](https://github.com/madzak/python-json-logger) (👨‍💻 43 · 🔀 140 · 📦 14K · 📋 62 - 27% open · ⏱️ 12.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/python-json-logger) (📥 2.7M / month · 📦 920 · ⏱️ 12.10.2020):
	```
	pip install python-json-logger
	```
- [Conda](https://anaconda.org/conda-forge/python-json-logger) (📥 600K · ⏱️ 12.10.2020):
	```
...
- [GitHub](https://github.com/WoLpH/python-progressbar) (👨‍💻 38 · 🔀 91 · 📥 1.6K · 📦 8.5K · 📋 190 - 4% open · ⏱️ 15.03.2021):

	```
	git clone https://github.com/WoLpH/python-progressbar
	```
- [PyPi](https://pypi.org/project/progressbar2) (📥 950K / month · 📦 2.2K · ⏱️ 09.09.2020):
	```
...
- [GitHub](https://github.com/borntyping/python-colorlog) (👨‍💻 29 · 🔀 72 · 📦 9.4K · 📋 62 - 1% open · ⏱️ 14.04.2021):

	```
	git clone https://github.com/borntyping/python-colorlog
	```
- [PyPi](https://pypi.org/project/colorlog) (📥 3.7M / month · 📦 3.7K · ⏱️ 13.04.2021):
	```
...
- [GitHub](https://github.com/xolox/python-coloredlogs) (👨‍💻 16 · 🔀 35 · 📦 7.3K · 📋 72 - 31% open · ⏱️ 10.12.2020):

	```
	git clone https://github.com/xolox/python-coloredlogs
	```
- [PyPi](https://pypi.org/project/coloredlogs) (📥 1.4M / month · 📦 2.1K · ⏱️ 10.12.2020):
	```
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 1 · 🔀 82 · 📦 270 · 📋 58 - 29% open · ⏱️ 08.01.2021):
...
- [PyPi](https://pypi.org/project/alive-progress) (📥 16K / month · ⏱️ 08.01.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/alive-progress) (📥 6.9K · ⏱️ 08.01.2021):
	```
...
- [GitHub](https://github.com/Qix-/better-exceptions) (👨‍💻 14 · 🔀 200 · 📋 70 - 41% open · ⏱️ 29.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/better-exceptions) (📥 43K / month · 📦 74 · ⏱️ 29.01.2021):
	```
...
- [GitHub](https://github.com/shobrook/rebound) (👨‍💻 16 · 🔀 330 · 📥 160 · 📦 18 · 📋 58 - 34% open · ⏱️ 04.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/rebound) (📥 2.3K / month · 📦 14 · ⏱️ 12.02.2021):
	```
	pip install rebound
	```
...
- [GitHub](https://github.com/cknd/stackprinter) (👨‍💻 6 · 🔀 31 · 📦 53 · 📋 22 - 40% open · ⏱️ 01.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/stackprinter) (📥 56K / month · 📦 4 · ⏱️ 31.10.2020):
	```
...
- [GitHub](https://github.com/onelivesleft/PrettyErrors) (👨‍💻 4 · 🔀 63 · 📋 30 - 13% open · ⏱️ 27.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/pretty_errors) (📥 16K / month · ⏱️ 24.11.2020):
	```
...
- <b><a href="https://github.com/jazzband/prettytable">prettytable</a></b> (🥈28 ·  ⭐ 430) - Display tabular data in a visually appealing ASCII table.. <code><a href="https://tldrlegal.com/search?q=BSD-1-Clause">❗️BSD-1-Clause</a></code>
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (👨‍💻 630 · 🔀 1.4K · 📦 140K · 📋 5.3K - 14% open · ⏱️ 15.04.2021):

	```
	git clone https://github.com/sphinx-doc/sphinx
	```
- [PyPi](https://pypi.org/project/sphinx) (📥 4.3M / month · 📦 100K · ⏱️ 11.04.2021):
	```
	pip install sphinx
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs) (👨‍💻 190 · 🔀 1.7K · 📦 12K · 📋 1.5K - 9% open · ⏱️ 15.04.2021):

	```
	git clone https://github.com/mkdocs/mkdocs
	```
- [PyPi](https://pypi.org/project/mkdocs) (📥 540K / month · 📦 5.9K · ⏱️ 14.05.2020):
	```
	pip install mkdocs
	```
...
- [GitHub](https://github.com/readthedocs/sphinx_rtd_theme) (👨‍💻 100 · 🔀 1.5K · 📦 16 · 📋 650 - 25% open · ⏱️ 09.04.2021):
...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 110 · 🔀 1.5K · 📦 6.1K · 📋 1K - 1% open · ⏱️ 15.04.2021):

	```
	git clone https://github.com/squidfunk/mkdocs-material
	```
- [PyPi](https://pypi.org/project/mkdocs-material) (📥 430K / month · 📦 1.5K · ⏱️ 29.03.2021):
	```
	pip install mkdocs-material
	```
- [Conda](https://anaconda.org/conda-forge/mkdocs-material) (📥 37K · ⏱️ 10.04.2021):
	```
...
- [GitHub](https://github.com/numpy/numpydoc) (👨‍💻 65 · 🔀 5.4K · 📦 25K · 📋 140 - 35% open · ⏱️ 13.04.2021):
...
- [PyPi](https://pypi.org/project/numpydoc) (📥 240K / month · 📦 7.3K · ⏱️ 01.07.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/numpydoc) (📥 750K · ⏱️ 01.10.2020):
	```
...
- [GitHub](https://github.com/michaeljones/breathe) (👨‍💻 93 · 🔀 140 · 📥 14 · 📦 4.3K · 📋 420 - 22% open · ⏱️ 09.04.2021):

	```
	git clone https://github.com/michaeljones/breathe
	```
- [PyPi](https://pypi.org/project/breathe) (📥 86K / month · 📦 2K · ⏱️ 09.04.2021):
	```
	pip install breathe
	```
- [Conda](https://anaconda.org/conda-forge/breathe) (📥 180K · ⏱️ 10.04.2021):
	```
...
- [GitHub](https://github.com/agronholm/sphinx-autodoc-typehints) (👨‍💻 29 · 🔀 65 · 📋 110 - 38% open · ⏱️ 15.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/sphinx-autodoc-typehints) (📥 230K / month · 📦 1.4K · ⏱️ 12.10.2020):
	```
...
- [PyPi](https://pypi.org/project/sphinx-autobuild) (📥 160K / month · 📦 4.7K · ⏱️ 14.03.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sphinx-autobuild) (📥 49K · ⏱️ 14.03.2021):
	```
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 28 · 🔀 100 · 📦 310 · 📋 150 - 1% open · ⏱️ 11.04.2021):

	```
	git clone https://github.com/mitmproxy/pdoc
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 30K / month · 📦 290 · ⏱️ 28.03.2021):
	```
	pip install pdoc
	```
</details>
...
- [GitHub](https://github.com/econchick/interrogate) (👨‍💻 8 · 🔀 17 · 📦 470 · 📋 27 - 40% open · ⏱️ 03.11.2020):

	```
	git clone https://github.com/econchick/interrogate
	```
- [PyPi](https://pypi.org/project/interrogate) (📥 49K / month · ⏱️ 03.11.2020):
	```
...
- [GitHub](https://github.com/zhaoterryy/mkdocs-pdf-export-plugin) (👨‍💻 9 · 🔀 27 · 📦 120 · 📋 72 - 40% open · ⏱️ 23.07.2020):
	...
	```
- [PyPi](https://pypi.org/project/mkdocs-pdf-export-plugin) (📥 14K / month · 📦 4 · ⏱️ 23.07.2020):
	```
	pip install mkdocs-pdf-export-plugin
	```
</details>
<details><summary><b><a href="https://github.com/mkdocstrings/mkdocstrings">mkdocstrings</a></b> (🥉20 ·  ⭐ 340) - Automatic documentation from sources, for MkDocs. <code><a href="http://bit.ly/3hkKRql">ISC</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/mkdocstrings/mkdocstrings) (👨‍💻 19 · 🔀 37 · 📋 170 - 28% open · ⏱️ 04.04.2021):

	```
	git clone https://github.com/pawamoy/mkdocstrings
	```
- [PyPi](https://pypi.org/project/mkdocstrings) (📥 42K / month · ⏱️ 28.02.2021):
	```
...
- [GitHub](https://github.com/asottile/blacken-docs) (👨‍💻 12 · 🔀 17 · 📋 26 - 7% open · ⏱️ 12.04.2021):

	```
	git clone https://github.com/asottile/blacken-docs
	```
- [PyPi](https://pypi.org/project/blacken-docs) (📥 4.4K / month · 📦 22 · ⏱️ 02.03.2021):
	```
...
<details><summary><b><a href="https://github.com/clayrisser/sphinx-markdown-builder">sphinx-markdown-builder</a></b> (🥉19 ·  ⭐ 98) - sphinx builder that outputs markdown files. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.sphinx-doc.org/en/master/_static/favicon.svg" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://github.com/orzih/mkdocs-with-pdf">mkdocs-with-pdf</a></b> (🥉19 ·  ⭐ 51) - Generate a single PDF file from MkDocs repository. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/orzih/mkdocs-with-pdf) (👨‍💻 5 · 🔀 8 · 📦 16 · 📋 38 - 26% open · ⏱️ 08.04.2021):
...
- [GitHub](https://github.com/timothycrosley/portray) (👨‍💻 15 · 🔀 55 · 📋 47 - 40% open · ⏱️ 07.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/portray) (📥 6.5K / month · 📦 8 · ⏱️ 02.04.2021):
	```
	pip install portray
	```
</details>
...
- [GitHub](https://github.com/ml-tooling/lazydocs) (👨‍💻 4 · 🔀 3 · 📦 11 · ⏱️ 15.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/lazydocs) (📥 570 / month · ⏱️ 15.03.2021):
	```
...
- <b><a href="https://github.com/zhaoterryy/mkdocs-git-revision-date-plugin">mkdocs-git-revision-date-plugin</a></b> (🥉19 ·  ⭐ 32) - MkDocs plugin for setting revision date from git per.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/timvink/mkdocs-print-site-plugin">mkdocs-print-site-plugin</a></b> (🥉16 ·  ⭐ 15) - MkDocs Plugin allowing your visitors to *File Print.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
- [PyPi](https://pypi.org/project/ipdb) (📥 1.6M / month · 📦 17K · ⏱️ 08.03.2021):
	...
	pip install ipdb
	```
- [Conda](https://anaconda.org/conda-forge/ipdb) (📥 160K · ⏱️ 21.11.2020):
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 75 · 🔀 390 · 📦 2K · 📋 160 - 33% open · ⏱️ 26.01.2021):

	```
	git clone https://github.com/eliben/pyelftools
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 710K / month · 📦 880 · ⏱️ 27.10.2020):
	```
...
- [GitHub](https://github.com/cool-RR/PySnooper) (👨‍💻 25 · 🔀 890 · 📦 370 · 📋 110 - 16% open · ⏱️ 04.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/pysnooper) (📥 57K / month · 📦 46 · ⏱️ 14.09.2020):
	```
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 72 · 🔀 170 · 📦 2.3K · 📋 270 - 51% open · ⏱️ 08.04.2021):

	```
	git clone https://github.com/inducer/pudb
	```
- [PyPi](https://pypi.org/project/pudb) (📥 660K / month · 📦 1.4K · ⏱️ 21.12.2020):
	```
	pip install pudb
	```
...
- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 39 · 🔀 39 · 📦 2K · 📋 160 - 33% open · ⏱️ 22.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/pdbpp) (📥 200K / month · 📦 1K · ⏱️ 04.10.2019):
	```
	pip install pdbpp
	```
...
- [GitHub](https://github.com/cs01/gdbgui) (👨‍💻 35 · 🔀 460 · 📥 3.2K · 📦 82 · 📋 260 - 41% open · ⏱️ 21.12.2020):

	```
	git clone https://github.com/cs01/gdbgui
	```
- [PyPi](https://pypi.org/project/gdbgui) (📥 64K / month · 📦 2 · ⏱️ 21.12.2020):
	```
	pip install gdbgui
	```
</details>
...
- [GitHub](https://github.com/agronholm/typeguard) (👨‍💻 17 · 🔀 57 · 📋 150 - 23% open · ⏱️ 01.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/typeguard) (📥 1.3M / month · 📦 160 · ⏱️ 01.04.2021):
	```
	pip install typeguard
	```
- [Conda](https://anaconda.org/conda-forge/typeguard) (📥 35K · ⏱️ 01.04.2021):
	```
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 8 · 🔀 29 · 📦 59 · 📋 81 - 43% open · ⏱️ 25.03.2021):
...
<details><summary><b><a href="https://github.com/gruns/icecream">icecream</a></b> (🥉22 ·  ⭐ 4.5K) - Never use print() to debug again. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/gruns/icecream) (👨‍💻 13 · 🔀 84 · 📋 60 - 30% open · ⏱️ 06.04.2021):

	```
	git clone https://github.com/gruns/icecream
	```
- [PyPi](https://pypi.org/project/icecream) (📥 31K / month · 📦 6 · ⏱️ 27.01.2021):
	```
...
- [GitHub](https://github.com/ionelmc/python-manhole) (👨‍💻 10 · 🔀 15 · 📦 67 · 📋 20 - 25% open · ⏱️ 08.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/manhole) (📥 14K / month · 📦 66 · ⏱️ 08.04.2021):
	```
	pip install manhole
	```
</details>
...
- [GitHub](https://github.com/alexmojaki/snoop) (👨‍💻 20 · 🔀 19 · 📦 30 · 📋 26 - 42% open · ⏱️ 26.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/snoop) (📥 27K / month · 📦 8 · ⏱️ 26.03.2021):
	```
	pip install snoop
	```
</details>
...
- [GitHub](https://github.com/alexmojaki/birdseye) (👨‍💻 9 · 🔀 70 · 📋 48 - 35% open · ⏱️ 26.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/birdseye) (📥 1.8K / month · ⏱️ 25.08.2020):
	```
...
<details><summary><b><a href="https://github.com/pytest-dev/pytest">pytest</a></b> (🥇36 ·  ⭐ 7.2K · 📈) - The pytest framework makes it easy to write small tests, yet.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pytest-dev/pytest) (👨‍💻 700 · 🔀 1.7K · 📦 310K · 📋 4.5K - 14% open · ⏱️ 15.04.2021):
...
- [PyPi](https://pypi.org/project/pytest) (📥 27M / month · 📦 130K · ⏱️ 03.04.2021):
	...
	pip install pytest
	```
- [Conda](https://anaconda.org/conda-forge/pytest) (📥 7.3M · ⏱️ 05.04.2021):
	```
...
- [GitHub](https://github.com/tox-dev/tox) (👨‍💻 240 · 🔀 360 · 📦 43K · 📋 1.2K - 11% open · ⏱️ 12.04.2021):

	```
	git clone https://github.com/tox-dev/tox
	```
- [PyPi](https://pypi.org/project/tox) (📥 4.2M / month · 📦 36K · ⏱️ 16.02.2021):
	```
	pip install tox
	```
- [Conda](https://anaconda.org/conda-forge/tox) (📥 260K · ⏱️ 03.03.2021):
	```
	conda install -c conda-forge tox
	```
</details>
<details><summary><b><a href="https://github.com/robotframework/robotframework">robotframework</a></b> (🥇34 ·  ⭐ 5.8K · 📈) - Generic automation framework for acceptance testing and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 140 · 🔀 1.6K · 📥 500 · 📦 3.6K · 📋 3.5K - 5% open · ⏱️ 12.04.2021):

	```
	git clone https://github.com/robotframework/robotframework
	```
- [PyPi](https://pypi.org/project/robotframework) (📥 750K / month · 📦 1.4K · ⏱️ 08.04.2021):
	```
	pip install robotframework
	```
- [Conda](https://anaconda.org/conda-forge/robotframework) (📥 44K · ⏱️ 09.04.2021):
	```
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 250 · 🔀 460 · 📦 8.3K · 📋 1.1K - 4% open · ⏱️ 15.04.2021):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 2M / month · 📦 2.6K · ⏱️ 12.04.2021):
	```
	pip install hypothesis
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 3.9M · ⏱️ 15.04.2021):
	```
	conda install -c conda-forge hypothesis
	```
</details>
<details><summary><b><a href="https://github.com/spulec/freezegun">freezegun</a></b> (🥇32 ·  ⭐ 2.8K · 📈) - Let your Python tests travel through time. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 94 · 🔀 200 · 📦 7.7K · 📋 230 - 28% open · ⏱️ 20.01.2021):
...
- [GitHub](https://github.com/pytest-dev/pytest-mock) (👨‍💻 51 · 🔀 89 · 📦 15K · 📋 95 - 11% open · ⏱️ 19.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-mock) (📥 3.6M / month · 📦 6.2K · ⏱️ 10.01.2021):
	```
	pip install pytest-mock
	```
- [Conda](https://anaconda.org/conda-forge/pytest-mock) (📥 850K · ⏱️ 11.01.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-xdist) (👨‍💻 73 · 🔀 150 · 📦 17K · 📋 420 - 45% open · ⏱️ 07.04.2021):

	```
	git clone https://github.com/pytest-dev/pytest-xdist
	```
- [PyPi](https://pypi.org/project/pytest-xdist) (📥 4.5M / month · 📦 7.3K · ⏱️ 09.02.2021):
	```
...
- [GitHub](https://github.com/TheKevJames/coveralls-python) (👨‍💻 55 · 🔀 170 · 📦 17K · 📋 140 - 3% open · ⏱️ 09.04.2021):

	```
	git clone https://github.com/coveralls-clients/coveralls-python
	```
- [PyPi](https://pypi.org/project/coveralls) (📥 580K / month · 📦 17K · ⏱️ 02.03.2021):
	```
...
- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 42 · 🔀 680 · 📦 7.1K · 📋 460 - 64% open · ⏱️ 04.10.2020):

	```
	git clone https://github.com/asweigart/pyautogui
	```
- [PyPi](https://pypi.org/project/pyautogui) (📥 450K / month · 📦 610 · ⏱️ 06.10.2020):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-html) (👨‍💻 43 · 🔀 160 · 📦 9K · 📋 250 - 28% open · ⏱️ 23.01.2021):
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 270 · 📥 160 · 📋 280 - 2% open · ⏱️ 05.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/mimesis) (📥 87K / month · 📦 84 · ⏱️ 21.12.2020):
	```
	pip install mimesis
	```
</details>
...
- [GitHub](https://github.com/pytest-dev/pytest-asyncio) (👨‍💻 26 · 🔀 75 · 📦 11K · 📋 150 - 39% open · ⏱️ 01.12.2020):

	```
	git clone https://github.com/pytest-dev/pytest-asyncio
	```
- [PyPi](https://pypi.org/project/pytest-asyncio) (📥 1.5M / month · 📦 2K · ⏱️ 23.06.2020):
	```
	pip install pytest-asyncio
	```
- [Conda](https://anaconda.org/conda-forge/pytest-asyncio) (📥 380K · ⏱️ 06.04.2021):
	```
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 71 · 🔀 130 · 📦 3.6K · 📋 250 - 21% open · ⏱️ 10.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/nose2) (📥 260K / month · 📦 1.9K · ⏱️ 27.01.2021):
	```
	pip install nose2
	```
...
- [PyPi](https://pypi.org/project/ddt) (📥 300K / month · 📦 2.5K · ⏱️ 15.05.2020):
	...
	pip install ddt
	```
- [Conda](https://anaconda.org/conda-forge/ddt) (📥 57K · ⏱️ 15.05.2020):
	```
	conda install -c conda-forge ddt
	```
</details>
<details><summary><b><a href="https://github.com/pytest-dev/pytest-bdd">pytest-bdd</a></b> (🥉27 ·  ⭐ 800) - BDD library for the py.test runner. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pytest-dev/pytest-bdd) (👨‍💻 39 · 🔀 130 · 📦 1.2K · 📋 230 - 44% open · ⏱️ 15.04.2021):

	```
	git clone https://github.com/pytest-dev/pytest-bdd
	```
- [PyPi](https://pypi.org/project/pytest-bdd) (📥 170K / month · 📦 270 · ⏱️ 07.12.2020):
	```
	pip install pytest-bdd
	```
- [Conda](https://anaconda.org/conda-forge/pytest-bdd) (📥 24K · ⏱️ 03.02.2020):
	```
...
- [PyPi](https://pypi.org/project/pytest-sugar) (📥 510K / month · 📦 4.6K · ⏱️ 06.07.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-sugar) (📥 95K · ⏱️ 18.09.2020):
	```
...
- [GitHub](https://github.com/ionelmc/pytest-benchmark) (👨‍💻 32 · 🔀 74 · 📦 1.7K · 📋 140 - 47% open · ⏱️ 12.03.2021):

	```
	git clone https://github.com/ionelmc/pytest-benchmark
	```
- [PyPi](https://pypi.org/project/pytest-benchmark) (📥 310K / month · 📦 730 · ⏱️ 10.01.2020):
	```
	pip install pytest-benchmark
	```
- [Conda](https://anaconda.org/conda-forge/pytest-benchmark) (📥 480K · ⏱️ 24.03.2020):
	```
...
- [GitHub](https://github.com/CleanCut/green) (👨‍💻 37 · 🔀 73 · 📦 570 · 📋 170 - 7% open · ⏱️ 03.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/green) (📥 15K / month · 📦 360 · ⏱️ 23.11.2020):
	```
	pip install green
	```
- [Conda](https://anaconda.org/conda-forge/green) (📥 73K · ⏱️ 12.11.2020):
	```
...
- [PyPi](https://pypi.org/project/pytest-mypy) (📥 240K / month · 📦 270 · ⏱️ 21.03.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-mypy) (📥 8.5K · ⏱️ 24.11.2020):
	```
...
- [GitHub](https://github.com/microsoft/playwright-python) (👨‍💻 17 · 🔀 360 · 📦 160 · 📋 300 - 11% open · ⏱️ 05.04.2021):

	```
	git clone https://github.com/microsoft/playwright-python
	```
- [PyPi](https://pypi.org/project/playwright) (📥 43K / month · ⏱️ 10.03.2021):
	```
...
- [PyPi](https://pypi.org/project/asv) (📥 17K / month · 📦 88 · ⏱️ 16.05.2020):
	...
	pip install asv
	```
- [Conda](https://anaconda.org/conda-forge/asv) (📥 380K · ⏱️ 16.02.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-testinfra) (👨‍💻 100 · 🔀 270 · 📋 310 - 36% open · ⏱️ 18.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-testinfra) (📥 100K / month · ⏱️ 12.11.2020):
	```
...
- [GitHub](https://github.com/theacodes/nox) (👨‍💻 55 · 🔀 87 · 📦 510 · 📋 220 - 23% open · ⏱️ 12.03.2021):
...
- [GitHub](https://github.com/tarpas/pytest-testmon) (👨‍💻 16 · 🔀 28 · 📦 290 · 📋 110 - 30% open · ⏱️ 18.03.2021):

	```
	git clone https://github.com/tarpas/pytest-testmon
	```
- [PyPi](https://pypi.org/project/pytest-testmon) (📥 76K / month · 📦 98 · ⏱️ 05.08.2020):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-randomly) (👨‍💻 15 · 🔀 22 · 📋 39 - 17% open · ⏱️ 11.04.2021):

	```
	git clone https://github.com/pytest-dev/pytest-randomly
	```
- [PyPi](https://pypi.org/project/pytest-randomly) (📥 660K / month · 📦 210 · ⏱️ 11.04.2021):
	```
	pip install pytest-randomly
	```
</details>
<details><summary><b><a href="https://github.com/Erotemic/xdoctest">xdoctest</a></b> (🥉23 ·  ⭐ 93) - A rewrite of Python's builtin doctest module (with pytest plugin.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Erotemic/xdoctest) (👨‍💻 5 · 🔀 5 · 📦 880 · 📋 32 - 50% open · ⏱️ 19.02.2021):

	```
	git clone https://github.com/Erotemic/xdoctest
	```
- [PyPi](https://pypi.org/project/xdoctest) (📥 53K / month · 📦 52 · ⏱️ 29.01.2021):
	```
...
- [GitHub](https://github.com/sixpack/sixpack) (👨‍💻 56 · 🔀 180 · 📦 8 · 📋 210 - 41% open · ⏱️ 26.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/sixpack) (📥 370 / month · 📦 4 · ⏱️ 22.11.2017):
	```
	pip install sixpack
	```
</details>
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 400 · 🔀 1.6K · 📥 690K · 📦 16K · 📋 4.1K - 8% open · ⏱️ 15.04.2021):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 550K / month · ⏱️ 13.01.2021):
	```
...
<details><summary><b><a href="https://github.com/pypa/packaging">packaging</a></b> (🥇30 ·  ⭐ 290) - Core utilities for Python packages. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/pypa/packaging) (👨‍💻 66 · 🔀 140 · 📥 71 · 📦 190K · 📋 190 - 27% open · ⏱️ 25.03.2021):

	```
	git clone https://github.com/pypa/packaging
	```
- [PyPi](https://pypi.org/project/packaging) (📥 52M / month · 📦 29K · ⏱️ 29.01.2021):
	```
	pip install packaging
	```
- [Conda](https://anaconda.org/conda-forge/packaging) (📥 6.8M · ⏱️ 04.02.2021):
	```
...
- [GitHub](https://github.com/Nuitka/Nuitka) (👨‍💻 91 · 🔀 270 · 📋 880 - 20% open · ⏱️ 12.04.2021):

	```
	git clone https://github.com/Nuitka/Nuitka
	```
- [PyPi](https://pypi.org/project/nuitka) (📥 20K / month · 📦 54 · ⏱️ 04.04.2021):
	```
	pip install nuitka
	```
- [Conda](https://anaconda.org/conda-forge/nuitka) (📥 270K · ⏱️ 04.04.2021):
	```
...
- [GitHub](https://github.com/pantsbuild/pex) (👨‍💻 97 · 🔀 190 · 📥 280K · 📋 680 - 20% open · ⏱️ 11.04.2021):

	```
	git clone https://github.com/pantsbuild/pex
	```
- [PyPi](https://pypi.org/project/pex) (📥 150K / month · 📦 230 · ⏱️ 01.04.2021):
	```
	pip install pex
	```
</details>
...
- [GitHub](https://github.com/py2exe/py2exe) (👨‍💻 14 · 🔀 34 · 📥 8.6K · 📦 1.1K · 📋 72 - 6% open · ⏱️ 28.03.2021):

	```
	git clone https://github.com/py2exe/py2exe
	```
- [PyPi](https://pypi.org/project/py2exe) (📥 40K / month · 📦 350 · ⏱️ 28.03.2021):
	```
	pip install py2exe
	```
</details>
...
<details><summary><b><a href="https://github.com/marcelotduarte/cx_Freeze">cx_Freeze</a></b> (🥉22 ·  ⭐ 690 · 📉) - Create standalone executables from Python scripts, with the.. <code><a href="http://bit.ly/35wkF7y">Python-2.0</a></code></summary>

- [GitHub](https://github.com/marcelotduarte/cx_Freeze) (👨‍💻 89 · 🔀 150 · 📋 660 - 12% open · ⏱️ 14.04.2021):

	```
	git clone https://github.com/marcelotduarte/cx_Freeze
	```
- [PyPi](https://pypi.org/project/cx_freeze) (📥 36K / month · 📦 150 · ⏱️ 16.12.2017):
	```
	pip install cx_freeze
	```
- [Conda](https://anaconda.org/conda-forge/cx_freeze) (📥 61K · ⏱️ 21.02.2021):
	```
...
- [GitHub](https://github.com/facebookincubator/xar) (👨‍💻 21 · 🔀 45 · 📦 14 · 📋 29 - 27% open · ⏱️ 16.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/xar) (📥 300 / month · ⏱️ 02.12.2020):
	```
	pip install xar
	```
</details>
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 30 · 🔀 64 · 📥 120 · 📋 82 - 31% open · ⏱️ 15.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/shiv) (📥 5.9K / month · 📦 10 · ⏱️ 19.10.2020):
	```
	pip install shiv
	```
</details>
...
- [GitHub](https://github.com/indygreg/PyOxidizer) (👨‍💻 32 · 🔀 110 · 📋 320 - 61% open · ⏱️ 15.04.2021):
...
- [GitHub](https://github.com/pypa/setuptools) (👨‍💻 420 · 🔀 720 · 📥 100 · 📦 97K · 📋 1.8K - 29% open · ⏱️ 14.04.2021):

	```
	git clone https://github.com/pypa/setuptools
	```
- [PyPi](https://pypi.org/project/setuptools) (📥 120M / month · 📦 58K · ⏱️ 09.04.2021):
	```
...
- [GitHub](https://github.com/pyinvoke/invoke) (👨‍💻 54 · 🔀 280 · 📦 7.4K · 📋 660 - 45% open · ⏱️ 31.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/invoke) (📥 1.3M / month · 📦 4.6K · ⏱️ 31.12.2020):
	```
	pip install invoke
	```
- [Conda](https://anaconda.org/conda-forge/invoke) (📥 280K · ⏱️ 06.01.2021):
	```
...
- [GitHub](https://github.com/pypa/twine) (👨‍💻 100 · 🔀 240 · 📦 38K · 📋 350 - 11% open · ⏱️ 10.04.2021):
...
- [GitHub](https://github.com/pypa/wheel) (👨‍💻 60 · 🔀 88 · 📋 310 - 7% open · ⏱️ 08.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/wheel) (📥 72M / month · 📦 63K · ⏱️ 13.12.2020):
	```
	pip install wheel
	```
...
- [GitHub](https://github.com/buildbot/buildbot) (👨‍💻 790 · 🔀 1.5K · 📥 15K · 📦 250 · 📋 1.3K - 48% open · ⏱️ 15.04.2021):

	```
	git clone https://github.com/buildbot/buildbot
	```
- [PyPi](https://pypi.org/project/buildbot) (📥 33K / month · 📦 890 · ⏱️ 05.04.2021):
	```
...
- [GitHub](https://github.com/SCons/scons) (👨‍💻 130 · 🔀 210 · 📥 350 · 📋 3.3K - 20% open · ⏱️ 13.04.2021):
...
- [GitHub](https://github.com/pydoit/doit) (👨‍💻 54 · 🔀 120 · 📦 680 · 📋 250 - 25% open · ⏱️ 10.04.2021):

	```
	git clone https://github.com/pydoit/doit
	```
- [PyPi](https://pypi.org/project/doit) (📥 120K / month · 📦 470 · ⏱️ 04.09.2020):
	```
	pip install doit
	```
- [Conda](https://anaconda.org/conda-forge/doit) (📥 49K · ⏱️ 11.10.2020):
	```
...
- [GitHub](https://github.com/takluyver/flit) (👨‍💻 42 · 🔀 68 · 📋 240 - 34% open · ⏱️ 02.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/flit) (📥 53K / month · 📦 230 · ⏱️ 01.03.2021):
	```
	pip install flit
	```
...
- [GitHub](https://github.com/pybuilder/pybuilder) (👨‍💻 35 · 🔀 230 · 📋 480 - 18% open · ⏱️ 18.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/pybuilder) (📥 18K / month · 📦 110 · ⏱️ 14.04.2021):
	```
...
- [GitHub](https://github.com/pypa/setuptools_scm) (👨‍💻 83 · 🔀 140 · 📋 330 - 20% open · ⏱️ 12.04.2021):
...
<details><summary><b><a href="https://github.com/ml-tooling/universal-build">universal-build</a></b> (🥉12 ·  ⭐ 7 · 🐣) - Universal build utilities for containerized build pipelines. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/ml-tooling/universal-build) (👨‍💻 4 · 🔀 2 · 📥 15 · ⏱️ 06.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/universal-build) (📥 470 / month · ⏱️ 12.12.2020):
	```
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 160 · 🔀 1.1K · 📦 81K · 📋 1.5K - 12% open · ⏱️ 08.04.2021):
...
- [PyPi](https://pypi.org/project/psutil) (📥 22M / month · 📦 25K · ⏱️ 19.12.2020):
	...
	pip install psutil
	```
- [Conda](https://anaconda.org/conda-forge/psutil) (📥 6.4M · ⏱️ 12.01.2021):
	```
...
- [GitHub](https://github.com/nicolargo/glances) (👨‍💻 140 · 🔀 1.2K · 📥 430 · 📦 290 · 📋 1.3K - 14% open · ⏱️ 11.04.2021):

	```
	git clone https://github.com/nicolargo/glances
	```
- [PyPi](https://pypi.org/project/glances) (📥 67K / month · 📦 50 · ⏱️ 07.02.2021):
	```
	pip install glances
	```
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 23 · 🔀 250 · 📥 4.9K · 📦 720 · 📋 200 - 31% open · ⏱️ 22.03.2021):

	```
	git clone https://github.com/benfred/py-spy
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 570K / month · 📦 50 · ⏱️ 22.03.2021):
	```
	pip install py-spy
	```
</details>
...
- [GitHub](https://github.com/pythonprofilers/memory_profiler) (👨‍💻 85 · 🔀 310 · 📋 190 - 47% open · ⏱️ 22.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 260K / month · 📦 530 · ⏱️ 16.08.2018):
	```
...
- [GitHub](https://github.com/joerick/pyinstrument) (👨‍💻 27 · 🔀 100 · 📦 240 · 📋 80 - 26% open · ⏱️ 10.04.2021):

	```
	git clone https://github.com/joerick/pyinstrument
	```
- [PyPi](https://pypi.org/project/pyinstrument) (📥 140K / month · 📦 140 · ⏱️ 19.02.2021):
	```
	pip install pyinstrument
	```
- [Conda](https://anaconda.org/conda-forge/pyinstrument) (📥 67K · ⏱️ 19.02.2021):
	```
...
- [GitHub](https://github.com/sumerc/yappi) (👨‍💻 22 · 🔀 43 · 📦 390 · 📋 43 - 27% open · ⏱️ 23.03.2021):

	```
	git clone https://github.com/sumerc/yappi
	```
- [PyPi](https://pypi.org/project/yappi) (📥 210K / month · 📦 640 · ⏱️ 27.11.2020):
	```
	pip install yappi
	```
- [Conda](https://anaconda.org/conda-forge/yappi) (📥 71K · ⏱️ 28.11.2020):
	```
...
- [GitHub](https://github.com/pyutils/line_profiler) (👨‍💻 21 · 🔀 240 · 📋 36 - 72% open · ⏱️ 14.04.2021):

	```
	git clone https://github.com/pyutils/line_profiler
	```
- [PyPi](https://pypi.org/project/line_profiler) (📥 370K / month · 📦 690 · ⏱️ 20.12.2017):
	```
...
- [GitHub](https://github.com/pympler/pympler) (👨‍💻 26 · 🔀 67 · 📋 78 - 41% open · ⏱️ 15.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/pympler) (📥 180K / month · 📦 480 · ⏱️ 14.10.2020):
	```
	pip install pympler
	```
...
<details><summary><b><a href="https://github.com/aristocratos/bpytop">Bpytop</a></b> (🥉23 ·  ⭐ 6.2K) - Linux/OSX/FreeBSD resource monitor. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/aristocratos/bpytop) (👨‍💻 27 · 🔀 230 · 📋 220 - 18% open · ⏱️ 21.02.2021):
...
- [GitHub](https://github.com/plasma-umass/scalene) (👨‍💻 18 · 🔀 140 · 📦 36 · 📋 92 - 15% open · ⏱️ 14.04.2021):

	```
	git clone https://github.com/emeryberger/scalene
	```
- [PyPi](https://pypi.org/project/scalene) (📥 4.2K / month · ⏱️ 09.04.2021):
	```
	pip install scalene
	```
</details>
...
- [GitHub](https://github.com/nvdv/vprof) (👨‍💻 17 · 🔀 160 · 📦 73 · 📋 79 - 29% open · ⏱️ 20.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/vprof) (📥 3.5K / month · 📦 18 · ⏱️ 29.02.2020):
	```
	pip install vprof
	```
</details>
...
<details><summary><b><a href="https://github.com/berkerpeksag/astor">astor</a></b> (🥈28 ·  ⭐ 570) - Python AST read/write. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/berkerpeksag/astor) (👨‍💻 31 · 🔀 80 · 📋 110 - 32% open · ⏱️ 15.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/astor) (📥 3.3M / month · 📦 3.8K · ⏱️ 10.12.2019):
	```
	pip install astor
	```
...
- [GitHub](https://github.com/serge-sans-paille/gast) (👨‍💻 10 · 🔀 22 · 📦 52K · 📋 25 - 16% open · ⏱️ 26.11.2020):

	```
	git clone https://github.com/serge-sans-paille/gast
	```
- [PyPi](https://pypi.org/project/gast) (📥 6.6M / month · 📦 3.4K · ⏱️ 07.08.2020):
	```
	pip install gast
	```
...
- [GitHub](https://github.com/pre-commit/pre-commit) (👨‍💻 120 · 🔀 430 · 📥 3.7K · 📋 1.1K - 2% open · ⏱️ 12.04.2021):

	```
	git clone https://github.com/pre-commit/pre-commit
	```
- [PyPi](https://pypi.org/project/pre-commit) (📥 2.9M / month · 📦 2.1K · ⏱️ 10.03.2021):
	```
	pip install pre-commit
	```
- [Conda](https://anaconda.org/conda-forge/pre-commit) (📥 470K · ⏱️ 07.04.2021):
	```
