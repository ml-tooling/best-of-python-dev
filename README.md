...
- [GitHub](https://github.com/python/mypy) (👨‍💻 520 · 🔀 1.9K · 📦 52K · 📋 7K - 28% open · ⏱️ 01.12.2021):

	```
	git clone https://github.com/python/mypy
	```
- [PyPi](https://pypi.org/project/mypy) (📥 6.3M / month · 📦 6.1K · ⏱️ 22.06.2021):
	```
	pip install mypy
	```
...
- [GitHub](https://github.com/PyCQA/flake8) (👨‍💻 160 · 🔀 180 · 📦 210K · 📋 1.3K - 2% open · ⏱️ 25.11.2021):

	```
	git clone https://github.com/PyCQA/flake8
	```
- [PyPi](https://pypi.org/project/flake8) (📥 11M / month · 📦 71K · ⏱️ 11.10.2021):
	```
	pip install flake8
	```
...
- [GitHub](https://github.com/PyCQA/pyflakes) (👨‍💻 79 · 🔀 160 · 📦 110K · 📋 440 - 18% open · ⏱️ 21.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyflakes) (📥 11M / month · 📦 26K · ⏱️ 06.10.2021):
	```
...
- [GitHub](https://github.com/davidhalter/parso) (👨‍💻 43 · 🔀 76 · 📦 160K · 📋 100 - 6% open · ⏱️ 30.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/parso) (📥 14M / month · 📦 11K · ⏱️ 30.11.2021):
	```
	pip install parso
	```
- [Conda](https://anaconda.org/conda-forge/parso) (📥 5.7M · ⏱️ 01.12.2021):
	```
...
- [GitHub](https://github.com/PyCQA/pycodestyle) (👨‍💻 130 · 🔀 610 · 📦 180K · 📋 660 - 16% open · ⏱️ 23.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pycodestyle) (📥 15M / month · 📦 21K · ⏱️ 11.10.2021):
	```
...
- [GitHub](https://github.com/PyCQA/pylint) (👨‍💻 430 · 🔀 790 · 📋 3.8K - 19% open · ⏱️ 30.11.2021):

	```
	git clone https://github.com/PyCQA/pylint
	```
- [PyPi](https://pypi.org/project/pylint) (📥 7.1M / month · 📦 38K · ⏱️ 25.11.2021):
	```
	pip install pylint
	```
- [Conda](https://anaconda.org/conda-forge/pylint) (📥 2.5M · ⏱️ 25.11.2021):
	```
...
- [GitHub](https://github.com/PyCQA/pydocstyle) (👨‍💻 74 · 🔀 150 · 📥 56 · 📦 21K · 📋 280 - 28% open · ⏱️ 10.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pydocstyle) (📥 1.5M / month · 📦 3.9K · ⏱️ 17.05.2021):
	```
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 160 · 🔀 310 · 📦 830 · 📋 1K - 9% open · ⏱️ 01.12.2021):

	```
	git clone https://github.com/wemake-services/wemake-python-styleguide
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 110K / month · 📦 14 · ⏱️ 21.06.2021):
	```
...
- [GitHub](https://github.com/PyCQA/flake8-bugbear) (👨‍💻 45 · 🔀 55 · 📦 5.8K · 📋 110 - 38% open · ⏱️ 29.11.2021):

	```
	git clone https://github.com/PyCQA/flake8-bugbear
	```
- [PyPi](https://pypi.org/project/flake8-bugbear) (📥 960K / month · 📦 1K · ⏱️ 29.11.2021):
	```
...
- [GitHub](https://github.com/openstack/hacking) (👨‍💻 180 · 🔀 66 · ⏱️ 07.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/hacking) (📥 450K / month · 📦 8.7K · ⏱️ 21.04.2021):
	```
	pip install hacking
	```
</details>
<details><summary><b><a href="https://github.com/klen/pylama">pylama</a></b> (🥈28 ·  ⭐ 830 · 📈) - Code audit tool for python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/klen/pylama) (👨‍💻 44 · 🔀 86 · 📦 2.8K · 📋 120 - 28% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/klen/pylama
	```
- [PyPi](https://pypi.org/project/pylama) (📥 66K / month · 📦 1K · ⏱️ 02.12.2021):
	```
	pip install pylama
	```
</details>
...
- [GitHub](https://github.com/PyCQA/pylint-django) (👨‍💻 60 · 🔀 100 · 📥 200 · 📦 16K · 📋 180 - 18% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pylint-django) (📥 510K / month · 📦 2.2K · ⏱️ 09.04.2021):
	```
...
- [GitHub](https://github.com/zheller/flake8-quotes) (👨‍💻 30 · 🔀 34 · 📦 3.9K · 📋 43 - 6% open · ⏱️ 19.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-quotes) (📥 490K / month · 📦 1.4K · ⏱️ 19.10.2021):
	```
...
- [GitHub](https://github.com/gforcada/flake8-isort) (👨‍💻 29 · 🔀 40 · 📦 4.2K · 📋 53 - 24% open · ⏱️ 15.10.2021):

	```
	git clone https://github.com/gforcada/flake8-isort
	```
- [PyPi](https://pypi.org/project/flake8-isort) (📥 400K / month · 📦 930 · ⏱️ 14.10.2021):
	```
...
- [GitHub](https://github.com/microsoft/pyright) (👨‍💻 67 · 🔀 390 · 📦 160 · 📋 2.1K - 0% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/Microsoft/pyright
	```
- [NPM](https://www.npmjs.com/package/pyright) (📥 200K / month · 📦 4 · ⏱️ 30.11.2021):
	```
	npm install pyright
	```
</details>
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 180 · 🔀 370 · 📋 280 - 27% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/facebook/pyre-check
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 22K / month · 📦 46 · ⏱️ 29.10.2021):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 70 · 🔀 220 · 📋 460 - 21% open · ⏱️ 01.12.2021):

	```
	git clone https://github.com/google/pytype
	```
- [PyPi](https://pypi.org/project/pytype) (📥 110K / month · 📦 88 · ⏱️ 30.11.2021):
	```
	pip install pytype
	```
...
- [GitHub](https://github.com/mgedmin/check-manifest) (👨‍💻 20 · 🔀 31 · 📦 6.9K · 📋 88 - 18% open · ⏱️ 16.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/check-manifest) (📥 140K / month · 📦 1.8K · ⏱️ 22.09.2021):
	```
...
- [GitHub](https://github.com/PyCQA/flake8-commas) (👨‍💻 12 · 🔀 23 · 📋 31 - 16% open · ⏱️ 13.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-commas) (📥 180K / month · 📦 550 · ⏱️ 13.10.2021):
	```
...
- [GitHub](https://github.com/dropbox/mypy-protobuf) (👨‍💻 30 · 🔀 62 · 📋 97 - 5% open · ⏱️ 26.11.2021):

	```
	git clone https://github.com/dropbox/mypy-protobuf
	```
- [PyPi](https://pypi.org/project/mypy-protobuf) (📥 820K / month · 📦 24 · ⏱️ 12.10.2021):
	```
...
- [GitHub](https://github.com/wemake-services/flake8-eradicate) (👨‍💻 13 · 🔀 7 · 📋 28 - 3% open · ⏱️ 01.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-eradicate) (📥 180K / month · 📦 72 · ⏱️ 19.10.2021):
	```
...
- [GitHub](https://github.com/peterjc/flake8-black) (👨‍💻 5 · 🔀 8 · 📦 1.5K · 📋 21 - 33% open · ⏱️ 22.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-black) (📥 180K / month · 📦 36 · ⏱️ 16.07.2021):
	```
...
- [GitHub](https://github.com/adamchainz/flake8-comprehensions) (👨‍💻 12 · 🔀 15 · 📋 41 - 17% open · ⏱️ 25.11.2021):

	```
	git clone https://github.com/adamchainz/flake8-comprehensions
	```
- [PyPi](https://pypi.org/project/flake8-comprehensions) (📥 430K / month · 📦 710 · ⏱️ 11.10.2021):
	```
...
- [GitHub](https://github.com/predictive-analytics-lab/data-science-types) (👨‍💻 44 · 🔀 57 · 📦 150 · 📋 62 - 62% open · ⏱️ 16.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/data-science-types) (📥 36K / month · ⏱️ 16.02.2021):
	```
...
- [GitHub](https://github.com/gforcada/flake8-builtins) (👨‍💻 15 · 🔀 17 · 📦 3K · 📋 34 - 5% open · ⏱️ 20.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-builtins) (📥 310K / month · 📦 510 · ⏱️ 14.05.2020):
	```
...
- [GitHub](https://github.com/Instagram/Fixit) (👨‍💻 29 · 🔀 41 · 📦 13 · 📋 57 - 56% open · ⏱️ 20.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/fixit) (📥 3.6K / month · ⏱️ 30.07.2021):
	```
	pip install fixit
	```
</details>
...
- [GitHub](https://github.com/jschaf/pylint-flask) (👨‍💻 7 · 🔀 9 · 📦 5.5K · 📋 10 - 50% open · ⏱️ 10.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pylint-flask) (📥 160K / month · 📦 710 · ⏱️ 30.01.2019):
	```
...
- [GitHub](https://github.com/andreoliwa/nitpick) (👨‍💻 13 · 🔀 13 · 📥 4 · 📋 89 - 35% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/andreoliwa/nitpick
	```
- [PyPi](https://pypi.org/project/nitpick) (📥 8.1K / month · ⏱️ 08.11.2021):
	```
	pip install nitpick
	```
</details>
...
- [GitHub](https://github.com/deppen8/pandas-vet) (👨‍💻 10 · 🔀 15 · 📥 39 · 📦 55 · 📋 50 - 42% open · ⏱️ 03.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pandas-vet) (📥 3.9K / month · ⏱️ 01.02.2020):
	```
...
- [GitHub](https://github.com/life4/flakehell) (👨‍💻 16 · 🔀 32 · 📥 57 · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/flakehell) (📥 32K / month · ⏱️ 11.01.2021):
	```
...
- [GitHub](https://github.com/justinabrahms/imhotep) (👨‍💻 16 · 🔀 37 · 📦 8 · 📋 46 - 50% open · ⏱️ 01.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/imhotep) (📥 23 / month · 📦 4 · ⏱️ 18.09.2016):
	```
	pip install imhotep
	```
</details>
<details><summary><b><a href="https://github.com/beartype/beartype">beartype</a></b> (🥉17 ·  ⭐ 950) - Unbearably fast O(1) runtime type-checking in pure Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/beartype/beartype) (👨‍💻 9 · 🔀 17 · 📋 54 - 22% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/beartype/beartype
	```
- [PyPi](https://pypi.org/project/beartype) (📥 37K / month · ⏱️ 06.11.2021):
	```
	pip install beartype
	```
- [Conda](https://anaconda.org/conda-forge/beartype) (📥 8.7K · ⏱️ 06.11.2021):
	```
...
- [GitHub](https://github.com/hchasestevens/bellybutton) (👨‍💻 5 · 🔀 11 · 📦 13 · 📋 14 - 57% open · ⏱️ 15.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/bellybutton) (📥 4.8K / month · ⏱️ 27.11.2020):
	```
...
- [GitHub](https://github.com/psf/black) (👨‍💻 290 · 🔀 1.5K · 📥 19K · 📦 99K · 📋 1.8K - 20% open · ⏱️ 01.12.2021):

	```
	git clone https://github.com/psf/black
	```
- [PyPi](https://pypi.org/project/black) (📥 7.6M / month · 📦 6.2K · ⏱️ 18.11.2021):
	```
	pip install black
	```
...
- [GitHub](https://github.com/hhatto/autopep8) (👨‍💻 51 · 🔀 250 · 📦 98K · 📋 430 - 21% open · ⏱️ 30.10.2021):

	```
	git clone https://github.com/hhatto/autopep8
	```
- [PyPi](https://pypi.org/project/autopep8) (📥 1.9M / month · 📦 10K · ⏱️ 24.10.2021):
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 250 · 🔀 430 · 📦 210K · 📋 1K - 3% open · ⏱️ 26.11.2021):

	```
	git clone https://github.com/PyCQA/isort
	```
- [PyPi](https://pypi.org/project/isort) (📥 13M / month · 📦 24K · ⏱️ 09.11.2021):
	```
	pip install isort
	```
...
- [GitHub](https://github.com/davidhalter/jedi) (👨‍💻 150 · 🔀 460 · 📦 160K · 📋 1.3K - 2% open · ⏱️ 17.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/jedi) (📥 14M / month · 📦 16K · ⏱️ 17.11.2021):
	```
	pip install jedi
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 68 · 🔀 150 · 📦 33K · 📋 230 - 30% open · ⏱️ 29.11.2021):

	```
	git clone https://github.com/python-rope/rope
	```
- [PyPi](https://pypi.org/project/rope) (📥 410K / month · 📦 2.9K · ⏱️ 22.11.2021):
	```
	pip install rope
	```
...
- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 29 · 🔀 91 · 📦 1.3K · 📋 150 - 9% open · ⏱️ 27.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/vulture) (📥 130K / month · 📦 360 · ⏱️ 16.01.2021):
	```
	pip install vulture
	```
...
- [GitHub](https://github.com/myint/autoflake) (👨‍💻 17 · 🔀 49 · 📦 3.4K · 📋 66 - 50% open · ⏱️ 27.12.2020):

	```
	git clone https://github.com/myint/autoflake
	```
- [PyPi](https://pypi.org/project/autoflake) (📥 460K / month · 📦 580 · ⏱️ 04.08.2019):
	```
...
- [GitHub](https://github.com/asottile/pyupgrade) (👨‍💻 21 · 🔀 85 · 📋 250 - 4% open · ⏱️ 28.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyupgrade) (📥 94K / month · 📦 10 · ⏱️ 16.11.2021):
	```
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 17 · 🔀 54 · 📦 66 · 📋 59 - 44% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyannotate) (📥 2.2K / month · 📦 26 · ⏱️ 16.09.2019):
	```
...
- [GitHub](https://github.com/asottile/add-trailing-comma) (👨‍💻 9 · 🔀 14 · 📋 37 - 2% open · ⏱️ 30.11.2021):

	```
	git clone https://github.com/asottile/add-trailing-comma
	```
- [PyPi](https://pypi.org/project/add-trailing-comma) (📥 12K / month · 📦 14 · ⏱️ 20.11.2021):
	```
...
- [GitHub](https://github.com/facebookincubator/Bowler) (👨‍💻 26 · 🔀 88 · 📋 80 - 57% open · ⏱️ 01.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/bowler) (📥 26K / month · 📦 10 · ⏱️ 17.09.2020):
	```
	pip install bowler
	```
...
- [GitHub](https://github.com/hakancelik96/unimport) (👨‍💻 13 · 🔀 13 · 📦 16 · 📋 76 - 13% open · ⏱️ 14.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/unimport) (📥 2.7K / month · ⏱️ 14.09.2021):
	```
...
- [GitHub](https://github.com/ambv/retype) (👨‍💻 8 · 🔀 17 · 📋 14 - 42% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/retype) (📥 770 / month · 📦 34 · ⏱️ 04.10.2021):
	```
	pip install retype
	```
...
- [GitHub](https://github.com/ilevkivskyi/com2ann) (👨‍💻 4 · 🔀 7 · 📦 7 · 📋 20 - 25% open · ⏱️ 21.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/com2ann) (📥 1.4K / month · ⏱️ 21.08.2021):
	```
	pip install com2ann
	```
</details>
...
- <b><a href="https://github.com/myint/unify">unify</a></b> (🥉19 ·  ⭐ 63 · 💀) - Modifies strings to all use the same quote where possible. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/PyCQA/bandit) (👨‍💻 140 · 🔀 380 · 📥 120 · 📦 9.3K · 📋 560 - 33% open · ⏱️ 13.11.2021):

	```
	git clone https://github.com/PyCQA/bandit
	```
- [PyPi](https://pypi.org/project/bandit) (📥 1.6M / month · 📦 2.4K · ⏱️ 12.11.2021):
	```
	pip install bandit
	```
...
- [GitHub](https://github.com/pyupio/safety) (👨‍💻 35 · 🔀 99 · 📥 100K · 📦 3.1K · 📋 120 - 37% open · ⏱️ 28.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/safety) (📥 550K / month · 📦 540 · ⏱️ 15.01.2021):
	```
	pip install safety
	```
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.6K · 📋 4.5K - 1% open · ⏱️ 27.11.2021):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 4.5K / month · 📦 8 · ⏱️ 01.11.2021):
	```
	pip install sqlmap
	```
</details>
...
- [GitHub](https://github.com/dlint-py/dlint) (👨‍💻 8 · 🔀 6 · 📋 33 - 57% open · ⏱️ 27.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/dlint) (📥 72K / month · 📦 18 · ⏱️ 27.10.2021):
	```
	pip install dlint
	```
</details>
...
- [GitHub](https://github.com/pypa/pipenv) (👨‍💻 400 · 🔀 1.7K · 📦 23K · 📋 3.5K - 16% open · ⏱️ 25.11.2021):

	```
	git clone https://github.com/pypa/pipenv
	```
- [PyPi](https://pypi.org/project/pipenv) (📥 3.2M / month · 📦 2.3K · ⏱️ 23.11.2021):
	```
	pip install pipenv
	```
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 220 · 🔀 910 · 📋 1.2K - 5% open · ⏱️ 01.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/virtualenv) (📥 18M / month · 📦 34K · ⏱️ 01.11.2021):
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 350 · 🔀 2.2K · 📋 1.4K - 2% open · ⏱️ 23.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyenv) (📥 5.2K / month · 📦 1 · ⏱️ 12.01.2019):
	```
	pip install pyenv
	```
</details>
...
- [GitHub](https://github.com/pypa/pip) (👨‍💻 650 · 🔀 2.4K · 📦 66K · 📋 6K - 15% open · ⏱️ 27.11.2021):

	```
	git clone https://github.com/pypa/pip
	```
- [PyPi](https://pypi.org/project/pip) (📥 66M / month · 📦 19K · ⏱️ 22.10.2021):
	```
	pip install pip
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 320 · 🔀 1.4K · 📥 9.5M · 📋 3.4K - 36% open · ⏱️ 30.11.2021):

	```
	git clone https://github.com/python-poetry/poetry
	```
- [PyPi](https://pypi.org/project/poetry) (📥 3.2M / month · 📦 64 · ⏱️ 28.11.2021):
	```
	pip install poetry
	```
...
- [GitHub](https://github.com/conda/conda) (👨‍💻 380 · 🔀 1.1K · 📋 8.2K - 22% open · ⏱️ 30.11.2021):
...
<details><summary><b><a href="https://github.com/jazzband/pip-tools">pip-tools</a></b> (🥈32 ·  ⭐ 5.3K) - A set of tools to keep your pinned Python dependencies fresh. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 160 · 🔀 470 · 📋 790 - 16% open · ⏱️ 12.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 2.8M / month · 📦 3.3K · ⏱️ 12.10.2021):
	```
...
- [GitHub](https://github.com/bndr/pipreqs) (👨‍💻 51 · 🔀 250 · 📦 7.8K · 📋 180 - 50% open · ⏱️ 23.10.2021):

	```
	git clone https://github.com/bndr/pipreqs
	```
- [PyPi](https://pypi.org/project/pipreqs) (📥 130K / month · 📦 530 · ⏱️ 23.10.2021):
	```
	pip install pipreqs
	```
...
- [GitHub](https://github.com/pypa/pipx) (👨‍💻 65 · 🔀 190 · 📋 430 - 21% open · ⏱️ 24.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pipx) (📥 63K / month · 📦 4 · ⏱️ 05.08.2021):
	```
	pip install pipx
	```
</details>
...
- [GitHub](https://github.com/mamba-org/mamba) (👨‍💻 64 · 🔀 130 · 📋 660 - 28% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/mamba-org/mamba
	```
- [Conda](https://anaconda.org/conda-forge/mamba) (📥 1.6M · ⏱️ 30.11.2021):
	```
...
- [GitHub](https://github.com/dephell/dephell) (👨‍💻 37 · 🔀 100 · 📥 160 · 📦 320 · 📋 270 - 40% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/dephell) (📥 6.5K / month · 📦 8 · ⏱️ 28.04.2020):
	```
	pip install dephell
	```
</details>
...
- [GitHub](https://github.com/David-OConnor/pyflow) (👨‍💻 27 · 🔀 35 · 📥 3.6K · 📋 110 - 38% open · ⏱️ 26.11.2021):
...
- [GitHub](https://github.com/jaraco/pip-run) (👨‍💻 11 · 🔀 10 · 📋 42 - 7% open · ⏱️ 20.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pip-run) (📥 5.5K / month · ⏱️ 20.11.2021):
	```
	pip install pip-run
	```
</details>
...
<details><summary><b><a href="https://github.com/PyCQA/prospector">prospector</a></b> (🥇28 ·  ⭐ 1.6K) - Inspects Python source files and provides information about.. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 78 · 🔀 150 · 📋 290 - 18% open · ⏱️ 30.11.2021):

	```
	git clone https://github.com/PyCQA/prospector
	```
- [PyPi](https://pypi.org/project/prospector) (📥 430K / month · 📦 1.1K · ⏱️ 30.11.2021):
	```
...
- [GitHub](https://github.com/PyCQA/mccabe) (👨‍💻 21 · 🔀 42 · 📦 230K · 📋 40 - 15% open · ⏱️ 02.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/mccabe) (📥 14M / month · 📦 31K · ⏱️ 26.01.2017):
	```
	pip install mccabe
	```
...
- [GitHub](https://github.com/rubik/radon) (👨‍💻 49 · 🔀 97 · 📦 2.1K · 📋 160 - 12% open · ⏱️ 08.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/radon) (📥 330K / month · 📦 1.1K · ⏱️ 08.08.2021):
	```
	pip install radon
	```
...
- [GitHub](https://github.com/tonybaloney/wily) (👨‍💻 16 · 🔀 45 · 📋 80 - 35% open · ⏱️ 01.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/wily) (📥 6.2K / month · 📦 16 · ⏱️ 01.07.2021):
	```
	pip install wily
	```
</details>
...
- [GitHub](https://github.com/rubik/xenon) (👨‍💻 8 · 🔀 16 · 📦 280 · 📋 32 - 21% open · ⏱️ 03.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/xenon) (📥 48K / month · 📦 120 · ⏱️ 03.09.2021):
	```
	pip install xenon
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1K · 📥 8K · 📦 230K · 📋 870 - 37% open · ⏱️ 20.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/tqdm) (📥 22M / month · 📦 26K · ⏱️ 20.09.2021):
	```
	pip install tqdm
	```
...
- [GitHub](https://github.com/willmcgugan/rich) (👨‍💻 140 · 🔀 1K · 📦 8.9K · 📋 610 - 5% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/willmcgugan/rich
	```
- [PyPi](https://pypi.org/project/rich) (📥 2.1M / month · ⏱️ 02.12.2021):
	```
	pip install rich
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 110 · 🔀 250 · 📥 4.5K · 📦 16K · 📋 600 - 33% open · ⏱️ 01.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/sentry-sdk) (📥 8.3M / month · 📦 990 · ⏱️ 17.11.2021):
	```
...
- [GitHub](https://github.com/astanin/python-tabulate) (👨‍💻 67 · 🔀 83 · 📦 57K · 📋 110 - 44% open · ⏱️ 04.03.2021):
...
- [GitHub](https://github.com/hynek/structlog) (👨‍💻 81 · 🔀 150 · 📋 200 - 12% open · ⏱️ 28.11.2021):

	```
	git clone https://github.com/hynek/structlog
	```
- [PyPi](https://pypi.org/project/structlog) (📥 2M / month · 📦 1.2K · ⏱️ 25.11.2021):
	```
...
- [GitHub](https://github.com/borntyping/python-colorlog) (👨‍💻 30 · 🔀 76 · 📦 12K · 📋 70 - 1% open · ⏱️ 08.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/colorlog) (📥 3.9M / month · 📦 3.7K · ⏱️ 08.11.2021):
	```
...
- [GitHub](https://github.com/liiight/notifiers) (👨‍💻 16 · 🔀 77 · 📦 190 · 📋 92 - 41% open · ⏱️ 22.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/notifiers) (📥 210K / month · 📦 6 · ⏱️ 05.10.2019):
	```
...
- [GitHub](https://github.com/xolox/python-coloredlogs) (👨‍💻 16 · 🔀 36 · 📦 9.6K · 📋 74 - 33% open · ⏱️ 11.06.2021):

	```
	git clone https://github.com/xolox/python-coloredlogs
	```
- [PyPi](https://pypi.org/project/coloredlogs) (📥 1.6M / month · 📦 2.1K · ⏱️ 11.06.2021):
	```
...
- [PyPi](https://pypi.org/project/wasabi) (📥 2.2M / month · 📦 410 · ⏱️ 31.01.2021):
	...
	pip install wasabi
	```
- [Conda](https://anaconda.org/conda-forge/wasabi) (📥 510K · ⏱️ 01.02.2021):
	```
...
- [GitHub](https://github.com/shobrook/rebound) (👨‍💻 16 · 🔀 350 · 📥 180 · 📦 22 · 📋 58 - 34% open · ⏱️ 04.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/rebound) (📥 1.4K / month · 📦 14 · ⏱️ 17.11.2021):
	```
	pip install rebound
	```
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 1 · 🔀 120 · 📦 490 · 📋 91 - 27% open · ⏱️ 06.11.2021):
...
- [GitHub](https://github.com/onelivesleft/PrettyErrors) (👨‍💻 5 · 🔀 68 · ⏱️ 24.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pretty_errors) (📥 12K / month · ⏱️ 24.11.2021):
	```
...
- [GitHub](https://github.com/samuelcolvin/python-devtools) (👨‍💻 7 · 🔀 15 · 📦 500 · 📋 36 - 5% open · ⏱️ 08.09.2021):
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (👨‍💻 690 · 🔀 1.6K · 📦 170K · 📋 5.8K - 16% open · ⏱️ 30.11.2021):

	```
	git clone https://github.com/sphinx-doc/sphinx
	```
- [PyPi](https://pypi.org/project/sphinx) (📥 3.1M / month · 📦 100K · ⏱️ 27.11.2021):
	```
	pip install sphinx
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs) (👨‍💻 210 · 🔀 1.8K · 📦 17K · 📋 1.6K - 6% open · ⏱️ 28.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/mkdocs) (📥 570K / month · 📦 5.9K · ⏱️ 12.10.2021):
	```
	pip install mkdocs
	```
...
<details><summary><b><a href="https://github.com/squidfunk/mkdocs-material">mkdocs-material</a></b> (🥇34 ·  ⭐ 8.1K · 📈) - Technical documentation that just works. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 140 · 🔀 1.9K · 📦 9.9K · 📋 1.2K - 0% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/squidfunk/mkdocs-material
	```
- [PyPi](https://pypi.org/project/mkdocs-material) (📥 560K / month · 📦 1.5K · ⏱️ 02.12.2021):
	```
	pip install mkdocs-material
	```
- [Conda](https://anaconda.org/conda-forge/mkdocs-material) (📥 74K · ⏱️ 30.11.2021):
	```
...
- [GitHub](https://github.com/readthedocs/sphinx_rtd_theme) (👨‍💻 110 · 🔀 1.6K · 📦 16 · 📋 730 - 26% open · ⏱️ 19.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/sphinx_rtd_theme) (📥 1.5M / month · 📦 23K · ⏱️ 05.10.2018):
	```
...
- [GitHub](https://github.com/numpy/numpydoc) (👨‍💻 68 · 🔀 6.2K · 📦 29K · 📋 160 - 36% open · ⏱️ 05.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/numpydoc) (📥 190K / month · 📦 7.3K · ⏱️ 01.07.2020):
	```
...
- [GitHub](https://github.com/bitprophet/alabaster) (👨‍💻 28 · 🔀 180 · 📦 55K · 📋 140 - 61% open · ⏱️ 24.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/alabaster) (📥 2.8M / month · 📦 15K · ⏱️ 03.10.2018):
	```
...
- [GitHub](https://github.com/michaeljones/breathe) (👨‍💻 98 · 🔀 140 · 📥 150 · 📦 5.5K · 📋 480 - 25% open · ⏱️ 30.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/breathe) (📥 140K / month · 📦 2K · ⏱️ 14.09.2021):
	```
	pip install breathe
	```
...
- [GitHub](https://github.com/econchick/interrogate) (👨‍💻 11 · 🔀 24 · 📦 1.1K · 📋 31 - 25% open · ⏱️ 10.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/interrogate) (📥 67K / month · ⏱️ 10.09.2021):
	```
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 32 · 🔀 120 · 📦 460 · 📋 190 - 3% open · ⏱️ 26.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 74K / month · 📦 290 · ⏱️ 29.10.2021):
	```
	pip install pdoc
	```
</details>
...
- [GitHub](https://github.com/mkdocstrings/mkdocstrings) (👨‍💻 25 · 🔀 58 · 📋 210 - 25% open · ⏱️ 31.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/mkdocstrings) (📥 71K / month · ⏱️ 04.10.2021):
	```
...
- [GitHub](https://github.com/zhaoterryy/mkdocs-pdf-export-plugin) (👨‍💻 11 · 🔀 34 · 📦 180 · 📋 85 - 48% open · ⏱️ 05.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/mkdocs-pdf-export-plugin) (📥 11K / month · 📦 4 · ⏱️ 05.10.2021):
	```
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-pages-plugin) (👨‍💻 3 · 🔀 20 · 📦 570 · 📋 45 - 15% open · ⏱️ 22.11.2021):

	```
	git clone https://github.com/lukasgeiter/mkdocs-awesome-pages-plugin
	```
- [PyPi](https://pypi.org/project/mkdocs-awesome-pages-plugin) (📥 33K / month · 📦 90 · ⏱️ 22.11.2021):
	```
...
- [GitHub](https://github.com/bitprophet/releases) (👨‍💻 10 · 🔀 36 · 📦 390 · 📋 76 - 43% open · ⏱️ 24.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/releases) (📥 7.5K / month · 📦 710 · ⏱️ 11.01.2020):
	```
...
- [GitHub](https://github.com/asottile/blacken-docs) (👨‍💻 13 · 🔀 20 · 📋 38 - 7% open · ⏱️ 23.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/blacken-docs) (📥 10K / month · 📦 22 · ⏱️ 19.11.2021):
	```
...
- [GitHub](https://github.com/orzih/mkdocs-with-pdf) (👨‍💻 6 · 🔀 20 · 📦 75 · 📋 65 - 43% open · ⏱️ 14.10.2021):

	```
	git clone https://github.com/orzih/mkdocs-with-pdf
	```
- [PyPi](https://pypi.org/project/mkdocs-with-pdf) (📥 8.6K / month · ⏱️ 03.07.2021):
	```
...
- [GitHub](https://github.com/timothycrosley/portray) (👨‍💻 16 · 🔀 58 · 📋 50 - 42% open · ⏱️ 13.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/portray) (📥 4.8K / month · 📦 8 · ⏱️ 13.06.2021):
	```
	pip install portray
	```
</details>
<details><summary><b><a href="https://github.com/ml-tooling/lazydocs">lazydocs</a></b> (🥉16 ·  ⭐ 51) - Generate markdown API documentation from Google-style Python docstring... <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ml-tooling/lazydocs) (👨‍💻 7 · 🔀 11 · 📦 54 · 📋 6 - 50% open · ⏱️ 20.08.2021):

	```
	git clone https://github.com/ml-tooling/lazydocs
	```
- [PyPi](https://pypi.org/project/lazydocs) (📥 720 / month · ⏱️ 27.07.2021):
	```
...
- [GitHub](https://github.com/gotcha/ipdb) (👨‍💻 49 · 🔀 130 · 📦 29K · 📋 170 - 33% open · ⏱️ 09.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipdb) (📥 1.3M / month · 📦 17K · ⏱️ 02.06.2021):
	```
	pip install ipdb
	```
...
- [GitHub](https://github.com/cool-RR/PySnooper) (👨‍💻 26 · 🔀 920 · 📦 530 · 📋 110 - 16% open · ⏱️ 11.09.2021):
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 80 · 🔀 190 · 📦 2.7K · 📋 290 - 48% open · ⏱️ 01.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pudb) (📥 120K / month · 📦 1.4K · ⏱️ 01.11.2021):
	```
	pip install pudb
	```
...
- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 40 · 🔀 46 · 📦 2.4K · 📋 180 - 35% open · ⏱️ 27.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pdbpp) (📥 140K / month · 📦 1K · ⏱️ 09.07.2021):
	```
	pip install pdbpp
	```
...
- [GitHub](https://github.com/cs01/gdbgui) (👨‍💻 38 · 🔀 480 · 📥 6.1K · 📦 120 · 📋 280 - 41% open · ⏱️ 06.09.2021):

	```
	git clone https://github.com/cs01/gdbgui
	```
- [PyPi](https://pypi.org/project/gdbgui) (📥 120K / month · 📦 2 · ⏱️ 06.09.2021):
	```
	pip install gdbgui
	```
</details>
...
- [GitHub](https://github.com/agronholm/typeguard) (👨‍💻 19 · 🔀 67 · 📋 170 - 18% open · ⏱️ 27.11.2021):

	```
	git clone https://github.com/agronholm/typeguard
	```
- [PyPi](https://pypi.org/project/typeguard) (📥 7.3M / month · 📦 160 · ⏱️ 22.11.2021):
	```
	pip install typeguard
	```
- [Conda](https://anaconda.org/conda-forge/typeguard) (📥 65K · ⏱️ 11.10.2021):
	```
...
- [GitHub](https://github.com/alexmojaki/snoop) (👨‍💻 21 · 🔀 24 · 📋 37 - 48% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/snoop) (📥 19K / month · 📦 8 · ⏱️ 11.11.2021):
	```
	pip install snoop
	```
</details>
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 35 · 📦 71 · 📋 87 - 42% open · ⏱️ 13.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/hunter) (📥 5.3K / month · 📦 34 · ⏱️ 23.06.2021):
	```
	pip install hunter
	```
</details>
...
- [GitHub](https://github.com/ionelmc/python-manhole) (👨‍💻 11 · 🔀 16 · 📦 78 · 📋 20 - 25% open · ⏱️ 15.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/manhole) (📥 30K / month · 📦 66 · ⏱️ 08.04.2021):
	```
	pip install manhole
	```
</details>
...
- [GitHub](https://github.com/alexmojaki/birdseye) (👨‍💻 10 · 🔀 70 · 📋 50 - 36% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/birdseye) (📥 980 / month · ⏱️ 11.11.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest) (👨‍💻 760 · 🔀 1.9K · 📦 410K · 📋 4.8K - 15% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/pytest-dev/pytest
	```
- [PyPi](https://pypi.org/project/pytest) (📥 26M / month · 📦 130K · ⏱️ 30.08.2021):
	```
	pip install pytest
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 150 · 🔀 1.8K · 📥 510 · 📦 4.7K · 📋 3.7K - 6% open · ⏱️ 01.12.2021):

	```
	git clone https://github.com/robotframework/robotframework
	```
- [PyPi](https://pypi.org/project/robotframework) (📥 620K / month · 📦 1.4K · ⏱️ 15.10.2021):
	```
...
- [GitHub](https://github.com/tox-dev/tox) (👨‍💻 250 · 🔀 380 · 📦 51K · 📋 1.3K - 10% open · ⏱️ 11.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/tox) (📥 2.8M / month · 📦 36K · ⏱️ 16.09.2021):
	```
	pip install tox
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-cov) (👨‍💻 72 · 🔀 160 · 📦 110K · 📋 300 - 34% open · ⏱️ 10.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-cov) (📥 8.3M / month · 📦 43K · ⏱️ 04.10.2021):
	```
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 250 · 🔀 480 · 📦 11K · 📋 1.2K - 4% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 1.8M / month · 📦 2.6K · ⏱️ 02.12.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-asyncio) (👨‍💻 26 · 🔀 89 · 📦 18K · 📋 180 - 43% open · ⏱️ 15.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-asyncio) (📥 5.5M / month · 📦 2K · ⏱️ 15.10.2021):
	```
	pip install pytest-asyncio
	```
- [Conda](https://anaconda.org/conda-forge/pytest-asyncio) (📥 700K · ⏱️ 18.10.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-xdist) (👨‍💻 77 · 🔀 160 · 📋 460 - 44% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/pytest-dev/pytest-xdist
	```
- [PyPi](https://pypi.org/project/pytest-xdist) (📥 3.7M / month · 📦 7.3K · ⏱️ 21.09.2021):
	```
...
- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 780 · 📦 12K · 📋 540 - 63% open · ⏱️ 14.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyautogui) (📥 380K / month · 📦 610 · ⏱️ 07.07.2021):
	```
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 97 · 🔀 220 · 📋 260 - 34% open · ⏱️ 25.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/freezegun) (📥 2.7M / month · 📦 8.4K · ⏱️ 20.01.2021):
	```
...
- [GitHub](https://github.com/TheKevJames/coveralls-python) (👨‍💻 63 · 🔀 180 · 📦 20K · 📋 150 - 3% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/coveralls) (📥 410K / month · 📦 17K · ⏱️ 11.11.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-mock) (👨‍💻 54 · 🔀 98 · 📦 21K · 📋 110 - 11% open · ⏱️ 25.11.2021):

	```
	git clone https://github.com/pytest-dev/pytest-mock
	```
- [PyPi](https://pypi.org/project/pytest-mock) (📥 3.9M / month · 📦 6.2K · ⏱️ 06.05.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-html) (👨‍💻 43 · 🔀 180 · 📦 14K · 📋 270 - 33% open · ⏱️ 23.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-html) (📥 1.3M / month · 📦 980 · ⏱️ 13.12.2020):
	```
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 280 · 📥 180 · 📋 300 - 1% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/lk-geimfari/mimesis
	```
- [PyPi](https://pypi.org/project/mimesis) (📥 67K / month · 📦 84 · ⏱️ 05.11.2021):
	```
	pip install mimesis
	```
</details>
...
- [GitHub](https://github.com/datadriventests/ddt) (👨‍💻 36 · 🔀 100 · 📦 3.9K · 📋 53 - 28% open · ⏱️ 04.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/ddt) (📥 220K / month · 📦 2.5K · ⏱️ 04.10.2021):
	```
	pip install ddt
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-bdd) (👨‍💻 44 · 🔀 150 · 📋 260 - 48% open · ⏱️ 14.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-bdd) (📥 180K / month · 📦 270 · ⏱️ 25.10.2021):
	```
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 71 · 🔀 130 · 📦 4.3K · 📋 260 - 21% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/nose2) (📥 300K / month · 📦 1.9K · ⏱️ 27.01.2021):
	```
	pip install nose2
	```
...
- [GitHub](https://github.com/microsoft/playwright-python) (👨‍💻 21 · 🔀 480 · 📦 580 · 📋 510 - 5% open · ⏱️ 22.11.2021):

	```
	git clone https://github.com/microsoft/playwright-python
	```
- [PyPi](https://pypi.org/project/playwright) (📥 110K / month · ⏱️ 30.11.2021):
	```
	pip install playwright
	```
</details>
<details><summary><b><a href="https://github.com/ionelmc/pytest-benchmark">pytest-benchmark</a></b> (🥉25 ·  ⭐ 830) - py.test fixture for benchmarking code. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/airspeed-velocity/asv) (👨‍💻 55 · 🔀 130 · 📦 210 · 📋 410 - 27% open · ⏱️ 15.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/asv) (📥 24K / month · 📦 88 · ⏱️ 16.05.2020):
	```
	pip install asv
	```
...
- [GitHub](https://github.com/hamcrest/PyHamcrest) (👨‍💻 36 · 🔀 89 · 📋 65 - 24% open · ⏱️ 22.11.2021):

	```
	git clone https://github.com/hamcrest/PyHamcrest
	```
- [PyPi](https://pypi.org/project/pyhamcrest) (📥 710K / month · 📦 3.4K · ⏱️ 02.03.2020):
	```
...
<details><summary><b><a href="https://github.com/theacodes/nox">nox</a></b> (🥉24 ·  ⭐ 670) - Flexible test automation for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/theacodes/nox) (👨‍💻 65 · 🔀 100 · 📋 240 - 15% open · ⏱️ 01.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/nox) (📥 480K / month · 📦 56 · ⏱️ 01.10.2021):
	```
	pip install nox
	```
- [Conda](https://anaconda.org/conda-forge/nox) (📥 43K · ⏱️ 02.10.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-testinfra) (👨‍💻 110 · 🔀 280 · 📋 320 - 36% open · ⏱️ 18.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-testinfra) (📥 86K / month · ⏱️ 20.06.2021):
	```
...
- [GitHub](https://github.com/tarpas/pytest-testmon) (👨‍💻 16 · 🔀 29 · 📋 120 - 24% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-testmon) (📥 71K / month · 📦 98 · ⏱️ 22.10.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-randomly) (👨‍💻 16 · 🔀 22 · 📋 47 - 10% open · ⏱️ 30.11.2021):

	```
	git clone https://github.com/pytest-dev/pytest-randomly
	```
- [PyPi](https://pypi.org/project/pytest-randomly) (📥 290K / month · 📦 210 · ⏱️ 30.11.2021):
	```
...
- [GitHub](https://github.com/Erotemic/xdoctest) (👨‍💻 6 · 🔀 7 · 📦 1.8K · 📋 37 - 45% open · ⏱️ 06.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/xdoctest) (📥 78K / month · 📦 52 · ⏱️ 06.10.2021):
	```
...
- [GitHub](https://github.com/avast/pytest-docker) (👨‍💻 11 · 🔀 42 · 📥 82 · 📋 33 - 51% open · ⏱️ 14.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-docker) (📥 43K / month · 📦 28 · ⏱️ 14.06.2021):
	```
...
- <b><a href="https://github.com/Teemu/pytest-sugar">pytest-sugar</a></b> (🥈27 ·  ⭐ 790 · 💀) - a plugin for py.test that changes the default look and.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/pypa/packaging) (👨‍💻 72 · 🔀 180 · 📥 180 · 📦 280K · 📋 230 - 28% open · ⏱️ 18.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/packaging) (📥 65M / month · 📦 29K · ⏱️ 18.11.2021):
	```
...
- [GitHub](https://github.com/Nuitka/Nuitka) (👨‍💻 100 · 🔀 340 · 📋 1.1K - 19% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/Nuitka/Nuitka
	```
- [PyPi](https://pypi.org/project/nuitka) (📥 20K / month · 📦 54 · ⏱️ 15.11.2021):
	```
	pip install nuitka
	```
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 420 · 🔀 1.7K · 📥 720K · 📋 4.4K - 7% open · ⏱️ 30.11.2021):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 520K / month · ⏱️ 10.11.2021):
	```
...
- [GitHub](https://github.com/pantsbuild/pex) (👨‍💻 100 · 🔀 210 · 📥 500K · 📋 760 - 18% open · ⏱️ 27.11.2021):

	```
	git clone https://github.com/pantsbuild/pex
	```
- [PyPi](https://pypi.org/project/pex) (📥 130K / month · 📦 230 · ⏱️ 25.11.2021):
	```
	pip install pex
	```
</details>
...
- [GitHub](https://github.com/ronaldoussoren/py2app) (👨‍💻 26 · 🔀 16 · 📦 3.8K · 📋 370 - 27% open · ⏱️ 05.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/py2app) (📥 9.7K / month · 📦 1.6K · ⏱️ 27.09.2021):
	```
	pip install py2app
	```
</details>
...
- [GitHub](https://github.com/py2exe/py2exe) (👨‍💻 14 · 🔀 43 · 📥 6.7K · 📦 1.3K · 📋 92 - 5% open · ⏱️ 16.11.2021):

	```
	git clone https://github.com/py2exe/py2exe
	```
- [PyPi](https://pypi.org/project/py2exe) (📥 19K / month · 📦 350 · ⏱️ 16.11.2021):
	```
	pip install py2exe
	```
</details>
...
- [GitHub](https://github.com/marcelotduarte/cx_Freeze) (👨‍💻 93 · 🔀 170 · 📋 710 - 8% open · ⏱️ 30.11.2021):

	```
	git clone https://github.com/marcelotduarte/cx_Freeze
	```
- [PyPi](https://pypi.org/project/cx_freeze) (📥 42K / month · 📦 150 · ⏱️ 16.12.2017):
	```
	pip install cx_freeze
	```
- [Conda](https://anaconda.org/conda-forge/cx_freeze) (📥 100K · ⏱️ 29.11.2021):
	```
...
- [GitHub](https://github.com/takluyver/pynsist) (👨‍💻 29 · 🔀 100 · 📋 160 - 15% open · ⏱️ 01.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pynsist) (📥 1.4K / month · 📦 88 · ⏱️ 28.03.2021):
	```
	pip install pynsist
	```
</details>
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 34 · 🔀 75 · 📥 160 · 📋 100 - 33% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/linkedin/shiv
	```
- [PyPi](https://pypi.org/project/shiv) (📥 5.1K / month · 📦 10 · ⏱️ 18.11.2021):
	```
	pip install shiv
	```
</details>
...
- [GitHub](https://github.com/facebookincubator/xar) (👨‍💻 29 · 🔀 45 · 📦 17 · 📋 29 - 27% open · ⏱️ 10.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/xar) (📥 79 / month · ⏱️ 02.12.2020):
	```
	pip install xar
	```
</details>
...
- [GitHub](https://github.com/indygreg/PyOxidizer) (👨‍💻 37 · 🔀 130 · 📥 1.3K · 📋 400 - 60% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/pypa/setuptools) (👨‍💻 470 · 🔀 790 · 📥 110 · 📦 130K · 📋 1.9K - 28% open · ⏱️ 29.11.2021):

	```
	git clone https://github.com/pypa/setuptools
	```
- [PyPi](https://pypi.org/project/setuptools) (📥 160M / month · 📦 58K · ⏱️ 29.11.2021):
	```
...
- [GitHub](https://github.com/buildbot/buildbot) (👨‍💻 800 · 🔀 1.6K · 📥 19K · 📦 260 · 📋 1.4K - 45% open · ⏱️ 19.11.2021):

	```
	git clone https://github.com/buildbot/buildbot
	```
- [PyPi](https://pypi.org/project/buildbot) (📥 42K / month · 📦 890 · ⏱️ 16.10.2021):
	```
...
- [GitHub](https://github.com/pypa/twine) (👨‍💻 100 · 🔀 250 · 📦 50K · 📋 380 - 8% open · ⏱️ 01.12.2021):

	```
	git clone https://github.com/pypa/twine
	```
- [PyPi](https://pypi.org/project/twine) (📥 1.9M / month · 📦 18K · ⏱️ 01.12.2021):
	```
	pip install twine
	```
- [Conda](https://anaconda.org/conda-forge/twine) (📥 370K · ⏱️ 01.12.2021):
	```
...
- [GitHub](https://github.com/pypa/wheel) (👨‍💻 62 · 🔀 100 · 📋 330 - 9% open · ⏱️ 07.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/wheel) (📥 73M / month · 📦 63K · ⏱️ 09.08.2021):
	```
	pip install wheel
	```
...
- [GitHub](https://github.com/SCons/scons) (👨‍💻 140 · 🔀 250 · 📥 380 · 📋 3.3K - 19% open · ⏱️ 28.11.2021):
...
- [GitHub](https://github.com/pydoit/doit) (👨‍💻 61 · 🔀 140 · 📦 820 · 📋 260 - 24% open · ⏱️ 28.11.2021):
...
<details><summary><b><a href="https://github.com/pypa/flit">flit</a></b> (🥉27 ·  ⭐ 1.6K) - Simplified packaging of Python modules. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pypa/flit) (👨‍💻 48 · 🔀 86 · 📋 280 - 32% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/takluyver/flit
	```
- [PyPi](https://pypi.org/project/flit) (📥 320K / month · 📦 230 · ⏱️ 23.11.2021):
	```
	pip install flit
	```
...
- [GitHub](https://github.com/pybuilder/pybuilder) (👨‍💻 36 · 🔀 240 · 📋 500 - 17% open · ⏱️ 08.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pybuilder) (📥 15K / month · 📦 110 · ⏱️ 08.11.2021):
	```
...
- [GitHub](https://github.com/paver/paver) (👨‍💻 45 · 🔀 78 · 📋 130 - 28% open · ⏱️ 21.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/paver) (📥 27K / month · 📦 1.9K · ⏱️ 31.12.2017):
	```
	pip install paver
	```
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 170 · 🔀 1.2K · 📦 120K · 📋 1.5K - 13% open · ⏱️ 30.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/psutil) (📥 26M / month · 📦 25K · ⏱️ 19.12.2020):
	```
	pip install psutil
	```
...
- [GitHub](https://github.com/nicolargo/glances) (👨‍💻 150 · 🔀 1.3K · 📥 710 · 📦 350 · 📋 1.4K - 14% open · ⏱️ 29.11.2021):
...
<details><summary><b><a href="https://github.com/sumerc/yappi">Yappi</a></b> (🥈28 ·  ⭐ 760) - Yet Another Python Profiler, but this time thread&coroutine&greenlet aware. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sumerc/yappi) (👨‍💻 27 · 🔀 52 · 📦 500 · 📋 54 - 29% open · ⏱️ 10.11.2021):

	```
	git clone https://github.com/sumerc/yappi
	```
- [PyPi](https://pypi.org/project/yappi) (📥 750K / month · 📦 640 · ⏱️ 05.10.2021):
	```
	pip install yappi
	```
...
<details><summary><b><a href="https://github.com/benfred/py-spy">py-spy</a></b> (🥈27 ·  ⭐ 7.6K) - Sampling profiler for Python programs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 29 · 🔀 280 · 📥 7.1K · 📋 240 - 30% open · ⏱️ 29.11.2021):

	```
	git clone https://github.com/benfred/py-spy
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 430K / month · 📦 50 · ⏱️ 13.11.2021):
	```
	pip install py-spy
	```
</details>
...
- [GitHub](https://github.com/plasma-umass/scalene) (👨‍💻 23 · 🔀 160 · 📦 73 · 📋 150 - 23% open · ⏱️ 30.11.2021):

	```
	git clone https://github.com/plasma-umass/scalene
	```
- [PyPi](https://pypi.org/project/scalene) (📥 3.7K / month · ⏱️ 21.10.2021):
	```
	pip install scalene
	```
</details>
...
- [GitHub](https://github.com/joerick/pyinstrument) (👨‍💻 36 · 🔀 150 · 📦 430 · 📋 92 - 14% open · ⏱️ 14.11.2021):

	```
	git clone https://github.com/joerick/pyinstrument
	```
- [PyPi](https://pypi.org/project/pyinstrument) (📥 200K / month · 📦 140 · ⏱️ 14.11.2021):
	```
	pip install pyinstrument
	```
- [Conda](https://anaconda.org/conda-forge/pyinstrument) (📥 90K · ⏱️ 15.11.2021):
	```
...
- [GitHub](https://github.com/pyutils/line_profiler) (👨‍💻 27 · 🔀 250 · 📋 49 - 57% open · ⏱️ 27.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/line_profiler) (📥 96K / month · 📦 690 · ⏱️ 20.12.2017):
	```
...
<details><summary><b><a href="https://github.com/aristocratos/bpytop">Bpytop</a></b> (🥉21 ·  ⭐ 7.9K · 📉) - Linux/OSX/FreeBSD resource monitor. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/aristocratos/bpytop) (👨‍💻 30 · 🔀 310 · 📋 270 - 19% open · ⏱️ 18.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/bpytop) (📥 6.7K / month · ⏱️ 07.06.2021):
	```
	pip install bpytop
	```
</details>
...
- [GitHub](https://github.com/alexmojaki/heartrate) (👨‍💻 3 · 🔀 120 · 📦 26 · 📋 7 - 57% open · ⏱️ 13.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/heartrate) (📥 1K / month · ⏱️ 13.11.2021):
	```
	pip install heartrate
	```
</details>
<details><summary><b><a href="https://github.com/csurfer/pyheat">pyheat</a></b> (🥉18 ·  ⭐ 690) - pprofile + matplotlib = Python program profiled as an awesome heatmap!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/csurfer/pyheat) (👨‍💻 5 · 🔀 38 · 📦 32 · 📋 12 - 25% open · ⏱️ 18.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/py-heat) (📥 3.1K / month · 📦 10 · ⏱️ 06.12.2018):
	```
	pip install py-heat
	```
</details>
...
- [GitHub](https://github.com/python/typed_ast) (👨‍💻 23 · 🔀 50 · 📋 84 - 4% open · ⏱️ 12.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/typed_ast) (📥 9.9M / month · 📦 10K · ⏱️ 12.11.2021):
	```
	pip install typed_ast
	```
</details>
<details><summary><b><a href="https://github.com/berkerpeksag/astor">astor</a></b> (🥈28 ·  ⭐ 620) - Python AST read/write. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/berkerpeksag/astor) (👨‍💻 31 · 🔀 84 · 📋 110 - 31% open · ⏱️ 27.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/astor) (📥 3.6M / month · 📦 3.8K · ⏱️ 10.12.2019):
	```
	pip install astor
	```
...
- [GitHub](https://github.com/serge-sans-paille/gast) (👨‍💻 10 · 🔀 24 · 📦 71K · 📋 26 - 3% open · ⏱️ 13.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/gast) (📥 7.8M / month · 📦 3.4K · ⏱️ 13.11.2021):
	```
	pip install gast
	```
...
- [GitHub](https://github.com/newville/asteval) (👨‍💻 19 · 🔀 32 · 📦 680 · 📋 52 - 11% open · ⏱️ 25.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/asteval) (📥 110K / month · 📦 240 · ⏱️ 22.06.2021):
	```
	pip install asteval
	```
...
<details><summary><b><a href="https://github.com/pre-commit/pre-commit">pre-commit</a></b> (🥇31 ·  ⭐ 6.9K) - A framework for managing and maintaining multi-language pre-commit.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pre-commit/pre-commit) (👨‍💻 130 · 🔀 520 · 📥 21K · 📋 1.3K - 1% open · ⏱️ 30.11.2021):

	```
	git clone https://github.com/pre-commit/pre-commit
	```
- [PyPi](https://pypi.org/project/pre-commit) (📥 3M / month · 📦 2.1K · ⏱️ 30.11.2021):
	```
	pip install pre-commit
	```
- [Conda](https://anaconda.org/conda-forge/pre-commit) (📥 860K · ⏱️ 01.12.2021):
	```
