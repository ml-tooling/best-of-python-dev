...
- [GitHub](https://github.com/python/mypy) (👨‍💻 470 · 🔀 1.8K · 📦 37K · 📋 6.5K - 27% open · ⏱️ 24.06.2021):

	```
	git clone https://github.com/python/mypy
	```
- [PyPi](https://pypi.org/project/mypy) (📥 7M / month · 📦 6.1K · ⏱️ 22.06.2021):
	```
	pip install mypy
	```
...
- [GitHub](https://github.com/PyCQA/flake8) (👨‍💻 160 · 🔀 180 · 📦 170K · 📋 1.3K - 2% open · ⏱️ 22.06.2021):
...
- [GitHub](https://github.com/PyCQA/pylint) (👨‍💻 390 · 🔀 720 · 📋 3.5K - 20% open · ⏱️ 23.06.2021):

	```
	git clone https://github.com/PyCQA/pylint
	```
- [PyPi](https://pypi.org/project/pylint) (📥 12M / month · 📦 38K · ⏱️ 17.06.2021):
	```
	pip install pylint
	```
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 160 · 🔀 320 · 📋 260 - 24% open · ⏱️ 24.06.2021):
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 140 · 🔀 280 · 📦 390 · 📋 950 - 8% open · ⏱️ 24.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 77K / month · 📦 14 · ⏱️ 21.06.2021):
	```
...
- [GitHub](https://github.com/PyCQA/flake8-bugbear) (👨‍💻 37 · 🔀 42 · 📦 3.9K · 📋 91 - 41% open · ⏱️ 01.04.2021):
...
- [PyPi](https://pypi.org/project/flake8-bugbear) (📥 810K / month · 📦 1K · ⏱️ 01.04.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flake8-bugbear) (📥 320K · ⏱️ 02.04.2021):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 63 · 🔀 190 · 📋 420 - 23% open · ⏱️ 23.06.2021):
...
- [GitHub](https://github.com/terrencepreilly/darglint) (👨‍💻 21 · 🔀 26 · 📦 510 · 📋 130 - 28% open · ⏱️ 04.04.2021):
...
- [GitHub](https://github.com/microsoft/pyright) (👨‍💻 57 · 🔀 340 · 📦 88 · 📋 1.7K - 0% open · ⏱️ 24.06.2021):

	```
	git clone https://github.com/Microsoft/pyright
	```
- [NPM](https://www.npmjs.com/package/pyright) (📥 89K / month · 📦 4 · ⏱️ 23.06.2021):
	```
	npm install pyright
	```
</details>
...
- [GitHub](https://github.com/mgedmin/check-manifest) (👨‍💻 19 · 🔀 30 · 📦 5.5K · 📋 86 - 17% open · ⏱️ 13.06.2021):
...
- [GitHub](https://github.com/dropbox/mypy-protobuf) (👨‍💻 27 · 🔀 54 · 📦 240 · 📋 72 - 18% open · ⏱️ 25.02.2021):
...
- [GitHub](https://github.com/predictive-analytics-lab/data-science-types) (👨‍💻 44 · 🔀 57 · 📦 84 · 📋 62 - 62% open · ⏱️ 16.02.2021):

	```
	git clone https://github.com/predictive-analytics-lab/data-science-types
	```
- [PyPi](https://pypi.org/project/data-science-types) (📥 18K / month · ⏱️ 16.02.2021):
	```
	pip install data-science-types
	```
</details>
<details><summary><b><a href="https://github.com/peterjc/flake8-black">flake8-black</a></b> (🥉22 ·  ⭐ 89) - flake8 plugin to run black for checking Python coding style. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://cdn.iconscout.com/icon/free/png-256/8-eight-digital-number-numerical-numbers-36025.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/peterjc/flake8-black) (👨‍💻 4 · 🔀 7 · 📦 820 · 📋 18 - 22% open · ⏱️ 15.04.2021):
...
- [GitHub](https://github.com/ambv/flake8-mypy) (👨‍💻 8 · 🔀 15 · 📦 700 · 📋 22 - 86% open · ⏱️ 19.06.2020):

	```
	git clone https://github.com/ambv/flake8-mypy
	```
- [PyPi](https://pypi.org/project/flake8-mypy) (📥 38K / month · 📦 200 · ⏱️ 31.08.2017):
	```
...
- [GitHub](https://github.com/andreoliwa/nitpick) (👨‍💻 10 · 🔀 9 · 📥 3 · 📋 84 - 36% open · ⏱️ 12.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/nitpick) (📥 9.8K / month · ⏱️ 16.03.2021):
	```
	pip install nitpick
	```
</details>
...
- [GitHub](https://github.com/deppen8/pandas-vet) (👨‍💻 10 · 🔀 14 · 📥 33 · 📦 44 · 📋 49 - 42% open · ⏱️ 03.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pandas-vet) (📥 4.5K / month · ⏱️ 01.02.2020):
	```
...
<details><summary><b><a href="https://github.com/beartype/beartype">beartype</a></b> (🥉17 ·  ⭐ 280) - Unbearably fast O(1) runtime type-checking in pure Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/beartype/beartype) (👨‍💻 4 · 🔀 6 · 📋 25 - 12% open · ⏱️ 21.06.2021):

	```
	git clone https://github.com/beartype/beartype
	```
- [PyPi](https://pypi.org/project/beartype) (📥 9.8K / month · ⏱️ 25.05.2021):
	```
	pip install beartype
	```
- [Conda](https://anaconda.org/conda-forge/beartype) (📥 4.6K · ⏱️ 25.05.2021):
	```
...
- [GitHub](https://github.com/lyft/linty_fresh) (👨‍💻 17 · 🔀 21 · 📋 9 - 88% open · ⏱️ 30.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/linty-fresh) (📥 51 / month · ⏱️ 12.12.2018):
	```
...
- [GitHub](https://github.com/hhatto/autopep8) (👨‍💻 50 · 🔀 240 · 📦 80K · 📋 420 - 20% open · ⏱️ 30.04.2021):
...
- [GitHub](https://github.com/psf/black) (👨‍💻 260 · 🔀 1.4K · 📥 14K · 📦 64K · 📋 1.6K - 18% open · ⏱️ 23.06.2021):
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 240 · 🔀 410 · 📦 180K · 📋 970 - 2% open · ⏱️ 24.06.2021):

	```
	git clone https://github.com/PyCQA/isort
	```
- [PyPi](https://pypi.org/project/isort) (📥 17M / month · 📦 24K · ⏱️ 21.06.2021):
	```
	pip install isort
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 63 · 🔀 140 · 📦 29K · 📋 190 - 37% open · ⏱️ 20.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/rope) (📥 440K / month · 📦 2.9K · ⏱️ 07.10.2020):
	```
	pip install rope
	```
...
- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 28 · 🔀 81 · 📦 980 · 📋 150 - 8% open · ⏱️ 04.06.2021):
...
- [GitHub](https://github.com/myint/autoflake) (👨‍💻 17 · 🔀 44 · 📦 2.3K · 📋 66 - 50% open · ⏱️ 27.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/autoflake) (📥 770K / month · 📦 580 · ⏱️ 04.08.2019):
	```
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 37 · 🔀 130 · 📦 120 · 📋 150 - 25% open · ⏱️ 23.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/monkeytype) (📥 40K / month · 📦 34 · ⏱️ 21.05.2021):
	```
...
- [GitHub](https://github.com/asottile/pyupgrade) (👨‍💻 18 · 🔀 68 · 📋 200 - 7% open · ⏱️ 22.06.2021):

	```
	git clone https://github.com/asottile/pyupgrade
	```
- [PyPi](https://pypi.org/project/pyupgrade) (📥 150K / month · 📦 10 · ⏱️ 11.06.2021):
	```
...
- [GitHub](https://github.com/asottile/add-trailing-comma) (👨‍💻 9 · 🔀 13 · 📋 35 - 2% open · ⏱️ 22.06.2021):

	```
	git clone https://github.com/asottile/add-trailing-comma
	```
- [PyPi](https://pypi.org/project/add-trailing-comma) (📥 9.7K / month · 📦 14 · ⏱️ 24.01.2021):
	```
...
- [GitHub](https://github.com/hakancelik96/unimport) (👨‍💻 11 · 🔀 15 · 📦 8 · 📋 71 - 12% open · ⏱️ 08.05.2021):

	```
	git clone https://github.com/hakancelik96/unimport
	```
- [PyPi](https://pypi.org/project/unimport) (📥 3.4K / month · ⏱️ 10.03.2021):
	```
...
- [GitHub](https://github.com/ambv/retype) (👨‍💻 8 · 🔀 16 · 📋 14 - 64% open · ⏱️ 15.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/retype) (📥 890 / month · 📦 34 · ⏱️ 15.05.2021):
	```
	pip install retype
	```
...
<details><summary><b><a href="https://github.com/elmotec/massedit">massedit</a></b> (🥉16 ·  ⭐ 91) - Programmatically edit text files with Python. Useful for source to source.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/elmotec/massedit) (👨‍💻 6 · 🔀 14 · 📥 15 · 📋 8 - 37% open · ⏱️ 23.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/massedit) (📥 940 / month · 📦 10 · ⏱️ 23.12.2020):
	```
...
- [GitHub](https://github.com/ilevkivskyi/com2ann) (👨‍💻 3 · 🔀 5 · 📦 2 · 📋 18 - 22% open · ⏱️ 07.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/com2ann) (📥 570 / month · ⏱️ 17.06.2019):
	```
	pip install com2ann
	```
</details>
...
- [GitHub](https://github.com/PyCQA/bandit) (👨‍💻 130 · 🔀 330 · 📥 52 · 📦 7K · 📋 530 - 31% open · ⏱️ 15.06.2021):
...
- [PyPi](https://pypi.org/project/bandit) (📥 1.5M / month · 📦 2.4K · ⏱️ 13.12.2020):
	...
	pip install bandit
	```
- [Conda](https://anaconda.org/conda-forge/bandit) (📥 74K · ⏱️ 10.03.2021):
	```
...
- [GitHub](https://github.com/pyupio/safety) (👨‍💻 35 · 🔀 87 · 📥 53K · 📦 2K · 📋 110 - 39% open · ⏱️ 28.04.2021):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.3K · 📋 4.3K - 1% open · ⏱️ 21.06.2021):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 13K / month · 📦 8 · ⏱️ 08.06.2021):
	```
	pip install sqlmap
	```
</details>
...
- <b><a href="https://github.com/dashingsoft/pyarmor">pyarmor</a></b> (🥉25 ·  ⭐ 990) - A tool used to obfuscate python scripts, bind obfuscated scripts.. <code><a href="https://tldrlegal.com/search?q=SGI-B-2.0">❗️SGI-B-2.0</a></code>
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 330 · 🔀 2.1K · 📋 1.3K - 2% open · ⏱️ 19.06.2021):

	```
	git clone https://github.com/pyenv/pyenv
	```
- [PyPi](https://pypi.org/project/pyenv) (📥 6.7K / month · 📦 1 · ⏱️ 12.01.2019):
	```
	pip install pyenv
	```
</details>
...
- [GitHub](https://github.com/pypa/pip) (👨‍💻 620 · 🔀 2.4K · 📦 53K · 📋 5.8K - 17% open · ⏱️ 23.06.2021):

	```
	git clone https://github.com/pypa/pip
	```
- [PyPi](https://pypi.org/project/pip) (📥 86M / month · 📦 19K · ⏱️ 23.05.2021):
	```
	pip install pip
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 280 · 🔀 1.2K · 📥 6.9M · 📋 3.1K - 37% open · ⏱️ 23.06.2021):
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 150 · 🔀 440 · 📋 730 - 15% open · ⏱️ 22.06.2021):
...
- [GitHub](https://github.com/conda/conda) (👨‍💻 360 · 🔀 1K · 📋 8.1K - 24% open · ⏱️ 23.06.2021):
...
- [GitHub](https://github.com/bndr/pipreqs) (👨‍💻 50 · 🔀 220 · 📦 5.6K · 📋 170 - 48% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/mamba-org/mamba) (👨‍💻 51 · 🔀 93 · 📦 330 · 📋 490 - 30% open · ⏱️ 23.06.2021):

	```
	git clone https://github.com/mamba-org/mamba
	```
- [Conda](https://anaconda.org/conda-forge/mamba) (📥 940K · ⏱️ 17.06.2021):
	```
...
- [GitHub](https://github.com/pypa/pipx) (👨‍💻 57 · 🔀 160 · 📋 400 - 17% open · ⏱️ 16.06.2021):
...
- [GitHub](https://github.com/dephell/dephell) (👨‍💻 37 · 🔀 99 · 📥 130 · 📦 220 · 📋 260 - 38% open · ⏱️ 11.01.2021):
...
<details><summary><b><a href="https://github.com/David-OConnor/pyflow">pyflow</a></b> (🥉18 ·  ⭐ 810) - An installation and dependency system for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/David-OConnor/pyflow) (👨‍💻 23 · 🔀 30 · 📥 3.2K · 📋 95 - 47% open · ⏱️ 23.06.2021):

	```
	git clone https://github.com/David-OConnor/pyflow
	```
- [PyPi](https://pypi.org/project/pyflow) (📥 240 / month · ⏱️ 29.05.2021):
	```
	pip install pyflow
	```
</details>
...
- [GitHub](https://github.com/jaraco/pip-run) (👨‍💻 9 · 🔀 10 · 📋 41 - 9% open · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pip-run) (📥 2.6K / month · ⏱️ 21.02.2021):
	```
	pip install pip-run
	```
</details>
...
- [GitHub](https://github.com/rubik/xenon) (👨‍💻 7 · 🔀 13 · 📦 210 · 📋 30 - 20% open · ⏱️ 26.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/xenon) (📥 64K / month · 📦 120 · ⏱️ 26.05.2021):
	```
	pip install xenon
	```
...
<details><summary><b><a href="https://github.com/tonybaloney/wily">wily</a></b> (🥉20 ·  ⭐ 770 · 📈) - A Python application for tracking, reporting on timing and complexity.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/tonybaloney/wily) (👨‍💻 15 · 🔀 45 · 📋 79 - 39% open · ⏱️ 02.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/wily) (📥 7.2K / month · 📦 16 · ⏱️ 02.09.2020):
	```
	pip install wily
	```
</details>
...
<details><summary><b><a href="https://github.com/tqdm/tqdm">tqdm</a></b> (🥇37 ·  ⭐ 19K · 📈) - A Fast, Extensible Progress Bar for Python and CLI. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 100 · 🔀 950 · 📥 7.9K · 📦 180K · 📋 800 - 35% open · ⏱️ 12.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/tqdm) (📥 25M / month · 📦 26K · ⏱️ 12.06.2021):
	```
	pip install tqdm
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 99 · 🔀 210 · 📥 4.5K · 📦 12K · 📋 550 - 31% open · ⏱️ 14.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/sentry-sdk) (📥 9.6M / month · 📦 990 · ⏱️ 06.05.2021):
	```
...
<details><summary><b><a href="https://github.com/Delgan/loguru">loguru</a></b> (🥈31 ·  ⭐ 9.2K) - Python logging made (stupidly) simple. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/astanin/python-tabulate) (👨‍💻 67 · 🔀 66 · 📦 46K · 📋 84 - 32% open · ⏱️ 04.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/tabulate) (📥 18M / month · 📦 8.1K · ⏱️ 22.02.2021):
	```
...
<details><summary><b><a href="https://github.com/madzak/python-json-logger">python-json-logger</a></b> (🥈29 ·  ⭐ 990 · 💤) - Json Formatter for the standard python logger. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [PyPi](https://pypi.org/project/python-json-logger) (📥 3.4M / month · 📦 920 · ⏱️ 12.10.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-json-logger) (📥 700K · ⏱️ 12.10.2020):
	```
...
- [PyPi](https://pypi.org/project/colorlog) (📥 5M / month · 📦 3.7K · ⏱️ 14.06.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/colorlog) (📥 380K · ⏱️ 14.04.2021):
	```
...
- [GitHub](https://github.com/WoLpH/python-progressbar) (👨‍💻 38 · 🔀 91 · 📥 1.6K · 📦 9.8K · 📋 190 - 4% open · ⏱️ 15.03.2021):
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 1 · 🔀 100 · 📦 320 · 📋 70 - 30% open · ⏱️ 08.01.2021):

	```
	git clone https://github.com/rsalmei/alive-progress
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 15K / month · ⏱️ 08.01.2021):
	```
...
- [GitHub](https://github.com/shobrook/rebound) (👨‍💻 16 · 🔀 340 · 📥 170 · 📦 19 · 📋 58 - 34% open · ⏱️ 04.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/rebound) (📥 2K / month · 📦 14 · ⏱️ 20.06.2021):
	```
	pip install rebound
	```
...
- [GitHub](https://github.com/cknd/stackprinter) (👨‍💻 6 · 🔀 31 · 📦 57 · 📋 23 - 39% open · ⏱️ 01.01.2021):
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (👨‍💻 650 · 🔀 1.5K · 📦 150K · 📋 5.4K - 14% open · ⏱️ 20.06.2021):

	```
	git clone https://github.com/sphinx-doc/sphinx
	```
- [PyPi](https://pypi.org/project/sphinx) (📥 4.1M / month · 📦 100K · ⏱️ 20.05.2021):
	```
	pip install sphinx
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs) (👨‍💻 190 · 🔀 1.8K · 📦 13K · 📋 1.5K - 8% open · ⏱️ 09.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/mkdocs) (📥 620K / month · 📦 5.9K · ⏱️ 09.06.2021):
	```
	pip install mkdocs
	```
- [Conda](https://anaconda.org/conda-forge/mkdocs) (📥 140K · ⏱️ 21.06.2021):
	```
	conda install -c conda-forge mkdocs
	```
</details>
<details><summary><b><a href="https://github.com/squidfunk/mkdocs-material">mkdocs-material</a></b> (🥇33 ·  ⭐ 6.8K) - A Material Design theme for MkDocs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 120 · 🔀 1.6K · 📦 7.1K · 📋 1.1K - 1% open · ⏱️ 20.06.2021):

	```
	git clone https://github.com/squidfunk/mkdocs-material
	```
- [PyPi](https://pypi.org/project/mkdocs-material) (📥 480K / month · 📦 1.5K · ⏱️ 12.06.2021):
	```
	pip install mkdocs-material
	```
- [Conda](https://anaconda.org/conda-forge/mkdocs-material) (📥 47K · ⏱️ 12.06.2021):
	```
...
- [GitHub](https://github.com/michaeljones/breathe) (👨‍💻 94 · 🔀 140 · 📥 76 · 📦 4.7K · 📋 440 - 23% open · ⏱️ 18.05.2021):

	```
	git clone https://github.com/michaeljones/breathe
	```
- [PyPi](https://pypi.org/project/breathe) (📥 93K / month · 📦 2K · ⏱️ 06.05.2021):
	```
	pip install breathe
	```
...
- [PyPi](https://pypi.org/project/sphinx-autobuild) (📥 160K / month · 📦 4.7K · ⏱️ 14.03.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sphinx-autobuild) (📥 61K · ⏱️ 14.03.2021):
	```
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 30 · 🔀 110 · 📦 330 · 📋 170 - 2% open · ⏱️ 16.06.2021):

	```
	git clone https://github.com/mitmproxy/pdoc
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 61K / month · 📦 290 · ⏱️ 11.06.2021):
	```
	pip install pdoc
	```
</details>
<details><summary><b><a href="https://github.com/econchick/interrogate">interrogate</a></b> (🥉23 ·  ⭐ 280) - Explain yourself! Interrogate a codebase for docstring coverage. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/econchick/interrogate) (👨‍💻 9 · 🔀 20 · 📦 650 · 📋 30 - 36% open · ⏱️ 02.06.2021):
...
- [GitHub](https://github.com/asottile/blacken-docs) (👨‍💻 12 · 🔀 17 · 📋 30 - 6% open · ⏱️ 22.06.2021):

	```
	git clone https://github.com/asottile/blacken-docs
	```
- [PyPi](https://pypi.org/project/blacken-docs) (📥 7.5K / month · 📦 22 · ⏱️ 02.03.2021):
	```
...
- [GitHub](https://github.com/mkdocstrings/mkdocstrings) (👨‍💻 19 · 🔀 46 · 📋 180 - 23% open · ⏱️ 09.06.2021):

	```
	git clone https://github.com/pawamoy/mkdocstrings
	```
- [PyPi](https://pypi.org/project/mkdocstrings) (📥 50K / month · ⏱️ 09.06.2021):
	```
	pip install mkdocstrings
	```
</details>
<details><summary><b><a href="https://github.com/lukasgeiter/mkdocs-awesome-pages-plugin">mkdocs-awesome-pages-plugin</a></b> (🥉20 ·  ⭐ 160) - An MkDocs plugin that simplifies configuring page.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-pages-plugin) (👨‍💻 2 · 🔀 17 · 📦 380 · 📋 38 - 15% open · ⏱️ 22.12.2020):

	```
	git clone https://github.com/lukasgeiter/mkdocs-awesome-pages-plugin
	```
- [PyPi](https://pypi.org/project/mkdocs-awesome-pages-plugin) (📥 38K / month · 📦 90 · ⏱️ 22.12.2020):
	```
...
<details><summary><b><a href="https://github.com/orzih/mkdocs-with-pdf">mkdocs-with-pdf</a></b> (🥉19 ·  ⭐ 66) - Generate a single PDF file from MkDocs repository. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/orzih/mkdocs-with-pdf) (👨‍💻 6 · 🔀 10 · 📦 28 · 📋 47 - 31% open · ⏱️ 15.06.2021):

	```
	git clone https://github.com/orzih/mkdocs-with-pdf
	```
- [PyPi](https://pypi.org/project/mkdocs-with-pdf) (📥 5.5K / month · ⏱️ 15.06.2021):
	```
...
- [GitHub](https://github.com/ml-tooling/lazydocs) (👨‍💻 4 · 🔀 6 · 📦 26 · ⏱️ 15.03.2021):

	```
	git clone https://github.com/ml-tooling/lazydocs
	```
- [PyPi](https://pypi.org/project/lazydocs) (📥 340 / month · ⏱️ 15.03.2021):
	```
...
- [GitHub](https://github.com/cool-RR/PySnooper) (👨‍💻 26 · 🔀 900 · 📦 420 · 📋 110 - 16% open · ⏱️ 19.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pysnooper) (📥 85K / month · 📦 46 · ⏱️ 19.05.2021):
	```
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 77 · 🔀 180 · 📦 2.4K · 📋 270 - 50% open · ⏱️ 08.06.2021):
...
- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 39 · 🔀 42 · 📦 2.1K · 📋 170 - 34% open · ⏱️ 30.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/pdbpp) (📥 290K / month · 📦 1K · ⏱️ 04.10.2019):
	```
	pip install pdbpp
	```
...
- [GitHub](https://github.com/cs01/gdbgui) (👨‍💻 36 · 🔀 470 · 📥 4K · 📦 89 · 📋 270 - 41% open · ⏱️ 01.06.2021):
...
- [GitHub](https://github.com/agronholm/typeguard) (👨‍💻 18 · 🔀 61 · 📋 160 - 25% open · ⏱️ 04.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/typeguard) (📥 3M / month · 📦 160 · ⏱️ 04.06.2021):
	```
	pip install typeguard
	```
- [Conda](https://anaconda.org/conda-forge/typeguard) (📥 43K · ⏱️ 04.06.2021):
	```
	conda install -c conda-forge typeguard
	```
</details>
<details><summary><b><a href="https://github.com/gruns/icecream">icecream</a></b> (🥉23 ·  ⭐ 4.9K) - Never use print() to debug again. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/gruns/icecream) (👨‍💻 14 · 🔀 96 · 📋 67 - 23% open · ⏱️ 22.06.2021):

	```
	git clone https://github.com/gruns/icecream
	```
- [PyPi](https://pypi.org/project/icecream) (📥 62K / month · 📦 6 · ⏱️ 22.06.2021):
	```
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 8 · 🔀 32 · 📦 63 · 📋 83 - 44% open · ⏱️ 23.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/hunter) (📥 5.5K / month · 📦 34 · ⏱️ 23.06.2021):
	```
	pip install hunter
	```
</details>
...
- [GitHub](https://github.com/ionelmc/python-manhole) (👨‍💻 10 · 🔀 15 · 📦 70 · 📋 20 - 25% open · ⏱️ 08.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/manhole) (📥 7.9K / month · 📦 66 · ⏱️ 08.04.2021):
	```
	pip install manhole
	```
</details>
...
- [GitHub](https://github.com/alexmojaki/birdseye) (👨‍💻 9 · 🔀 70 · 📋 48 - 35% open · ⏱️ 26.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/birdseye) (📥 1.2K / month · ⏱️ 25.08.2020):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest) (👨‍💻 730 · 🔀 1.7K · 📦 330K · 📋 4.5K - 14% open · ⏱️ 24.06.2021):
...
- [GitHub](https://github.com/tox-dev/tox) (👨‍💻 240 · 🔀 370 · 📦 45K · 📋 1.2K - 11% open · ⏱️ 23.06.2021):
...
- [PyPi](https://pypi.org/project/tox) (📥 4.2M / month · 📦 36K · ⏱️ 05.05.2021):
	...
	pip install tox
	```
- [Conda](https://anaconda.org/conda-forge/tox) (📥 300K · ⏱️ 05.05.2021):
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 140 · 🔀 1.7K · 📥 510 · 📦 3.9K · 📋 3.6K - 5% open · ⏱️ 24.06.2021):
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 250 · 🔀 460 · 📦 9K · 📋 1.1K - 5% open · ⏱️ 15.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 1.8M / month · 📦 2.6K · ⏱️ 09.06.2021):
	```
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 94 · 🔀 200 · 📦 8.2K · 📋 230 - 28% open · ⏱️ 18.06.2021):
...
- [GitHub](https://github.com/pytest-dev/pytest-cov) (👨‍💻 66 · 🔀 150 · 📦 89K · 📋 290 - 34% open · ⏱️ 01.06.2021):
...
- [PyPi](https://pypi.org/project/pytest-cov) (📥 13M / month · 📦 43K · ⏱️ 01.06.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-cov) (📥 3M · ⏱️ 02.06.2021):
	```
...
- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 50 · 🔀 720 · 📦 8.5K · 📋 480 - 64% open · ⏱️ 18.04.2021):

	```
	git clone https://github.com/asweigart/pyautogui
	```
- [PyPi](https://pypi.org/project/pyautogui) (📥 420K / month · 📦 610 · ⏱️ 06.10.2020):
	```
...
- [PyPi](https://pypi.org/project/pytest-mock) (📥 4.2M / month · 📦 6.2K · ⏱️ 06.05.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-mock) (📥 970K · ⏱️ 07.05.2021):
	```
...
- [PyPi](https://pypi.org/project/pytest-asyncio) (📥 1.7M / month · 📦 2K · ⏱️ 21.04.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-asyncio) (📥 460K · ⏱️ 21.05.2021):
	```
...
- [GitHub](https://github.com/microsoft/playwright-python) (👨‍💻 21 · 🔀 410 · 📦 260 · 📋 360 - 4% open · ⏱️ 23.06.2021):

	```
	git clone https://github.com/microsoft/playwright-python
	```
- [PyPi](https://pypi.org/project/playwright) (📥 91K / month · ⏱️ 11.06.2021):
	```
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 270 · 📥 160 · 📋 290 - 1% open · ⏱️ 20.06.2021):
...
- [PyPi](https://pypi.org/project/pytest-benchmark) (📥 320K / month · 📦 730 · ⏱️ 17.04.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-benchmark) (📥 620K · ⏱️ 18.04.2021):
	```
...
- [PyPi](https://pypi.org/project/pytest-bdd) (📥 190K / month · 📦 270 · ⏱️ 07.12.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-bdd) (📥 31K · ⏱️ 03.02.2020):
	```
...
- [GitHub](https://github.com/airspeed-velocity/asv) (👨‍💻 54 · 🔀 130 · 📦 170 · 📋 410 - 26% open · ⏱️ 21.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/asv) (📥 19K / month · 📦 88 · ⏱️ 16.05.2020):
	```
	pip install asv
	```
...
- [GitHub](https://github.com/hamcrest/PyHamcrest) (👨‍💻 34 · 🔀 84 · 📋 60 - 20% open · ⏱️ 08.03.2021):
...
- [GitHub](https://github.com/pytest-dev/pytest-testinfra) (👨‍💻 100 · 🔀 270 · 📋 310 - 36% open · ⏱️ 20.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-testinfra) (📥 81K / month · ⏱️ 20.06.2021):
	```
...
- [GitHub](https://github.com/xiaocong/uiautomator) (👨‍💻 13 · 🔀 590 · 📦 190 · 📋 290 - 59% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/uiautomator) (📥 14K / month · 📦 120 · ⏱️ 16.11.2020):
	```
...
- [GitHub](https://github.com/Erotemic/xdoctest) (👨‍💻 5 · 🔀 5 · 📦 1.1K · 📋 32 - 50% open · ⏱️ 19.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/xdoctest) (📥 79K / month · 📦 52 · ⏱️ 29.01.2021):
	```
	pip install xdoctest
	```
</details>
<details><summary><b><a href="https://github.com/theacodes/nox">nox</a></b> (🥉23 ·  ⭐ 570) - Flexible test automation for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [PyPi](https://pypi.org/project/nox) (📥 370K / month · 📦 56 · ⏱️ 13.06.2021):
	...
	pip install nox
	```
- [Conda](https://anaconda.org/conda-forge/nox) (📥 31K · ⏱️ 20.06.2021):
	```
	conda install -c conda-forge nox
	```
</details>
<details><summary><b><a href="https://github.com/pytest-dev/pytest-randomly">pytest-randomly</a></b> (🥉23 ·  ⭐ 320) - Pytest plugin to randomly order tests and control random.seed. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/pytest-dev/pytest-randomly) (👨‍💻 15 · 🔀 22 · 📋 43 - 16% open · ⏱️ 22.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-randomly) (📥 400K / month · 📦 210 · ⏱️ 10.05.2021):
	```
...
- [GitHub](https://github.com/sixpack/sixpack) (👨‍💻 56 · 🔀 180 · 📦 8 · 📋 210 - 41% open · ⏱️ 26.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/sixpack) (📥 320 / month · 📦 4 · ⏱️ 22.11.2017):
	```
	pip install sixpack
	```
</details>
...
- [GitHub](https://github.com/avast/pytest-docker) (👨‍💻 11 · 🔀 40 · 📥 66 · 📋 31 - 54% open · ⏱️ 14.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-docker) (📥 28K / month · 📦 28 · ⏱️ 14.06.2021):
	```
...
- [GitHub](https://github.com/pypa/packaging) (👨‍💻 70 · 🔀 150 · 📥 96 · 📦 220K · 📋 200 - 26% open · ⏱️ 19.06.2021):

	```
	git clone https://github.com/pypa/packaging
	```
- [PyPi](https://pypi.org/project/packaging) (📥 57M / month · 📦 29K · ⏱️ 29.01.2021):
	```
	pip install packaging
	```
- [Conda](https://anaconda.org/conda-forge/packaging) (📥 7.9M · ⏱️ 04.02.2021):
	```
	conda install -c conda-forge packaging
	```
</details>
<details><summary><b><a href="https://github.com/Nuitka/Nuitka">Nuitka</a></b> (🥈27 ·  ⭐ 5.3K) - Nuitka is a Python compiler written in Python. It's fully compatible.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Nuitka/Nuitka) (👨‍💻 98 · 🔀 310 · 📋 940 - 21% open · ⏱️ 19.06.2021):

	```
	git clone https://github.com/Nuitka/Nuitka
	```
- [PyPi](https://pypi.org/project/nuitka) (📥 26K / month · 📦 54 · ⏱️ 24.06.2021):
	```
	pip install nuitka
	```
- [Conda](https://anaconda.org/conda-forge/nuitka) (📥 290K · ⏱️ 07.06.2021):
	```
...
- [GitHub](https://github.com/pantsbuild/pex) (👨‍💻 99 · 🔀 200 · 📥 320K · 📋 690 - 19% open · ⏱️ 21.06.2021):
...
- [GitHub](https://github.com/py2exe/py2exe) (👨‍💻 14 · 🔀 36 · 📥 9.7K · 📦 1.2K · 📋 73 - 6% open · ⏱️ 24.04.2021):
...
- [GitHub](https://github.com/marcelotduarte/cx_Freeze) (👨‍💻 90 · 🔀 160 · 📋 660 - 9% open · ⏱️ 23.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/cx_freeze) (📥 41K / month · 📦 150 · ⏱️ 16.12.2017):
	```
	pip install cx_freeze
	```
- [Conda](https://anaconda.org/conda-forge/cx_freeze) (📥 77K · ⏱️ 17.04.2021):
	```
...
- [GitHub](https://github.com/takluyver/pynsist) (👨‍💻 28 · 🔀 100 · 📋 150 - 16% open · ⏱️ 21.06.2021):
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 33 · 🔀 69 · 📥 140 · 📋 86 - 31% open · ⏱️ 23.06.2021):

	```
	git clone https://github.com/linkedin/shiv
	```
- [PyPi](https://pypi.org/project/shiv) (📥 8K / month · 📦 10 · ⏱️ 30.04.2021):
	```
	pip install shiv
	```
</details>
...
- [GitHub](https://github.com/indygreg/PyOxidizer) (👨‍💻 34 · 🔀 110 · 📥 340 · 📋 340 - 58% open · ⏱️ 06.06.2021):
...
- [GitHub](https://github.com/pypa/setuptools) (👨‍💻 440 · 🔀 730 · 📥 110 · 📦 110K · 📋 1.8K - 30% open · ⏱️ 29.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/setuptools) (📥 96M / month · 📦 58K · ⏱️ 23.05.2021):
	```
	pip install setuptools
	```
- [Conda](https://anaconda.org/conda-forge/setuptools) (📥 23M · ⏱️ 08.01.2021):
	```
...
- [GitHub](https://github.com/buildbot/buildbot) (👨‍💻 790 · 🔀 1.5K · 📥 15K · 📦 250 · 📋 1.3K - 48% open · ⏱️ 24.06.2021):
...
- [GitHub](https://github.com/pyinvoke/invoke) (👨‍💻 56 · 🔀 280 · 📦 8K · 📋 660 - 45% open · ⏱️ 06.06.2021):
...
- [PyPi](https://pypi.org/project/invoke) (📥 1.6M / month · 📦 4.6K · ⏱️ 31.12.2020):
	...
	pip install invoke
	```
- [Conda](https://anaconda.org/conda-forge/invoke) (📥 330K · ⏱️ 06.01.2021):
	```
...
- [GitHub](https://github.com/takluyver/flit) (👨‍💻 42 · 🔀 73 · 📋 240 - 34% open · ⏱️ 02.04.2021):

	```
	git clone https://github.com/takluyver/flit
	```
- [PyPi](https://pypi.org/project/flit) (📥 84K / month · 📦 230 · ⏱️ 01.03.2021):
	```
	pip install flit
	```
- [Conda](https://anaconda.org/conda-forge/flit) (📥 85K · ⏱️ 22.03.2021):
	```
...
- [PyPi](https://pypi.org/project/doit) (📥 210K / month · 📦 470 · ⏱️ 04.09.2020):
	...
	pip install doit
	```
- [Conda](https://anaconda.org/conda-forge/doit) (📥 58K · ⏱️ 11.10.2020):
	```
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 160 · 🔀 1.1K · 📦 91K · 📋 1.5K - 12% open · ⏱️ 06.06.2021):
...
- [GitHub](https://github.com/nicolargo/glances) (👨‍💻 140 · 🔀 1.2K · 📥 430 · 📦 310 · 📋 1.4K - 14% open · ⏱️ 20.06.2021):
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 26 · 🔀 250 · 📥 5.4K · 📦 900 · 📋 210 - 28% open · ⏱️ 09.06.2021):
...
- [GitHub](https://github.com/pyutils/line_profiler) (👨‍💻 24 · 🔀 250 · 📋 45 - 73% open · ⏱️ 04.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/line_profiler) (📥 350K / month · 📦 690 · ⏱️ 20.12.2017):
	```
...
- [GitHub](https://github.com/pythonprofilers/memory_profiler) (👨‍💻 88 · 🔀 310 · 📋 190 - 47% open · ⏱️ 12.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 480K / month · 📦 530 · ⏱️ 16.08.2018):
	```
...
- [GitHub](https://github.com/joerick/pyinstrument) (👨‍💻 27 · 🔀 110 · 📦 280 · 📋 80 - 25% open · ⏱️ 03.05.2021):
...
- [PyPi](https://pypi.org/project/pyinstrument) (📥 160K / month · 📦 140 · ⏱️ 03.05.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyinstrument) (📥 73K · ⏱️ 03.05.2021):
	```
...
- [PyPi](https://pypi.org/project/yappi) (📥 120K / month · 📦 640 · ⏱️ 27.11.2020):
	...
	pip install yappi
	```
- [Conda](https://anaconda.org/conda-forge/yappi) (📥 81K · ⏱️ 28.11.2020):
	```
...
- [GitHub](https://github.com/plasma-umass/scalene) (👨‍💻 19 · 🔀 140 · 📦 44 · 📋 120 - 18% open · ⏱️ 09.06.2021):

	```
	git clone https://github.com/emeryberger/scalene
	```
- [PyPi](https://pypi.org/project/scalene) (📥 5.7K / month · ⏱️ 04.06.2021):
	```
	pip install scalene
	```
</details>
...
- [GitHub](https://github.com/aristocratos/bpytop) (👨‍💻 30 · 🔀 260 · 📋 240 - 16% open · ⏱️ 07.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/bpytop) (📥 12K / month · ⏱️ 07.06.2021):
	```
	pip install bpytop
	```
</details>
...
- [GitHub](https://github.com/serge-sans-paille/gast) (👨‍💻 10 · 🔀 22 · 📦 59K · 📋 25 - 16% open · ⏱️ 26.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/gast) (📥 7.9M / month · 📦 3.4K · ⏱️ 07.08.2020):
	```
	pip install gast
	```
...
- [GitHub](https://github.com/newville/asteval) (👨‍💻 18 · 🔀 32 · 📦 570 · 📋 50 - 12% open · ⏱️ 22.06.2021):
...
<details><summary><b><a href="https://github.com/pre-commit/pre-commit">pre-commit</a></b> (🥇32 ·  ⭐ 6.1K) - A framework for managing and maintaining multi-language pre-commit.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pre-commit/pre-commit) (👨‍💻 120 · 🔀 450 · 📥 7.2K · 📋 1.2K - 1% open · ⏱️ 22.06.2021):
...
- [PyPi](https://pypi.org/project/pre-commit) (📥 3.3M / month · 📦 2.1K · ⏱️ 21.05.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pre-commit) (📥 590K · ⏱️ 27.05.2021):
	```
