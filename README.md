...
- [GitHub](https://github.com/python/mypy) (👨‍💻 520 · 🔀 2K · 📦 54K · 📋 7.2K - 28% open · ⏱️ 30.12.2021):

	```
	git clone https://github.com/python/mypy
	```
- [PyPi](https://pypi.org/project/mypy) (📥 7.9M / month · 📦 6.1K · ⏱️ 22.12.2021):
	```
	pip install mypy
	```
- [Conda](https://anaconda.org/conda-forge/mypy) (📥 1.5M · ⏱️ 25.12.2021):
	```
...
- [GitHub](https://github.com/PyCQA/flake8) (👨‍💻 160 · 🔀 180 · 📦 220K · 📋 1.3K - 2% open · ⏱️ 27.12.2021):
...
- [GitHub](https://github.com/davidhalter/parso) (👨‍💻 43 · 🔀 77 · 📦 170K · 📋 100 - 6% open · ⏱️ 30.11.2021):

	```
	git clone https://github.com/davidhalter/parso
	```
- [PyPi](https://pypi.org/project/parso) (📥 17M / month · 📦 11K · ⏱️ 30.11.2021):
	```
	pip install parso
	```
- [Conda](https://anaconda.org/conda-forge/parso) (📥 5.9M · ⏱️ 01.12.2021):
	```
...
- [GitHub](https://github.com/PyCQA/pycodestyle) (👨‍💻 130 · 🔀 610 · 📦 180K · 📋 670 - 16% open · ⏱️ 28.12.2021):
...
- [GitHub](https://github.com/PyCQA/pylint) (👨‍💻 430 · 🔀 800 · 📋 3.9K - 19% open · ⏱️ 30.12.2021):

	```
	git clone https://github.com/PyCQA/pylint
	```
- [PyPi](https://pypi.org/project/pylint) (📥 8.6M / month · 📦 38K · ⏱️ 03.12.2021):
	```
	pip install pylint
	```
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 160 · 🔀 310 · 📦 890 · 📋 990 - 7% open · ⏱️ 30.12.2021):

	```
	git clone https://github.com/wemake-services/wemake-python-styleguide
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 120K / month · 📦 14 · ⏱️ 13.12.2021):
	```
...
- [GitHub](https://github.com/PyCQA/pydocstyle) (👨‍💻 74 · 🔀 150 · 📥 56 · 📦 22K · 📋 280 - 28% open · ⏱️ 10.10.2021):
...
- [PyPi](https://pypi.org/project/pydocstyle) (📥 1.8M / month · 📦 3.9K · ⏱️ 17.05.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pydocstyle) (📥 490K · ⏱️ 18.05.2021):
	```
...
- [GitHub](https://github.com/PyCQA/flake8-bugbear) (👨‍💻 45 · 🔀 55 · 📦 6.2K · 📋 110 - 38% open · ⏱️ 29.11.2021):

	```
	git clone https://github.com/PyCQA/flake8-bugbear
	```
- [PyPi](https://pypi.org/project/flake8-bugbear) (📥 1.1M / month · 📦 1K · ⏱️ 29.11.2021):
	```
	pip install flake8-bugbear
	```
- [Conda](https://anaconda.org/conda-forge/flake8-bugbear) (📥 540K · ⏱️ 29.11.2021):
	```
...
- [GitHub](https://github.com/openstack/hacking) (👨‍💻 180 · 🔀 66 · ⏱️ 07.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/hacking) (📥 540K / month · 📦 8.7K · ⏱️ 21.04.2021):
	```
	pip install hacking
	```
</details>
...
- [GitHub](https://github.com/klen/pylama) (👨‍💻 45 · 🔀 86 · 📦 3.2K · 📋 120 - 27% open · ⏱️ 15.12.2021):

	```
	git clone https://github.com/klen/pylama
	```
- [PyPi](https://pypi.org/project/pylama) (📥 100K / month · 📦 1K · ⏱️ 15.12.2021):
	```
	pip install pylama
	```
</details>
...
- [GitHub](https://github.com/PyCQA/pylint-django) (👨‍💻 60 · 🔀 100 · 📥 200 · 📦 16K · 📋 190 - 18% open · ⏱️ 28.12.2021):

	```
	git clone https://github.com/PyCQA/pylint-django
	```
- [PyPi](https://pypi.org/project/pylint-django) (📥 570K / month · 📦 2.2K · ⏱️ 09.04.2021):
	```
...
- [GitHub](https://github.com/terrencepreilly/darglint) (👨‍💻 22 · 🔀 33 · 📦 1.5K · 📋 140 - 33% open · ⏱️ 18.10.2021):

	```
	git clone https://github.com/terrencepreilly/darglint
	```
- [PyPi](https://pypi.org/project/darglint) (📥 210K / month · 📦 20 · ⏱️ 18.10.2021):
	```
...
- [GitHub](https://github.com/zheller/flake8-quotes) (👨‍💻 30 · 🔀 33 · 📦 4.1K · 📋 43 - 6% open · ⏱️ 19.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-quotes) (📥 470K / month · 📦 1.4K · ⏱️ 15.12.2021):
	```
...
- [GitHub](https://github.com/gforcada/flake8-isort) (👨‍💻 30 · 🔀 40 · 📦 4.4K · 📋 53 - 24% open · ⏱️ 03.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-isort) (📥 500K / month · 📦 930 · ⏱️ 14.10.2021):
	```
...
<details><summary><b><a href="https://github.com/microsoft/pyright">pyright</a></b> (🥉25 ·  ⭐ 7.5K) - Static type checker for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/microsoft/pyright) (👨‍💻 68 · 🔀 400 · 📦 170 · 📋 2.2K - 0% open · ⏱️ 30.12.2021):

	```
	git clone https://github.com/Microsoft/pyright
	```
- [NPM](https://www.npmjs.com/package/pyright) (📥 220K / month · 📦 4 · ⏱️ 30.12.2021):
	```
	npm install pyright
	```
</details>
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 190 · 🔀 380 · 📋 300 - 30% open · ⏱️ 30.12.2021):

	```
	git clone https://github.com/facebook/pyre-check
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 25K / month · 📦 46 · ⏱️ 22.12.2021):
	```
	pip install pyre-check
	```
</details>
<details><summary><b><a href="https://github.com/google/pytype">pytype</a></b> (🥉25 ·  ⭐ 3.6K) - A static type analyzer for Python code. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/google/pytype) (👨‍💻 71 · 🔀 220 · 📋 470 - 20% open · ⏱️ 21.12.2021):

	```
	git clone https://github.com/google/pytype
	```
- [PyPi](https://pypi.org/project/pytype) (📥 140K / month · 📦 88 · ⏱️ 15.12.2021):
	```
	pip install pytype
	```
...
- [GitHub](https://github.com/mgedmin/check-manifest) (👨‍💻 20 · 🔀 31 · 📦 7K · 📋 88 - 18% open · ⏱️ 16.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/check-manifest) (📥 160K / month · 📦 1.8K · ⏱️ 22.09.2021):
	```
...
- [GitHub](https://github.com/dropbox/mypy-protobuf) (👨‍💻 31 · 🔀 64 · 📋 97 - 4% open · ⏱️ 24.12.2021):

	```
	git clone https://github.com/dropbox/mypy-protobuf
	```
- [PyPi](https://pypi.org/project/mypy-protobuf) (📥 1.1M / month · 📦 24 · ⏱️ 24.12.2021):
	```
...
- [GitHub](https://github.com/adamchainz/flake8-comprehensions) (👨‍💻 12 · 🔀 15 · 📋 41 - 17% open · ⏱️ 30.12.2021):

	```
	git clone https://github.com/adamchainz/flake8-comprehensions
	```
- [PyPi](https://pypi.org/project/flake8-comprehensions) (📥 530K / month · 📦 710 · ⏱️ 11.10.2021):
	```
	pip install flake8-comprehensions
	```
- [Conda](https://anaconda.org/conda-forge/flake8-comprehensions) (📥 480K · ⏱️ 12.10.2021):
	```
...
- [GitHub](https://github.com/wemake-services/flake8-eradicate) (👨‍💻 13 · 🔀 7 · 📋 28 - 3% open · ⏱️ 30.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-eradicate) (📥 230K / month · 📦 72 · ⏱️ 19.10.2021):
	```
...
<details><summary><b><a href="https://github.com/Instagram/Fixit">Fixit</a></b> (🥉20 ·  ⭐ 290) - Fixit is a Python Lint Framework based on LibCST. It comes with useful.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/andreoliwa/nitpick">nitpick</a></b> (🥉19 ·  ⭐ 200) - Enforce the same settings on multiple projects. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://cdn.iconscout.com/icon/free/png-256/8-eight-digital-number-numerical-numbers-36025.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/andreoliwa/nitpick) (👨‍💻 13 · 🔀 13 · 📥 4 · 📋 93 - 34% open · ⏱️ 30.12.2021):
...
- [PyPi](https://pypi.org/project/pandas-vet) (📥 5.2K / month · ⏱️ 01.02.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pandas-vet) (📥 7.8K · ⏱️ 01.02.2020):
	```
...
- [GitHub](https://github.com/justinabrahms/imhotep) (👨‍💻 16 · 🔀 37 · 📦 9 · 📋 46 - 50% open · ⏱️ 01.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/imhotep) (📥 40 / month · 📦 8 · ⏱️ 18.09.2016):
	```
	pip install imhotep
	```
</details>
<details><summary><b><a href="https://github.com/beartype/beartype">beartype</a></b> (🥉17 ·  ⭐ 1K) - Unbearably fast O(1) runtime type-checking in pure Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/beartype/beartype) (👨‍💻 9 · 🔀 17 · 📋 59 - 16% open · ⏱️ 30.12.2021):
...
- [PyPi](https://pypi.org/project/beartype) (📥 45K / month · ⏱️ 06.11.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/beartype) (📥 9.2K · ⏱️ 06.11.2021):
	```
...
- [GitHub](https://github.com/hchasestevens/bellybutton) (👨‍💻 5 · 🔀 11 · 📦 15 · 📋 14 - 57% open · ⏱️ 15.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/bellybutton) (📥 7K / month · ⏱️ 27.11.2020):
	```
...
- [GitHub](https://github.com/psf/black) (👨‍💻 290 · 🔀 1.5K · 📥 19K · 📦 100K · 📋 1.8K - 19% open · ⏱️ 25.12.2021):

	```
	git clone https://github.com/psf/black
	```
- [PyPi](https://pypi.org/project/black) (📥 9.3M / month · 📦 6.2K · ⏱️ 05.12.2021):
	```
	pip install black
	```
...
- [GitHub](https://github.com/hhatto/autopep8) (👨‍💻 51 · 🔀 250 · 📦 100K · 📋 430 - 21% open · ⏱️ 30.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/autopep8) (📥 2.4M / month · 📦 10K · ⏱️ 24.10.2021):
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 250 · 🔀 430 · 📦 210K · 📋 1K - 3% open · ⏱️ 30.12.2021):

	```
	git clone https://github.com/PyCQA/isort
	```
- [PyPi](https://pypi.org/project/isort) (📥 16M / month · 📦 24K · ⏱️ 09.11.2021):
	```
	pip install isort
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 130 · 🔀 820 · 📦 27K · 📋 720 - 46% open · ⏱️ 27.12.2021):

	```
	git clone https://github.com/google/yapf
	```
- [PyPi](https://pypi.org/project/yapf) (📥 1.6M / month · 📦 3.4K · ⏱️ 26.12.2021):
	```
	pip install yapf
	```
...
- [GitHub](https://github.com/myint/docformatter) (👨‍💻 15 · 🔀 33 · 📦 790 · 📋 49 - 55% open · ⏱️ 27.12.2020):
...
- [GitHub](https://github.com/davidhalter/jedi) (👨‍💻 150 · 🔀 460 · 📦 170K · 📋 1.3K - 2% open · ⏱️ 25.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/jedi) (📥 17M / month · 📦 16K · ⏱️ 17.11.2021):
	```
	pip install jedi
	```
- [Conda](https://anaconda.org/conda-forge/jedi) (📥 7.3M · ⏱️ 17.11.2021):
	```
	conda install -c conda-forge jedi
	```
</details>
<details><summary><b><a href="https://github.com/python-rope/rope">rope</a></b> (🥇32 ·  ⭐ 1.3K) - a python refactoring library. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 68 · 🔀 150 · 📦 34K · 📋 230 - 30% open · ⏱️ 20.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/rope) (📥 520K / month · 📦 2.9K · ⏱️ 15.12.2021):
	```
	pip install rope
	```
...
<details><summary><b><a href="https://github.com/myint/autoflake">autoflake</a></b> (🥈26 ·  ⭐ 460 · 💤) - Removes unused imports and unused variables as reported by pyflakes. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/myint/autoflake) (👨‍💻 17 · 🔀 51 · 📦 3.5K · 📋 66 - 50% open · ⏱️ 27.12.2020):
...
- [PyPi](https://pypi.org/project/autoflake) (📥 580K / month · 📦 580 · ⏱️ 04.08.2019):
	...
	```
- [Conda](https://anaconda.org/conda-forge/autoflake) (📥 230K · ⏱️ 26.05.2021):
	```
...
- [GitHub](https://github.com/asottile/pyupgrade) (👨‍💻 22 · 🔀 89 · 📋 250 - 3% open · ⏱️ 28.12.2021):

	```
	git clone https://github.com/asottile/pyupgrade
	```
- [PyPi](https://pypi.org/project/pyupgrade) (📥 140K / month · 📦 10 · ⏱️ 28.12.2021):
	```
	pip install pyupgrade
	```
- [Conda](https://anaconda.org/conda-forge/pyupgrade) (📥 300K · ⏱️ 28.12.2021):
	```
	conda install -c conda-forge pyupgrade
	```
</details>
<details><summary><b><a href="https://github.com/PyCQA/baron">baron</a></b> (🥈25 ·  ⭐ 260) - IDE allow you to refactor code, Baron allows you to write refactoring.. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/PyCQA/baron) (👨‍💻 33 · 🔀 52 · 📦 190 · 📋 75 - 61% open · ⏱️ 09.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/baron) (📥 28K / month · 📦 110 · ⏱️ 09.12.2021):
	```
	pip install baron
	```
</details>
...
- [GitHub](https://github.com/PyCQA/redbaron) (👨‍💻 34 · 🔀 67 · 📦 340 · 📋 130 - 63% open · ⏱️ 09.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/redbaron) (📥 27K / month · 📦 170 · ⏱️ 17.03.2019):
	```
	pip install redbaron
	```
</details>
<details><summary><b><a href="https://github.com/Instagram/MonkeyType">MonkeyType</a></b> (🥉23 ·  ⭐ 3.6K) - A Python library that generates static type annotations by.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 37 · 🔀 130 · 📦 160 · 📋 150 - 24% open · ⏱️ 15.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/monkeytype) (📥 27K / month · 📦 34 · ⏱️ 21.05.2021):
	```
...
- [GitHub](https://github.com/facebookincubator/Bowler) (👨‍💻 26 · 🔀 88 · 📋 80 - 57% open · ⏱️ 01.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/bowler) (📥 39K / month · 📦 10 · ⏱️ 17.09.2020):
	```
	pip install bowler
	```
...
- [GitHub](https://github.com/asottile/add-trailing-comma) (👨‍💻 9 · 🔀 15 · 📋 38 - 2% open · ⏱️ 28.12.2021):

	```
	git clone https://github.com/asottile/add-trailing-comma
	```
- [PyPi](https://pypi.org/project/add-trailing-comma) (📥 18K / month · 📦 14 · ⏱️ 20.11.2021):
	```
...
- [GitHub](https://github.com/hakancelik96/unimport) (👨‍💻 13 · 🔀 13 · 📦 17 · 📋 76 - 13% open · ⏱️ 28.12.2021):
...
- [GitHub](https://github.com/ambv/retype) (👨‍💻 8 · 🔀 17 · 📋 15 - 46% open · ⏱️ 29.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/retype) (📥 1K / month · 📦 34 · ⏱️ 29.12.2021):
	```
	pip install retype
	```
- [Conda](https://anaconda.org/conda-forge/retype) (📥 15K · ⏱️ 29.12.2021):
	```
	conda install -c conda-forge retype
	```
</details>
<details><summary><b><a href="https://github.com/elmotec/massedit">massedit</a></b> (🥉17 ·  ⭐ 95 · 💤) - Programmatically edit text files with Python. Useful for source to.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/ilevkivskyi/com2ann) (👨‍💻 4 · 🔀 7 · 📦 7 · 📋 20 - 25% open · ⏱️ 21.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/com2ann) (📥 3K / month · ⏱️ 21.08.2021):
	```
	pip install com2ann
	```
</details>
...
- <b><a href="https://github.com/myint/unify">unify</a></b> (🥉20 ·  ⭐ 64 · 💀) - Modifies strings to all use the same quote where possible. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/PyCQA/bandit) (👨‍💻 140 · 🔀 380 · 📥 130 · 📦 10K · 📋 560 - 33% open · ⏱️ 13.11.2021):

	```
	git clone https://github.com/PyCQA/bandit
	```
- [PyPi](https://pypi.org/project/bandit) (📥 1.8M / month · 📦 2.4K · ⏱️ 12.11.2021):
	```
	pip install bandit
	```
...
- [GitHub](https://github.com/pyupio/safety) (👨‍💻 35 · 🔀 99 · 📥 110K · 📦 3.3K · 📋 120 - 36% open · ⏱️ 28.04.2021):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.6K · 📋 4.5K - 1% open · ⏱️ 27.12.2021):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 7.7K / month · 📦 8 · ⏱️ 02.12.2021):
	```
	pip install sqlmap
	```
</details>
...
- [GitHub](https://github.com/Yelp/detect-secrets) (👨‍💻 53 · 🔀 240 · 📋 240 - 35% open · ⏱️ 15.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/detect-secrets) (📥 240K / month · 📦 34 · ⏱️ 14.04.2021):
	```
...
<details><summary><b><a href="https://github.com/dlint-py/dlint">dlint</a></b> (🥉21 ·  ⭐ 79) - Dlint is a tool for encouraging best coding practices and helping ensure.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/dlint-py/dlint) (👨‍💻 8 · 🔀 6 · 📋 33 - 57% open · ⏱️ 27.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/dlint) (📥 85K / month · 📦 18 · ⏱️ 27.10.2021):
	```
	pip install dlint
	```
</details>
...
- <b><a href="https://github.com/dashingsoft/pyarmor">pyarmor</a></b> (🥈27 ·  ⭐ 1.3K) - A tool used to obfuscate python scripts, bind obfuscated scripts.. <code><a href="https://tldrlegal.com/search?q=SGI-B-2.0">❗️SGI-B-2.0</a></code>
...
<details><summary><b><a href="https://github.com/pypa/pipenv">pipenv</a></b> (🥇34 ·  ⭐ 23K) - Python Development Workflow for Humans. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pypa/pipenv) (👨‍💻 400 · 🔀 1.7K · 📦 24K · 📋 3.6K - 16% open · ⏱️ 29.12.2021):

	```
	git clone https://github.com/pypa/pipenv
	```
- [PyPi](https://pypi.org/project/pipenv) (📥 3.8M / month · 📦 2.3K · ⏱️ 23.11.2021):
	```
	pip install pipenv
	```
- [Conda](https://anaconda.org/conda-forge/pipenv) (📥 46K · ⏱️ 24.11.2021):
	```
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 220 · 🔀 920 · 📋 1.2K - 5% open · ⏱️ 29.12.2021):

	```
	git clone https://github.com/pypa/virtualenv
	```
- [PyPi](https://pypi.org/project/virtualenv) (📥 22M / month · 📦 34K · ⏱️ 29.12.2021):
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 350 · 🔀 2.3K · 📋 1.4K - 2% open · ⏱️ 23.12.2021):
...
<details><summary><b><a href="https://github.com/pyenv/pyenv-virtualenv">pyenv-virtualenv</a></b> (🥉18 ·  ⭐ 4.7K) - a pyenv plugin to manage virtualenv (a.k.a. python-virtualenv). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/pyenv/pyenv-installer">pyenv-installer</a></b> (🥉15 ·  ⭐ 3K) - This tool is used to install `pyenv` and friends. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/pypa/pip) (👨‍💻 650 · 🔀 2.4K · 📦 68K · 📋 6.1K - 15% open · ⏱️ 21.12.2021):

	```
	git clone https://github.com/pypa/pip
	```
- [PyPi](https://pypi.org/project/pip) (📥 77M / month · 📦 19K · ⏱️ 22.10.2021):
	```
	pip install pip
	```
...
<details><summary><b><a href="https://github.com/python-poetry/poetry">poetry</a></b> (🥈33 ·  ⭐ 18K) - Python dependency management and packaging made easy. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 320 · 🔀 1.4K · 📥 10M · 📋 3.6K - 35% open · ⏱️ 26.12.2021):

	```
	git clone https://github.com/python-poetry/poetry
	```
- [PyPi](https://pypi.org/project/poetry) (📥 4.2M / month · 📦 64 · ⏱️ 28.11.2021):
	```
	pip install poetry
	```
...
<details><summary><b><a href="https://github.com/jazzband/pip-tools">pip-tools</a></b> (🥈33 ·  ⭐ 5.4K) - A set of tools to keep your pinned Python dependencies fresh. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/conda/conda">conda</a></b> (🥈33 ·  ⭐ 4.5K · 📉) - OS-agnostic, system-level binary package manager and ecosystem. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/conda/conda) (👨‍💻 380 · 🔀 1.1K · 📋 8.3K - 22% open · ⏱️ 06.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/conda) (📥 69K / month · 📦 2.1K · ⏱️ 22.04.2017):
	```
	pip install conda
	```
...
- [GitHub](https://github.com/bndr/pipreqs) (👨‍💻 51 · 🔀 260 · 📦 8.2K · 📋 190 - 52% open · ⏱️ 23.10.2021):

	```
	git clone https://github.com/bndr/pipreqs
	```
- [PyPi](https://pypi.org/project/pipreqs) (📥 250K / month · 📦 530 · ⏱️ 23.10.2021):
	```
	pip install pipreqs
	```
...
<details><summary><b><a href="https://github.com/pypa/pipx">pipx</a></b> (🥉23 ·  ⭐ 4.4K) - Install and Run Python Applications in Isolated Environments. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pypa/pipx) (👨‍💻 64 · 🔀 210 · 📋 460 - 24% open · ⏱️ 28.12.2021):

	```
	git clone https://github.com/pypa/pipx
	```
- [PyPi](https://pypi.org/project/pipx) (📥 72K / month · 📦 4 · ⏱️ 28.12.2021):
	```
	pip install pipx
	```
</details>
<details><summary><b><a href="https://github.com/mamba-org/mamba">mamba</a></b> (🥉23 ·  ⭐ 2.6K) - The Fast Cross-Platform Package Manager. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/mamba-org/mamba) (👨‍💻 66 · 🔀 130 · 📋 680 - 29% open · ⏱️ 13.12.2021):
...
- [GitHub](https://github.com/dephell/dephell) (👨‍💻 37 · 🔀 100 · 📥 170 · 📦 330 · 📋 270 - 40% open · ⏱️ 11.01.2021):
...
<details><summary><b><a href="https://github.com/David-OConnor/pyflow">pyflow</a></b> (🥉19 ·  ⭐ 960) - An installation and dependency system for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/David-OConnor/pyflow) (👨‍💻 28 · 🔀 37 · 📥 3.7K · 📋 110 - 38% open · ⏱️ 04.12.2021):
...
- [GitHub](https://github.com/jaraco/pip-run) (👨‍💻 11 · 🔀 10 · 📋 42 - 7% open · ⏱️ 20.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pip-run) (📥 5.7K / month · ⏱️ 20.11.2021):
	```
	pip install pip-run
	```
</details>
...
- [GitHub](https://github.com/rubik/radon) (👨‍💻 49 · 🔀 97 · 📦 2.2K · 📋 160 - 12% open · ⏱️ 08.08.2021):

	```
	git clone https://github.com/rubik/radon
	```
- [PyPi](https://pypi.org/project/radon) (📥 260K / month · 📦 1.1K · ⏱️ 15.12.2021):
	```
	pip install radon
	```
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 78 · 🔀 140 · 📋 290 - 18% open · ⏱️ 28.12.2021):

	```
	git clone https://github.com/PyCQA/prospector
	```
- [PyPi](https://pypi.org/project/prospector) (📥 370K / month · 📦 1.1K · ⏱️ 08.12.2021):
	```
...
- [GitHub](https://github.com/rubik/xenon) (👨‍💻 8 · 🔀 16 · 📦 280 · 📋 32 - 21% open · ⏱️ 03.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/xenon) (📥 58K / month · 📦 120 · ⏱️ 03.09.2021):
	```
	pip install xenon
	```
...
<details><summary><b><a href="https://github.com/tqdm/tqdm">tqdm</a></b> (🥇37 ·  ⭐ 21K) - A Fast, Extensible Progress Bar for Python and CLI. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1.1K · 📥 8.1K · 📦 240K · 📋 870 - 37% open · ⏱️ 20.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/tqdm) (📥 28M / month · 📦 26K · ⏱️ 15.12.2021):
	```
	pip install tqdm
	```
- [Conda](https://anaconda.org/conda-forge/tqdm) (📥 9.2M · ⏱️ 20.09.2021):
	```
...
<details><summary><b><a href="https://github.com/getsentry/sentry-python">sentry-sdk</a></b> (🥇34 ·  ⭐ 1.1K) - The new Python SDK for Sentry.io. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 110 · 🔀 260 · 📥 4.5K · 📦 17K · 📋 610 - 30% open · ⏱️ 23.12.2021):

	```
	git clone https://github.com/getsentry/sentry-python
	```
- [PyPi](https://pypi.org/project/sentry-sdk) (📥 12M / month · 📦 990 · ⏱️ 13.12.2021):
	```
...
- [GitHub](https://github.com/madzak/python-json-logger) (👨‍💻 46 · 🔀 170 · 📦 19K · 📋 70 - 34% open · ⏱️ 27.07.2021):
...
<details><summary><b><a href="https://github.com/Delgan/loguru">loguru</a></b> (🥈31 ·  ⭐ 11K) - Python logging made (stupidly) simple. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 30 · 🔀 470 · 📦 13K · 📋 500 - 18% open · ⏱️ 09.09.2021):

	```
	git clone https://github.com/Delgan/loguru
	```
- [PyPi](https://pypi.org/project/loguru) (📥 1.9M / month · 📦 340 · ⏱️ 20.09.2020):
	```
	pip install loguru
	```
...
- [GitHub](https://github.com/astanin/python-tabulate) (👨‍💻 67 · 🔀 84 · 📦 59K · 📋 110 - 45% open · ⏱️ 04.03.2021):
...
<details><summary><b><a href="https://github.com/WoLpH/python-progressbar">progressbar2</a></b> (🥈29 ·  ⭐ 740) - Progressbar 2 - A progress bar for Python 2 and Python 3 - pip.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/WoLpH/python-progressbar) (👨‍💻 40 · 🔀 100 · 📥 1.6K · 📦 14K · 📋 200 - 4% open · ⏱️ 15.10.2021):

	```
	git clone https://github.com/WoLpH/python-progressbar
	```
- [PyPi](https://pypi.org/project/progressbar2) (📥 3.1M / month · 📦 2.2K · ⏱️ 15.10.2021):
	```
...
<details><summary><b><a href="https://github.com/hynek/structlog">structlog</a></b> (🥈28 ·  ⭐ 1.9K) - Structured Logging for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/hynek/structlog) (👨‍💻 84 · 🔀 150 · 📋 200 - 12% open · ⏱️ 29.12.2021):

	```
	git clone https://github.com/hynek/structlog
	```
- [PyPi](https://pypi.org/project/structlog) (📥 2.7M / month · 📦 1.2K · ⏱️ 16.12.2021):
	```
	pip install structlog
	```
- [Conda](https://anaconda.org/conda-forge/structlog) (📥 160K · ⏱️ 29.11.2021):
	```
...
- [GitHub](https://github.com/ines/wasabi) (👨‍💻 7 · 🔀 20 · 📦 15K · 📋 6 - 50% open · ⏱️ 06.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/wasabi) (📥 5.4M / month · 📦 410 · ⏱️ 06.12.2021):
	```
	pip install wasabi
	```
- [Conda](https://anaconda.org/conda-forge/wasabi) (📥 550K · ⏱️ 07.12.2021):
	```
...
- [GitHub](https://github.com/xolox/python-coloredlogs) (👨‍💻 16 · 🔀 37 · 📦 9.9K · 📋 74 - 33% open · ⏱️ 11.06.2021):
...
- [GitHub](https://github.com/shobrook/rebound) (👨‍💻 16 · 🔀 360 · 📥 180 · 📦 22 · 📋 58 - 34% open · ⏱️ 04.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/rebound) (📥 1.5K / month · 📦 14 · ⏱️ 15.12.2021):
	```
	pip install rebound
	```
...
- [GitHub](https://github.com/cknd/stackprinter) (👨‍💻 6 · 🔀 33 · 📦 84 · 📋 26 - 42% open · ⏱️ 01.01.2021):

	```
	git clone https://github.com/cknd/stackprinter
	```
- [PyPi](https://pypi.org/project/stackprinter) (📥 300K / month · 📦 4 · ⏱️ 31.10.2020):
	```
	pip install stackprinter
	```
</details>
<details><summary><b><a href="https://github.com/rsalmei/alive-progress">alive-progress</a></b> (🥉22 ·  ⭐ 3K) - A new kind of Progress Bar, with real-time throughput, ETA, and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 1 · 🔀 130 · 📦 520 · 📋 92 - 27% open · ⏱️ 06.11.2021):

	```
	git clone https://github.com/rsalmei/alive-progress
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 21K / month · ⏱️ 19.10.2021):
	```
...
- [GitHub](https://github.com/onelivesleft/PrettyErrors) (👨‍💻 5 · 🔀 71 · 📋 37 - 2% open · ⏱️ 24.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pretty_errors) (📥 22K / month · ⏱️ 24.11.2021):
	```
...
- [GitHub](https://github.com/samuelcolvin/python-devtools) (👨‍💻 7 · 🔀 16 · 📦 520 · 📋 36 - 5% open · ⏱️ 08.09.2021):

	```
	git clone https://github.com/samuelcolvin/python-devtools
	```
- [PyPi](https://pypi.org/project/python-devtools) (📥 540 / month · 📦 1 · ⏱️ 21.08.2017):
	```
...
- <b><a href="https://github.com/jazzband/prettytable">prettytable</a></b> (🥉23 ·  ⭐ 630) - Display tabular data in a visually appealing ASCII table.. <code><a href="https://tldrlegal.com/search?q=BSD-1-Clause">❗️BSD-1-Clause</a></code>
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (👨‍💻 700 · 🔀 1.6K · 📦 170K · 📋 5.8K - 16% open · ⏱️ 28.12.2021):

	```
	git clone https://github.com/sphinx-doc/sphinx
	```
- [PyPi](https://pypi.org/project/sphinx) (📥 4.1M / month · 📦 100K · ⏱️ 19.12.2021):
	```
	pip install sphinx
	```
- [Conda](https://anaconda.org/conda-forge/sphinx) (📥 4.5M · ⏱️ 19.12.2021):
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs) (👨‍💻 210 · 🔀 1.8K · 📦 17K · 📋 1.6K - 6% open · ⏱️ 13.12.2021):

	```
	git clone https://github.com/mkdocs/mkdocs
	```
- [PyPi](https://pypi.org/project/mkdocs) (📥 690K / month · 📦 5.9K · ⏱️ 15.12.2021):
	```
	pip install mkdocs
	```
...
<details><summary><b><a href="https://github.com/squidfunk/mkdocs-material">mkdocs-material</a></b> (🥇34 ·  ⭐ 8.4K) - Technical documentation that just works. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 140 · 🔀 1.9K · 📦 10K · 📋 1.2K - 1% open · ⏱️ 30.12.2021):

	```
	git clone https://github.com/squidfunk/mkdocs-material
	```
- [PyPi](https://pypi.org/project/mkdocs-material) (📥 690K / month · 📦 1.5K · ⏱️ 19.12.2021):
	```
	pip install mkdocs-material
	```
- [Conda](https://anaconda.org/conda-forge/mkdocs-material) (📥 77K · ⏱️ 20.12.2021):
	```
...
- [GitHub](https://github.com/bitprophet/alabaster) (👨‍💻 28 · 🔀 180 · 📦 56K · 📋 140 - 60% open · ⏱️ 24.09.2021):
...
- [GitHub](https://github.com/numpy/numpydoc) (👨‍💻 69 · 🔀 6.3K · 📦 29K · 📋 160 - 36% open · ⏱️ 27.12.2021):
...
- [GitHub](https://github.com/michaeljones/breathe) (👨‍💻 99 · 🔀 150 · 📥 170 · 📦 5.6K · 📋 480 - 25% open · ⏱️ 28.12.2021):
...
- [GitHub](https://github.com/ryan-roemer/sphinx-bootstrap-theme) (👨‍💻 38 · 🔀 210 · 📋 140 - 40% open · ⏱️ 02.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/sphinx-bootstrap-theme) (📥 220K / month · 📦 980 · ⏱️ 12.09.2021):
	```
	pip install sphinx-bootstrap-theme
	```
</details>
<details><summary><b><a href="https://github.com/pdoc3/pdoc">pdoc3</a></b> (🥈26 ·  ⭐ 760) - Auto-generate API documentation for Python projects. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/econchick/interrogate) (👨‍💻 12 · 🔀 26 · 📦 1.2K · 📋 31 - 25% open · ⏱️ 27.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/interrogate) (📥 83K / month · ⏱️ 10.09.2021):
	```
	pip install interrogate
	```
</details>
<details><summary><b><a href="https://github.com/mitmproxy/pdoc">pdoc</a></b> (🥉25 ·  ⭐ 1.1K) - API Documentation for Python Projects. <code><a href="http://bit.ly/3rvuUlR">Unlicense</a></code></summary>

- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 32 · 🔀 120 · 📦 480 · 📋 200 - 3% open · ⏱️ 29.12.2021):

	```
	git clone https://github.com/mitmproxy/pdoc
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 94K / month · 📦 290 · ⏱️ 28.12.2021):
	```
	pip install pdoc
	```
</details>
...
- [GitHub](https://github.com/zhaoterryy/mkdocs-pdf-export-plugin) (👨‍💻 11 · 🔀 34 · 📦 190 · 📋 85 - 48% open · ⏱️ 05.10.2021):
...
- [GitHub](https://github.com/mkdocstrings/mkdocstrings) (👨‍💻 26 · 🔀 58 · 📋 210 - 23% open · ⏱️ 28.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/mkdocstrings) (📥 95K / month · ⏱️ 27.12.2021):
	```
...
<details><summary><b><a href="https://github.com/orzih/mkdocs-with-pdf">mkdocs-with-pdf</a></b> (🥉22 ·  ⭐ 120) - Generate a single PDF file from MkDocs repository. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/orzih/mkdocs-with-pdf) (👨‍💻 6 · 🔀 21 · 📦 86 · 📋 66 - 43% open · ⏱️ 14.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/mkdocs-with-pdf) (📥 9.2K / month · ⏱️ 03.07.2021):
	```
...
- [GitHub](https://github.com/asottile/blacken-docs) (👨‍💻 13 · 🔀 20 · 📋 38 - 7% open · ⏱️ 27.12.2021):

	```
	git clone https://github.com/asottile/blacken-docs
	```
- [PyPi](https://pypi.org/project/blacken-docs) (📥 13K / month · 📦 22 · ⏱️ 19.11.2021):
	```
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-pages-plugin) (👨‍💻 3 · 🔀 20 · 📋 46 - 15% open · ⏱️ 27.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/mkdocs-awesome-pages-plugin) (📥 39K / month · 📦 90 · ⏱️ 22.11.2021):
	```
	pip install mkdocs-awesome-pages-plugin
	```
</details>
<details><summary><b><a href="https://github.com/ml-tooling/lazydocs">lazydocs</a></b> (🥉18 ·  ⭐ 56) - Generate markdown API documentation from Google-style Python docstring... <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ml-tooling/lazydocs) (👨‍💻 7 · 🔀 14 · 📦 57 · 📋 10 - 60% open · ⏱️ 20.08.2021):

	```
	git clone https://github.com/ml-tooling/lazydocs
	```
- [PyPi](https://pypi.org/project/lazydocs) (📥 1.7K / month · ⏱️ 27.07.2021):
	```
...
- [GitHub](https://github.com/timothycrosley/portray) (👨‍💻 16 · 🔀 58 · 📋 50 - 42% open · ⏱️ 13.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/portray) (📥 4.3K / month · 📦 8 · ⏱️ 13.06.2021):
	```
	pip install portray
	```
</details>
...
<details><summary><b><a href="https://github.com/cool-RR/PySnooper">PySnooper</a></b> (🥇28 ·  ⭐ 15K) - Never use print for debugging again. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/cool-RR/PySnooper) (👨‍💻 26 · 🔀 920 · 📦 530 · 📋 110 - 15% open · ⏱️ 11.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/pysnooper) (📥 120K / month · 📦 46 · ⏱️ 11.09.2021):
	```
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 81 · 🔀 190 · 📦 2.8K · 📋 290 - 48% open · ⏱️ 29.12.2021):
...
<details><summary><b><a href="https://github.com/cs01/gdbgui">gdbgui</a></b> (🥉26 ·  ⭐ 8.4K) - Browser-based frontend to gdb (gnu debugger). Add breakpoints, view.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/cs01/gdbgui) (👨‍💻 38 · 🔀 480 · 📥 6.4K · 📦 130 · 📋 280 - 41% open · ⏱️ 06.09.2021):

	```
	git clone https://github.com/cs01/gdbgui
	```
- [PyPi](https://pypi.org/project/gdbgui) (📥 150K / month · 📦 2 · ⏱️ 06.09.2021):
	```
	pip install gdbgui
	```
</details>
...
- [GitHub](https://github.com/agronholm/typeguard) (👨‍💻 19 · 🔀 69 · 📋 180 - 16% open · ⏱️ 10.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/typeguard) (📥 8.8M / month · 📦 160 · ⏱️ 10.12.2021):
	```
	pip install typeguard
	```
- [Conda](https://anaconda.org/conda-forge/typeguard) (📥 67K · ⏱️ 11.10.2021):
	```
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 36 · 📦 76 · 📋 87 - 42% open · ⏱️ 15.12.2021):

	```
	git clone https://github.com/ionelmc/python-hunter
	```
- [PyPi](https://pypi.org/project/hunter) (📥 10K / month · 📦 34 · ⏱️ 15.12.2021):
	```
	pip install hunter
	```
</details>
...
- [GitHub](https://github.com/alexmojaki/snoop) (👨‍💻 21 · 🔀 24 · 📋 37 - 48% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/snoop) (📥 18K / month · 📦 8 · ⏱️ 11.11.2021):
	```
	pip install snoop
	```
</details>
...
- [GitHub](https://github.com/ionelmc/python-manhole) (👨‍💻 11 · 🔀 17 · 📦 82 · 📋 20 - 25% open · ⏱️ 15.09.2021):

	```
	git clone https://github.com/ionelmc/python-manhole
	```
- [PyPi](https://pypi.org/project/manhole) (📥 24K / month · 📦 66 · ⏱️ 08.04.2021):
	```
	pip install manhole
	```
</details>
...
<details><summary><b><a href="https://github.com/tox-dev/tox">tox</a></b> (🥇36 ·  ⭐ 2.5K · 📈) - Command line driven CI frontend and development task automation tool. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tox-dev/tox) (👨‍💻 250 · 🔀 390 · 📦 52K · 📋 1.3K - 10% open · ⏱️ 29.12.2021):

	```
	git clone https://github.com/tox-dev/tox
	```
- [PyPi](https://pypi.org/project/tox) (📥 3.5M / month · 📦 36K · ⏱️ 29.12.2021):
	```
	pip install tox
	```
- [Conda](https://anaconda.org/conda-forge/tox) (📥 390K · ⏱️ 29.12.2021):
	```
	conda install -c conda-forge tox
	```
</details>
<details><summary><b><a href="https://github.com/pytest-dev/pytest">pytest</a></b> (🥇35 ·  ⭐ 8.1K) - The pytest framework makes it easy to write small tests, yet scales.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pytest-dev/pytest) (👨‍💻 760 · 🔀 1.9K · 📦 420K · 📋 4.8K - 15% open · ⏱️ 30.12.2021):

	```
	git clone https://github.com/pytest-dev/pytest
	```
- [PyPi](https://pypi.org/project/pytest) (📥 31M / month · 📦 130K · ⏱️ 07.12.2021):
	```
	pip install pytest
	```
...
<details><summary><b><a href="https://github.com/robotframework/robotframework">robotframework</a></b> (🥇35 ·  ⭐ 6.6K) - Generic automation framework for acceptance testing and RPA. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 150 · 🔀 1.8K · 📥 510 · 📦 4.7K · 📋 3.7K - 5% open · ⏱️ 24.12.2021):

	```
	git clone https://github.com/robotframework/robotframework
	```
- [PyPi](https://pypi.org/project/robotframework) (📥 820K / month · 📦 1.4K · ⏱️ 15.12.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-cov) (👨‍💻 74 · 🔀 160 · 📦 110K · 📋 310 - 34% open · ⏱️ 21.12.2021):
...
- [PyPi](https://pypi.org/project/pytest-cov) (📥 10M / month · 📦 43K · ⏱️ 04.10.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-cov) (📥 4.3M · ⏱️ 04.10.2021):
	```
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 260 · 🔀 480 · 📦 11K · 📋 1.2K - 4% open · ⏱️ 30.12.2021):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 2.1M / month · 📦 2.6K · ⏱️ 30.12.2021):
	```
	pip install hypothesis
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 5.1M · ⏱️ 30.12.2021):
	```
	conda install -c conda-forge hypothesis
	```
</details>
<details><summary><b><a href="https://github.com/asweigart/pyautogui">pyautogui</a></b> (🥈31 ·  ⭐ 6K) - A cross-platform GUI automation Python module for human beings. Used.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 790 · 📦 12K · 📋 540 - 63% open · ⏱️ 14.09.2021):
...
- [GitHub](https://github.com/pytest-dev/pytest-xdist) (👨‍💻 77 · 🔀 160 · 📋 460 - 44% open · ⏱️ 27.12.2021):

	```
	git clone https://github.com/pytest-dev/pytest-xdist
	```
- [PyPi](https://pypi.org/project/pytest-xdist) (📥 4.4M / month · 📦 7.3K · ⏱️ 10.12.2021):
	```
...
- [GitHub](https://github.com/TheKevJames/coveralls-python) (👨‍💻 63 · 🔀 180 · 📦 20K · 📋 150 - 3% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/coveralls) (📥 460K / month · 📦 17K · ⏱️ 11.11.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-asyncio) (👨‍💻 27 · 🔀 91 · 📦 19K · 📋 180 - 44% open · ⏱️ 29.12.2021):
...
- [PyPi](https://pypi.org/project/pytest-asyncio) (📥 2M / month · 📦 2K · ⏱️ 15.10.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-asyncio) (📥 740K · ⏱️ 18.10.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-mock) (👨‍💻 54 · 🔀 100 · 📦 22K · 📋 110 - 12% open · ⏱️ 27.12.2021):

	```
	git clone https://github.com/pytest-dev/pytest-mock
	```
- [PyPi](https://pypi.org/project/pytest-mock) (📥 4.7M / month · 📦 6.2K · ⏱️ 06.05.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-html) (👨‍💻 43 · 🔀 180 · 📦 14K · 📋 270 - 34% open · ⏱️ 23.01.2021):
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 280 · 📥 190 · 📋 300 - 0% open · ⏱️ 22.12.2021):

	```
	git clone https://github.com/lk-geimfari/mimesis
	```
- [PyPi](https://pypi.org/project/mimesis) (📥 89K / month · 📦 84 · ⏱️ 11.12.2021):
	```
	pip install mimesis
	```
</details>
...
- [GitHub](https://github.com/datadriventests/ddt) (👨‍💻 36 · 🔀 100 · 📦 3.9K · 📋 53 - 28% open · ⏱️ 04.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/ddt) (📥 260K / month · 📦 2.5K · ⏱️ 04.10.2021):
	```
	pip install ddt
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-bdd) (👨‍💻 45 · 🔀 160 · 📋 270 - 49% open · ⏱️ 27.12.2021):

	```
	git clone https://github.com/pytest-dev/pytest-bdd
	```
- [PyPi](https://pypi.org/project/pytest-bdd) (📥 220K / month · 📦 270 · ⏱️ 25.10.2021):
	```
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 71 · 🔀 130 · 📦 4.4K · 📋 260 - 21% open · ⏱️ 13.12.2021):
...
<details><summary><b><a href="https://github.com/microsoft/playwright-python">playwright-python</a></b> (🥉26 ·  ⭐ 5.6K) - Python version of the Playwright testing and automation.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/microsoft/playwright-python) (👨‍💻 21 · 🔀 500 · 📦 640 · 📋 540 - 5% open · ⏱️ 10.12.2021):

	```
	git clone https://github.com/microsoft/playwright-python
	```
- [PyPi](https://pypi.org/project/playwright) (📥 180K / month · ⏱️ 02.12.2021):
	```
...
- [GitHub](https://github.com/ionelmc/pytest-benchmark) (👨‍💻 34 · 🔀 92 · 📦 2.4K · 📋 160 - 50% open · ⏱️ 14.06.2021):
...
- [GitHub](https://github.com/hamcrest/PyHamcrest) (👨‍💻 37 · 🔀 91 · 📋 69 - 27% open · ⏱️ 27.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyhamcrest) (📥 840K / month · 📦 3.4K · ⏱️ 12.12.2021):
	```
...
- [GitHub](https://github.com/dbader/pytest-mypy) (👨‍💻 15 · 🔀 33 · 📦 1.4K · 📋 47 - 19% open · ⏱️ 16.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-mypy) (📥 520K / month · 📦 270 · ⏱️ 21.03.2021):
	```
...
- [GitHub](https://github.com/CleanCut/green) (👨‍💻 37 · 🔀 75 · 📦 630 · 📋 170 - 3% open · ⏱️ 16.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/green) (📥 13K / month · 📦 360 · ⏱️ 16.07.2021):
	```
	pip install green
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-testinfra) (👨‍💻 110 · 🔀 290 · 📋 320 - 36% open · ⏱️ 07.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-testinfra) (📥 130K / month · ⏱️ 07.12.2021):
	```
...
- [PyPi](https://pypi.org/project/nox) (📥 600K / month · 📦 56 · ⏱️ 01.10.2021):
	...
	pip install nox
	```
- [Conda](https://anaconda.org/conda-forge/nox) (📥 44K · ⏱️ 03.12.2021):
	```
...
- [GitHub](https://github.com/tarpas/pytest-testmon) (👨‍💻 16 · 🔀 29 · 📋 120 - 24% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-testmon) (📥 97K / month · 📦 98 · ⏱️ 22.10.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-randomly) (👨‍💻 16 · 🔀 22 · 📋 48 - 12% open · ⏱️ 30.12.2021):

	```
	git clone https://github.com/pytest-dev/pytest-randomly
	```
- [PyPi](https://pypi.org/project/pytest-randomly) (📥 360K / month · 📦 210 · ⏱️ 30.11.2021):
	```
...
- [GitHub](https://github.com/Erotemic/xdoctest) (👨‍💻 7 · 🔀 7 · 📦 1.9K · 📋 37 - 45% open · ⏱️ 20.12.2021):

	```
	git clone https://github.com/Erotemic/xdoctest
	```
- [PyPi](https://pypi.org/project/xdoctest) (📥 120K / month · 📦 52 · ⏱️ 06.10.2021):
	```
	pip install xdoctest
	```
</details>
<details><summary><b><a href="https://github.com/avast/pytest-docker">pytest-docker</a></b> (🥉20 ·  ⭐ 260) - Docker-based integration tests. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/avast/pytest-docker) (👨‍💻 11 · 🔀 40 · 📥 82 · 📋 33 - 51% open · ⏱️ 14.06.2021):

	```
	git clone https://github.com/avast/pytest-docker
	```
- [PyPi](https://pypi.org/project/pytest-docker) (📥 57K / month · 📦 28 · ⏱️ 14.06.2021):
	```
...
- [GitHub](https://github.com/pypa/packaging) (👨‍💻 72 · 🔀 180 · 📥 210 · 📦 290K · 📋 230 - 28% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/pypa/packaging
	```
- [PyPi](https://pypi.org/project/packaging) (📥 85M / month · 📦 29K · ⏱️ 18.11.2021):
	```
...
<details><summary><b><a href="https://github.com/Nuitka/Nuitka">Nuitka</a></b> (🥇28 ·  ⭐ 6.2K) - Nuitka is a Python compiler written in Python. It's fully compatible.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Nuitka/Nuitka) (👨‍💻 110 · 🔀 350 · 📋 1.1K - 16% open · ⏱️ 30.12.2021):

	```
	git clone https://github.com/Nuitka/Nuitka
	```
- [PyPi](https://pypi.org/project/nuitka) (📥 24K / month · 📦 54 · ⏱️ 30.12.2021):
	```
	pip install nuitka
	```
- [Conda](https://anaconda.org/conda-forge/nuitka) (📥 330K · ⏱️ 09.12.2021):
	```
	conda install -c conda-forge nuitka
	```
</details>
<details><summary><b><a href="https://github.com/pyinstaller/pyinstaller">pyinstaller</a></b> (🥈27 ·  ⭐ 8.7K) - Freeze (package) Python programs into stand-alone executables. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 420 · 🔀 1.7K · 📥 720K · 📋 4.4K - 7% open · ⏱️ 30.12.2021):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 610K / month · ⏱️ 10.11.2021):
	```
...
- [GitHub](https://github.com/pantsbuild/pex) (👨‍💻 100 · 🔀 210 · 📥 540K · 📋 780 - 18% open · ⏱️ 23.12.2021):

	```
	git clone https://github.com/pantsbuild/pex
	```
- [PyPi](https://pypi.org/project/pex) (📥 160K / month · 📦 230 · ⏱️ 23.12.2021):
	```
	pip install pex
	```
</details>
...
- [GitHub](https://github.com/ronaldoussoren/py2app) (👨‍💻 26 · 🔀 17 · 📦 3.9K · 📋 380 - 28% open · ⏱️ 05.10.2021):
...
- [GitHub](https://github.com/py2exe/py2exe) (👨‍💻 14 · 🔀 44 · 📥 7.1K · 📦 1.4K · 📋 94 - 4% open · ⏱️ 16.11.2021):

	```
	git clone https://github.com/py2exe/py2exe
	```
- [PyPi](https://pypi.org/project/py2exe) (📥 22K / month · 📦 350 · ⏱️ 15.12.2021):
	```
	pip install py2exe
	```
</details>
...
- [GitHub](https://github.com/beeware/briefcase) (👨‍💻 87 · 🔀 220 · 📋 370 - 30% open · ⏱️ 17.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/briefcase) (📥 3.6K / month · 📦 24 · ⏱️ 06.03.2021):
	```
	pip install briefcase
	```
</details>
<details><summary><b><a href="https://github.com/marcelotduarte/cx_Freeze">cx_Freeze</a></b> (🥉22 ·  ⭐ 840) - Create standalone executables from Python scripts, with the same.. <code><a href="http://bit.ly/35wkF7y">Python-2.0</a></code></summary>

- [GitHub](https://github.com/marcelotduarte/cx_Freeze) (👨‍💻 93 · 🔀 170 · 📋 720 - 8% open · ⏱️ 26.12.2021):
...
- [PyPi](https://pypi.org/project/cx_freeze) (📥 48K / month · 📦 150 · ⏱️ 16.12.2017):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cx_freeze) (📥 110K · ⏱️ 08.12.2021):
	```
...
- [GitHub](https://github.com/takluyver/pynsist) (👨‍💻 29 · 🔀 100 · 📋 160 - 15% open · ⏱️ 01.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pynsist) (📥 1.5K / month · 📦 88 · ⏱️ 28.03.2021):
	```
	pip install pynsist
	```
</details>
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 34 · 🔀 75 · 📥 160 · 📋 100 - 32% open · ⏱️ 18.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/shiv) (📥 6.1K / month · 📦 10 · ⏱️ 18.11.2021):
	```
	pip install shiv
	```
</details>
...
- [GitHub](https://github.com/conda/constructor) (👨‍💻 48 · 🔀 130 · 📥 220 · 📦 12 · 📋 250 - 22% open · ⏱️ 29.12.2021):

	```
	git clone https://github.com/conda/constructor
	```
- [Conda](https://anaconda.org/anaconda/constructor) (📥 5K · ⏱️ 01.04.2021):
	```
...
- [GitHub](https://github.com/indygreg/PyOxidizer) (👨‍💻 37 · 🔀 130 · 📥 1.4K · 📋 420 - 60% open · ⏱️ 21.12.2021):
...
- [GitHub](https://github.com/pypa/setuptools) (👨‍💻 470 · 🔀 800 · 📥 110 · 📦 130K · 📋 1.9K - 28% open · ⏱️ 29.12.2021):

	```
	git clone https://github.com/pypa/setuptools
	```
- [PyPi](https://pypi.org/project/setuptools) (📥 210M / month · 📦 58K · ⏱️ 29.12.2021):
	```
	pip install setuptools
	```
- [Conda](https://anaconda.org/conda-forge/setuptools) (📥 31M · ⏱️ 29.12.2021):
	```
...
- [GitHub](https://github.com/pyinvoke/invoke) (👨‍💻 56 · 🔀 300 · 📦 9.8K · 📋 700 - 48% open · ⏱️ 16.10.2021):

	```
	git clone https://github.com/pyinvoke/invoke
	```
- [PyPi](https://pypi.org/project/invoke) (📥 2M / month · 📦 4.6K · ⏱️ 15.12.2021):
	```
	pip install invoke
	```
...
- [GitHub](https://github.com/buildbot/buildbot) (👨‍💻 800 · 🔀 1.6K · 📥 19K · 📦 260 · 📋 1.4K - 45% open · ⏱️ 20.12.2021):
...
- [GitHub](https://github.com/pypa/twine) (👨‍💻 100 · 🔀 250 · 📦 52K · 📋 390 - 8% open · ⏱️ 07.12.2021):

	```
	git clone https://github.com/pypa/twine
	```
- [PyPi](https://pypi.org/project/twine) (📥 2.4M / month · 📦 18K · ⏱️ 07.12.2021):
	```
	pip install twine
	```
...
- [GitHub](https://github.com/pypa/wheel) (👨‍💻 63 · 🔀 100 · 📋 330 - 8% open · ⏱️ 29.12.2021):

	```
	git clone https://github.com/pypa/wheel
	```
- [PyPi](https://pypi.org/project/wheel) (📥 94M / month · 📦 63K · ⏱️ 22.12.2021):
	```
	pip install wheel
	```
- [Conda](https://anaconda.org/conda-forge/wheel) (📥 24M · ⏱️ 22.12.2021):
	```
	conda install -c conda-forge wheel
	```
</details>
<details><summary><b><a href="https://github.com/pydoit/doit">doit</a></b> (🥈29 ·  ⭐ 1.3K) - task management & automation tool. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/pydoit/doit) (👨‍💻 62 · 🔀 140 · 📦 840 · 📋 260 - 23% open · ⏱️ 21.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/doit) (📥 190K / month · 📦 470 · ⏱️ 11.12.2021):
	```
	pip install doit
	```
- [Conda](https://anaconda.org/conda-forge/doit) (📥 71K · ⏱️ 12.12.2021):
	```
...
- [GitHub](https://github.com/SCons/scons) (👨‍💻 140 · 🔀 250 · 📥 380 · 📋 3.3K - 19% open · ⏱️ 28.12.2021):
...
- [GitHub](https://github.com/pybuilder/pybuilder) (👨‍💻 36 · 🔀 240 · 📋 500 - 17% open · ⏱️ 08.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pybuilder) (📥 16K / month · 📦 110 · ⏱️ 08.11.2021):
	```
...
- [GitHub](https://github.com/pypa/setuptools_scm) (👨‍💻 96 · 🔀 150 · 📋 370 - 21% open · ⏱️ 29.12.2021):
...
- [PyPi](https://pypi.org/project/setuptools_scm) (📥 16M / month · 📦 690 · ⏱️ 09.08.2018):
	...
	```
- [Conda](https://anaconda.org/conda-forge/setuptools_scm) (📥 840K · ⏱️ 11.09.2021):
	```
...
- [GitHub](https://github.com/pypa/flit) (👨‍💻 49 · 🔀 89 · 📋 280 - 29% open · ⏱️ 27.12.2021):

	```
	git clone https://github.com/takluyver/flit
	```
- [PyPi](https://pypi.org/project/flit) (📥 400K / month · 📦 230 · ⏱️ 27.12.2021):
	```
	pip install flit
	```
...
- [GitHub](https://github.com/ml-tooling/universal-build) (👨‍💻 4 · 🔀 5 · 📥 16 · 📦 7 · ⏱️ 17.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/universal-build) (📥 840 / month · ⏱️ 12.12.2020):
	```
...
<details><summary><b><a href="https://github.com/giampaolo/psutil">psutil</a></b> (🥇38 ·  ⭐ 8K · 📈) - Cross-platform lib for process and system monitoring in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 170 · 🔀 1.2K · 📦 130K · 📋 1.5K - 13% open · ⏱️ 29.12.2021):

	```
	git clone https://github.com/giampaolo/psutil
	```
- [PyPi](https://pypi.org/project/psutil) (📥 33M / month · 📦 25K · ⏱️ 29.12.2021):
	```
	pip install psutil
	```
- [Conda](https://anaconda.org/conda-forge/psutil) (📥 9.5M · ⏱️ 02.11.2021):
	```
...
- [GitHub](https://github.com/nicolargo/glances) (👨‍💻 150 · 🔀 1.3K · 📥 710 · 📦 360 · 📋 1.4K - 14% open · ⏱️ 28.12.2021):
...
<details><summary><b><a href="https://github.com/benfred/py-spy">py-spy</a></b> (🥈28 ·  ⭐ 7.8K) - Sampling profiler for Python programs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 29 · 🔀 280 · 📥 7.3K · 📋 240 - 29% open · ⏱️ 22.12.2021):

	```
	git clone https://github.com/benfred/py-spy
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 560K / month · 📦 50 · ⏱️ 13.11.2021):
	```
	pip install py-spy
	```
</details>
<details><summary><b><a href="https://github.com/sumerc/yappi">Yappi</a></b> (🥈28 ·  ⭐ 770) - Yet Another Python Profiler, but this time thread&coroutine&greenlet aware. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sumerc/yappi) (👨‍💻 27 · 🔀 53 · 📦 500 · 📋 55 - 30% open · ⏱️ 08.12.2021):

	```
	git clone https://github.com/sumerc/yappi
	```
- [PyPi](https://pypi.org/project/yappi) (📥 900K / month · 📦 640 · ⏱️ 15.12.2021):
	```
	pip install yappi
	```
...
<details><summary><b><a href="https://github.com/pythonprofilers/memory_profiler">memory-profiler</a></b> (🥈27 ·  ⭐ 3.3K) - Monitor Memory usage of Python code. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/pythonprofilers/memory_profiler) (👨‍💻 91 · 🔀 330 · 📋 220 - 51% open · ⏱️ 18.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 410K / month · 📦 530 · ⏱️ 16.08.2018):
	```
	pip install memory_profiler
	```
</details>
<details><summary><b><a href="https://github.com/python-diamond/Diamond">Diamond</a></b> (🥈27 ·  ⭐ 1.6K) - Diamond is a python daemon that collects system metrics and publishes.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-diamond/Diamond) (👨‍💻 360 · 🔀 590 · 📦 69 · 📋 360 - 63% open · ⏱️ 29.12.2021):

	```
	git clone https://github.com/python-diamond/Diamond
	```
- [PyPi](https://pypi.org/project/diamond) (📥 52K / month · 📦 62 · ⏱️ 25.11.2016):
	```
	pip install diamond
	```
</details>
...
- [GitHub](https://github.com/pympler/pympler) (👨‍💻 29 · 🔀 75 · 📋 90 - 44% open · ⏱️ 29.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pympler) (📥 1M / month · 📦 480 · ⏱️ 22.12.2021):
	```
	pip install pympler
	```
...
<details><summary><b><a href="https://github.com/plasma-umass/scalene">Scalene</a></b> (🥉26 ·  ⭐ 4.9K) - Scalene: a high-performance, high-precision CPU, GPU, and memory.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/plasma-umass/scalene) (👨‍💻 23 · 🔀 170 · 📦 75 · 📋 150 - 24% open · ⏱️ 29.12.2021):

	```
	git clone https://github.com/plasma-umass/scalene
	```
- [PyPi](https://pypi.org/project/scalene) (📥 4K / month · ⏱️ 21.10.2021):
	```
	pip install scalene
	```
</details>
<details><summary><b><a href="https://github.com/joerick/pyinstrument">pyinstrument</a></b> (🥉26 ·  ⭐ 3.9K) - Call stack profiler for Python. Shows you why your code is slow!. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/joerick/pyinstrument) (👨‍💻 38 · 🔀 160 · 📦 460 · 📋 94 - 15% open · ⏱️ 17.12.2021):

	```
	git clone https://github.com/joerick/pyinstrument
	```
- [PyPi](https://pypi.org/project/pyinstrument) (📥 220K / month · 📦 140 · ⏱️ 14.11.2021):
	```
	pip install pyinstrument
	```
- [Conda](https://anaconda.org/conda-forge/pyinstrument) (📥 92K · ⏱️ 15.11.2021):
	```
...
- [GitHub](https://github.com/pyutils/line_profiler) (👨‍💻 27 · 🔀 250 · 📋 50 - 57% open · ⏱️ 29.12.2021):
...
<details><summary><b><a href="https://github.com/aristocratos/bpytop">Bpytop</a></b> (🥉24 ·  ⭐ 8.1K · 📈) - Linux/OSX/FreeBSD resource monitor. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/aristocratos/bpytop) (👨‍💻 35 · 🔀 320 · 📋 280 - 20% open · ⏱️ 22.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/bpytop) (📥 9.6K / month · ⏱️ 22.12.2021):
	```
	pip install bpytop
	```
</details>
...
- [GitHub](https://github.com/nvdv/vprof) (👨‍💻 17 · 🔀 170 · 📦 87 · 📋 82 - 31% open · ⏱️ 20.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/vprof) (📥 3.9K / month · 📦 18 · ⏱️ 29.02.2020):
	```
	pip install vprof
	```
</details>
...
- [GitHub](https://github.com/alexmojaki/heartrate) (👨‍💻 3 · 🔀 120 · 📦 30 · 📋 7 - 57% open · ⏱️ 13.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/heartrate) (📥 480 / month · ⏱️ 13.11.2021):
	```
...
- [GitHub](https://github.com/csurfer/pyheat) (👨‍💻 5 · 🔀 38 · 📦 33 · 📋 13 - 30% open · ⏱️ 18.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/py-heat) (📥 1.8K / month · 📦 10 · ⏱️ 06.12.2018):
	```
	pip install py-heat
	```
</details>
...
- [GitHub](https://github.com/python/typed_ast) (👨‍💻 24 · 🔀 51 · 📋 89 - 6% open · ⏱️ 03.12.2021):

	```
	git clone https://github.com/python/typed_ast
	```
- [PyPi](https://pypi.org/project/typed_ast) (📥 12M / month · 📦 10K · ⏱️ 03.12.2021):
	```
...
- [GitHub](https://github.com/berkerpeksag/astor) (👨‍💻 31 · 🔀 84 · 📋 110 - 31% open · ⏱️ 27.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/astor) (📥 4.8M / month · 📦 3.8K · ⏱️ 10.12.2019):
	```
	pip install astor
	```
...
- [GitHub](https://github.com/serge-sans-paille/gast) (👨‍💻 10 · 🔀 24 · 📦 73K · 📋 26 - 3% open · ⏱️ 13.11.2021):

	```
	git clone https://github.com/serge-sans-paille/gast
	```
- [PyPi](https://pypi.org/project/gast) (📥 12M / month · 📦 3.4K · ⏱️ 13.11.2021):
	```
	pip install gast
	```
...
- [GitHub](https://github.com/newville/asteval) (👨‍💻 19 · 🔀 32 · 📦 700 · 📋 52 - 11% open · ⏱️ 25.09.2021):

	```
	git clone https://github.com/newville/asteval
	```
- [PyPi](https://pypi.org/project/asteval) (📥 130K / month · 📦 240 · ⏱️ 22.06.2021):
	```
	pip install asteval
	```
...
<details><summary><b><a href="https://github.com/pre-commit/pre-commit">pre-commit</a></b> (🥇32 ·  ⭐ 7.1K) - A framework for managing and maintaining multi-language pre-commit.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pre-commit/pre-commit) (👨‍💻 130 · 🔀 520 · 📥 24K · 📋 1.3K - 1% open · ⏱️ 28.12.2021):

	```
	git clone https://github.com/pre-commit/pre-commit
	```
- [PyPi](https://pypi.org/project/pre-commit) (📥 3.5M / month · 📦 2.1K · ⏱️ 30.11.2021):
	```
	pip install pre-commit
	```
- [Conda](https://anaconda.org/conda-forge/pre-commit) (📥 910K · ⏱️ 01.12.2021):
	```
