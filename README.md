...
- [GitHub](https://github.com/python/mypy) (👨‍💻 510 · 🔀 1.9K · 📦 50K · 📋 7K - 28% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/python/mypy
	```
- [PyPi](https://pypi.org/project/mypy) (📥 8M / month · 📦 6.1K · ⏱️ 22.06.2021):
	```
	pip install mypy
	```
...
- [GitHub](https://github.com/PyCQA/flake8) (👨‍💻 160 · 🔀 180 · 📦 210K · 📋 1.3K - 2% open · ⏱️ 15.11.2021):

	```
	git clone https://github.com/PyCQA/flake8
	```
- [PyPi](https://pypi.org/project/flake8) (📥 14M / month · 📦 71K · ⏱️ 11.10.2021):
	```
	pip install flake8
	```
...
- [GitHub](https://github.com/PyCQA/pyflakes) (👨‍💻 78 · 🔀 160 · 📦 110K · 📋 440 - 18% open · ⏱️ 06.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyflakes) (📥 15M / month · 📦 26K · ⏱️ 06.10.2021):
	```
...
- [GitHub](https://github.com/PyCQA/pycodestyle) (👨‍💻 130 · 🔀 610 · 📦 170K · 📋 660 - 16% open · ⏱️ 09.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pycodestyle) (📥 21M / month · 📦 21K · ⏱️ 11.10.2021):
	```
	pip install pycodestyle
	```
- [Conda](https://anaconda.org/conda-forge/pycodestyle) (📥 3.5M · ⏱️ 11.10.2021):
	```
...
- [GitHub](https://github.com/PyCQA/pylint) (👨‍💻 430 · 🔀 760 · 📋 3.7K - 19% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/davidhalter/parso) (👨‍💻 43 · 🔀 76 · 📦 160K · 📋 100 - 7% open · ⏱️ 15.09.2021):
...
- [PyPi](https://pypi.org/project/parso) (📥 18M / month · 📦 11K · ⏱️ 30.03.2021):
	...
	pip install parso
	```
- [Conda](https://anaconda.org/conda-forge/parso) (📥 5.6M · ⏱️ 31.03.2021):
	```
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 160 · 🔀 310 · 📦 800 · 📋 990 - 9% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/wemake-services/wemake-python-styleguide
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 130K / month · 📦 14 · ⏱️ 21.06.2021):
	```
...
<details><summary><b><a href="https://github.com/PyCQA/flake8-bugbear">flake8-bugbear</a></b> (🥈29 ·  ⭐ 630) - A plugin for Flake8 finding likely bugs and design problems.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://cdn.iconscout.com/icon/free/png-256/8-eight-digital-number-numerical-numbers-36025.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PyCQA/flake8-bugbear) (👨‍💻 43 · 🔀 53 · 📦 5.7K · 📋 100 - 41% open · ⏱️ 29.10.2021):

	```
	git clone https://github.com/PyCQA/flake8-bugbear
	```
- [PyPi](https://pypi.org/project/flake8-bugbear) (📥 1.3M / month · 📦 1K · ⏱️ 29.09.2021):
	```
	pip install flake8-bugbear
	```
- [Conda](https://anaconda.org/conda-forge/flake8-bugbear) (📥 530K · ⏱️ 29.09.2021):
	```
...
- [GitHub](https://github.com/openstack/hacking) (👨‍💻 180 · 🔀 66 · ⏱️ 07.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/hacking) (📥 630K / month · 📦 8.7K · ⏱️ 21.04.2021):
	```
	pip install hacking
	```
</details>
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 70 · 🔀 220 · 📋 460 - 21% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/google/pytype
	```
- [PyPi](https://pypi.org/project/pytype) (📥 150K / month · 📦 88 · ⏱️ 12.11.2021):
	```
	pip install pytype
	```
...
- [GitHub](https://github.com/PyCQA/pylint-django) (👨‍💻 60 · 🔀 100 · 📥 200 · 📦 15K · 📋 180 - 18% open · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/terrencepreilly/darglint) (👨‍💻 22 · 🔀 32 · 📦 1.2K · 📋 140 - 33% open · ⏱️ 18.10.2021):

	```
	git clone https://github.com/terrencepreilly/darglint
	```
- [PyPi](https://pypi.org/project/darglint) (📥 240K / month · 📦 20 · ⏱️ 18.10.2021):
	```
	pip install darglint
	```
- [Conda](https://anaconda.org/conda-forge/darglint) (📥 26K · ⏱️ 05.11.2021):
	```
...
- [GitHub](https://github.com/zheller/flake8-quotes) (👨‍💻 30 · 🔀 34 · 📦 3.8K · 📋 43 - 6% open · ⏱️ 19.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-quotes) (📥 670K / month · 📦 1.4K · ⏱️ 19.10.2021):
	```
...
- [GitHub](https://github.com/gforcada/flake8-isort) (👨‍💻 29 · 🔀 40 · 📦 4.1K · 📋 53 - 24% open · ⏱️ 15.10.2021):
...
- [GitHub](https://github.com/microsoft/pyright) (👨‍💻 65 · 🔀 390 · 📦 150 · 📋 2.1K - 0% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/Microsoft/pyright
	```
- [NPM](https://www.npmjs.com/package/pyright) (📥 150K / month · 📦 4 · ⏱️ 18.11.2021):
	```
	npm install pyright
	```
</details>
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 180 · 🔀 370 · 📋 280 - 27% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/facebook/pyre-check
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 29K / month · 📦 46 · ⏱️ 29.10.2021):
	```
...
- [GitHub](https://github.com/adamchainz/flake8-comprehensions) (👨‍💻 12 · 🔀 15 · 📋 40 - 17% open · ⏱️ 15.11.2021):

	```
	git clone https://github.com/adamchainz/flake8-comprehensions
	```
- [PyPi](https://pypi.org/project/flake8-comprehensions) (📥 580K / month · 📦 710 · ⏱️ 11.10.2021):
	```
	pip install flake8-comprehensions
	```
- [Conda](https://anaconda.org/conda-forge/flake8-comprehensions) (📥 460K · ⏱️ 12.10.2021):
	```
...
- [GitHub](https://github.com/wemake-services/flake8-eradicate) (👨‍💻 13 · 🔀 7 · 📋 28 - 3% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-eradicate) (📥 240K / month · 📦 72 · ⏱️ 19.10.2021):
	```
	pip install flake8-eradicate
	```
</details>
<details><summary><b><a href="https://github.com/peterjc/flake8-black">flake8-black</a></b> (🥉23 ·  ⭐ 99) - flake8 plugin to run black for checking Python coding style. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://cdn.iconscout.com/icon/free/png-256/8-eight-digital-number-numerical-numbers-36025.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/predictive-analytics-lab/data-science-types) (👨‍💻 44 · 🔀 57 · 📦 140 · 📋 62 - 62% open · ⏱️ 16.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/data-science-types) (📥 53K / month · ⏱️ 16.02.2021):
	```
	pip install data-science-types
	```
</details>
<details><summary><b><a href="https://github.com/gforcada/flake8-builtins">flake8-builtins</a></b> (🥉22 ·  ⭐ 74) - Check for python builtins being used as variables or.. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code> <code><img src="https://cdn.iconscout.com/icon/free/png-256/8-eight-digital-number-numerical-numbers-36025.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/Instagram/Fixit) (👨‍💻 27 · 🔀 39 · 📦 12 · 📋 57 - 56% open · ⏱️ 05.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/fixit) (📥 5.2K / month · ⏱️ 30.07.2021):
	```
	pip install fixit
	```
</details>
...
<details><summary><b><a href="https://github.com/andreoliwa/nitpick">nitpick</a></b> (🥉19 ·  ⭐ 190) - Enforce the same settings on multiple projects. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://cdn.iconscout.com/icon/free/png-256/8-eight-digital-number-numerical-numbers-36025.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/andreoliwa/nitpick) (👨‍💻 13 · 🔀 13 · 📥 4 · 📋 89 - 35% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/andreoliwa/nitpick
	```
- [PyPi](https://pypi.org/project/nitpick) (📥 12K / month · ⏱️ 08.11.2021):
	```
	pip install nitpick
	```
</details>
...
- [GitHub](https://github.com/deppen8/pandas-vet) (👨‍💻 10 · 🔀 15 · 📥 39 · 📦 54 · 📋 50 - 42% open · ⏱️ 03.03.2021):

	```
	git clone https://github.com/deppen8/pandas-vet
	```
- [PyPi](https://pypi.org/project/pandas-vet) (📥 5.1K / month · ⏱️ 01.02.2020):
	```
...
- [GitHub](https://github.com/justinabrahms/imhotep) (👨‍💻 16 · 🔀 37 · 📦 7 · 📋 46 - 50% open · ⏱️ 01.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/imhotep) (📥 36 / month · 📦 4 · ⏱️ 18.09.2016):
	```
	pip install imhotep
	```
</details>
<details><summary><b><a href="https://github.com/beartype/beartype">beartype</a></b> (🥉17 ·  ⭐ 530) - Unbearably fast O(1) runtime type-checking in pure Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/beartype/beartype) (👨‍💻 9 · 🔀 15 · 📋 53 - 20% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/beartype/beartype
	```
- [PyPi](https://pypi.org/project/beartype) (📥 45K / month · ⏱️ 06.11.2021):
	```
	pip install beartype
	```
- [Conda](https://anaconda.org/conda-forge/beartype) (📥 8.5K · ⏱️ 06.11.2021):
	```
...
- <b><a href="https://github.com/tylerwince/flake8-bandit">flake8-bandit</a></b> (🥉20 ·  ⭐ 66 · 💀) - Automated security testing using bandit and flake8. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://cdn.iconscout.com/icon/free/png-256/8-eight-digital-number-numerical-numbers-36025.png" style="display:inline;" width="13" height="13"></code>
- <b><a href="https://github.com/cemsbr/yala">yala</a></b> (🥉19 ·  ⭐ 12) - Yet Another Linter Aggregator. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://cdn.iconscout.com/icon/free/png-256/8-eight-digital-number-numerical-numbers-36025.png" style="display:inline;" width="13" height="13"></code> <code><img src="https://www.pylint.org/ico/favicon.ico" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/psf/black) (👨‍💻 280 · 🔀 1.5K · 📥 18K · 📦 95K · 📋 1.7K - 20% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/psf/black
	```
- [PyPi](https://pypi.org/project/black) (📥 9.7M / month · 📦 6.2K · ⏱️ 18.11.2021):
	```
	pip install black
	```
...
- [GitHub](https://github.com/hhatto/autopep8) (👨‍💻 51 · 🔀 250 · 📦 96K · 📋 430 - 21% open · ⏱️ 30.10.2021):
...
- [PyPi](https://pypi.org/project/autopep8) (📥 2.5M / month · 📦 10K · ⏱️ 24.10.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/autopep8) (📥 570K · ⏱️ 26.10.2021):
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 250 · 🔀 430 · 📦 200K · 📋 1K - 3% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 130 · 🔀 820 · 📦 26K · 📋 720 - 46% open · ⏱️ 08.11.2021):
...
- [GitHub](https://github.com/myint/docformatter) (👨‍💻 15 · 🔀 32 · 📦 760 · 📋 49 - 55% open · ⏱️ 27.12.2020):

	```
	git clone https://github.com/myint/docformatter
	```
- [PyPi](https://pypi.org/project/docformatter) (📥 94K / month · 📦 110 · ⏱️ 27.12.2020):
	```
...
- [GitHub](https://github.com/davidhalter/jedi) (👨‍💻 150 · 🔀 460 · 📦 160K · 📋 1.3K - 2% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/davidhalter/jedi
	```
- [PyPi](https://pypi.org/project/jedi) (📥 18M / month · 📦 16K · ⏱️ 17.11.2021):
	```
	pip install jedi
	```
- [Conda](https://anaconda.org/conda-forge/jedi) (📥 6.9M · ⏱️ 17.11.2021):
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 67 · 🔀 150 · 📦 33K · 📋 230 - 30% open · ⏱️ 14.11.2021):

	```
	git clone https://github.com/python-rope/rope
	```
- [PyPi](https://pypi.org/project/rope) (📥 550K / month · 📦 2.9K · ⏱️ 11.11.2021):
	```
	pip install rope
	```
...
<details><summary><b><a href="https://github.com/myint/autoflake">autoflake</a></b> (🥈27 ·  ⭐ 450 · 💤) - Removes unused imports and unused variables as reported by pyflakes. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/myint/autoflake) (👨‍💻 17 · 🔀 49 · 📦 3.3K · 📋 66 - 50% open · ⏱️ 27.12.2020):

	```
	git clone https://github.com/myint/autoflake
	```
- [PyPi](https://pypi.org/project/autoflake) (📥 590K / month · 📦 580 · ⏱️ 04.08.2019):
	```
...
- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 29 · 🔀 90 · 📦 1.3K · 📋 150 - 9% open · ⏱️ 27.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/vulture) (📥 180K / month · 📦 360 · ⏱️ 16.01.2021):
	```
	pip install vulture
	```
...
- [GitHub](https://github.com/asottile/pyupgrade) (👨‍💻 21 · 🔀 85 · 📋 250 - 4% open · ⏱️ 16.11.2021):

	```
	git clone https://github.com/asottile/pyupgrade
	```
- [PyPi](https://pypi.org/project/pyupgrade) (📥 110K / month · 📦 10 · ⏱️ 16.11.2021):
	```
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 37 · 🔀 130 · 📦 160 · 📋 150 - 24% open · ⏱️ 15.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/monkeytype) (📥 37K / month · 📦 34 · ⏱️ 21.05.2021):
	```
...
- [GitHub](https://github.com/facebookincubator/Bowler) (👨‍💻 26 · 🔀 88 · 📋 80 - 57% open · ⏱️ 01.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/bowler) (📥 37K / month · 📦 10 · ⏱️ 17.09.2020):
	```
	pip install bowler
	```
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 17 · 🔀 54 · 📦 66 · 📋 59 - 44% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyannotate) (📥 3K / month · 📦 26 · ⏱️ 16.09.2019):
	```
...
- [GitHub](https://github.com/asottile/add-trailing-comma) (👨‍💻 9 · 🔀 14 · 📋 35 - 2% open · ⏱️ 01.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/add-trailing-comma) (📥 15K / month · 📦 14 · ⏱️ 19.10.2021):
	```
...
- [GitHub](https://github.com/hakancelik96/unimport) (👨‍💻 13 · 🔀 13 · 📦 15 · 📋 76 - 13% open · ⏱️ 14.09.2021):

	```
	git clone https://github.com/hakancelik96/unimport
	```
- [PyPi](https://pypi.org/project/unimport) (📥 4.2K / month · ⏱️ 14.09.2021):
	```
...
- [GitHub](https://github.com/elmotec/massedit) (👨‍💻 6 · 🔀 14 · 📥 17 · 📋 8 - 37% open · ⏱️ 23.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/massedit) (📥 1.6K / month · 📦 10 · ⏱️ 23.12.2020):
	```
...
- <b><a href="https://github.com/myint/unify">unify</a></b> (🥉20 ·  ⭐ 62 · 💀) - Modifies strings to all use the same quote where possible. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
<details><summary><b><a href="https://github.com/PyCQA/bandit">bandit</a></b> (🥇32 ·  ⭐ 3.7K) - Bandit is a tool designed to find common security issues in Python.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/PyCQA/bandit) (👨‍💻 140 · 🔀 380 · 📥 120 · 📦 9.1K · 📋 560 - 33% open · ⏱️ 13.11.2021):

	```
	git clone https://github.com/PyCQA/bandit
	```
- [PyPi](https://pypi.org/project/bandit) (📥 2.1M / month · 📦 2.4K · ⏱️ 12.11.2021):
	```
	pip install bandit
	```
- [Conda](https://anaconda.org/conda-forge/bandit) (📥 97K · ⏱️ 13.11.2021):
	```
...
- [GitHub](https://github.com/pyupio/safety) (👨‍💻 35 · 🔀 97 · 📥 98K · 📦 3K · 📋 120 - 38% open · ⏱️ 28.04.2021):

	```
	git clone https://github.com/pyupio/safety
	```
- [PyPi](https://pypi.org/project/safety) (📥 730K / month · 📦 540 · ⏱️ 15.01.2021):
	```
	pip install safety
	```
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.6K · 📋 4.5K - 1% open · ⏱️ 16.11.2021):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 6K / month · 📦 8 · ⏱️ 01.11.2021):
	```
	pip install sqlmap
	```
</details>
...
- [GitHub](https://github.com/Yelp/detect-secrets) (👨‍💻 53 · 🔀 240 · 📋 240 - 35% open · ⏱️ 15.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/detect-secrets) (📥 210K / month · 📦 34 · ⏱️ 14.04.2021):
	```
	pip install detect-secrets
	```
</details>
<details><summary><b><a href="https://github.com/landscapeio/dodgy">dodgy</a></b> (🥉21 ·  ⭐ 94 · 💤) - Looks at Python code to search for things which look dodgy such as.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/dlint-py/dlint) (👨‍💻 8 · 🔀 6 · 📋 33 - 57% open · ⏱️ 27.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/dlint) (📥 100K / month · 📦 18 · ⏱️ 27.10.2021):
	```
	pip install dlint
	```
</details>
...
<details><summary><b><a href="https://github.com/pypa/pipenv">pipenv</a></b> (🥇34 ·  ⭐ 22K) - Python Development Workflow for Humans. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pypa/pipenv) (👨‍💻 390 · 🔀 1.7K · 📦 23K · 📋 3.5K - 16% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/pypa/pipenv
	```
- [PyPi](https://pypi.org/project/pipenv) (📥 4.1M / month · 📦 2.3K · ⏱️ 15.11.2021):
	```
	pip install pipenv
	```
- [Conda](https://anaconda.org/conda-forge/pipenv) (📥 45K · ⏱️ 15.11.2021):
	```
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 220 · 🔀 910 · 📋 1.2K - 5% open · ⏱️ 01.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/virtualenv) (📥 24M / month · 📦 34K · ⏱️ 01.11.2021):
	```
...
- [GitHub](https://github.com/pyenv/pyenv-virtualenv) (👨‍💻 46 · 🔀 300 · 📋 330 - 40% open · ⏱️ 13.11.2021):
...
- [GitHub](https://github.com/pypa/pip) (👨‍💻 640 · 🔀 2.4K · 📦 65K · 📋 6K - 15% open · ⏱️ 12.11.2021):

	```
	git clone https://github.com/pypa/pip
	```
- [PyPi](https://pypi.org/project/pip) (📥 95M / month · 📦 19K · ⏱️ 22.10.2021):
	```
	pip install pip
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 320 · 🔀 1.4K · 📥 9.3M · 📋 3.5K - 38% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 160 · 🔀 470 · 📋 790 - 16% open · ⏱️ 12.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 3.6M / month · 📦 3.3K · ⏱️ 12.10.2021):
	```
...
- [GitHub](https://github.com/conda/conda) (👨‍💻 370 · 🔀 1.1K · 📋 8.3K - 24% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/bndr/pipreqs) (👨‍💻 51 · 🔀 250 · 📦 7.6K · 📋 180 - 50% open · ⏱️ 23.10.2021):
...
- [GitHub](https://github.com/dephell/dephell) (👨‍💻 37 · 🔀 100 · 📥 160 · 📦 320 · 📋 270 - 40% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/dephell) (📥 12K / month · 📦 8 · ⏱️ 28.04.2020):
	```
	pip install dephell
	```
</details>
...
- [GitHub](https://github.com/pypa/pipx) (👨‍💻 64 · 🔀 190 · 📋 430 - 21% open · ⏱️ 11.11.2021):
...
<details><summary><b><a href="https://github.com/mamba-org/mamba">mamba</a></b> (🥉23 ·  ⭐ 2.4K · 📈) - The Fast Cross-Platform Package Manager. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/mamba-org/mamba) (👨‍💻 62 · 🔀 130 · 📋 650 - 31% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/mamba-org/mamba
	```
- [Conda](https://anaconda.org/conda-forge/mamba) (📥 1.6M · ⏱️ 14.10.2021):
	```
...
- [GitHub](https://github.com/jaraco/pip-run) (👨‍💻 11 · 🔀 10 · 📋 42 - 9% open · ⏱️ 02.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pip-run) (📥 8.4K / month · ⏱️ 02.10.2021):
	```
	pip install pip-run
	```
</details>
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 78 · 🔀 140 · 📋 280 - 18% open · ⏱️ 14.11.2021):

	```
	git clone https://github.com/PyCQA/prospector
	```
- [PyPi](https://pypi.org/project/prospector) (📥 530K / month · 📦 1.1K · ⏱️ 17.09.2021):
	```
...
- [GitHub](https://github.com/rubik/radon) (👨‍💻 49 · 🔀 97 · 📦 2.1K · 📋 160 - 12% open · ⏱️ 08.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/radon) (📥 450K / month · 📦 1.1K · ⏱️ 08.08.2021):
	```
	pip install radon
	```
...
- [PyPi](https://pypi.org/project/mccabe) (📥 19M / month · 📦 31K · ⏱️ 26.01.2017):
	...
	pip install mccabe
	```
- [Conda](https://anaconda.org/conda-forge/mccabe) (📥 3.6M · ⏱️ 08.07.2018):
	```
...
- [GitHub](https://github.com/rubik/xenon) (👨‍💻 8 · 🔀 15 · 📦 270 · 📋 31 - 19% open · ⏱️ 03.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/xenon) (📥 64K / month · 📦 120 · ⏱️ 03.09.2021):
	```
	pip install xenon
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1K · 📥 8K · 📦 220K · 📋 870 - 37% open · ⏱️ 20.09.2021):
...
- [GitHub](https://github.com/madzak/python-json-logger) (👨‍💻 46 · 🔀 160 · 📦 18K · 📋 69 - 33% open · ⏱️ 27.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-json-logger) (📥 4.4M / month · 📦 920 · ⏱️ 27.07.2021):
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 110 · 🔀 250 · 📥 4.5K · 📦 16K · 📋 600 - 33% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/getsentry/sentry-python
	```
- [PyPi](https://pypi.org/project/sentry-sdk) (📥 11M / month · 📦 990 · ⏱️ 17.11.2021):
	```
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 30 · 🔀 460 · 📦 12K · 📋 480 - 16% open · ⏱️ 09.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/loguru) (📥 2.1M / month · 📦 340 · ⏱️ 20.09.2020):
	```
	pip install loguru
	```
...
- [GitHub](https://github.com/astanin/python-tabulate) (👨‍💻 67 · 🔀 82 · 📦 56K · 📋 110 - 44% open · ⏱️ 04.03.2021):

	```
	git clone https://github.com/astanin/python-tabulate
	```
- [PyPi](https://pypi.org/project/tabulate) (📥 32M / month · 📦 8.1K · ⏱️ 22.02.2021):
	```
...
- [GitHub](https://github.com/WoLpH/python-progressbar) (👨‍💻 40 · 🔀 100 · 📥 1.6K · 📦 13K · 📋 190 - 3% open · ⏱️ 15.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/progressbar2) (📥 2.3M / month · 📦 2.2K · ⏱️ 15.10.2021):
	```
...
- [GitHub](https://github.com/borntyping/python-colorlog) (👨‍💻 30 · 🔀 76 · 📦 12K · ⏱️ 08.11.2021):
...
<details><summary><b><a href="https://github.com/hynek/structlog">structlog</a></b> (🥉27 ·  ⭐ 1.8K) - Structured Logging for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/hynek/structlog) (👨‍💻 79 · 🔀 150 · 📋 200 - 14% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/hynek/structlog
	```
- [PyPi](https://pypi.org/project/structlog) (📥 2.6M / month · 📦 1.2K · ⏱️ 12.10.2021):
	```
...
- [GitHub](https://github.com/xolox/python-coloredlogs) (👨‍💻 16 · 🔀 36 · 📦 9.5K · 📋 74 - 33% open · ⏱️ 11.06.2021):
...
- [GitHub](https://github.com/ines/wasabi) (👨‍💻 4 · 🔀 18 · 📦 15K · 📋 6 - 50% open · ⏱️ 31.01.2021):
...
- [PyPi](https://pypi.org/project/wasabi) (📥 3.7M / month · 📦 410 · ⏱️ 31.01.2021):
	...
	pip install wasabi
	```
- [Conda](https://anaconda.org/conda-forge/wasabi) (📥 490K · ⏱️ 01.02.2021):
	```
...
- [GitHub](https://github.com/cknd/stackprinter) (👨‍💻 6 · 🔀 33 · 📦 82 · 📋 26 - 42% open · ⏱️ 01.01.2021):

	```
	git clone https://github.com/cknd/stackprinter
	```
- [PyPi](https://pypi.org/project/stackprinter) (📥 470K / month · 📦 4 · ⏱️ 31.10.2020):
	```
...
- [GitHub](https://github.com/shobrook/rebound) (👨‍💻 16 · 🔀 350 · 📥 180 · 📦 22 · 📋 58 - 34% open · ⏱️ 04.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/rebound) (📥 1.8K / month · 📦 14 · ⏱️ 17.11.2021):
	```
	pip install rebound
	```
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 1 · 🔀 110 · 📦 480 · 📋 91 - 27% open · ⏱️ 06.11.2021):

	```
	git clone https://github.com/rsalmei/alive-progress
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 26K / month · ⏱️ 19.10.2021):
	```
...
<details><summary><b><a href="https://github.com/samuelcolvin/python-devtools">python-devtools</a></b> (🥉20 ·  ⭐ 430) - Dev tools for python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/samuelcolvin/python-devtools) (👨‍💻 7 · 🔀 15 · 📦 480 · 📋 36 - 5% open · ⏱️ 08.09.2021):
...
- <b><a href="https://github.com/jazzband/prettytable">prettytable</a></b> (🥉23 ·  ⭐ 600) - Display tabular data in a visually appealing ASCII table.. <code><a href="https://tldrlegal.com/search?q=BSD-1-Clause">❗️BSD-1-Clause</a></code>
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (👨‍💻 690 · 🔀 1.6K · 📦 170K · 📋 5.7K - 16% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/sphinx-doc/sphinx
	```
- [PyPi](https://pypi.org/project/sphinx) (📥 4M / month · 📦 100K · ⏱️ 10.11.2021):
	```
	pip install sphinx
	```
- [Conda](https://anaconda.org/conda-forge/sphinx) (📥 4.4M · ⏱️ 10.11.2021):
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs) (👨‍💻 210 · 🔀 1.8K · 📦 16K · 📋 1.6K - 6% open · ⏱️ 16.11.2021):

	```
	git clone https://github.com/mkdocs/mkdocs
	```
- [PyPi](https://pypi.org/project/mkdocs) (📥 780K / month · 📦 5.9K · ⏱️ 12.10.2021):
	```
	pip install mkdocs
	```
...
- [GitHub](https://github.com/readthedocs/sphinx_rtd_theme) (👨‍💻 110 · 🔀 1.6K · 📦 16 · 📋 720 - 26% open · ⏱️ 19.10.2021):
...
<details><summary><b><a href="https://github.com/squidfunk/mkdocs-material">mkdocs-material</a></b> (🥈32 ·  ⭐ 8K) - Technical documentation that just works. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 130 · 🔀 1.9K · 📦 9.7K · 📋 1.2K - 1% open · ⏱️ 15.11.2021):

	```
	git clone https://github.com/squidfunk/mkdocs-material
	```
- [PyPi](https://pypi.org/project/mkdocs-material) (📥 740K / month · 📦 1.5K · ⏱️ 13.11.2021):
	```
...
- [GitHub](https://github.com/michaeljones/breathe) (👨‍💻 98 · 🔀 140 · 📥 150 · 📦 5.4K · 📋 470 - 25% open · ⏱️ 07.11.2021):

	```
	git clone https://github.com/michaeljones/breathe
	```
- [PyPi](https://pypi.org/project/breathe) (📥 180K / month · 📦 2K · ⏱️ 14.09.2021):
	```
	pip install breathe
	```
...
- [GitHub](https://github.com/ryan-roemer/sphinx-bootstrap-theme) (👨‍💻 38 · 🔀 210 · 📋 140 - 40% open · ⏱️ 02.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/sphinx-bootstrap-theme) (📥 61K / month · 📦 980 · ⏱️ 12.09.2021):
	```
...
- [GitHub](https://github.com/agronholm/sphinx-autodoc-typehints) (👨‍💻 30 · 🔀 71 · 📋 130 - 44% open · ⏱️ 08.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/sphinx-autodoc-typehints) (📥 330K / month · 📦 1.4K · ⏱️ 12.10.2020):
	```
...
- [GitHub](https://github.com/econchick/interrogate) (👨‍💻 11 · 🔀 24 · 📦 1K · 📋 31 - 25% open · ⏱️ 10.09.2021):

	```
	git clone https://github.com/econchick/interrogate
	```
- [PyPi](https://pypi.org/project/interrogate) (📥 87K / month · ⏱️ 10.09.2021):
	```
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 31 · 🔀 120 · 📦 440 · 📋 190 - 3% open · ⏱️ 29.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 94K / month · 📦 290 · ⏱️ 29.10.2021):
	```
	pip install pdoc
	```
</details>
...
- [GitHub](https://github.com/bitprophet/releases) (👨‍💻 10 · 🔀 36 · 📦 390 · 📋 76 - 43% open · ⏱️ 24.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/releases) (📥 10K / month · 📦 710 · ⏱️ 11.01.2020):
	```
...
- [GitHub](https://github.com/executablebooks/sphinx-autobuild) (👨‍💻 17 · 🔀 51 · 📋 57 - 22% open · ⏱️ 14.03.2021):

	```
	git clone https://github.com/executablebooks/sphinx-autobuild
	```
- [PyPi](https://pypi.org/project/sphinx-autobuild) (📥 210K / month · 📦 4.7K · ⏱️ 14.03.2021):
	```
...
- [GitHub](https://github.com/mkdocstrings/mkdocstrings) (👨‍💻 25 · 🔀 56 · 📋 210 - 24% open · ⏱️ 31.10.2021):

	```
	git clone https://github.com/mkdocstrings/mkdocstrings
	```
- [PyPi](https://pypi.org/project/mkdocstrings) (📥 89K / month · ⏱️ 04.10.2021):
	```
	pip install mkdocstrings
	```
- [Conda](https://anaconda.org/conda-forge/mkdocstrings) (📥 10K · ⏱️ 04.10.2021):
	```
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-pages-plugin) (👨‍💻 3 · 🔀 20 · 📦 550 · 📋 48 - 22% open · ⏱️ 19.10.2021):

	```
	git clone https://github.com/lukasgeiter/mkdocs-awesome-pages-plugin
	```
- [PyPi](https://pypi.org/project/mkdocs-awesome-pages-plugin) (📥 44K / month · 📦 90 · ⏱️ 19.10.2021):
	```
...
- [GitHub](https://github.com/asottile/blacken-docs) (👨‍💻 12 · 🔀 18 · 📋 37 - 8% open · ⏱️ 25.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/blacken-docs) (📥 13K / month · 📦 22 · ⏱️ 27.08.2021):
	```
	pip install blacken-docs
	```
- [Conda](https://anaconda.org/conda-forge/blacken-docs) (📥 19K · ⏱️ 27.08.2021):
	```
	conda install -c conda-forge blacken-docs
	```
</details>
<details><summary><b><a href="https://github.com/orzih/mkdocs-with-pdf">mkdocs-with-pdf</a></b> (🥉21 ·  ⭐ 100) - Generate a single PDF file from MkDocs repository. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/orzih/mkdocs-with-pdf) (👨‍💻 6 · 🔀 19 · 📦 73 · 📋 63 - 41% open · ⏱️ 14.10.2021):
...
<details><summary><b><a href="https://github.com/ml-tooling/lazydocs">lazydocs</a></b> (🥉16 ·  ⭐ 48 · 📉) - Generate markdown API documentation from Google-style Python.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ml-tooling/lazydocs) (👨‍💻 7 · 🔀 11 · 📦 51 · 📋 6 - 50% open · ⏱️ 20.08.2021):
...
- [GitHub](https://github.com/cool-RR/PySnooper) (👨‍💻 26 · 🔀 920 · 📦 520 · 📋 110 - 16% open · ⏱️ 11.09.2021):

	```
	git clone https://github.com/cool-RR/PySnooper
	```
- [PyPi](https://pypi.org/project/pysnooper) (📥 89K / month · 📦 46 · ⏱️ 11.09.2021):
	```
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 80 · 🔀 190 · 📦 2.6K · 📋 280 - 48% open · ⏱️ 01.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pudb) (📥 170K / month · 📦 1.4K · ⏱️ 01.11.2021):
	```
	pip install pudb
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 80 · 🔀 400 · 📦 2.7K · 📋 170 - 31% open · ⏱️ 17.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 800K / month · 📦 880 · ⏱️ 27.10.2020):
	```
...
- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 40 · 🔀 46 · 📦 2.4K · 📋 180 - 35% open · ⏱️ 28.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/pdbpp) (📥 190K / month · 📦 1K · ⏱️ 09.07.2021):
	```
	pip install pdbpp
	```
...
- [GitHub](https://github.com/cs01/gdbgui) (👨‍💻 38 · 🔀 480 · 📥 5.9K · 📦 120 · 📋 280 - 40% open · ⏱️ 06.09.2021):
...
- [GitHub](https://github.com/agronholm/typeguard) (👨‍💻 18 · 🔀 64 · 📋 170 - 18% open · ⏱️ 11.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/typeguard) (📥 10M / month · 📦 160 · ⏱️ 10.10.2021):
	```
	pip install typeguard
	```
- [Conda](https://anaconda.org/conda-forge/typeguard) (📥 63K · ⏱️ 11.10.2021):
	```
...
- [GitHub](https://github.com/gruns/icecream) (👨‍💻 16 · 🔀 110 · 📋 82 - 31% open · ⏱️ 31.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/icecream) (📥 110K / month · 📦 6 · ⏱️ 22.06.2021):
	```
	pip install icecream
	```
</details>
<details><summary><b><a href="https://github.com/alexmojaki/snoop">snoop</a></b> (🥉22 ·  ⭐ 650) - A powerful set of Python debugging tools, based on PySnooper. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/alexmojaki/snoop) (👨‍💻 21 · 🔀 24 · 📋 37 - 48% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/snoop) (📥 29K / month · 📦 8 · ⏱️ 11.11.2021):
	```
	pip install snoop
	```
</details>
<details><summary><b><a href="https://github.com/ionelmc/python-hunter">python-hunter</a></b> (🥉22 ·  ⭐ 650) - Hunter is a flexible code tracing toolkit. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 35 · 📦 70 · 📋 87 - 42% open · ⏱️ 13.10.2021):

	```
	git clone https://github.com/ionelmc/python-hunter
	```
- [PyPi](https://pypi.org/project/hunter) (📥 6.3K / month · 📦 34 · ⏱️ 23.06.2021):
	```
	pip install hunter
	```
</details>
...
- [GitHub](https://github.com/ionelmc/python-manhole) (👨‍💻 11 · 🔀 16 · 📦 77 · 📋 20 - 25% open · ⏱️ 15.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/manhole) (📥 40K / month · 📦 66 · ⏱️ 08.04.2021):
	```
	pip install manhole
	```
</details>
...
- [GitHub](https://github.com/alexmojaki/birdseye) (👨‍💻 10 · 🔀 70 · 📋 50 - 36% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/birdseye) (📥 1.2K / month · ⏱️ 11.11.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest) (👨‍💻 750 · 🔀 1.9K · 📦 400K · 📋 4.7K - 15% open · ⏱️ 13.11.2021):

	```
	git clone https://github.com/pytest-dev/pytest
	```
- [PyPi](https://pypi.org/project/pytest) (📥 34M / month · 📦 130K · ⏱️ 30.08.2021):
	```
	pip install pytest
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 150 · 🔀 1.8K · 📥 510 · 📦 4.5K · 📋 3.7K - 6% open · ⏱️ 16.11.2021):
...
- [GitHub](https://github.com/tox-dev/tox) (👨‍💻 250 · 🔀 380 · 📦 51K · 📋 1.3K - 10% open · ⏱️ 11.10.2021):

	```
	git clone https://github.com/tox-dev/tox
	```
- [PyPi](https://pypi.org/project/tox) (📥 3.7M / month · 📦 36K · ⏱️ 16.09.2021):
	```
	pip install tox
	```
...
- [PyPi](https://pypi.org/project/pytest-cov) (📥 11M / month · 📦 43K · ⏱️ 04.10.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-cov) (📥 4.1M · ⏱️ 04.10.2021):
	```
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 250 · 🔀 480 · 📦 10K · 📋 1.2K - 5% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 2.3M / month · 📦 2.6K · ⏱️ 18.11.2021):
	```
...
<details><summary><b><a href="https://github.com/spulec/freezegun">freezegun</a></b> (🥈31 ·  ⭐ 3.1K) - Let your Python tests travel through time. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/pytest-dev/pytest-asyncio">pytest-asyncio</a></b> (🥈31 ·  ⭐ 820) - Pytest support for asyncio. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/pytest-dev/pytest-asyncio) (👨‍💻 26 · 🔀 89 · 📦 17K · 📋 180 - 43% open · ⏱️ 15.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-asyncio) (📥 7M / month · 📦 2K · ⏱️ 15.10.2021):
	```
	pip install pytest-asyncio
	```
- [Conda](https://anaconda.org/conda-forge/pytest-asyncio) (📥 680K · ⏱️ 18.10.2021):
	```
	conda install -c conda-forge pytest-asyncio
	```
</details>
<details><summary><b><a href="https://github.com/pytest-dev/pytest-xdist">pytest-xdist</a></b> (🥈31 ·  ⭐ 790) - pytest plugin for distributed testing and loop-on-failures.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pytest-dev/pytest-xdist) (👨‍💻 76 · 🔀 160 · 📋 460 - 44% open · ⏱️ 02.11.2021):
...
- [GitHub](https://github.com/TheKevJames/coveralls-python) (👨‍💻 63 · 🔀 180 · 📦 20K · 📋 150 - 3% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/coveralls) (📥 530K / month · 📦 17K · ⏱️ 11.11.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-mock) (👨‍💻 54 · 🔀 98 · 📦 21K · 📋 100 - 11% open · ⏱️ 01.11.2021):
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 280 · 📥 180 · 📋 300 - 1% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/lk-geimfari/mimesis
	```
- [PyPi](https://pypi.org/project/mimesis) (📥 80K / month · 📦 84 · ⏱️ 05.11.2021):
	```
	pip install mimesis
	```
</details>
...
<details><summary><b><a href="https://github.com/pytest-dev/pytest-bdd">pytest-bdd</a></b> (🥈27 ·  ⭐ 910) - BDD library for the py.test runner. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/pytest-dev/pytest-bdd) (👨‍💻 44 · 🔀 150 · 📋 260 - 48% open · ⏱️ 14.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-bdd) (📥 250K / month · 📦 270 · ⏱️ 25.10.2021):
	```
...
<details><summary><b><a href="https://github.com/microsoft/playwright-python">playwright-python</a></b> (🥉26 ·  ⭐ 5.4K) - Python version of the Playwright testing and automation.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/microsoft/playwright-python) (👨‍💻 21 · 🔀 460 · 📦 530 · 📋 510 - 6% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/microsoft/playwright-python
	```
- [PyPi](https://pypi.org/project/playwright) (📥 140K / month · ⏱️ 29.10.2021):
	```
...
- [GitHub](https://github.com/CleanCut/green) (👨‍💻 37 · 🔀 75 · 📦 610 · 📋 170 - 3% open · ⏱️ 16.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/green) (📥 19K / month · 📦 360 · ⏱️ 16.07.2021):
	```
	pip install green
	```
...
- [GitHub](https://github.com/airspeed-velocity/asv) (👨‍💻 55 · 🔀 130 · 📦 200 · 📋 410 - 27% open · ⏱️ 15.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/asv) (📥 31K / month · 📦 88 · ⏱️ 16.05.2020):
	```
	pip install asv
	```
...
- [GitHub](https://github.com/hamcrest/PyHamcrest) (👨‍💻 35 · 🔀 87 · 📋 65 - 24% open · ⏱️ 10.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyhamcrest) (📥 930K / month · 📦 3.4K · ⏱️ 02.03.2020):
	```
...
- [GitHub](https://github.com/dbader/pytest-mypy) (👨‍💻 15 · 🔀 32 · 📦 1.4K · 📋 47 - 19% open · ⏱️ 16.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-mypy) (📥 450K / month · 📦 270 · ⏱️ 21.03.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-testinfra) (👨‍💻 110 · 🔀 280 · 📋 320 - 36% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/xiaocong/uiautomator) (👨‍💻 13 · 🔀 590 · 📦 200 · 📋 290 - 59% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/uiautomator) (📥 32K / month · 📦 120 · ⏱️ 16.11.2020):
	```
	pip install uiautomator
	```
</details>
<details><summary><b><a href="https://github.com/theacodes/nox">nox</a></b> (🥉24 ·  ⭐ 660) - Flexible test automation for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/theacodes/nox) (👨‍💻 63 · 🔀 100 · 📋 240 - 15% open · ⏱️ 25.10.2021):

	```
	git clone https://github.com/theacodes/nox
	```
- [PyPi](https://pypi.org/project/nox) (📥 640K / month · 📦 56 · ⏱️ 01.10.2021):
	```
	pip install nox
	```
...
- [GitHub](https://github.com/nestorsalceda/mamba) (👨‍💻 22 · 🔀 64 · 📦 380 · 📋 97 - 46% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/mamba) (📥 22K / month · 📦 220 · ⏱️ 16.11.2020):
	```
	pip install mamba
	```
</details>
...
- [GitHub](https://github.com/pytest-dev/pytest-randomly) (👨‍💻 16 · 🔀 22 · 📋 46 - 10% open · ⏱️ 15.11.2021):

	```
	git clone https://github.com/pytest-dev/pytest-randomly
	```
- [PyPi](https://pypi.org/project/pytest-randomly) (📥 380K / month · 📦 210 · ⏱️ 10.11.2021):
	```
	pip install pytest-randomly
	```
</details>
<details><summary><b><a href="https://github.com/TvoroG/pytest-lazy-fixture">pytest-lazy-fixture</a></b> (🥉22 ·  ⭐ 220) - It helps to use fixtures in pytest.mark.parametrize. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/TvoroG/pytest-lazy-fixture) (👨‍💻 8 · 🔀 15 · 📦 470 · 📋 35 - 42% open · ⏱️ 17.11.2021):
...
- [GitHub](https://github.com/Erotemic/xdoctest) (👨‍💻 6 · 🔀 6 · 📦 1.7K · 📋 37 - 45% open · ⏱️ 06.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/xdoctest) (📥 97K / month · 📦 52 · ⏱️ 06.10.2021):
	```
...
- [GitHub](https://github.com/avast/pytest-docker) (👨‍💻 11 · 🔀 42 · 📥 82 · 📋 33 - 51% open · ⏱️ 14.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-docker) (📥 54K / month · 📦 28 · ⏱️ 14.06.2021):
	```
...
- [GitHub](https://github.com/pypa/packaging) (👨‍💻 72 · 🔀 170 · 📥 170 · 📦 270K · 📋 230 - 29% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/pypa/packaging
	```
- [PyPi](https://pypi.org/project/packaging) (📥 83M / month · 📦 29K · ⏱️ 18.11.2021):
	```
...
- [GitHub](https://github.com/Nuitka/Nuitka) (👨‍💻 100 · 🔀 340 · 📋 1.1K - 20% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/Nuitka/Nuitka
	```
- [PyPi](https://pypi.org/project/nuitka) (📥 26K / month · 📦 54 · ⏱️ 15.11.2021):
	```
	pip install nuitka
	```
- [Conda](https://anaconda.org/conda-forge/nuitka) (📥 320K · ⏱️ 15.11.2021):
	```
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 420 · 🔀 1.7K · 📥 720K · 📋 4.3K - 7% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 650K / month · ⏱️ 10.11.2021):
	```
...
- [GitHub](https://github.com/pantsbuild/pex) (👨‍💻 100 · 🔀 210 · 📥 480K · 📋 750 - 19% open · ⏱️ 10.11.2021):
...
- [GitHub](https://github.com/ronaldoussoren/py2app) (👨‍💻 26 · 🔀 16 · 📦 3.8K · 📋 370 - 27% open · ⏱️ 05.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/py2app) (📥 12K / month · 📦 1.6K · ⏱️ 27.09.2021):
	```
	pip install py2app
	```
</details>
...
- [GitHub](https://github.com/beeware/briefcase) (👨‍💻 87 · 🔀 200 · 📋 360 - 27% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/beeware/briefcase
	```
- [PyPi](https://pypi.org/project/briefcase) (📥 3.3K / month · 📦 24 · ⏱️ 06.03.2021):
	```
	pip install briefcase
	```
</details>
<details><summary><b><a href="https://github.com/py2exe/py2exe">py2exe</a></b> (🥈24 ·  ⭐ 320) - A distutils extension to create standalone Windows programs from Python code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/py2exe/py2exe) (👨‍💻 14 · 🔀 42 · 📥 6.6K · 📦 1.3K · 📋 90 - 4% open · ⏱️ 16.11.2021):

	```
	git clone https://github.com/py2exe/py2exe
	```
- [PyPi](https://pypi.org/project/py2exe) (📥 24K / month · 📦 350 · ⏱️ 16.11.2021):
	```
	pip install py2exe
	```
</details>
<details><summary><b><a href="https://github.com/marcelotduarte/cx_Freeze">cx_Freeze</a></b> (🥉23 ·  ⭐ 820) - Create standalone executables from Python scripts, with the same.. <code><a href="http://bit.ly/35wkF7y">Python-2.0</a></code></summary>
...
- [PyPi](https://pypi.org/project/cx_freeze) (📥 53K / month · 📦 150 · ⏱️ 16.12.2017):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cx_freeze) (📥 100K · ⏱️ 10.11.2021):
	```
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 34 · 🔀 71 · 📥 150 · 📋 90 - 30% open · ⏱️ 12.10.2021):
...
- [GitHub](https://github.com/pypa/setuptools) (👨‍💻 470 · 🔀 790 · 📥 110 · 📦 120K · 📋 1.9K - 28% open · ⏱️ 15.11.2021):

	```
	git clone https://github.com/pypa/setuptools
	```
- [PyPi](https://pypi.org/project/setuptools) (📥 170M / month · 📦 58K · ⏱️ 16.11.2021):
	```
	pip install setuptools
	```
- [Conda](https://anaconda.org/conda-forge/setuptools) (📥 29M · ⏱️ 16.11.2021):
	```
...
- [GitHub](https://github.com/pyinvoke/invoke) (👨‍💻 56 · 🔀 290 · 📦 9.4K · 📋 700 - 47% open · ⏱️ 16.10.2021):

	```
	git clone https://github.com/pyinvoke/invoke
	```
- [PyPi](https://pypi.org/project/invoke) (📥 2.2M / month · 📦 4.6K · ⏱️ 09.07.2021):
	```
	pip install invoke
	```
- [Conda](https://anaconda.org/conda-forge/invoke) (📥 470K · ⏱️ 10.07.2021):
	```
...
- [PyPi](https://pypi.org/project/buildbot) (📥 56K / month · 📦 890 · ⏱️ 16.10.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/buildbot) (📥 46K · ⏱️ 16.10.2021):
	```
...
- [GitHub](https://github.com/pypa/twine) (👨‍💻 100 · 🔀 250 · 📦 49K · 📋 380 - 9% open · ⏱️ 12.11.2021):
...
- [PyPi](https://pypi.org/project/twine) (📥 2.5M / month · 📦 18K · ⏱️ 10.11.2021):
	...
	pip install twine
	```
- [Conda](https://anaconda.org/conda-forge/twine) (📥 370K · ⏱️ 10.11.2021):
	```
...
- [GitHub](https://github.com/pypa/wheel) (👨‍💻 62 · 🔀 100 · 📋 330 - 9% open · ⏱️ 07.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/wheel) (📥 98M / month · 📦 63K · ⏱️ 09.08.2021):
	```
	pip install wheel
	```
...
- [GitHub](https://github.com/SCons/scons) (👨‍💻 140 · 🔀 250 · 📥 380 · 📋 3.3K - 19% open · ⏱️ 17.11.2021):
...
- [PyPi](https://pypi.org/project/scons) (📥 200K / month · 📦 50 · ⏱️ 17.12.2019):
	...
	pip install scons
	```
- [Conda](https://anaconda.org/conda-forge/scons) (📥 240K · ⏱️ 17.11.2021):
	```
...
- [GitHub](https://github.com/pydoit/doit) (👨‍💻 60 · 🔀 140 · 📦 820 · 📋 260 - 24% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/pydoit/doit
	```
- [PyPi](https://pypi.org/project/doit) (📥 240K / month · 📦 470 · ⏱️ 04.09.2020):
	```
	pip install doit
	```
- [Conda](https://anaconda.org/conda-forge/doit) (📥 69K · ⏱️ 11.10.2020):
	```
...
- [GitHub](https://github.com/takluyver/flit) (👨‍💻 48 · 🔀 82 · 📋 280 - 34% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/takluyver/flit
	```
- [PyPi](https://pypi.org/project/flit) (📥 350K / month · 📦 230 · ⏱️ 10.10.2021):
	```
	pip install flit
	```
- [Conda](https://anaconda.org/conda-forge/flit) (📥 98K · ⏱️ 12.10.2021):
	```
...
- [GitHub](https://github.com/pybuilder/pybuilder) (👨‍💻 36 · 🔀 240 · 📋 500 - 17% open · ⏱️ 08.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pybuilder) (📥 19K / month · 📦 110 · ⏱️ 08.11.2021):
	```
...
- [PyPi](https://pypi.org/project/setuptools_scm) (📥 13M / month · 📦 690 · ⏱️ 09.08.2018):
	...
	```
- [Conda](https://anaconda.org/conda-forge/setuptools_scm) (📥 810K · ⏱️ 11.09.2021):
	```
...
- [GitHub](https://github.com/ml-tooling/universal-build) (👨‍💻 4 · 🔀 5 · 📥 16 · 📦 6 · ⏱️ 17.11.2021):

	```
	git clone https://github.com/ml-tooling/universal-build
	```
- [PyPi](https://pypi.org/project/universal-build) (📥 550 / month · ⏱️ 12.12.2020):
	```
...
<details><summary><b><a href="https://github.com/giampaolo/psutil">psutil</a></b> (🥇37 ·  ⭐ 7.9K) - Cross-platform lib for process and system monitoring in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 170 · 🔀 1.2K · 📦 120K · 📋 1.5K - 13% open · ⏱️ 14.11.2021):

	```
	git clone https://github.com/giampaolo/psutil
	```
- [PyPi](https://pypi.org/project/psutil) (📥 36M / month · 📦 25K · ⏱️ 19.12.2020):
	```
	pip install psutil
	```
...
<details><summary><b><a href="https://github.com/nicolargo/glances">Glances</a></b> (🥇31 ·  ⭐ 19K) - Glances an Eye on your system. A top/htop alternative for.. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/nicolargo/glances) (👨‍💻 150 · 🔀 1.2K · 📥 700 · 📦 350 · 📋 1.4K - 14% open · ⏱️ 14.11.2021):
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 29 · 🔀 280 · 📥 7K · 📋 240 - 30% open · ⏱️ 13.11.2021):

	```
	git clone https://github.com/benfred/py-spy
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 550K / month · 📦 50 · ⏱️ 13.11.2021):
	```
	pip install py-spy
	```
</details>
...
- [GitHub](https://github.com/sumerc/yappi) (👨‍💻 27 · 🔀 50 · 📦 490 · 📋 54 - 29% open · ⏱️ 10.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/yappi) (📥 960K / month · 📦 640 · ⏱️ 05.10.2021):
	```
	pip install yappi
	```
...
- [GitHub](https://github.com/pythonprofilers/memory_profiler) (👨‍💻 90 · 🔀 320 · 📋 210 - 50% open · ⏱️ 06.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 420K / month · 📦 530 · ⏱️ 16.08.2018):
	```
...
- [GitHub](https://github.com/plasma-umass/scalene) (👨‍💻 23 · 🔀 160 · 📦 73 · 📋 150 - 24% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/plasma-umass/scalene
	```
- [PyPi](https://pypi.org/project/scalene) (📥 5K / month · ⏱️ 21.10.2021):
	```
	pip install scalene
	```
</details>
<details><summary><b><a href="https://github.com/joerick/pyinstrument">pyinstrument</a></b> (🥈26 ·  ⭐ 3.6K) - Call stack profiler for Python. Shows you why your code is slow!. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/joerick/pyinstrument) (👨‍💻 36 · 🔀 150 · 📦 420 · 📋 91 - 14% open · ⏱️ 14.11.2021):

	```
	git clone https://github.com/joerick/pyinstrument
	```
- [PyPi](https://pypi.org/project/pyinstrument) (📥 250K / month · 📦 140 · ⏱️ 14.11.2021):
	```
	pip install pyinstrument
	```
- [Conda](https://anaconda.org/conda-forge/pyinstrument) (📥 89K · ⏱️ 15.11.2021):
	```
...
- [GitHub](https://github.com/aristocratos/bpytop) (👨‍💻 30 · 🔀 300 · 📋 270 - 19% open · ⏱️ 18.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/bpytop) (📥 9.5K / month · ⏱️ 07.06.2021):
	```
	pip install bpytop
	```
</details>
...
- [GitHub](https://github.com/nvdv/vprof) (👨‍💻 17 · 🔀 170 · 📦 84 · 📋 81 - 30% open · ⏱️ 20.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/vprof) (📥 3.8K / month · 📦 18 · ⏱️ 29.02.2020):
	```
	pip install vprof
	```
</details>
<details><summary><b><a href="https://github.com/alexmojaki/heartrate">heartrate</a></b> (🥉21 ·  ⭐ 1.3K) - Simple real time visualisation of the execution of a Python program. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/alexmojaki/heartrate) (👨‍💻 3 · 🔀 120 · 📦 26 · 📋 7 - 57% open · ⏱️ 13.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/heartrate) (📥 1.3K / month · ⏱️ 13.11.2021):
	```
	pip install heartrate
	```
</details>
<details><summary><b><a href="https://github.com/csurfer/pyheat">pyheat</a></b> (🥉19 ·  ⭐ 680) - pprofile + matplotlib = Python program profiled as an awesome heatmap!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/csurfer/pyheat) (👨‍💻 5 · 🔀 37 · 📦 32 · 📋 12 - 25% open · ⏱️ 18.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/py-heat) (📥 3.4K / month · 📦 10 · ⏱️ 06.12.2018):
	```
	pip install py-heat
	```
</details>
...
- [GitHub](https://github.com/python/typed_ast) (👨‍💻 23 · 🔀 50 · 📋 84 - 4% open · ⏱️ 12.11.2021):

	```
	git clone https://github.com/python/typed_ast
	```
- [PyPi](https://pypi.org/project/typed_ast) (📥 13M / month · 📦 10K · ⏱️ 12.11.2021):
	```
...
- [GitHub](https://github.com/berkerpeksag/astor) (👨‍💻 31 · 🔀 84 · 📋 110 - 31% open · ⏱️ 27.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/astor) (📥 4.7M / month · 📦 3.8K · ⏱️ 10.12.2019):
	```
	pip install astor
	```
...
- [GitHub](https://github.com/serge-sans-paille/gast) (👨‍💻 10 · 🔀 24 · 📦 70K · 📋 26 - 3% open · ⏱️ 13.11.2021):

	```
	git clone https://github.com/serge-sans-paille/gast
	```
- [PyPi](https://pypi.org/project/gast) (📥 10M / month · 📦 3.4K · ⏱️ 13.11.2021):
	```
	pip install gast
	```
...
- [GitHub](https://github.com/newville/asteval) (👨‍💻 19 · 🔀 32 · 📦 670 · 📋 52 - 11% open · ⏱️ 25.09.2021):
...
- [GitHub](https://github.com/pre-commit/pre-commit) (👨‍💻 130 · 🔀 500 · 📥 19K · 📋 1.3K - 1% open · ⏱️ 01.11.2021):

	```
	git clone https://github.com/pre-commit/pre-commit
	```
- [PyPi](https://pypi.org/project/pre-commit) (📥 4M / month · 📦 2.1K · ⏱️ 03.09.2021):
	```
	pip install pre-commit
	```
- [Conda](https://anaconda.org/conda-forge/pre-commit) (📥 830K · ⏱️ 04.11.2021):
	```
