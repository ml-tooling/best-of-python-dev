...
- [GitHub](https://github.com/python/mypy) (👨‍💻 520 · 🔀 2K · 📦 55K · 📋 7.2K - 28% open · ⏱️ 06.01.2022):

	```
	git clone https://github.com/python/mypy
	```
- [PyPi](https://pypi.org/project/mypy) (📥 7M / month · 📦 6.1K · ⏱️ 22.12.2021):
	```
	pip install mypy
	```
...
- [GitHub](https://github.com/PyCQA/flake8) (👨‍💻 160 · 🔀 180 · 📦 220K · 📋 1.3K - 2% open · ⏱️ 06.01.2022):
...
- [GitHub](https://github.com/davidhalter/parso) (👨‍💻 43 · 🔀 78 · 📦 170K · 📋 100 - 6% open · ⏱️ 30.11.2021):

	```
	git clone https://github.com/davidhalter/parso
	```
- [PyPi](https://pypi.org/project/parso) (📥 16M / month · 📦 11K · ⏱️ 30.11.2021):
	```
	pip install parso
	```
...
- [GitHub](https://github.com/PyCQA/pycodestyle) (👨‍💻 130 · 🔀 610 · 📦 180K · 📋 670 - 16% open · ⏱️ 03.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pycodestyle) (📥 16M / month · 📦 21K · ⏱️ 11.10.2021):
	```
...
<details><summary><b><a href="https://github.com/PyCQA/pylint">pylint</a></b> (🥇31 ·  ⭐ 3.8K) - It's not just a linter that annoys you!. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/PyCQA/pylint) (👨‍💻 440 · 🔀 800 · 📋 3.9K - 19% open · ⏱️ 06.01.2022):

	```
	git clone https://github.com/PyCQA/pylint
	```
- [PyPi](https://pypi.org/project/pylint) (📥 7.9M / month · 📦 38K · ⏱️ 03.12.2021):
	```
	pip install pylint
	```
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 160 · 🔀 310 · 📦 890 · 📋 990 - 7% open · ⏱️ 05.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 91K / month · 📦 14 · ⏱️ 13.12.2021):
	```
...
- [GitHub](https://github.com/PyCQA/pydocstyle) (👨‍💻 77 · 🔀 150 · 📥 56 · 📦 22K · 📋 280 - 28% open · ⏱️ 30.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pydocstyle) (📥 1.6M / month · 📦 3.9K · ⏱️ 17.05.2021):
	```
...
- [GitHub](https://github.com/PyCQA/flake8-bugbear) (👨‍💻 46 · 🔀 55 · 📦 6.2K · 📋 110 - 37% open · ⏱️ 01.01.2022):

	```
	git clone https://github.com/PyCQA/flake8-bugbear
	```
- [PyPi](https://pypi.org/project/flake8-bugbear) (📥 920K / month · 📦 1K · ⏱️ 29.11.2021):
	```
...
<details><summary><b><a href="https://github.com/PyCQA/pylint-django">pylint-django</a></b> (🥈29 ·  ⭐ 490 · 📈) - Pylint plugin for improving code analysis for when.. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code> <code><img src="https://www.pylint.org/ico/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PyCQA/pylint-django) (👨‍💻 62 · 🔀 100 · 📥 200 · 📦 16K · 📋 190 - 17% open · ⏱️ 03.01.2022):

	```
	git clone https://github.com/PyCQA/pylint-django
	```
- [PyPi](https://pypi.org/project/pylint-django) (📥 530K / month · 📦 2.2K · ⏱️ 02.01.2022):
	```
	pip install pylint-django
	```
- [Conda](https://anaconda.org/conda-forge/pylint-django) (📥 89K · ⏱️ 27.09.2021):
	```
...
- [GitHub](https://github.com/klen/pylama) (👨‍💻 45 · 🔀 86 · 📦 3.2K · 📋 120 - 27% open · ⏱️ 15.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pylama) (📥 94K / month · 📦 1K · ⏱️ 15.12.2021):
	```
	pip install pylama
	```
</details>
...
- [GitHub](https://github.com/openstack/hacking) (👨‍💻 180 · 🔀 66 · ⏱️ 07.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/hacking) (📥 480K / month · 📦 8.7K · ⏱️ 21.04.2021):
	```
	pip install hacking
	```
</details>
...
- [GitHub](https://github.com/coala/coala) (👨‍💻 480 · 🔀 1.4K · 📥 150 · 📦 10 · 📋 3.2K - 26% open · ⏱️ 11.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/coala-bears) (📥 4.2K / month · 📦 210 · ⏱️ 10.11.2017):
	```
...
- [GitHub](https://github.com/terrencepreilly/darglint) (👨‍💻 22 · 🔀 34 · 📦 1.5K · 📋 140 - 33% open · ⏱️ 18.10.2021):
...
- [GitHub](https://github.com/gforcada/flake8-isort) (👨‍💻 30 · 🔀 40 · 📦 4.4K · 📋 53 - 24% open · ⏱️ 03.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-isort) (📥 460K / month · 📦 930 · ⏱️ 14.10.2021):
	```
...
- [GitHub](https://github.com/zheller/flake8-quotes) (👨‍💻 30 · 🔀 33 · 📦 4.1K · 📋 43 - 6% open · ⏱️ 19.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-quotes) (📥 420K / month · 📦 1.4K · ⏱️ 15.12.2021):
	```
...
- [GitHub](https://github.com/microsoft/pyright) (👨‍💻 69 · 🔀 400 · 📦 180 · 📋 2.3K - 0% open · ⏱️ 06.01.2022):

	```
	git clone https://github.com/Microsoft/pyright
	```
- [NPM](https://www.npmjs.com/package/pyright) (📥 190K / month · 📦 4 · ⏱️ 05.01.2022):
	```
	npm install pyright
	```
</details>
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 190 · 🔀 380 · 📋 300 - 30% open · ⏱️ 05.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 23K / month · 📦 46 · ⏱️ 22.12.2021):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 71 · 🔀 230 · 📋 470 - 21% open · ⏱️ 05.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytype) (📥 130K / month · 📦 88 · ⏱️ 05.01.2022):
	```
	pip install pytype
	```
- [Conda](https://anaconda.org/conda-forge/pytype) (📥 65K · ⏱️ 06.01.2022):
	```
...
- [GitHub](https://github.com/dropbox/mypy-protobuf) (👨‍💻 31 · 🔀 64 · 📋 97 - 4% open · ⏱️ 04.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/mypy-protobuf) (📥 990K / month · 📦 24 · ⏱️ 24.12.2021):
	```
...
- [GitHub](https://github.com/adamchainz/flake8-comprehensions) (👨‍💻 12 · 🔀 15 · 📋 41 - 17% open · ⏱️ 04.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/flake8-comprehensions) (📥 480K / month · 📦 710 · ⏱️ 11.10.2021):
	```
...
- [GitHub](https://github.com/wemake-services/flake8-eradicate) (👨‍💻 13 · 🔀 7 · 📋 28 - 3% open · ⏱️ 30.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-eradicate) (📥 210K / month · 📦 72 · ⏱️ 19.10.2021):
	```
...
- [GitHub](https://github.com/PyCQA/flake8-commas) (👨‍💻 12 · 🔀 23 · 📋 31 - 16% open · ⏱️ 13.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-commas) (📥 220K / month · 📦 550 · ⏱️ 13.10.2021):
	```
...
- [GitHub](https://github.com/peterjc/flake8-black) (👨‍💻 5 · 🔀 9 · 📦 1.6K · 📋 21 - 33% open · ⏱️ 27.12.2021):
...
- [GitHub](https://github.com/Instagram/Fixit) (👨‍💻 29 · 🔀 41 · 📦 14 · 📋 57 - 56% open · ⏱️ 20.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/fixit) (📥 6.5K / month · ⏱️ 30.07.2021):
	```
	pip install fixit
	```
</details>
...
- [GitHub](https://github.com/deppen8/pandas-vet) (👨‍💻 10 · 🔀 15 · 📥 39 · 📦 55 · 📋 50 - 42% open · ⏱️ 03.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pandas-vet) (📥 4.6K / month · ⏱️ 01.02.2020):
	```
...
- [PyPi](https://pypi.org/project/beartype) (📥 41K / month · ⏱️ 06.11.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/beartype) (📥 9.5K · ⏱️ 06.11.2021):
	```
...
- [GitHub](https://github.com/hchasestevens/bellybutton) (👨‍💻 5 · 🔀 11 · 📦 15 · 📋 14 - 57% open · ⏱️ 15.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/bellybutton) (📥 6.4K / month · ⏱️ 27.11.2020):
	```
...
- [GitHub](https://github.com/psf/black) (👨‍💻 290 · 🔀 1.5K · 📥 19K · 📦 110K · 📋 1.8K - 19% open · ⏱️ 02.01.2022):

	```
	git clone https://github.com/psf/black
	```
- [PyPi](https://pypi.org/project/black) (📥 8.7M / month · 📦 6.2K · ⏱️ 05.12.2021):
	```
	pip install black
	```
...
- [GitHub](https://github.com/hhatto/autopep8) (👨‍💻 51 · 🔀 250 · 📦 100K · 📋 430 - 21% open · ⏱️ 30.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/autopep8) (📥 2.2M / month · 📦 10K · ⏱️ 24.10.2021):
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 250 · 🔀 430 · 📦 210K · 📋 1K - 3% open · ⏱️ 30.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/isort) (📥 14M / month · 📦 24K · ⏱️ 09.11.2021):
	```
	pip install isort
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 130 · 🔀 820 · 📦 27K · 📋 720 - 46% open · ⏱️ 04.01.2022):

	```
	git clone https://github.com/google/yapf
	```
- [PyPi](https://pypi.org/project/yapf) (📥 1.4M / month · 📦 3.4K · ⏱️ 26.12.2021):
	```
	pip install yapf
	```
...
- <b><a href="https://github.com/myint/pyformat">pyformat</a></b> (🥉18 ·  ⭐ 84 · 💀) - Formats Python code to follow a consistent style. <code><a href="https://tldrlegal.com/search?q=Saxpath">❗️Saxpath</a></code>
</details>
<br>
...
- [GitHub](https://github.com/davidhalter/jedi) (👨‍💻 150 · 🔀 460 · 📦 170K · 📋 1.3K - 2% open · ⏱️ 25.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/jedi) (📥 16M / month · 📦 16K · ⏱️ 17.11.2021):
	```
	pip install jedi
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 68 · 🔀 150 · 📦 34K · 📋 230 - 30% open · ⏱️ 20.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/rope) (📥 490K / month · 📦 2.9K · ⏱️ 15.12.2021):
	```
	pip install rope
	```
...
- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 30 · 🔀 93 · 📦 1.3K · 📋 150 - 9% open · ⏱️ 03.01.2022):
...
- [GitHub](https://github.com/asottile/pyupgrade) (👨‍💻 22 · 🔀 91 · 📋 250 - 3% open · ⏱️ 03.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pyupgrade) (📥 140K / month · 📦 10 · ⏱️ 01.01.2022):
	```
...
- [GitHub](https://github.com/PyCQA/baron) (👨‍💻 33 · 🔀 52 · 📦 190 · 📋 75 - 61% open · ⏱️ 09.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/baron) (📥 26K / month · 📦 110 · ⏱️ 09.12.2021):
	```
	pip install baron
	```
</details>
...
- [GitHub](https://github.com/PyCQA/redbaron) (👨‍💻 34 · 🔀 67 · 📦 340 · 📋 130 - 63% open · ⏱️ 09.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/redbaron) (📥 24K / month · 📦 170 · ⏱️ 17.03.2019):
	```
	pip install redbaron
	```
</details>
<details><summary><b><a href="https://github.com/Instagram/MonkeyType">MonkeyType</a></b> (🥉22 ·  ⭐ 3.6K) - A Python library that generates static type annotations by.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 37 · 🔀 130 · 📦 160 · 📋 150 - 24% open · ⏱️ 15.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/monkeytype) (📥 23K / month · 📦 34 · ⏱️ 21.05.2021):
	```
...
- [GitHub](https://github.com/hakancelik96/unimport) (👨‍💻 13 · 🔀 13 · 📦 17 · 📋 76 - 13% open · ⏱️ 04.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/unimport) (📥 3.3K / month · ⏱️ 14.09.2021):
	```
...
- [GitHub](https://github.com/ilevkivskyi/com2ann) (👨‍💻 4 · 🔀 7 · 📦 7 · 📋 20 - 25% open · ⏱️ 21.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/com2ann) (📥 3.1K / month · ⏱️ 21.08.2021):
	```
	pip install com2ann
	```
</details>
...
- [GitHub](https://github.com/PyCQA/bandit) (👨‍💻 140 · 🔀 390 · 📥 130 · 📦 10K · 📋 560 - 33% open · ⏱️ 13.11.2021):
...
- [GitHub](https://github.com/pyupio/safety) (👨‍💻 35 · 🔀 99 · 📥 110K · 📦 3.3K · 📋 120 - 37% open · ⏱️ 28.04.2021):

	```
	git clone https://github.com/pyupio/safety
	```
- [PyPi](https://pypi.org/project/safety) (📥 620K / month · 📦 540 · ⏱️ 15.01.2021):
	```
	pip install safety
	```
...
- [GitHub](https://github.com/Yelp/detect-secrets) (👨‍💻 53 · 🔀 240 · 📋 240 - 35% open · ⏱️ 15.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/detect-secrets) (📥 220K / month · 📦 34 · ⏱️ 14.04.2021):
	```
	pip install detect-secrets
	```
</details>
<details><summary><b><a href="https://github.com/sqlmapproject/sqlmap">sqlmap</a></b> (🥉25 ·  ⭐ 22K) - Automatic SQL injection and database takeover tool. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.6K · 📋 4.5K - 1% open · ⏱️ 03.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 6.9K / month · 📦 8 · ⏱️ 03.01.2022):
	```
	pip install sqlmap
	```
</details>
...
- [GitHub](https://github.com/dlint-py/dlint) (👨‍💻 8 · 🔀 6 · 📋 33 - 57% open · ⏱️ 27.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/dlint) (📥 84K / month · 📦 18 · ⏱️ 27.10.2021):
	```
	pip install dlint
	```
</details>
...
- [GitHub](https://github.com/pypa/pipenv) (👨‍💻 400 · 🔀 1.7K · 📦 24K · 📋 3.6K - 16% open · ⏱️ 06.01.2022):

	```
	git clone https://github.com/pypa/pipenv
	```
- [PyPi](https://pypi.org/project/pipenv) (📥 3.6M / month · 📦 2.3K · ⏱️ 23.11.2021):
	```
	pip install pipenv
	```
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 220 · 🔀 920 · 📋 1.2K - 5% open · ⏱️ 03.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/virtualenv) (📥 20M / month · 📦 34K · ⏱️ 02.01.2022):
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 360 · 🔀 2.3K · 📋 1.4K - 2% open · ⏱️ 05.01.2022):
...
- [GitHub](https://github.com/pypa/pip) (👨‍💻 650 · 🔀 2.4K · 📦 69K · 📋 6.1K - 15% open · ⏱️ 21.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pip) (📥 74M / month · 📦 19K · ⏱️ 22.10.2021):
	```
	pip install pip
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 320 · 🔀 1.4K · 📥 10M · 📋 3.6K - 35% open · ⏱️ 05.01.2022):

	```
	git clone https://github.com/python-poetry/poetry
	```
- [PyPi](https://pypi.org/project/poetry) (📥 3.9M / month · 📦 64 · ⏱️ 28.11.2021):
	```
	pip install poetry
	```
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 160 · 🔀 480 · 📋 800 - 17% open · ⏱️ 12.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 3.3M / month · 📦 3.3K · ⏱️ 12.10.2021):
	```
...
- [GitHub](https://github.com/conda/conda) (👨‍💻 380 · 🔀 1.1K · 📋 8.3K - 22% open · ⏱️ 06.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/conda) (📥 68K / month · 📦 2.1K · ⏱️ 22.04.2017):
	```
	pip install conda
	```
...
- [GitHub](https://github.com/bndr/pipreqs) (👨‍💻 51 · 🔀 260 · 📦 8.3K · 📋 190 - 52% open · ⏱️ 23.10.2021):
...
<details><summary><b><a href="https://github.com/pypa/pipx">pipx</a></b> (🥉23 ·  ⭐ 4.5K) - Install and Run Python Applications in Isolated Environments. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/pypa/pipx) (👨‍💻 71 · 🔀 210 · 📋 450 - 22% open · ⏱️ 04.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pipx) (📥 68K / month · 📦 4 · ⏱️ 04.01.2022):
	```
	pip install pipx
	```
</details>
...
- [GitHub](https://github.com/dephell/dephell) (👨‍💻 37 · 🔀 110 · 📥 170 · 📦 330 · 📋 270 - 40% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/dephell) (📥 4.4K / month · 📦 8 · ⏱️ 28.04.2020):
	```
	pip install dephell
	```
</details>
...
- [GitHub](https://github.com/jaraco/pip-run) (👨‍💻 11 · 🔀 10 · 📋 42 - 7% open · ⏱️ 03.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pip-run) (📥 4.8K / month · ⏱️ 03.01.2022):
	```
	pip install pip-run
	```
</details>
...
- [GitHub](https://github.com/rubik/radon) (👨‍💻 49 · 🔀 97 · 📦 2.2K · 📋 160 - 13% open · ⏱️ 08.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/radon) (📥 220K / month · 📦 1.1K · ⏱️ 15.12.2021):
	```
	pip install radon
	```
...
- [GitHub](https://github.com/tonybaloney/wily) (👨‍💻 16 · 🔀 45 · 📋 80 - 35% open · ⏱️ 01.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/wily) (📥 9.8K / month · 📦 16 · ⏱️ 01.07.2021):
	```
	pip install wily
	```
</details>
...
- [GitHub](https://github.com/rubik/xenon) (👨‍💻 8 · 🔀 16 · 📦 280 · 📋 32 - 21% open · ⏱️ 03.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/xenon) (📥 51K / month · 📦 120 · ⏱️ 03.09.2021):
	```
	pip install xenon
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1.1K · 📥 8.1K · 📦 240K · 📋 870 - 37% open · ⏱️ 20.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/tqdm) (📥 27M / month · 📦 26K · ⏱️ 15.12.2021):
	```
	pip install tqdm
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 120 · 🔀 260 · 📥 4.5K · 📦 17K · 📋 700 - 26% open · ⏱️ 04.01.2022):

	```
	git clone https://github.com/getsentry/sentry-python
	```
- [PyPi](https://pypi.org/project/sentry-sdk) (📥 11M / month · 📦 990 · ⏱️ 13.12.2021):
	```
...
<details><summary><b><a href="https://github.com/madzak/python-json-logger">python-json-logger</a></b> (🥈31 ·  ⭐ 1.2K · 📉) - Json Formatter for the standard python logger. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/astanin/python-tabulate) (👨‍💻 67 · 🔀 85 · 📦 59K · 📋 110 - 45% open · ⏱️ 04.03.2021):
...
- [GitHub](https://github.com/WoLpH/python-progressbar) (👨‍💻 40 · 🔀 100 · 📥 1.6K · 📦 14K · 📋 200 - 5% open · ⏱️ 05.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/progressbar2) (📥 3.4M / month · 📦 2.2K · ⏱️ 05.01.2022):
	```
...
- [GitHub](https://github.com/borntyping/python-colorlog) (👨‍💻 30 · 🔀 76 · 📦 13K · ⏱️ 08.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/colorlog) (📥 4.9M / month · 📦 3.7K · ⏱️ 08.11.2021):
	```
...
- [GitHub](https://github.com/ines/wasabi) (👨‍💻 7 · 🔀 20 · 📦 15K · 📋 6 - 50% open · ⏱️ 06.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/wasabi) (📥 4.7M / month · 📦 410 · ⏱️ 06.12.2021):
	```
	pip install wasabi
	```
...
- [GitHub](https://github.com/shobrook/rebound) (👨‍💻 16 · 🔀 360 · 📥 180 · 📦 22 · 📋 58 - 34% open · ⏱️ 04.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/rebound) (📥 1.3K / month · 📦 14 · ⏱️ 15.12.2021):
	```
	pip install rebound
	```
...
- <b><a href="https://github.com/jazzband/prettytable">prettytable</a></b> (🥉23 ·  ⭐ 640) - Display tabular data in a visually appealing ASCII table.. <code><a href="https://tldrlegal.com/search?q=BSD-1-Clause">❗️BSD-1-Clause</a></code>
...
<details><summary><b><a href="https://github.com/sphinx-doc/sphinx">sphinx</a></b> (🥇38 ·  ⭐ 4.4K) - Main repository for the Sphinx documentation builder. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://www.sphinx-doc.org/en/master/_static/favicon.svg" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/sphinx-doc/sphinx) (👨‍💻 700 · 🔀 1.6K · 📦 170K · 📋 5.8K - 16% open · ⏱️ 03.01.2022):

	```
	git clone https://github.com/sphinx-doc/sphinx
	```
- [PyPi](https://pypi.org/project/sphinx) (📥 3.8M / month · 📦 100K · ⏱️ 19.12.2021):
	```
	pip install sphinx
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs) (👨‍💻 210 · 🔀 1.8K · 📦 17K · 📋 1.6K - 6% open · ⏱️ 30.12.2021):

	```
	git clone https://github.com/mkdocs/mkdocs
	```
- [PyPi](https://pypi.org/project/mkdocs) (📥 650K / month · 📦 5.9K · ⏱️ 15.12.2021):
	```
	pip install mkdocs
	```
...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 140 · 🔀 2K · 📦 10K · 📋 1.3K - 1% open · ⏱️ 06.01.2022):

	```
	git clone https://github.com/squidfunk/mkdocs-material
	```
- [PyPi](https://pypi.org/project/mkdocs-material) (📥 650K / month · 📦 1.5K · ⏱️ 02.01.2022):
	```
	pip install mkdocs-material
	```
- [Conda](https://anaconda.org/conda-forge/mkdocs-material) (📥 78K · ⏱️ 03.01.2022):
	```
...
- [GitHub](https://github.com/readthedocs/sphinx_rtd_theme) (👨‍💻 110 · 🔀 1.6K · 📦 16 · 📋 740 - 26% open · ⏱️ 19.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/sphinx_rtd_theme) (📥 1.7M / month · 📦 23K · ⏱️ 05.10.2018):
	```
...
- [GitHub](https://github.com/bitprophet/alabaster) (👨‍💻 28 · 🔀 180 · 📦 56K · 📋 140 - 60% open · ⏱️ 24.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/alabaster) (📥 3.5M / month · 📦 15K · ⏱️ 03.10.2018):
	```
...
- [GitHub](https://github.com/numpy/numpydoc) (👨‍💻 69 · 🔀 6.3K · 📦 30K · 📋 160 - 36% open · ⏱️ 27.12.2021):

	```
	git clone https://github.com/numpy/numpydoc
	```
- [PyPi](https://pypi.org/project/numpydoc) (📥 220K / month · 📦 7.3K · ⏱️ 01.07.2020):
	```
...
- [GitHub](https://github.com/michaeljones/breathe) (👨‍💻 99 · 🔀 150 · 📥 180 · 📦 5.6K · 📋 480 - 25% open · ⏱️ 28.12.2021):
...
- [GitHub](https://github.com/ryan-roemer/sphinx-bootstrap-theme) (👨‍💻 38 · 🔀 210 · 📋 140 - 40% open · ⏱️ 02.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/sphinx-bootstrap-theme) (📥 250K / month · 📦 980 · ⏱️ 12.09.2021):
	```
...
- [GitHub](https://github.com/econchick/interrogate) (👨‍💻 12 · 🔀 26 · 📦 1.2K · 📋 31 - 25% open · ⏱️ 27.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/interrogate) (📥 73K / month · ⏱️ 10.09.2021):
	```
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 32 · 🔀 120 · 📦 480 · 📋 200 - 4% open · ⏱️ 05.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 92K / month · 📦 290 · ⏱️ 05.01.2022):
	```
	pip install pdoc
	```
</details>
...
- [GitHub](https://github.com/tox-dev/sphinx-autodoc-typehints) (👨‍💻 32 · 🔀 74 · 📋 120 - 40% open · ⏱️ 06.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/sphinx-autodoc-typehints) (📥 310K / month · 📦 1.4K · ⏱️ 06.01.2022):
	```
...
- [GitHub](https://github.com/bitprophet/releases) (👨‍💻 10 · 🔀 36 · 📦 410 · 📋 76 - 43% open · ⏱️ 24.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/releases) (📥 12K / month · 📦 710 · ⏱️ 11.01.2020):
	```
...
- [GitHub](https://github.com/mkdocstrings/mkdocstrings) (👨‍💻 26 · 🔀 58 · 📋 210 - 23% open · ⏱️ 28.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/mkdocstrings) (📥 89K / month · ⏱️ 27.12.2021):
	```
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-pages-plugin) (👨‍💻 3 · 🔀 20 · 📋 46 - 15% open · ⏱️ 27.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/mkdocs-awesome-pages-plugin) (📥 36K / month · 📦 90 · ⏱️ 22.11.2021):
	```
...
- [GitHub](https://github.com/orzih/mkdocs-with-pdf) (👨‍💻 6 · 🔀 21 · 📦 86 · 📋 66 - 43% open · ⏱️ 14.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/mkdocs-with-pdf) (📥 7.7K / month · ⏱️ 03.07.2021):
	```
...
- [GitHub](https://github.com/timothycrosley/portray) (👨‍💻 16 · 🔀 58 · 📋 50 - 42% open · ⏱️ 13.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/portray) (📥 3.6K / month · 📦 8 · ⏱️ 13.06.2021):
	```
	pip install portray
	```
</details>
...
- [GitHub](https://github.com/cool-RR/PySnooper) (👨‍💻 26 · 🔀 920 · 📦 540 · 📋 110 - 15% open · ⏱️ 11.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/pysnooper) (📥 140K / month · 📦 46 · ⏱️ 11.09.2021):
	```
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 81 · 🔀 190 · 📦 2.8K · 📋 290 - 48% open · ⏱️ 01.01.2022):

	```
	git clone https://github.com/inducer/pudb
	```
- [PyPi](https://pypi.org/project/pudb) (📥 150K / month · 📦 1.4K · ⏱️ 01.11.2021):
	```
	pip install pudb
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 80 · 🔀 410 · 📦 2.8K · 📋 170 - 32% open · ⏱️ 15.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 660K / month · 📦 880 · ⏱️ 27.10.2020):
	```
...
- [GitHub](https://github.com/cs01/gdbgui) (👨‍💻 38 · 🔀 480 · 📥 6.5K · 📦 130 · 📋 280 - 41% open · ⏱️ 06.09.2021):
...
- [GitHub](https://github.com/agronholm/typeguard) (👨‍💻 19 · 🔀 69 · 📋 180 - 16% open · ⏱️ 10.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/typeguard) (📥 8.5M / month · 📦 160 · ⏱️ 10.12.2021):
	```
	pip install typeguard
	```
- [Conda](https://anaconda.org/conda-forge/typeguard) (📥 68K · ⏱️ 11.10.2021):
	```
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 36 · 📦 77 · 📋 87 - 42% open · ⏱️ 15.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/hunter) (📥 9.7K / month · 📦 34 · ⏱️ 15.12.2021):
	```
	pip install hunter
	```
</details>
...
- [GitHub](https://github.com/alexmojaki/snoop) (👨‍💻 21 · 🔀 24 · 📋 38 - 47% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/snoop) (📥 17K / month · 📦 8 · ⏱️ 11.11.2021):
	```
	pip install snoop
	```
</details>
...
- [GitHub](https://github.com/ionelmc/python-manhole) (👨‍💻 11 · 🔀 17 · 📦 82 · 📋 21 - 28% open · ⏱️ 15.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/manhole) (📥 23K / month · 📦 66 · ⏱️ 08.04.2021):
	```
	pip install manhole
	```
</details>
...
<details><summary><b><a href="https://github.com/pytest-dev/pytest">pytest</a></b> (🥇36 ·  ⭐ 8.1K · 📈) - The pytest framework makes it easy to write small tests, yet.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pytest-dev/pytest) (👨‍💻 760 · 🔀 1.9K · 📦 420K · 📋 4.8K - 15% open · ⏱️ 04.01.2022):

	```
	git clone https://github.com/pytest-dev/pytest
	```
- [PyPi](https://pypi.org/project/pytest) (📥 29M / month · 📦 130K · ⏱️ 07.12.2021):
	```
	pip install pytest
	```
...
- [GitHub](https://github.com/tox-dev/tox) (👨‍💻 250 · 🔀 390 · 📦 52K · 📋 1.3K - 10% open · ⏱️ 04.01.2022):

	```
	git clone https://github.com/tox-dev/tox
	```
- [PyPi](https://pypi.org/project/tox) (📥 3.4M / month · 📦 36K · ⏱️ 04.01.2022):
	```
	pip install tox
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 150 · 🔀 1.8K · 📥 510 · 📦 4.8K · 📋 3.7K - 5% open · ⏱️ 06.01.2022):

	```
	git clone https://github.com/robotframework/robotframework
	```
- [PyPi](https://pypi.org/project/robotframework) (📥 770K / month · 📦 1.4K · ⏱️ 15.12.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-cov) (👨‍💻 74 · 🔀 160 · 📦 110K · 📋 310 - 34% open · ⏱️ 21.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-cov) (📥 9.3M / month · 📦 43K · ⏱️ 04.10.2021):
	```
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 260 · 🔀 480 · 📦 11K · 📋 1.2K - 4% open · ⏱️ 05.01.2022):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 1.9M / month · 📦 2.6K · ⏱️ 05.01.2022):
	```
	pip install hypothesis
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 5.1M · ⏱️ 05.01.2022):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-xdist) (👨‍💻 77 · 🔀 160 · 📋 460 - 44% open · ⏱️ 04.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytest-xdist) (📥 4.2M / month · 📦 7.3K · ⏱️ 10.12.2021):
	```
...
<details><summary><b><a href="https://github.com/asweigart/pyautogui">pyautogui</a></b> (🥈30 ·  ⭐ 6.1K) - A cross-platform GUI automation Python module for human beings. Used.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 800 · 📦 12K · 📋 540 - 63% open · ⏱️ 14.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyautogui) (📥 450K / month · 📦 610 · ⏱️ 07.07.2021):
	```
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 97 · 🔀 220 · 📋 260 - 34% open · ⏱️ 25.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/freezegun) (📥 2.9M / month · 📦 8.4K · ⏱️ 20.01.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-asyncio) (👨‍💻 28 · 🔀 91 · 📦 19K · 📋 180 - 44% open · ⏱️ 06.01.2022):

	```
	git clone https://github.com/pytest-dev/pytest-asyncio
	```
- [PyPi](https://pypi.org/project/pytest-asyncio) (📥 1.8M / month · 📦 2K · ⏱️ 15.10.2021):
	```
...
<details><summary><b><a href="https://github.com/FactoryBoy/factory_boy">factory_boy</a></b> (🥈29 ·  ⭐ 2.7K) - A test fixtures replacement for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/pytest-dev/pytest-mock) (👨‍💻 54 · 🔀 100 · 📦 22K · 📋 110 - 12% open · ⏱️ 27.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-mock) (📥 4.4M / month · 📦 6.2K · ⏱️ 06.05.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-html) (👨‍💻 43 · 🔀 180 · 📦 15K · 📋 270 - 34% open · ⏱️ 23.01.2021):
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 280 · 📥 190 · 📋 300 - 0% open · ⏱️ 06.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/mimesis) (📥 85K / month · 📦 84 · ⏱️ 11.12.2021):
	```
	pip install mimesis
	```
</details>
...
- [GitHub](https://github.com/pytest-dev/pytest-bdd) (👨‍💻 45 · 🔀 160 · 📋 270 - 49% open · ⏱️ 04.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytest-bdd) (📥 200K / month · 📦 270 · ⏱️ 25.10.2021):
	```
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 71 · 🔀 130 · 📦 4.4K · 📋 260 - 21% open · ⏱️ 03.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/nose2) (📥 380K / month · 📦 1.9K · ⏱️ 27.01.2021):
	```
	pip install nose2
	```
...
- [GitHub](https://github.com/datadriventests/ddt) (👨‍💻 36 · 🔀 100 · 📦 3.9K · 📋 53 - 28% open · ⏱️ 04.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/ddt) (📥 230K / month · 📦 2.5K · ⏱️ 04.10.2021):
	```
	pip install ddt
	```
...
<details><summary><b><a href="https://github.com/microsoft/playwright-python">playwright-python</a></b> (🥉26 ·  ⭐ 5.7K) - Python version of the Playwright testing and automation.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/ionelmc/pytest-benchmark) (👨‍💻 34 · 🔀 92 · 📦 2.5K · 📋 160 - 50% open · ⏱️ 14.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-benchmark) (📥 300K / month · 📦 730 · ⏱️ 17.04.2021):
	```
...
- [GitHub](https://github.com/hamcrest/PyHamcrest) (👨‍💻 37 · 🔀 91 · 📋 69 - 27% open · ⏱️ 27.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyhamcrest) (📥 800K / month · 📦 3.4K · ⏱️ 12.12.2021):
	```
...
- [GitHub](https://github.com/dbader/pytest-mypy) (👨‍💻 15 · 🔀 33 · 📦 1.4K · 📋 47 - 19% open · ⏱️ 16.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-mypy) (📥 500K / month · 📦 270 · ⏱️ 21.03.2021):
	```
...
- [GitHub](https://github.com/CleanCut/green) (👨‍💻 37 · 🔀 75 · 📦 630 · 📋 170 - 3% open · ⏱️ 16.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/green) (📥 12K / month · 📦 360 · ⏱️ 16.07.2021):
	```
	pip install green
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-randomly) (👨‍💻 16 · 🔀 22 · 📋 48 - 12% open · ⏱️ 04.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytest-randomly) (📥 330K / month · 📦 210 · ⏱️ 30.11.2021):
	```
...
- [GitHub](https://github.com/tarpas/pytest-testmon) (👨‍💻 16 · 🔀 29 · 📋 120 - 24% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-testmon) (📥 89K / month · 📦 98 · ⏱️ 22.10.2021):
	```
...
- [GitHub](https://github.com/TvoroG/pytest-lazy-fixture) (👨‍💻 8 · 🔀 15 · 📦 510 · 📋 35 - 42% open · ⏱️ 17.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-lazy-fixture) (📥 220K / month · 📦 62 · ⏱️ 01.02.2020):
	```
...
<details><summary><b><a href="https://github.com/Nuitka/Nuitka">Nuitka</a></b> (🥇28 ·  ⭐ 6.3K) - Nuitka is a Python compiler written in Python. It's fully compatible.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Nuitka/Nuitka) (👨‍💻 110 · 🔀 350 · 📋 1.1K - 16% open · ⏱️ 05.01.2022):

	```
	git clone https://github.com/Nuitka/Nuitka
	```
- [PyPi](https://pypi.org/project/nuitka) (📥 22K / month · 📦 54 · ⏱️ 30.12.2021):
	```
	pip install nuitka
	```
- [Conda](https://anaconda.org/conda-forge/nuitka) (📥 330K · ⏱️ 31.12.2021):
	```
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 420 · 🔀 1.7K · 📥 720K · 📋 4.4K - 7% open · ⏱️ 05.01.2022):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 580K / month · ⏱️ 10.11.2021):
	```
	pip install pyinstaller
	```
- [Conda](https://anaconda.org/conda-forge/pyinstaller) (📥 290K · ⏱️ 13.11.2021):
	```
...
- [GitHub](https://github.com/pantsbuild/pex) (👨‍💻 100 · 🔀 210 · 📥 550K · 📋 780 - 18% open · ⏱️ 23.12.2021):

	```
	git clone https://github.com/pantsbuild/pex
	```
- [PyPi](https://pypi.org/project/pex) (📥 150K / month · 📦 230 · ⏱️ 23.12.2021):
	```
	pip install pex
	```
</details>
...
- [GitHub](https://github.com/py2exe/py2exe) (👨‍💻 14 · 🔀 44 · 📥 7.1K · 📦 1.4K · 📋 95 - 5% open · ⏱️ 16.11.2021):

	```
	git clone https://github.com/py2exe/py2exe
	```
- [PyPi](https://pypi.org/project/py2exe) (📥 21K / month · 📦 350 · ⏱️ 15.12.2021):
	```
	pip install py2exe
	```
</details>
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 34 · 🔀 75 · 📥 160 · 📋 100 - 32% open · ⏱️ 18.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/shiv) (📥 5K / month · 📦 10 · ⏱️ 18.11.2021):
	```
	pip install shiv
	```
</details>
...
- [GitHub](https://github.com/indygreg/PyOxidizer) (👨‍💻 37 · 🔀 140 · 📥 1.4K · 📋 420 - 60% open · ⏱️ 03.01.2022):
...
- [GitHub](https://github.com/pypa/setuptools) (👨‍💻 470 · 🔀 810 · 📥 110 · 📦 130K · 📋 1.9K - 25% open · ⏱️ 06.01.2022):

	```
	git clone https://github.com/pypa/setuptools
	```
- [PyPi](https://pypi.org/project/setuptools) (📥 190M / month · 📦 58K · ⏱️ 06.01.2022):
	```
	pip install setuptools
	```
- [Conda](https://anaconda.org/conda-forge/setuptools) (📥 31M · ⏱️ 30.12.2021):
	```
...
- [GitHub](https://github.com/buildbot/buildbot) (👨‍💻 800 · 🔀 1.6K · 📥 19K · 📦 260 · 📋 1.4K - 45% open · ⏱️ 05.01.2022):
...
<details><summary><b><a href="https://github.com/pyinvoke/invoke">invoke</a></b> (🥇31 ·  ⭐ 3.5K · 📉) - Pythonic task management & command execution. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/pyinvoke/invoke) (👨‍💻 56 · 🔀 300 · 📦 9.9K · 📋 700 - 48% open · ⏱️ 16.10.2021):
...
- [GitHub](https://github.com/pypa/twine) (👨‍💻 100 · 🔀 250 · 📦 52K · 📋 390 - 8% open · ⏱️ 31.12.2021):

	```
	git clone https://github.com/pypa/twine
	```
- [PyPi](https://pypi.org/project/twine) (📥 2.2M / month · 📦 18K · ⏱️ 07.12.2021):
	```
	pip install twine
	```
...
- [GitHub](https://github.com/pydoit/doit) (👨‍💻 62 · 🔀 140 · 📦 840 · 📋 260 - 23% open · ⏱️ 21.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/doit) (📥 160K / month · 📦 470 · ⏱️ 11.12.2021):
	```
	pip install doit
	```
...
- [GitHub](https://github.com/SCons/scons) (👨‍💻 140 · 🔀 250 · 📥 380 · 📋 3.3K - 19% open · ⏱️ 02.01.2022):
...
- [GitHub](https://github.com/pypa/flit) (👨‍💻 50 · 🔀 87 · 📋 280 - 29% open · ⏱️ 03.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/flit) (📥 330K / month · 📦 230 · ⏱️ 27.12.2021):
	```
	pip install flit
	```
...
- <b><a href="https://github.com/buildout/buildout">buildout</a></b> (🥉28 ·  ⭐ 530) - Buildout is a deployment automation tool written in and extended.. <code><a href="https://tldrlegal.com/search?q=ZPL-2.1">❗️ZPL-2.1</a></code>
...
- [PyPi](https://pypi.org/project/psutil) (📥 33M / month · 📦 25K · ⏱️ 29.12.2021):
	...
	pip install psutil
	```
- [Conda](https://anaconda.org/conda-forge/psutil) (📥 9.5M · ⏱️ 30.12.2021):
	```
...
- [GitHub](https://github.com/nicolargo/glances) (👨‍💻 150 · 🔀 1.3K · 📥 710 · 📦 360 · 📋 1.4K - 14% open · ⏱️ 02.01.2022):
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 29 · 🔀 280 · 📥 7.3K · 📋 240 - 29% open · ⏱️ 04.01.2022):

	```
	git clone https://github.com/benfred/py-spy
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 490K / month · 📦 50 · ⏱️ 13.11.2021):
	```
	pip install py-spy
	```
</details>
...
- [GitHub](https://github.com/sumerc/yappi) (👨‍💻 27 · 🔀 53 · 📦 510 · 📋 55 - 30% open · ⏱️ 08.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/yappi) (📥 1.1M / month · 📦 640 · ⏱️ 15.12.2021):
	```
	pip install yappi
	```
...
- [GitHub](https://github.com/python-diamond/Diamond) (👨‍💻 360 · 🔀 590 · 📦 69 · 📋 360 - 63% open · ⏱️ 31.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/diamond) (📥 48K / month · 📦 62 · ⏱️ 25.11.2016):
	```
	pip install diamond
	```
</details>
...
- [GitHub](https://github.com/pympler/pympler) (👨‍💻 29 · 🔀 75 · 📋 90 - 44% open · ⏱️ 29.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pympler) (📥 950K / month · 📦 480 · ⏱️ 22.12.2021):
	```
	pip install pympler
	```
...
<details><summary><b><a href="https://github.com/joerick/pyinstrument">pyinstrument</a></b> (🥉26 ·  ⭐ 4K) - Call stack profiler for Python. Shows you why your code is slow!. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/joerick/pyinstrument) (👨‍💻 38 · 🔀 160 · 📦 470 · 📋 94 - 15% open · ⏱️ 17.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyinstrument) (📥 210K / month · 📦 140 · ⏱️ 14.11.2021):
	```
...
- [GitHub](https://github.com/pyutils/line_profiler) (👨‍💻 27 · 🔀 250 · 📋 51 - 56% open · ⏱️ 06.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/line_profiler) (📥 110K / month · 📦 690 · ⏱️ 20.12.2017):
	```
...
- [GitHub](https://github.com/aristocratos/bpytop) (👨‍💻 35 · 🔀 320 · 📋 280 - 20% open · ⏱️ 22.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/bpytop) (📥 9.9K / month · ⏱️ 22.12.2021):
	```
	pip install bpytop
	```
</details>
...
- [GitHub](https://github.com/csurfer/pyheat) (👨‍💻 5 · 🔀 38 · 📦 33 · 📋 13 - 30% open · ⏱️ 18.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/py-heat) (📥 1.7K / month · 📦 10 · ⏱️ 06.12.2018):
	```
	pip install py-heat
	```
</details>
...
- [GitHub](https://github.com/python/typed_ast) (👨‍💻 24 · 🔀 51 · 📋 89 - 6% open · ⏱️ 01.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/typed_ast) (📥 11M / month · 📦 10K · ⏱️ 03.12.2021):
	```
...
- [GitHub](https://github.com/serge-sans-paille/gast) (👨‍💻 10 · 🔀 25 · 📦 74K · 📋 26 - 3% open · ⏱️ 13.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/gast) (📥 11M / month · 📦 3.4K · ⏱️ 13.11.2021):
	```
	pip install gast
	```
...
- [GitHub](https://github.com/berkerpeksag/astor) (👨‍💻 31 · 🔀 84 · 📋 110 - 31% open · ⏱️ 27.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/astor) (📥 4.9M / month · 📦 3.8K · ⏱️ 10.12.2019):
	```
	pip install astor
	```
...
- [GitHub](https://github.com/newville/asteval) (👨‍💻 19 · 🔀 32 · 📦 710 · 📋 53 - 13% open · ⏱️ 06.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/asteval) (📥 120K / month · 📦 240 · ⏱️ 22.06.2021):
	```
	pip install asteval
	```
...
<details><summary><b><a href="https://github.com/pre-commit/pre-commit">pre-commit</a></b> (🥇31 ·  ⭐ 7.2K · 📉) - A framework for managing and maintaining multi-language pre-.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pre-commit/pre-commit) (👨‍💻 130 · 🔀 520 · 📥 24K · 📋 1.3K - 1% open · ⏱️ 06.01.2022):

	```
	git clone https://github.com/pre-commit/pre-commit
	```
- [PyPi](https://pypi.org/project/pre-commit) (📥 3.2M / month · 📦 2.1K · ⏱️ 30.11.2021):
	```
