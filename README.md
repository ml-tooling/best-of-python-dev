...
- [GitHub](https://github.com/python/mypy) (👨‍💻 480 · 🔀 1.8K · 📦 39K · 📋 6.6K - 28% open · ⏱️ 22.07.2021):

	```
	git clone https://github.com/python/mypy
	```
- [PyPi](https://pypi.org/project/mypy) (📥 6.7M / month · 📦 6.1K · ⏱️ 22.06.2021):
	```
	pip install mypy
	```
...
- [GitHub](https://github.com/PyCQA/flake8) (👨‍💻 160 · 🔀 180 · 📦 180K · 📋 1.3K - 2% open · ⏱️ 19.07.2021):
...
- [GitHub](https://github.com/PyCQA/pyflakes) (👨‍💻 77 · 🔀 150 · 📦 94K · 📋 430 - 19% open · ⏱️ 28.05.2021):
...
- [PyPi](https://pypi.org/project/pyflakes) (📥 12M / month · 📦 26K · ⏱️ 24.03.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyflakes) (📥 2.7M · ⏱️ 24.03.2021):
	```
...
- [GitHub](https://github.com/davidhalter/parso) (👨‍💻 40 · 🔀 68 · 📦 140K · 📋 100 - 8% open · ⏱️ 30.05.2021):
...
- [GitHub](https://github.com/PyCQA/pylint) (👨‍💻 400 · 🔀 730 · 📋 3.5K - 20% open · ⏱️ 21.07.2021):

	```
	git clone https://github.com/PyCQA/pylint
	```
- [PyPi](https://pypi.org/project/pylint) (📥 14M / month · 📦 38K · ⏱️ 21.07.2021):
	```
	pip install pylint
	```
- [Conda](https://anaconda.org/conda-forge/pylint) (📥 2M · ⏱️ 21.07.2021):
	```
...
- [PyPi](https://pypi.org/project/pydocstyle) (📥 2M / month · 📦 3.9K · ⏱️ 17.05.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pydocstyle) (📥 390K · ⏱️ 18.05.2021):
	```
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 170 · 🔀 320 · 📋 260 - 24% open · ⏱️ 22.07.2021):
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 140 · 🔀 280 · 📦 490 · 📋 960 - 8% open · ⏱️ 22.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 80K / month · 📦 14 · ⏱️ 21.06.2021):
	```
...
- [GitHub](https://github.com/PyCQA/flake8-bugbear) (👨‍💻 37 · 🔀 42 · 📦 4.2K · 📋 93 - 43% open · ⏱️ 01.04.2021):
...
- [PyPi](https://pypi.org/project/flake8-bugbear) (📥 810K / month · 📦 1K · ⏱️ 01.04.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flake8-bugbear) (📥 350K · ⏱️ 02.04.2021):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 63 · 🔀 200 · 📋 420 - 21% open · ⏱️ 21.07.2021):

	```
	git clone https://github.com/google/pytype
	```
- [PyPi](https://pypi.org/project/pytype) (📥 110K / month · 📦 88 · ⏱️ 19.07.2021):
	```
	pip install pytype
	```
...
- [GitHub](https://github.com/coala/coala) (👨‍💻 480 · 🔀 1.4K · 📥 140 · 📦 10 · 📋 3.2K - 26% open · ⏱️ 11.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/coala-bears) (📥 4.5K / month · 📦 210 · ⏱️ 10.11.2017):
	```
...
- [GitHub](https://github.com/PyCQA/pylint-django) (👨‍💻 58 · 🔀 100 · 📥 200 · 📦 14K · 📋 180 - 15% open · ⏱️ 26.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/pylint-django) (📥 580K / month · 📦 2.2K · ⏱️ 09.04.2021):
	```
	pip install pylint-django
	```
- [Conda](https://anaconda.org/conda-forge/pylint-django) (📥 82K · ⏱️ 12.01.2021):
	```
...
- [GitHub](https://github.com/terrencepreilly/darglint) (👨‍💻 21 · 🔀 26 · 📦 630 · 📋 130 - 28% open · ⏱️ 04.04.2021):
...
- [GitHub](https://github.com/microsoft/pyright) (👨‍💻 57 · 🔀 350 · 📦 96 · 📋 1.7K - 0% open · ⏱️ 22.07.2021):

	```
	git clone https://github.com/Microsoft/pyright
	```
- [NPM](https://www.npmjs.com/package/pyright) (📥 90K / month · 📦 4 · ⏱️ 16.07.2021):
	```
	npm install pyright
	```
</details>
<details><summary><b><a href="https://github.com/dropbox/mypy-protobuf">mypy-protobuf</a></b> (🥈25 ·  ⭐ 370) - open source tools to generate mypy stubs from protobufs. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/dropbox/mypy-protobuf) (👨‍💻 27 · 🔀 57 · 📦 260 · 📋 83 - 14% open · ⏱️ 22.07.2021):

	```
	git clone https://github.com/dropbox/mypy-protobuf
	```
- [PyPi](https://pypi.org/project/mypy-protobuf) (📥 500K / month · 📦 24 · ⏱️ 20.07.2021):
	```
...
- [GitHub](https://github.com/PyCQA/flake8-import-order) (👨‍💻 40 · 🔀 61 · 📋 96 - 11% open · ⏱️ 04.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/flake8-import-order) (📥 310K / month · 📦 1.9K · ⏱️ 04.03.2019):
	```
...
- [GitHub](https://github.com/adamchainz/flake8-comprehensions) (👨‍💻 10 · 🔀 13 · 📋 37 - 18% open · ⏱️ 20.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-comprehensions) (📥 510K / month · 📦 710 · ⏱️ 10.05.2021):
	```
...
- [GitHub](https://github.com/gforcada/flake8-builtins) (👨‍💻 14 · 🔀 16 · 📦 2.3K · 📋 33 - 6% open · ⏱️ 14.04.2021):

	```
	git clone https://github.com/gforcada/flake8-builtins
	```
- [PyPi](https://pypi.org/project/flake8-builtins) (📥 330K / month · 📦 510 · ⏱️ 14.05.2020):
	```
...
<details><summary><b><a href="https://github.com/Instagram/Fixit">Fixit</a></b> (🥉20 ·  ⭐ 250) - Fixit is a Python Lint Framework based on LibCST. It comes with useful.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/Instagram/Fixit) (👨‍💻 25 · 🔀 37 · 📦 7 · 📋 59 - 57% open · ⏱️ 02.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/fixit) (📥 1.3K / month · ⏱️ 11.12.2020):
	```
	pip install fixit
	```
</details>
...
- [GitHub](https://github.com/andreoliwa/nitpick) (👨‍💻 10 · 🔀 10 · 📥 3 · 📋 88 - 37% open · ⏱️ 20.07.2021):

	```
	git clone https://github.com/andreoliwa/nitpick
	```
- [PyPi](https://pypi.org/project/nitpick) (📥 7.8K / month · ⏱️ 20.07.2021):
	```
	pip install nitpick
	```
</details>
...
- [GitHub](https://github.com/deppen8/pandas-vet) (👨‍💻 10 · 🔀 14 · 📥 38 · 📦 47 · 📋 49 - 42% open · ⏱️ 03.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pandas-vet) (📥 5K / month · ⏱️ 01.02.2020):
	```
...
- [GitHub](https://github.com/beartype/beartype) (👨‍💻 6 · 🔀 8 · 📋 29 - 10% open · ⏱️ 20.07.2021):

	```
	git clone https://github.com/beartype/beartype
	```
- [PyPi](https://pypi.org/project/beartype) (📥 8.4K / month · ⏱️ 30.06.2021):
	```
	pip install beartype
	```
- [Conda](https://anaconda.org/conda-forge/beartype) (📥 5.1K · ⏱️ 30.06.2021):
	```
...
- [GitHub](https://github.com/lyft/linty_fresh) (👨‍💻 17 · 🔀 21 · 📋 9 - 88% open · ⏱️ 30.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/linty-fresh) (📥 50 / month · ⏱️ 12.12.2018):
	```
...
- [GitHub](https://github.com/hhatto/autopep8) (👨‍💻 50 · 🔀 240 · 📦 83K · 📋 420 - 20% open · ⏱️ 30.04.2021):
...
- [PyPi](https://pypi.org/project/autopep8) (📥 2M / month · 📦 10K · ⏱️ 30.04.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/autopep8) (📥 490K · ⏱️ 30.04.2021):
	```
...
- [GitHub](https://github.com/psf/black) (👨‍💻 260 · 🔀 1.4K · 📥 15K · 📦 70K · 📋 1.6K - 18% open · ⏱️ 22.07.2021):
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 240 · 🔀 410 · 📦 180K · 📋 980 - 2% open · ⏱️ 21.07.2021):

	```
	git clone https://github.com/PyCQA/isort
	```
- [PyPi](https://pypi.org/project/isort) (📥 19M / month · 📦 24K · ⏱️ 08.07.2021):
	```
	pip install isort
	```
...
- [GitHub](https://github.com/myint/docformatter) (👨‍💻 15 · 🔀 31 · 📦 660 · 📋 49 - 55% open · ⏱️ 27.12.2020):

	```
	git clone https://github.com/myint/docformatter
	```
- [PyPi](https://pypi.org/project/docformatter) (📥 66K / month · 📦 110 · ⏱️ 27.12.2020):
	```
...
- [PyPi](https://pypi.org/project/jedi) (📥 14M / month · 📦 16K · ⏱️ 25.12.2020):
	...
	pip install jedi
	```
- [Conda](https://anaconda.org/conda-forge/jedi) (📥 5.5M · ⏱️ 29.06.2021):
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 63 · 🔀 140 · 📦 30K · 📋 190 - 37% open · ⏱️ 20.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/rope) (📥 430K / month · 📦 2.9K · ⏱️ 07.10.2020):
	```
	pip install rope
	```
...
- [GitHub](https://github.com/myint/autoflake) (👨‍💻 17 · 🔀 46 · 📦 2.5K · 📋 66 - 50% open · ⏱️ 27.12.2020):

	```
	git clone https://github.com/myint/autoflake
	```
- [PyPi](https://pypi.org/project/autoflake) (📥 610K / month · 📦 580 · ⏱️ 04.08.2019):
	```
	pip install autoflake
	```
- [Conda](https://anaconda.org/conda-forge/autoflake) (📥 140K · ⏱️ 26.05.2021):
	```
...
- [GitHub](https://github.com/asottile/pyupgrade) (👨‍💻 19 · 🔀 71 · 📋 200 - 7% open · ⏱️ 16.07.2021):

	```
	git clone https://github.com/asottile/pyupgrade
	```
- [PyPi](https://pypi.org/project/pyupgrade) (📥 150K / month · 📦 10 · ⏱️ 16.07.2021):
	```
	pip install pyupgrade
	```
- [Conda](https://anaconda.org/conda-forge/pyupgrade) (📥 230K · ⏱️ 16.07.2021):
	```
...
- [GitHub](https://github.com/asottile/add-trailing-comma) (👨‍💻 9 · 🔀 14 · 📋 35 - 2% open · ⏱️ 19.07.2021):

	```
	git clone https://github.com/asottile/add-trailing-comma
	```
- [PyPi](https://pypi.org/project/add-trailing-comma) (📥 6.1K / month · 📦 14 · ⏱️ 24.01.2021):
	```
...
- [GitHub](https://github.com/ambv/retype) (👨‍💻 8 · 🔀 16 · 📋 15 - 60% open · ⏱️ 15.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/retype) (📥 1.2K / month · 📦 34 · ⏱️ 15.05.2021):
	```
	pip install retype
	```
...
- [GitHub](https://github.com/elmotec/massedit) (👨‍💻 6 · 🔀 14 · 📥 17 · 📋 8 - 37% open · ⏱️ 23.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/massedit) (📥 780 / month · 📦 10 · ⏱️ 23.12.2020):
	```
...
- [GitHub](https://github.com/ilevkivskyi/com2ann) (👨‍💻 3 · 🔀 5 · 📦 3 · 📋 18 - 22% open · ⏱️ 07.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/com2ann) (📥 490 / month · ⏱️ 17.06.2019):
	```
	pip install com2ann
	```
</details>
...
- [GitHub](https://github.com/PyCQA/bandit) (👨‍💻 130 · 🔀 330 · 📥 55 · 📦 7.4K · 📋 530 - 31% open · ⏱️ 29.06.2021):
...
- [PyPi](https://pypi.org/project/bandit) (📥 1.7M / month · 📦 2.4K · ⏱️ 13.12.2020):
	...
	pip install bandit
	```
- [Conda](https://anaconda.org/conda-forge/bandit) (📥 79K · ⏱️ 10.03.2021):
	```
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.4K · 📋 4.4K - 1% open · ⏱️ 19.07.2021):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 22K / month · 📦 8 · ⏱️ 04.07.2021):
	```
	pip install sqlmap
	```
</details>
...
- [GitHub](https://github.com/pyupio/safety) (👨‍💻 35 · 🔀 89 · 📥 61K · 📦 2.2K · 📋 110 - 39% open · ⏱️ 28.04.2021):
...
- [GitHub](https://github.com/dlint-py/dlint) (👨‍💻 7 · 🔀 13 · 📋 32 - 62% open · ⏱️ 08.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/dlint) (📥 28K / month · 📦 18 · ⏱️ 30.10.2020):
	```
	pip install dlint
	```
</details>
...
- [GitHub](https://github.com/pypa/pipenv) (👨‍💻 380 · 🔀 1.6K · 📦 20K · 📋 3.4K - 16% open · ⏱️ 09.07.2021):
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 170 · 🔀 900 · 📋 1.1K - 5% open · ⏱️ 20.07.2021):
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 330 · 🔀 2.1K · 📋 1.3K - 2% open · ⏱️ 20.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyenv) (📥 6.3K / month · 📦 1 · ⏱️ 12.01.2019):
	```
	pip install pyenv
	```
</details>
...
- [GitHub](https://github.com/pyenv/pyenv-virtualenv) (👨‍💻 44 · 🔀 300 · 📋 310 - 43% open · ⏱️ 17.06.2021):
...
- [GitHub](https://github.com/pypa/pip) (👨‍💻 620 · 🔀 2.4K · 📦 55K · 📋 5.9K - 16% open · ⏱️ 22.07.2021):

	```
	git clone https://github.com/pypa/pip
	```
- [PyPi](https://pypi.org/project/pip) (📥 91M / month · 📦 19K · ⏱️ 26.06.2021):
	```
	pip install pip
	```
- [Conda](https://anaconda.org/conda-forge/pip) (📥 22M · ⏱️ 26.06.2021):
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 280 · 🔀 1.3K · 📥 7.4M · 📋 3.1K - 37% open · ⏱️ 11.07.2021):

	```
	git clone https://github.com/python-poetry/poetry
	```
- [PyPi](https://pypi.org/project/poetry) (📥 2.8M / month · 📦 64 · ⏱️ 25.06.2021):
	```
	pip install poetry
	```
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 150 · 🔀 450 · 📋 750 - 16% open · ⏱️ 17.07.2021):

	```
	git clone https://github.com/jazzband/pip-tools
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 3.1M / month · 📦 3.3K · ⏱️ 22.06.2021):
	```
...
- [GitHub](https://github.com/bndr/pipreqs) (👨‍💻 50 · 🔀 230 · 📦 6K · 📋 170 - 48% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/pypa/pipx) (👨‍💻 57 · 🔀 160 · 📋 400 - 18% open · ⏱️ 16.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pipx) (📥 79K / month · 📦 4 · ⏱️ 28.05.2021):
	```
	pip install pipx
	```
</details>
...
- [GitHub](https://github.com/mamba-org/mamba) (👨‍💻 53 · 🔀 100 · 📦 340 · 📋 530 - 28% open · ⏱️ 16.07.2021):

	```
	git clone https://github.com/mamba-org/mamba
	```
- [Conda](https://anaconda.org/conda-forge/mamba) (📥 1M · ⏱️ 16.07.2021):
	```
...
- [GitHub](https://github.com/jaraco/pip-run) (👨‍💻 10 · 🔀 10 · 📋 39 - 5% open · ⏱️ 19.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/pip-run) (📥 7.1K / month · ⏱️ 19.07.2021):
	```
	pip install pip-run
	```
</details>
...
- [GitHub](https://github.com/PyCQA/mccabe) (👨‍💻 21 · 🔀 40 · 📦 210K · 📋 41 - 17% open · ⏱️ 02.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/mccabe) (📥 22M / month · 📦 31K · ⏱️ 26.01.2017):
	```
	pip install mccabe
	```
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 67 · 🔀 130 · 📦 2.3K · 📋 270 - 20% open · ⏱️ 21.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/prospector) (📥 410K / month · 📦 1.1K · ⏱️ 21.10.2020):
	```
...
- [GitHub](https://github.com/rubik/xenon) (👨‍💻 7 · 🔀 14 · 📦 220 · 📋 30 - 20% open · ⏱️ 26.05.2021):
...
<details><summary><b><a href="https://github.com/tonybaloney/wily">wily</a></b> (🥉21 ·  ⭐ 780) - A Python application for tracking, reporting on timing and complexity in.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/tonybaloney/wily) (👨‍💻 16 · 🔀 45 · 📋 80 - 35% open · ⏱️ 01.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/wily) (📥 9.2K / month · 📦 16 · ⏱️ 01.07.2021):
	```
	pip install wily
	```
</details>
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 100 · 🔀 960 · 📥 8K · 📦 190K · 📋 810 - 35% open · ⏱️ 06.07.2021):
...
- [Conda](https://anaconda.org/conda-forge/tqdm) (📥 6.9M · ⏱️ 07.07.2021):
	...
	```
- [Docker Hub](https://hub.docker.com/r/tqdm/tqdm) (📥 3.7K · ⭐ 1 · ⏱️ 17.07.2021):
	```
...
<details><summary><b><a href="https://github.com/getsentry/sentry-python">sentry-sdk</a></b> (🥇32 ·  ⭐ 960) - The new Python SDK for Sentry.io. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 99 · 🔀 210 · 📥 4.5K · 📦 13K · 📋 540 - 30% open · ⏱️ 21.07.2021):

	```
	git clone https://github.com/getsentry/sentry-python
	```
- [PyPi](https://pypi.org/project/sentry-sdk) (📥 9.6M / month · 📦 990 · ⏱️ 08.07.2021):
	```
...
- [GitHub](https://github.com/astanin/python-tabulate) (👨‍💻 67 · 🔀 68 · 📦 48K · 📋 88 - 35% open · ⏱️ 04.03.2021):
...
- [GitHub](https://github.com/hynek/structlog) (👨‍💻 73 · 🔀 140 · 📦 3.4K · 📋 190 - 17% open · ⏱️ 20.07.2021):
...
- [GitHub](https://github.com/madzak/python-json-logger) (👨‍💻 43 · 🔀 150 · 📦 16K · 📋 64 - 29% open · ⏱️ 12.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/python-json-logger) (📥 3.4M / month · 📦 920 · ⏱️ 12.10.2020):
	```
	pip install python-json-logger
	```
- [Conda](https://anaconda.org/conda-forge/python-json-logger) (📥 750K · ⏱️ 12.10.2020):
	```
...
- [GitHub](https://github.com/borntyping/python-colorlog) (👨‍💻 30 · 🔀 75 · 📦 11K · 📋 66 - 3% open · ⏱️ 14.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/colorlog) (📥 5.4M / month · 📦 3.7K · ⏱️ 14.06.2021):
	```
	pip install colorlog
	```
- [Conda](https://anaconda.org/conda-forge/colorlog) (📥 390K · ⏱️ 30.06.2021):
	```
...
- [GitHub](https://github.com/xolox/python-coloredlogs) (👨‍💻 16 · 🔀 36 · 📦 8.3K · 📋 74 - 33% open · ⏱️ 11.06.2021):
...
- [GitHub](https://github.com/WoLpH/python-progressbar) (👨‍💻 38 · 🔀 92 · 📥 1.6K · 📦 10K · 📋 190 - 4% open · ⏱️ 15.03.2021):
...
- [GitHub](https://github.com/ines/wasabi) (👨‍💻 4 · 🔀 17 · 📦 12K · 📋 6 - 50% open · ⏱️ 31.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/wasabi) (📥 2.4M / month · 📦 410 · ⏱️ 31.01.2021):
	```
	pip install wasabi
	```
...
- [GitHub](https://github.com/shobrook/rebound) (👨‍💻 16 · 🔀 340 · 📥 170 · 📦 20 · 📋 58 - 34% open · ⏱️ 04.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/rebound) (📥 2.9K / month · 📦 14 · ⏱️ 22.07.2021):
	```
	pip install rebound
	```
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 1 · 🔀 100 · 📦 350 · 📋 71 - 29% open · ⏱️ 08.01.2021):

	```
	git clone https://github.com/rsalmei/alive-progress
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 20K / month · ⏱️ 08.01.2021):
	```
...
- [GitHub](https://github.com/cknd/stackprinter) (👨‍💻 6 · 🔀 32 · 📦 64 · 📋 24 - 37% open · ⏱️ 01.01.2021):

	```
	git clone https://github.com/cknd/stackprinter
	```
- [PyPi](https://pypi.org/project/stackprinter) (📥 21K / month · 📦 4 · ⏱️ 31.10.2020):
	```
...
- [GitHub](https://github.com/onelivesleft/PrettyErrors) (👨‍💻 5 · 🔀 65 · 📋 30 - 3% open · ⏱️ 02.07.2021):
...
<details><summary><b><a href="https://github.com/samuelcolvin/python-devtools">python-devtools</a></b> (🥉19 ·  ⭐ 360) - Dev tools for python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/samuelcolvin/python-devtools) (👨‍💻 5 · 🔀 12 · 📦 380 · 📋 34 - 35% open · ⏱️ 30.03.2021):
...
- <b><a href="https://github.com/jazzband/prettytable">prettytable</a></b> (🥉23 ·  ⭐ 510) - Display tabular data in a visually appealing ASCII table.. <code><a href="https://tldrlegal.com/search?q=BSD-1-Clause">❗️BSD-1-Clause</a></code>
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (👨‍💻 660 · 🔀 1.5K · 📦 150K · 📋 5.5K - 14% open · ⏱️ 19.07.2021):

	```
	git clone https://github.com/sphinx-doc/sphinx
	```
- [PyPi](https://pypi.org/project/sphinx) (📥 3.9M / month · 📦 100K · ⏱️ 14.07.2021):
	```
	pip install sphinx
	```
- [Conda](https://anaconda.org/conda-forge/sphinx) (📥 3.6M · ⏱️ 14.07.2021):
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs) (👨‍💻 200 · 🔀 1.8K · 📦 14K · 📋 1.6K - 6% open · ⏱️ 18.07.2021):
...
<details><summary><b><a href="https://github.com/squidfunk/mkdocs-material">mkdocs-material</a></b> (🥇33 ·  ⭐ 7K) - A Material Design theme for MkDocs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 120 · 🔀 1.7K · 📦 7.6K · 📋 1.1K - 0% open · ⏱️ 21.07.2021):

	```
	git clone https://github.com/squidfunk/mkdocs-material
	```
- [PyPi](https://pypi.org/project/mkdocs-material) (📥 480K / month · 📦 1.5K · ⏱️ 21.07.2021):
	```
	pip install mkdocs-material
	```
- [Conda](https://anaconda.org/conda-forge/mkdocs-material) (📥 52K · ⏱️ 21.07.2021):
	```
...
- [PyPi](https://pypi.org/project/numpydoc) (📥 250K / month · 📦 7.3K · ⏱️ 01.07.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/numpydoc) (📥 800K · ⏱️ 01.10.2020):
	```
...
- [GitHub](https://github.com/michaeljones/breathe) (👨‍💻 94 · 🔀 140 · 📥 88 · 📦 4.8K · 📋 440 - 23% open · ⏱️ 18.05.2021):

	```
	git clone https://github.com/michaeljones/breathe
	```
- [PyPi](https://pypi.org/project/breathe) (📥 94K / month · 📦 2K · ⏱️ 06.05.2021):
	```
	pip install breathe
	```
...
- [GitHub](https://github.com/pdoc3/pdoc) (👨‍💻 55 · 🔀 110 · 📦 920 · 📋 260 - 32% open · ⏱️ 13.06.2021):

	```
	git clone https://github.com/pdoc3/pdoc
	```
- [PyPi](https://pypi.org/project/pdoc3) (📥 160K / month · 📦 90 · ⏱️ 27.11.2020):
	```
	pip install pdoc3
	```
</details>
...
- [PyPi](https://pypi.org/project/sphinx-autobuild) (📥 160K / month · 📦 4.7K · ⏱️ 14.03.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sphinx-autobuild) (📥 66K · ⏱️ 14.03.2021):
	```
	conda install -c conda-forge sphinx-autobuild
	```
</details>
<details><summary><b><a href="https://github.com/mitmproxy/pdoc">pdoc</a></b> (🥉24 ·  ⭐ 970) - API Documentation for Python Projects. <code><a href="http://bit.ly/3rvuUlR">Unlicense</a></code></summary>

- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 30 · 🔀 110 · 📦 350 · 📋 170 - 3% open · ⏱️ 16.06.2021):

	```
	git clone https://github.com/mitmproxy/pdoc
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 63K / month · 📦 290 · ⏱️ 11.06.2021):
	```
	pip install pdoc
	```
</details>
...
- [GitHub](https://github.com/econchick/interrogate) (👨‍💻 11 · 🔀 21 · 📦 720 · 📋 31 - 35% open · ⏱️ 07.07.2021):

	```
	git clone https://github.com/econchick/interrogate
	```
- [PyPi](https://pypi.org/project/interrogate) (📥 130K / month · ⏱️ 15.05.2021):
	```
...
- [GitHub](https://github.com/zhaoterryy/mkdocs-pdf-export-plugin) (👨‍💻 9 · 🔀 31 · 📦 130 · 📋 80 - 45% open · ⏱️ 23.07.2020):
...
- [PyPi](https://pypi.org/project/mkdocstrings) (📥 52K / month · ⏱️ 09.06.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/mkdocstrings) (📥 5.8K · ⏱️ 10.06.2021):
	```
	conda install -c conda-forge mkdocstrings
	```
</details>
<details><summary><b><a href="https://github.com/asottile/blacken-docs">blacken-docs</a></b> (🥉20 ·  ⭐ 230) - Run `black` on python code blocks in documentation files. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/asottile/blacken-docs) (👨‍💻 12 · 🔀 17 · 📋 31 - 6% open · ⏱️ 19.07.2021):

	```
	git clone https://github.com/asottile/blacken-docs
	```
- [PyPi](https://pypi.org/project/blacken-docs) (📥 5.1K / month · 📦 22 · ⏱️ 02.03.2021):
	```
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-pages-plugin) (👨‍💻 2 · 🔀 17 · 📦 400 · 📋 38 - 15% open · ⏱️ 22.12.2020):
...
<details><summary><b><a href="https://github.com/orzih/mkdocs-with-pdf">mkdocs-with-pdf</a></b> (🥉19 ·  ⭐ 70) - Generate a single PDF file from MkDocs repository. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/orzih/mkdocs-with-pdf) (👨‍💻 6 · 🔀 12 · 📦 42 · 📋 49 - 32% open · ⏱️ 03.07.2021):

	```
	git clone https://github.com/orzih/mkdocs-with-pdf
	```
- [PyPi](https://pypi.org/project/mkdocs-with-pdf) (📥 6.4K / month · ⏱️ 03.07.2021):
	```
...
- [GitHub](https://github.com/timothycrosley/portray) (👨‍💻 16 · 🔀 57 · 📋 49 - 40% open · ⏱️ 13.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/portray) (📥 7.1K / month · 📦 8 · ⏱️ 13.06.2021):
	```
	pip install portray
	```
</details>
<details><summary><b><a href="https://github.com/ml-tooling/lazydocs">lazydocs</a></b> (🥉16 ·  ⭐ 29) - Generate markdown API documentation from Google-style Python docstring... <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ml-tooling/lazydocs) (👨‍💻 4 · 🔀 7 · 📦 32 · 📋 4 - 50% open · ⏱️ 30.06.2021):

	```
	git clone https://github.com/ml-tooling/lazydocs
	```
- [PyPi](https://pypi.org/project/lazydocs) (📥 480 / month · ⏱️ 30.06.2021):
	```
...
- <b><a href="https://github.com/timvink/mkdocs-print-site-plugin">mkdocs-print-site-plugin</a></b> (🥉17 ·  ⭐ 20) - MkDocs Plugin allowing your visitors to *File Print.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
- [GitHub](https://github.com/cool-RR/PySnooper) (👨‍💻 26 · 🔀 900 · 📦 450 · 📋 110 - 16% open · ⏱️ 19.05.2021):

	```
	git clone https://github.com/cool-RR/PySnooper
	```
- [PyPi](https://pypi.org/project/pysnooper) (📥 74K / month · 📦 46 · ⏱️ 19.05.2021):
	```
...
<details><summary><b><a href="https://github.com/pdbpp/pdbpp">pdbpp</a></b> (🥈28 ·  ⭐ 760 · 📈) - pdb++, a drop-in replacement for pdb (the Python debugger). <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 39 · 🔀 44 · 📦 2.1K · 📋 180 - 36% open · ⏱️ 12.07.2021):

	```
	git clone https://github.com/pdbpp/pdbpp
	```
- [PyPi](https://pypi.org/project/pdbpp) (📥 450K / month · 📦 1K · ⏱️ 09.07.2021):
	```
	pip install pdbpp
	```
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 78 · 🔀 180 · 📦 2.4K · 📋 280 - 49% open · ⏱️ 20.07.2021):
...
- [GitHub](https://github.com/agronholm/typeguard) (👨‍💻 18 · 🔀 62 · 📋 160 - 26% open · ⏱️ 04.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/typeguard) (📥 7.5M / month · 📦 160 · ⏱️ 04.06.2021):
	```
	pip install typeguard
	```
- [Conda](https://anaconda.org/conda-forge/typeguard) (📥 46K · ⏱️ 04.06.2021):
	```
...
- [GitHub](https://github.com/cs01/gdbgui) (👨‍💻 36 · 🔀 470 · 📥 4.4K · 📦 95 · 📋 280 - 41% open · ⏱️ 01.06.2021):
...
- [GitHub](https://github.com/gruns/icecream) (👨‍💻 14 · 🔀 100 · 📋 73 - 26% open · ⏱️ 22.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/icecream) (📥 77K / month · 📦 6 · ⏱️ 22.06.2021):
	```
	pip install icecream
	```
</details>
<details><summary><b><a href="https://github.com/alexmojaki/snoop">snoop</a></b> (🥉23 ·  ⭐ 610) - A powerful set of Python debugging tools, based on PySnooper. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/alexmojaki/snoop) (👨‍💻 20 · 🔀 21 · 📦 57 · 📋 30 - 46% open · ⏱️ 05.07.2021):

	```
	git clone https://github.com/alexmojaki/snoop
	```
- [PyPi](https://pypi.org/project/snoop) (📥 32K / month · 📦 8 · ⏱️ 05.07.2021):
	```
	pip install snoop
	```
</details>
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 8 · 🔀 32 · 📦 63 · 📋 84 - 44% open · ⏱️ 23.06.2021):

	```
	git clone https://github.com/ionelmc/python-hunter
	```
- [PyPi](https://pypi.org/project/hunter) (📥 6.6K / month · 📦 34 · ⏱️ 23.06.2021):
	```
	pip install hunter
	```
</details>
...
- [GitHub](https://github.com/alexmojaki/birdseye) (👨‍💻 9 · 🔀 67 · 📋 49 - 34% open · ⏱️ 03.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/birdseye) (📥 990 / month · ⏱️ 03.07.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest) (👨‍💻 740 · 🔀 1.8K · 📦 350K · 📋 4.6K - 15% open · ⏱️ 20.07.2021):
...
- [PyPi](https://pypi.org/project/pytest) (📥 30M / month · 📦 130K · ⏱️ 04.05.2021):
	...
	pip install pytest
	```
- [Conda](https://anaconda.org/conda-forge/pytest) (📥 8.6M · ⏱️ 29.06.2021):
	```
...
- [GitHub](https://github.com/tox-dev/tox) (👨‍💻 250 · 🔀 380 · 📦 46K · 📋 1.2K - 11% open · ⏱️ 22.07.2021):

	```
	git clone https://github.com/tox-dev/tox
	```
- [PyPi](https://pypi.org/project/tox) (📥 4.2M / month · 📦 36K · ⏱️ 14.07.2021):
	```
	pip install tox
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 140 · 🔀 1.7K · 📥 510 · 📦 4K · 📋 3.6K - 5% open · ⏱️ 19.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/robotframework) (📥 730K / month · 📦 1.4K · ⏱️ 19.07.2021):
	```
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 250 · 🔀 460 · 📦 9.3K · 📋 1.1K - 5% open · ⏱️ 18.07.2021):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 2.1M / month · 📦 2.6K · ⏱️ 18.07.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-cov) (👨‍💻 67 · 🔀 150 · 📦 93K · 📋 290 - 34% open · ⏱️ 19.07.2021):
...
- [GitHub](https://github.com/pytest-dev/pytest-xdist) (👨‍💻 74 · 🔀 150 · 📦 20K · 📋 430 - 45% open · ⏱️ 20.07.2021):
...
<details><summary><b><a href="https://github.com/asweigart/pyautogui">pyautogui</a></b> (🥈31 ·  ⭐ 5.3K · 📈) - A cross-platform GUI automation Python module for human beings... <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 720 · 📦 9K · 📋 500 - 65% open · ⏱️ 08.07.2021):

	```
	git clone https://github.com/asweigart/pyautogui
	```
- [PyPi](https://pypi.org/project/pyautogui) (📥 440K / month · 📦 610 · ⏱️ 07.07.2021):
	```
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 94 · 🔀 200 · 📦 8.5K · 📋 230 - 28% open · ⏱️ 18.06.2021):

	```
	git clone https://github.com/spulec/freezegun
	```
- [PyPi](https://pypi.org/project/freezegun) (📥 3.9M / month · 📦 8.4K · ⏱️ 20.01.2021):
	```
...
- [GitHub](https://github.com/TheKevJames/coveralls-python) (👨‍💻 59 · 🔀 180 · 📦 18K · 📋 140 - 5% open · ⏱️ 20.07.2021):

	```
	git clone https://github.com/TheKevJames/coveralls-python
	```
- [PyPi](https://pypi.org/project/coveralls) (📥 490K / month · 📦 17K · ⏱️ 20.07.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-mock) (👨‍💻 54 · 🔀 95 · 📦 18K · 📋 99 - 10% open · ⏱️ 20.07.2021):
...
- [PyPi](https://pypi.org/project/pytest-asyncio) (📥 1.6M / month · 📦 2K · ⏱️ 21.04.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-asyncio) (📥 500K · ⏱️ 21.05.2021):
	```
...
- [GitHub](https://github.com/microsoft/playwright-python) (👨‍💻 21 · 🔀 420 · 📦 300 · 📋 390 - 3% open · ⏱️ 21.07.2021):

	```
	git clone https://github.com/microsoft/playwright-python
	```
- [PyPi](https://pypi.org/project/playwright) (📥 97K / month · ⏱️ 21.07.2021):
	```
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 270 · 📥 170 · 📋 290 - 1% open · ⏱️ 17.07.2021):

	```
	git clone https://github.com/lk-geimfari/mimesis
	```
- [PyPi](https://pypi.org/project/mimesis) (📥 73K / month · 📦 84 · ⏱️ 21.12.2020):
	```
	pip install mimesis
	```
</details>
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 71 · 🔀 130 · 📦 3.9K · 📋 250 - 21% open · ⏱️ 02.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/nose2) (📥 480K / month · 📦 1.9K · ⏱️ 27.01.2021):
	```
	pip install nose2
	```
...
- [PyPi](https://pypi.org/project/pytest-benchmark) (📥 330K / month · 📦 730 · ⏱️ 17.04.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-benchmark) (📥 690K · ⏱️ 18.04.2021):
	```
...
- [GitHub](https://github.com/Teemu/pytest-sugar) (👨‍💻 36 · 🔀 53 · 📦 7.7K · 📋 100 - 33% open · ⏱️ 24.10.2020):
...
- [GitHub](https://github.com/datadriventests/ddt) (👨‍💻 34 · 🔀 96 · 📦 3.6K · 📋 47 - 36% open · ⏱️ 12.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/ddt) (📥 280K / month · 📦 2.5K · ⏱️ 15.05.2020):
	```
	pip install ddt
	```
- [Conda](https://anaconda.org/conda-forge/ddt) (📥 61K · ⏱️ 15.05.2020):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-bdd) (👨‍💻 40 · 🔀 140 · 📋 250 - 46% open · ⏱️ 03.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-bdd) (📥 190K / month · 📦 270 · ⏱️ 03.07.2021):
	```
...
- [GitHub](https://github.com/hamcrest/PyHamcrest) (👨‍💻 34 · 🔀 85 · 📋 61 - 21% open · ⏱️ 30.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyhamcrest) (📥 970K / month · 📦 3.4K · ⏱️ 02.03.2020):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-testinfra) (👨‍💻 100 · 🔀 270 · 📋 310 - 35% open · ⏱️ 04.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-testinfra) (📥 98K / month · ⏱️ 20.06.2021):
	```
...
- [GitHub](https://github.com/tarpas/pytest-testmon) (👨‍💻 16 · 🔀 28 · 📦 330 · 📋 110 - 25% open · ⏱️ 19.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-testmon) (📥 70K / month · 📦 98 · ⏱️ 28.04.2021):
	```
...
- [GitHub](https://github.com/Erotemic/xdoctest) (👨‍💻 5 · 🔀 5 · 📦 1.2K · 📋 33 - 48% open · ⏱️ 28.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/xdoctest) (📥 79K / month · 📦 52 · ⏱️ 28.06.2021):
	```
...
- [GitHub](https://github.com/theacodes/nox) (👨‍💻 60 · 🔀 95 · 📋 220 - 15% open · ⏱️ 10.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/nox) (📥 310K / month · 📦 56 · ⏱️ 13.06.2021):
	```
	pip install nox
	```
- [Conda](https://anaconda.org/conda-forge/nox) (📥 35K · ⏱️ 20.06.2021):
	```
...
<details><summary><b><a href="https://github.com/pyinstaller/pyinstaller">pyinstaller</a></b> (🥇34 ·  ⭐ 8.3K) - Freeze (package) Python programs into stand-alone executables. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 400 · 🔀 1.7K · 📥 710K · 📦 19K · 📋 4.2K - 7% open · ⏱️ 21.07.2021):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 550K / month · ⏱️ 13.07.2021):
	```
...
- [GitHub](https://github.com/pypa/packaging) (👨‍💻 70 · 🔀 160 · 📥 120 · 📦 230K · 📋 210 - 26% open · ⏱️ 04.07.2021):

	```
	git clone https://github.com/pypa/packaging
	```
- [PyPi](https://pypi.org/project/packaging) (📥 63M / month · 📦 29K · ⏱️ 03.07.2021):
	```
	pip install packaging
	```
- [Conda](https://anaconda.org/conda-forge/packaging) (📥 8.5M · ⏱️ 03.07.2021):
	```
...
- [GitHub](https://github.com/Nuitka/Nuitka) (👨‍💻 98 · 🔀 310 · 📋 960 - 21% open · ⏱️ 02.07.2021):

	```
	git clone https://github.com/Nuitka/Nuitka
	```
- [PyPi](https://pypi.org/project/nuitka) (📥 24K / month · 📦 54 · ⏱️ 02.07.2021):
	```
	pip install nuitka
	```
...
- [GitHub](https://github.com/pantsbuild/pex) (👨‍💻 99 · 🔀 200 · 📥 340K · 📋 700 - 19% open · ⏱️ 14.07.2021):

	```
	git clone https://github.com/pantsbuild/pex
	```
- [PyPi](https://pypi.org/project/pex) (📥 130K / month · 📦 230 · ⏱️ 14.07.2021):
	```
	pip install pex
	```
</details>
...
- [GitHub](https://github.com/beeware/briefcase) (👨‍💻 82 · 🔀 190 · 📋 340 - 31% open · ⏱️ 10.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/briefcase) (📥 2.2K / month · 📦 24 · ⏱️ 06.03.2021):
	```
...
- [GitHub](https://github.com/py2exe/py2exe) (👨‍💻 14 · 🔀 38 · 📥 10K · 📦 1.2K · 📋 77 - 11% open · ⏱️ 24.04.2021):
...
- [GitHub](https://github.com/marcelotduarte/cx_Freeze) (👨‍💻 90 · 🔀 160 · 📋 670 - 9% open · ⏱️ 21.07.2021):
...
- [PyPi](https://pypi.org/project/cx_freeze) (📥 46K / month · 📦 150 · ⏱️ 16.12.2017):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cx_freeze) (📥 85K · ⏱️ 15.07.2021):
	```
...
- [GitHub](https://github.com/takluyver/pynsist) (👨‍💻 28 · 🔀 100 · 📋 160 - 16% open · ⏱️ 21.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pynsist) (📥 4.7K / month · 📦 88 · ⏱️ 28.03.2021):
	```
	pip install pynsist
	```
</details>
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 33 · 🔀 69 · 📥 140 · 📋 87 - 31% open · ⏱️ 28.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/shiv) (📥 7.6K / month · 📦 10 · ⏱️ 30.04.2021):
	```
	pip install shiv
	```
</details>
...
- [GitHub](https://github.com/indygreg/PyOxidizer) (👨‍💻 34 · 🔀 110 · 📥 430 · 📋 350 - 58% open · ⏱️ 06.06.2021):
...
- [GitHub](https://github.com/pyinvoke/invoke) (👨‍💻 56 · 🔀 290 · 📦 8.2K · 📋 670 - 46% open · ⏱️ 12.07.2021):
...
- [PyPi](https://pypi.org/project/invoke) (📥 1.6M / month · 📦 4.6K · ⏱️ 09.07.2021):
	...
	pip install invoke
	```
- [Conda](https://anaconda.org/conda-forge/invoke) (📥 350K · ⏱️ 10.07.2021):
	```
...
- [GitHub](https://github.com/buildbot/buildbot) (👨‍💻 790 · 🔀 1.5K · 📥 16K · 📦 250 · 📋 1.3K - 48% open · ⏱️ 18.07.2021):
...
- [PyPi](https://pypi.org/project/buildbot) (📥 57K / month · 📦 890 · ⏱️ 19.06.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/buildbot) (📥 38K · ⏱️ 19.06.2021):
	```
...
- [GitHub](https://github.com/pypa/wheel) (👨‍💻 61 · 🔀 89 · 📋 320 - 8% open · ⏱️ 23.05.2021):
...
- [GitHub](https://github.com/pypa/twine) (👨‍💻 100 · 🔀 240 · 📦 43K · 📋 360 - 12% open · ⏱️ 22.07.2021):

	```
	git clone https://github.com/pypa/twine
	```
- [PyPi](https://pypi.org/project/twine) (📥 1.8M / month · 📦 18K · ⏱️ 20.07.2021):
	```
	pip install twine
	```
- [Conda](https://anaconda.org/conda-forge/twine) (📥 300K · ⏱️ 20.07.2021):
	```
...
- [GitHub](https://github.com/takluyver/flit) (👨‍💻 44 · 🔀 76 · 📋 250 - 33% open · ⏱️ 04.07.2021):

	```
	git clone https://github.com/takluyver/flit
	```
- [PyPi](https://pypi.org/project/flit) (📥 74K / month · 📦 230 · ⏱️ 01.03.2021):
	```
	pip install flit
	```
...
- [GitHub](https://github.com/SCons/scons) (👨‍💻 130 · 🔀 230 · 📥 360 · 📋 3.3K - 19% open · ⏱️ 21.07.2021):
...
- [GitHub](https://github.com/pydoit/doit) (👨‍💻 56 · 🔀 130 · 📦 730 · 📋 260 - 25% open · ⏱️ 06.07.2021):
...
- [PyPi](https://pypi.org/project/doit) (📥 220K / month · 📦 470 · ⏱️ 04.09.2020):
	...
	pip install doit
	```
- [Conda](https://anaconda.org/conda-forge/doit) (📥 62K · ⏱️ 11.10.2020):
	```
...
- [GitHub](https://github.com/pypa/setuptools_scm) (👨‍💻 89 · 🔀 140 · 📋 340 - 21% open · ⏱️ 20.07.2021):
...
- [PyPi](https://pypi.org/project/setuptools_scm) (📥 11M / month · 📦 690 · ⏱️ 09.08.2018):
	...
	```
- [Conda](https://anaconda.org/conda-forge/setuptools_scm) (📥 700K · ⏱️ 17.03.2021):
	```
...
- [GitHub](https://github.com/ml-tooling/universal-build) (👨‍💻 4 · 🔀 3 · 📥 16 · 📦 5 · ⏱️ 19.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/universal-build) (📥 340 / month · ⏱️ 12.12.2020):
	```
...
<details><summary><b><a href="https://github.com/giampaolo/psutil">psutil</a></b> (🥇36 ·  ⭐ 7.5K · 📈) - Cross-platform lib for process and system monitoring in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 160 · 🔀 1.1K · 📦 96K · 📋 1.5K - 12% open · ⏱️ 29.06.2021):
...
- [GitHub](https://github.com/nicolargo/glances) (👨‍💻 140 · 🔀 1.2K · 📥 430 · 📦 320 · 📋 1.4K - 14% open · ⏱️ 17.07.2021):

	```
	git clone https://github.com/nicolargo/glances
	```
- [PyPi](https://pypi.org/project/glances) (📥 180K / month · 📦 50 · ⏱️ 10.07.2021):
	```
	pip install glances
	```
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 26 · 🔀 260 · 📥 5.8K · 📋 220 - 31% open · ⏱️ 15.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 590K / month · 📦 50 · ⏱️ 16.05.2021):
	```
	pip install py-spy
	```
</details>
...
- [GitHub](https://github.com/pyutils/line_profiler) (👨‍💻 25 · 🔀 250 · 📋 45 - 73% open · ⏱️ 25.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/line_profiler) (📥 310K / month · 📦 690 · ⏱️ 20.12.2017):
	```
...
<details><summary><b><a href="https://github.com/joerick/pyinstrument">pyinstrument</a></b> (🥈27 ·  ⭐ 2.9K) - Call stack profiler for Python. Shows you why your code is slow!. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/joerick/pyinstrument) (👨‍💻 29 · 🔀 110 · 📦 290 · 📋 83 - 27% open · ⏱️ 29.06.2021):
...
- [PyPi](https://pypi.org/project/pyinstrument) (📥 160K / month · 📦 140 · ⏱️ 03.05.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyinstrument) (📥 76K · ⏱️ 03.05.2021):
	```
	conda install -c conda-forge pyinstrument
	```
</details>
<details><summary><b><a href="https://github.com/sumerc/yappi">Yappi</a></b> (🥈26 ·  ⭐ 670) - Yet Another Python Profiler, but this time thread&coroutine&greenlet aware. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sumerc/yappi) (👨‍💻 24 · 🔀 47 · 📦 440 · 📋 46 - 30% open · ⏱️ 01.06.2021):

	```
	git clone https://github.com/sumerc/yappi
	```
- [PyPi](https://pypi.org/project/yappi) (📥 430K / month · 📦 640 · ⏱️ 27.11.2020):
	```
	pip install yappi
	```
- [Conda](https://anaconda.org/conda-forge/yappi) (📥 85K · ⏱️ 28.11.2020):
	```
...
- [GitHub](https://github.com/plasma-umass/scalene) (👨‍💻 19 · 🔀 150 · 📦 47 · 📋 130 - 21% open · ⏱️ 16.07.2021):

	```
	git clone https://github.com/plasma-umass/scalene
	```
- [PyPi](https://pypi.org/project/scalene) (📥 5.4K / month · ⏱️ 16.07.2021):
	```
	pip install scalene
	```
</details>
...
- [GitHub](https://github.com/aristocratos/bpytop) (👨‍💻 30 · 🔀 260 · 📋 250 - 17% open · ⏱️ 07.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/bpytop) (📥 9.3K / month · ⏱️ 07.06.2021):
	```
	pip install bpytop
	```
</details>
...
- [GitHub](https://github.com/alexmojaki/heartrate) (👨‍💻 2 · 🔀 110 · 📦 24 · 📋 6 - 66% open · ⏱️ 06.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/heartrate) (📥 350 / month · ⏱️ 14.08.2019):
	```
...
- [GitHub](https://github.com/serge-sans-paille/gast) (👨‍💻 10 · 🔀 22 · 📦 62K · 📋 23 - 8% open · ⏱️ 28.06.2021):

	```
	git clone https://github.com/serge-sans-paille/gast
	```
- [PyPi](https://pypi.org/project/gast) (📥 9.4M / month · 📦 3.4K · ⏱️ 28.06.2021):
	```
	pip install gast
	```
...
- [GitHub](https://github.com/newville/asteval) (👨‍💻 18 · 🔀 32 · 📦 590 · 📋 50 - 12% open · ⏱️ 22.06.2021):
...
<details><summary><b><a href="https://github.com/pre-commit/pre-commit">pre-commit</a></b> (🥇31 ·  ⭐ 6.2K) - A framework for managing and maintaining multi-language pre-commit.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pre-commit/pre-commit) (👨‍💻 120 · 🔀 460 · 📥 8.9K · 📋 1.2K - 1% open · ⏱️ 19.07.2021):

	```
	git clone https://github.com/pre-commit/pre-commit
	```
- [PyPi](https://pypi.org/project/pre-commit) (📥 3.2M / month · 📦 2.1K · ⏱️ 21.05.2021):
	```
	pip install pre-commit
	```
- [Conda](https://anaconda.org/conda-forge/pre-commit) (📥 640K · ⏱️ 27.05.2021):
	```
