...
- [GitHub](https://github.com/astral-sh/ruff) (👨‍💻 850 · 🔀 2K · 📥 4.8M · 📦 180K · 📋 7.9K - 20% open · ⏱️ 16.04.2026):

	```
	git clone https://github.com/charliermarsh/ruff
	```
- [PyPi](https://pypi.org/project/ruff) (📥 190M / month · 📦 51K · ⏱️ 09.04.2026):
	```
	pip install ruff
	```
- [Conda](https://anaconda.org/conda-forge/ruff) (📥 6.4M · ⏱️ 09.04.2026):
	```
...
- [GitHub](https://github.com/pylint-dev/pylint) (👨‍💻 640 · 🔀 1.2K · 📥 620 · 📦 490K · 📋 5.9K - 17% open · ⏱️ 13.04.2026):

	```
	git clone https://github.com/PyCQA/pylint
	```
- [PyPi](https://pypi.org/project/pylint) (📥 47M / month · 📦 12K · ⏱️ 20.02.2026):
	```
	pip install pylint
	```
...
- [GitHub](https://github.com/PyCQA/flake8) (👨‍💻 180 · 🔀 340 · 📦 690K · 📋 1.6K - 1% open · ⏱️ 14.04.2026):
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 220 · 🔀 420 · 📦 18K · 📋 1.2K - 1% open · ⏱️ 13.04.2026):
...
- [GitHub](https://github.com/beartype/beartype) (👨‍💻 30 · 🔀 72 · 📦 11K · 📋 470 - 21% open · ⏱️ 16.04.2026):

	```
	git clone https://github.com/beartype/beartype
	```
- [PyPi](https://pypi.org/project/beartype) (📥 87M / month · 📦 900 · ⏱️ 13.12.2025):
	```
	pip install beartype
	```
- [Conda](https://anaconda.org/conda-forge/beartype) (📥 610K · ⏱️ 14.12.2025):
	```
...
<details><summary><b><a href="https://github.com/davidhalter/parso">parso</a></b> (🥈32 ·  ⭐ 670 · 📉) - A Python Parser. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/davidhalter/parso) (👨‍💻 52 · 🔀 120 · 📋 120 - 10% open · ⏱️ 03.04.2026):

	```
	git clone https://github.com/davidhalter/parso
	```
- [PyPi](https://pypi.org/project/parso) (📥 120M / month · 📦 1.1K · ⏱️ 09.02.2026):
	```
	pip install parso
	```
...
- [GitHub](https://github.com/PyCQA/flake8-bugbear) (👨‍💻 90 · 🔀 120 · 📋 250 - 25% open · ⏱️ 16.03.2026):

	```
	git clone https://github.com/PyCQA/flake8-bugbear
	```
- [PyPi](https://pypi.org/project/flake8-bugbear) (📥 4.4M / month · 📦 1.5K · ⏱️ 29.11.2025):
	```
...
- [GitHub](https://github.com/nipunn1313/mypy-protobuf) (👨‍💻 40 · 🔀 80 · 📦 4.5K · 📋 150 - 14% open · ⏱️ 13.01.2026):

	```
	git clone https://github.com/dropbox/mypy-protobuf
	```
- [PyPi](https://pypi.org/project/mypy-protobuf) (📥 18M / month · 📦 270 · ⏱️ 13.01.2026):
	```
...
- [PyPi](https://pypi.org/project/pylint-django) (📥 2M / month · 📦 160 · ⏱️ 01.01.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pylint-django) (📥 440K · ⏱️ 02.01.2026):
	```
...
- [GitHub](https://github.com/adamchainz/flake8-comprehensions) (👨‍💻 16 · 🔀 23 · 📦 30K · 📋 62 - 9% open · ⏱️ 07.04.2026):
...
- [GitHub](https://github.com/andreoliwa/nitpick) (👨‍💻 18 · 🔀 25 · 📥 12 · 📦 1.4K · 📋 130 - 36% open · ⏱️ 13.04.2026):
...
<details><summary><b><a href="https://github.com/mgedmin/check-manifest">check-manifest</a></b> (🥉26 ·  ⭐ 300) - Tool to check the completeness of MANIFEST.in for Python packages. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/mgedmin/check-manifest) (👨‍💻 23 · 🔀 39 · 📦 12K · 📋 100 - 22% open · ⏱️ 05.01.2026):
	...
	```
- [PyPi](https://pypi.org/project/check-manifest) (📥 1.5M / month · 📦 5K · ⏱️ 15.10.2025):
	```
...
- [PyPi](https://pypi.org/project/flake8-import-order) (📥 1.5M / month · 📦 650 · ⏱️ 24.06.2025):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flake8-import-order) (📥 450K · ⏱️ 26.06.2025):
	```
...
- [PyPi](https://pypi.org/project/flake8-builtins) (📥 1M / month · 📦 590 · ⏱️ 25.10.2025):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flake8-builtins) (📥 520K · ⏱️ 27.10.2025):
	```
...
- [GitHub](https://github.com/microsoft/pyright) (👨‍💻 140 · 🔀 1.8K · 📥 6.6K · 📦 1.6K · 📋 7.5K - 3% open · ⏱️ 15.04.2026):

	```
	git clone https://github.com/Microsoft/pyright
	```
- [npm](https://www.npmjs.com/package/pyright) (📥 4.6M / month · 📦 57 · ⏱️ 16.04.2026):
	```
	npm install pyright
	```
</details>
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 300 · 🔀 450 · 📦 21 · 📋 470 - 33% open · ⏱️ 16.04.2026):
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 110 · 🔀 290 · 📋 950 - 21% open · ⏱️ 23.01.2026):
	...
	```
- [PyPi](https://pypi.org/project/pytype) (📥 840K / month · 📦 230 · ⏱️ 11.10.2024):
	```
	pip install pytype
	```
...
- [GitHub](https://github.com/psf/black) (👨‍💻 520 · 🔀 2.7K · 📥 150K · 📦 670K · 📋 2.8K - 11% open · ⏱️ 16.04.2026):
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 340 · 🔀 620 · 📦 580K · 📋 1.4K - 9% open · ⏱️ 15.04.2026):

	```
	git clone https://github.com/PyCQA/isort
	```
- [PyPi](https://pypi.org/project/isort) (📥 89M / month · 📦 27K · ⏱️ 28.02.2026):
	```
	pip install isort
	```
...
- [GitHub](https://github.com/hhatto/autopep8) (👨‍💻 64 · 🔀 290 · 📦 230K · 📋 520 - 23% open · ⏱️ 03.04.2026):

	```
	git clone https://github.com/hhatto/autopep8
	```
- [PyPi](https://pypi.org/project/autopep8) (📥 9.3M / month · 📦 1.7K · ⏱️ 14.01.2025):
	```
...
<details><summary><b><a href="https://github.com/PyCQA/docformatter">docformatter</a></b> (🥉28 ·  ⭐ 590) - Formats docstrings to follow PEP 257. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/davidhalter/jedi) (👨‍💻 180 · 🔀 520 · 📦 600K · 📋 1.5K - 6% open · ⏱️ 13.02.2026):

	```
	git clone https://github.com/davidhalter/jedi
	```
- [PyPi](https://pypi.org/project/jedi) (📥 120M / month · 📦 1.2K · ⏱️ 11.11.2024):
	```
	pip install jedi
	```
...
<details><summary><b><a href="https://github.com/jendrikseipp/vulture">vulture</a></b> (🥇33 ·  ⭐ 4.5K) - Find dead Python code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 48 · 🔀 180 · 📦 6.8K · 📋 250 - 22% open · ⏱️ 26.03.2026):

	```
	git clone https://github.com/jendrikseipp/vulture
	```
- [PyPi](https://pypi.org/project/vulture) (📥 8M / month · 📦 660 · ⏱️ 25.03.2026):
	```
	pip install vulture
	```
- [Conda](https://anaconda.org/conda-forge/vulture) (📥 190K · ⏱️ 26.03.2026):
	```
...
- [GitHub](https://github.com/asottile/pyupgrade) (👨‍💻 36 · 🔀 210 · 📋 470 - 4% open · ⏱️ 14.04.2026):
...
- [GitHub](https://github.com/PyCQA/autoflake) (👨‍💻 40 · 🔀 84 · 📋 120 - 31% open · ⏱️ 08.04.2026):

	```
	git clone https://github.com/myint/autoflake
	```
- [PyPi](https://pypi.org/project/autoflake) (📥 8.1M / month · 📦 1.4K · ⏱️ 20.02.2026):
	```
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 51 · 🔀 200 · 📋 200 - 30% open · ⏱️ 14.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/monkeytype) (📥 280K / month · 📦 23 · ⏱️ 20.03.2023):
	```
...
- [GitHub](https://github.com/hakancelikdev/unimport) (👨‍💻 16 · 🔀 21 · 📦 170 · 📋 120 - 0% open · ⏱️ 18.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/unimport) (📥 42K / month · 📦 40 · ⏱️ 18.02.2026):
	```
...
- [GitHub](https://github.com/asottile/add-trailing-comma) (👨‍💻 11 · 🔀 29 · ⏱️ 14.04.2026):
...
- [GitHub](https://github.com/PyCQA/bandit) (👨‍💻 200 · 🔀 740 · 📥 920 · 📦 64K · 📋 740 - 29% open · ⏱️ 13.04.2026):
...
<details><summary><b><a href="https://github.com/sqlmapproject/sqlmap">sqlmap</a></b> (🥈37 ·  ⭐ 37K) - Automatic SQL injection and database takeover tool. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 150 · 🔀 6.2K · 📦 21 · 📋 5.4K - 1% open · ⏱️ 15.04.2026):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 78K / month · 📦 12 · ⏱️ 09.04.2026):
	```
	pip install sqlmap
	```
</details>
...
- [GitHub](https://github.com/pyupio/safety) (👨‍💻 55 · 🔀 170 · 📥 1.2M · 📦 20K · 📋 270 - 15% open · ⏱️ 23.03.2026):
...
- [GitHub](https://github.com/Yelp/detect-secrets) (👨‍💻 89 · 🔀 510 · 📋 370 - 33% open · ⏱️ 02.04.2026):
	...
	```
- [PyPi](https://pypi.org/project/detect-secrets) (📥 3.5M / month · 📦 95 · ⏱️ 06.05.2024):
	```
...
- [GitHub](https://github.com/pypa/pipenv) (👨‍💻 540 · 🔀 1.9K · 📦 170K · 📋 4.4K - 0% open · ⏱️ 13.04.2026):

	```
	git clone https://github.com/pypa/pipenv
	```
- [PyPi](https://pypi.org/project/pipenv) (📥 23M / month · 📦 260 · ⏱️ 03.04.2026):
	```
	pip install pipenv
	```
- [Conda](https://anaconda.org/conda-forge/pipenv) (📥 330K · ⏱️ 03.04.2026):
	```
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 310 · 🔀 1.1K · 📥 76 · 📦 500K · ⏱️ 15.04.2026):

	```
	git clone https://github.com/pypa/virtualenv
	```
- [PyPi](https://pypi.org/project/virtualenv) (📥 400M / month · 📦 2.1K · ⏱️ 14.04.2026):
	```
	pip install virtualenv
	```
- [Conda](https://anaconda.org/conda-forge/virtualenv) (📥 20M · ⏱️ 15.04.2026):
	```
...
- [GitHub](https://github.com/ekalinin/nodeenv) (👨‍💻 110 · 🔀 220 · 📦 140K · 📋 230 - 28% open · ⏱️ 27.12.2025):
	...
	```
- [PyPi](https://pypi.org/project/nodeenv) (📥 140M / month · 📦 410 · ⏱️ 20.12.2025):
	```
	pip install nodeenv
	```
- [Conda](https://anaconda.org/conda-forge/nodeenv) (📥 8.1M · ⏱️ 20.12.2025):
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 480 · 🔀 3.2K · 📦 21 · 📋 1.9K - 4% open · ⏱️ 15.04.2026):
...
- [GitHub](https://github.com/pypa/pip) (👨‍💻 870 · 🔀 3.3K · 📦 250K · 📋 7.8K - 13% open · ⏱️ 15.04.2026):

	```
	git clone https://github.com/pypa/pip
	```
- [PyPi](https://pypi.org/project/pip) (📥 530M / month · 📦 5.7K · ⏱️ 05.02.2026):
	```
	pip install pip
	```
...
- [GitHub](https://github.com/conda/conda) (👨‍💻 490 · 🔀 2.1K · 📥 45K · 📦 52K · 📋 11K - 5% open · ⏱️ 16.04.2026):

	```
	git clone https://github.com/conda/conda
	```
- [PyPi](https://pypi.org/project/conda) (📥 7K / month · 📦 83 · ⏱️ 22.04.2017):
	```
	pip install conda
	```
- [Conda](https://anaconda.org/conda-forge/conda) (📥 72M · ⏱️ 10.04.2026):
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 640 · 🔀 2.4K · 📥 16M · 📋 6.4K - 8% open · ⏱️ 12.04.2026):

	```
	git clone https://github.com/python-poetry/poetry
	```
- [PyPi](https://pypi.org/project/poetry) (📥 78M / month · 📦 910 · ⏱️ 12.04.2026):
	```
	pip install poetry
	```
- [Conda](https://anaconda.org/conda-forge/poetry) (📥 7.8M · ⏱️ 12.04.2026):
	```
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 230 · 🔀 660 · 📦 38K · 📋 1.2K - 16% open · ⏱️ 15.04.2026):
...
- [GitHub](https://github.com/pypa/pipx) (👨‍💻 180 · 🔀 540 · 📥 1M · 📦 4.8K · 📋 900 - 13% open · ⏱️ 15.04.2026):

	```
	git clone https://github.com/pypa/pipx
	```
- [PyPi](https://pypi.org/project/pipx) (📥 8.5M / month · 📦 97 · ⏱️ 31.03.2026):
	```
	pip install pipx
	```
...
- [GitHub](https://github.com/pdm-project/pdm) (👨‍💻 240 · 🔀 470 · 📥 26K · 📦 600 · 📋 2K - 2% open · ⏱️ 16.04.2026):

	```
	git clone https://github.com/pdm-project/pdm
	```
- [PyPi](https://pypi.org/project/pdm) (📥 10M / month · 📦 220 · ⏱️ 24.03.2026):
	```
	pip install pdm
	```
- [Conda](https://anaconda.org/conda-forge/pdm) (📥 1.8M · ⏱️ 24.03.2026):
	```
...
- [GitHub](https://github.com/mamba-org/mamba) (👨‍💻 180 · 🔀 440 · 📋 2.1K - 22% open · ⏱️ 14.04.2026):

	```
	git clone https://github.com/mamba-org/mamba
	```
- [Conda](https://anaconda.org/conda-forge/mamba) (📥 23M · ⏱️ 14.04.2026):
	```
...
- [PyPi](https://pypi.org/project/pipreqs) (📥 770K / month · 📦 320 · ⏱️ 18.02.2024):
	...
	pip install pipreqs
	```
- [Conda](https://anaconda.org/conda-forge/pipreqs) (📥 97K · ⏱️ 22.04.2025):
	```
...
- [GitHub](https://github.com/prospector-dev/prospector) (👨‍💻 98 · 🔀 180 · 📦 5.5K · 📋 400 - 8% open · ⏱️ 13.04.2026):

	```
	git clone https://github.com/PyCQA/prospector
	```
- [PyPi](https://pypi.org/project/prospector) (📥 480K / month · 📦 290 · ⏱️ 03.02.2026):
	```
...
- [GitHub](https://github.com/tonybaloney/wily) (👨‍💻 24 · 🔀 65 · 📦 300 · 📋 120 - 37% open · ⏱️ 19.10.2025):

	```
	git clone https://github.com/tonybaloney/wily
	```
- [PyPi](https://pypi.org/project/wily) (📥 52K / month · 📦 2 · ⏱️ 11.10.2023):
	```
	pip install wily
	```
</details>
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 130 · 🔀 1.4K · 📥 20K · 📦 1.2M · 📋 1.2K - 49% open · ⏱️ 03.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/tqdm) (📥 410M / month · 📦 50K · ⏱️ 03.02.2026):
	```
	pip install tqdm
	```
- [Conda](https://anaconda.org/conda-forge/tqdm) (📥 48M · ⏱️ 03.02.2026):
	...
	```
- [Docker Hub](https://hub.docker.com/r/tqdm/tqdm) (📥 6.2K · ⭐ 3 · ⏱️ 11.04.2026):
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 310 · 🔀 600 · 📥 4K · 📋 2.3K - 16% open · ⏱️ 16.04.2026):

	```
	git clone https://github.com/getsentry/sentry-python
	```
- [PyPi](https://pypi.org/project/sentry-sdk) (📥 130M / month · 📦 1.6K · ⏱️ 13.04.2026):
	```
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 74 · 🔀 780 · 📦 150K · 📋 1.2K - 20% open · ⏱️ 06.04.2026):
	...
	```
- [PyPi](https://pypi.org/project/loguru) (📥 71M / month · 📦 11K · ⏱️ 06.12.2024):
	```
	pip install loguru
	```
...
- [GitHub](https://github.com/hynek/structlog) (👨‍💻 140 · 🔀 280 · 📦 32K · 📋 390 - 9% open · ⏱️ 06.04.2026):
	...
	```
- [PyPi](https://pypi.org/project/structlog) (📥 71M / month · 📦 2.2K · ⏱️ 27.10.2025):
	```
...
- [PyPi](https://pypi.org/project/alive-progress) (📥 2.9M / month · 📦 590 · ⏱️ 20.07.2025):
	...
	```
- [Conda](https://anaconda.org/conda-forge/alive-progress) (📥 260K · ⏱️ 08.03.2026):
	```
...
- [GitHub](https://github.com/borntyping/python-colorlog) (👨‍💻 35 · 🔀 95 · 📦 65K · ⏱️ 16.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/colorlog) (📥 58M / month · 📦 2.7K · ⏱️ 16.10.2025):
	```
...
<details><summary><b><a href="https://github.com/wolph/python-progressbar">progressbar2</a></b> (🥉29 ·  ⭐ 880) - Progressbar 2 - A progress bar for Python 2 and Python 3 - pip.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/wolph/python-progressbar) (👨‍💻 47 · 🔀 100 · 📥 3.3K · 📋 230 - 3% open · ⏱️ 07.04.2026):
...
- [PyPi](https://pypi.org/project/progressbar2) (📥 23M / month · 📦 930 · ⏱️ 28.08.2024):
	...
	```
- [Conda](https://anaconda.org/conda-forge/progressbar2) (📥 4.4M · ⏱️ 22.04.2025):
	```
...
- [GitHub](https://github.com/cknd/stackprinter) (👨‍💻 8 · 🔀 42 · 📦 450 · 📋 36 - 30% open · ⏱️ 30.10.2025):
...
- [GitHub](https://github.com/xxh/xxh) (👨‍💻 28 · 🔀 120 · 📥 5.2K · 📋 100 - 30% open · ⏱️ 12.04.2026):
	...
	```
- [PyPi](https://pypi.org/project/xxh-xxh) (📥 740 / month · ⏱️ 06.04.2024):
	```
	pip install xxh-xxh
	```
</details>
...
- <b><a href="https://github.com/xonsh/xonsh">xonsh</a></b> (🥇36 ·  ⭐ 9.3K) - Python-powered shell. Full-featured, cross-platform and AI-.. <code><a href="https://tldrlegal.com/search?q=BSD-1-Clause">❗️BSD-1-Clause</a></code>
</details>
<br>
...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 330 · 🔀 4.1K · 📦 84K · 📋 2.7K - 0% open · ⏱️ 16.04.2026):
...
- [PyPi](https://pypi.org/project/mkdocs-material) (📥 17M / month · 📦 9.5K · ⏱️ 19.03.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/mkdocs-material) (📥 950K · ⏱️ 27.03.2026):
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs) (👨‍💻 260 · 🔀 2.6K · 📦 99K · 📋 2.1K - 6% open · ⏱️ 20.10.2025):
...
- [PyPi](https://pypi.org/project/mkdocs) (📥 16M / month · 📦 7.1K · ⏱️ 30.08.2024):
	...
	pip install mkdocs
	```
- [Conda](https://anaconda.org/conda-forge/mkdocs) (📥 860K · ⏱️ 22.04.2025):
	```
...
- [GitHub](https://github.com/mkdocstrings/mkdocstrings) (👨‍💻 55 · 🔀 120 · 📦 26K · 📋 470 - 1% open · ⏱️ 15.04.2026):
	...
	```
- [PyPi](https://pypi.org/project/mkdocstrings) (📥 7.4M / month · 📦 2K · ⏱️ 15.04.2026):
	```
	pip install mkdocstrings
	```
- [Conda](https://anaconda.org/conda-forge/mkdocstrings) (📥 330K · ⏱️ 08.02.2026):
	```
...
- [GitHub](https://github.com/mkdocstrings/griffe) (👨‍💻 46 · 🔀 63 · 📦 16K · 📋 300 - 10% open · ⏱️ 30.03.2026):
...
- [PyPi](https://pypi.org/project/griffe) (📥 29M / month · 📦 500 · ⏱️ 27.03.2026):
	...
	pip install griffe
	```
- [Conda](https://anaconda.org/conda-forge/griffe) (📥 850K · ⏱️ 27.03.2026):
	```
...
- [GitHub](https://github.com/tox-dev/sphinx-autodoc-typehints) (👨‍💻 66 · 🔀 110 · 📦 60K · ⏱️ 15.04.2026):

	```
	git clone https://github.com/tox-dev/sphinx-autodoc-typehints
	```
- [PyPi](https://pypi.org/project/sphinx-autodoc-typehints) (📥 9.3M / month · 📦 6.8K · ⏱️ 15.04.2026):
	```
...
- [PyPi](https://pypi.org/project/sphinx-autobuild) (📥 5.1M / month · 📦 2.3K · ⏱️ 25.08.2025):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sphinx-autobuild) (📥 490K · ⏱️ 04.11.2025):
	```
...
- [GitHub](https://github.com/pdoc3/pdoc) (👨‍💻 69 · 🔀 140 · 📦 5.1K · 📋 340 - 30% open · ⏱️ 03.11.2025):
	...
	```
- [PyPi](https://pypi.org/project/pdoc3) (📥 710K / month · 📦 490 · ⏱️ 20.03.2025):
	```
	pip install pdoc3
	```
...
- [GitHub](https://github.com/adamchainz/blacken-docs) (👨‍💻 26 · 🔀 45 · 📦 1.6K · 📋 81 - 11% open · ⏱️ 07.04.2026):
...
<details><summary><b><a href="https://github.com/breathe-doc/breathe">breathe</a></b> (🥉26 ·  ⭐ 810 · 📉) - ReStructuredText and Sphinx bridge to Doxygen. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/breathe-doc/breathe) (👨‍💻 120 · 🔀 210 · 📥 810 · 📋 620 - 31% open · ⏱️ 01.12.2025):
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-nav) (👨‍💻 12 · 🔀 42 · 📦 540 · 📋 120 - 19% open · ⏱️ 10.04.2026):
	...
	```
- [PyPi](https://pypi.org/project/mkdocs-awesome-pages-plugin) (📥 780K / month · 📦 220 · ⏱️ 22.12.2024):
	```
...
- [GitHub](https://github.com/ml-tooling/lazydocs) (👨‍💻 13 · 🔀 44 · 📦 410 · 📋 46 - 8% open · ⏱️ 28.08.2025):
...
- <b><a href="https://github.com/econchick/interrogate">interrogate</a></b> (🥉25 ·  ⭐ 660 · 💀) - Explain yourself! Interrogate a codebase for docstring coverage. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/gruns/icecream) (👨‍💻 37 · 🔀 220 · 📦 21 · 📋 170 - 37% open · ⏱️ 03.04.2026):
	...
	```
- [PyPi](https://pypi.org/project/icecream) (📥 2.7M / month · 📦 600 · ⏱️ 03.04.2026):
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 110 · 🔀 540 · 📦 12K · 📋 280 - 27% open · ⏱️ 08.04.2026):

	```
	git clone https://github.com/eliben/pyelftools
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 12M / month · 📦 270 · ⏱️ 19.02.2025):
	```
...
- [GitHub](https://github.com/cool-RR/PySnooper) (👨‍💻 29 · 🔀 950 · 📦 2.1K · 📋 140 - 20% open · ⏱️ 08.03.2026):
	...
	```
- [PyPi](https://pypi.org/project/pysnooper) (📥 470K / month · 📦 67 · ⏱️ 31.05.2025):
	```
...
- [PyPi](https://pypi.org/project/ipdb) (📥 14M / month · 📦 1.1K · ⏱️ 09.03.2023):
	...
	pip install ipdb
	```
- [Conda](https://anaconda.org/conda-forge/ipdb) (📥 810K · ⏱️ 22.04.2025):
	```
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 10 · 🔀 51 · 📋 100 - 46% open · ⏱️ 22.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/hunter) (📥 930K / month · 📦 17 · ⏱️ 22.08.2025):
	```
	pip install hunter
	```
...
- [GitHub](https://github.com/lmacken/pyrasite) (👨‍💻 25 · 🔀 200 · 📦 72 · 📋 60 - 71% open · ⏱️ 07.04.2025):

	```
	git clone https://github.com/lmacken/pyrasite
	```
- [PyPi](https://pypi.org/project/pyrasite) (📥 60K / month · ⏱️ 09.05.2012):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest) (👨‍💻 1.1K · 🔀 3.1K · 📥 29K · 📦 1.8M · 📋 6.4K - 15% open · ⏱️ 16.04.2026):

	```
	git clone https://github.com/pytest-dev/pytest
	```
- [PyPi](https://pypi.org/project/pytest) (📥 610M / month · 📦 150K · ⏱️ 07.04.2026):
	```
	pip install pytest
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 230 · 🔀 2.5K · 📥 580 · 📦 14K · 📋 4.8K - 5% open · ⏱️ 16.04.2026):
...
- [GitHub](https://github.com/tox-dev/tox) (👨‍💻 350 · 🔀 550 · 📦 130K · ⏱️ 15.04.2026):

	```
	git clone https://github.com/tox-dev/tox
	```
- [PyPi](https://pypi.org/project/tox) (📥 40M / month · 📦 13K · ⏱️ 14.04.2026):
	```
	pip install tox
	```
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 370 · 🔀 640 · 📦 40K · 📋 1.8K - 4% open · ⏱️ 15.04.2026):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 29M / month · 📦 5K · ⏱️ 14.04.2026):
	```
	pip install hypothesis
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 18M · ⏱️ 15.04.2026):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-asyncio) (👨‍💻 78 · 🔀 180 · 📥 1.9K · 📦 190K · 📋 390 - 12% open · ⏱️ 15.04.2026):

	```
	git clone https://github.com/pytest-dev/pytest-asyncio
	```
- [PyPi](https://pypi.org/project/pytest-asyncio) (📥 160M / month · 📦 34K · ⏱️ 15.04.2026):
	```
...
<details><summary><b><a href="https://github.com/microsoft/playwright-python">playwright-python</a></b> (🥈39 ·  ⭐ 15K) - Python version of the Playwright testing and automation.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/microsoft/playwright-python) (👨‍💻 51 · 🔀 1.1K · 📦 53K · 📋 1.5K - 4% open · ⏱️ 11.02.2026):

	```
	git clone https://github.com/microsoft/playwright-python
	```
- [PyPi](https://pypi.org/project/playwright) (📥 63M / month · 📦 3.7K · ⏱️ 30.01.2026):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-xdist) (👨‍💻 120 · 🔀 260 · 📥 430 · 📦 130K · 📋 710 - 42% open · ⏱️ 13.04.2026):
...
- [GitHub](https://github.com/pytest-dev/pytest-mock) (👨‍💻 82 · 🔀 160 · 📥 160 · 📦 130K · 📋 170 - 8% open · ⏱️ 13.04.2026):
...
- [GitHub](https://github.com/pytest-dev/pytest-html) (👨‍💻 65 · 🔀 250 · 📦 58K · 📋 450 - 41% open · ⏱️ 13.04.2026):
...
- [GitHub](https://github.com/wntrblm/nox) (👨‍💻 120 · 🔀 180 · 📦 7.7K · 📋 440 - 15% open · ⏱️ 12.04.2026):
...
- [PyPi](https://pypi.org/project/nox) (📥 5.6M / month · 📦 1.6K · ⏱️ 10.04.2026):
	...
	pip install nox
	```
- [Conda](https://anaconda.org/conda-forge/nox) (📥 570K · ⏱️ 10.04.2026):
	```
...
- [GitHub](https://github.com/TheKevJames/coveralls-python) (👨‍💻 67 · 🔀 190 · 📦 37K · 📋 180 - 4% open · ⏱️ 14.04.2026):
...
- [GitHub](https://github.com/pytest-dev/pytest-bdd) (👨‍💻 67 · 🔀 240 · 📦 4.7K · 📋 380 - 22% open · ⏱️ 06.04.2026):
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 130 · 🔀 350 · 📥 870 · 📦 2.3K · 📋 360 - 3% open · ⏱️ 18.01.2026):
	...
	```
- [PyPi](https://pypi.org/project/mimesis) (📥 1.6M / month · 📦 83 · ⏱️ 11.01.2026):
	```
	pip install mimesis
	```
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 130 · 🔀 290 · 📥 170 · 📋 360 - 40% open · ⏱️ 19.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/freezegun) (📥 43M / month · 📦 1.3K · ⏱️ 09.08.2025):
	```
...
- [GitHub](https://github.com/ionelmc/pytest-benchmark) (👨‍💻 54 · 🔀 130 · 📋 220 - 54% open · ⏱️ 26.03.2026):
...
- [GitHub](https://github.com/Teemu/pytest-sugar) (👨‍💻 58 · 🔀 82 · 📥 55 · 📦 30K · 📋 130 - 25% open · ⏱️ 12.12.2025):
	...
	```
- [PyPi](https://pypi.org/project/pytest-sugar) (📥 6.1M / month · 📦 1.5K · ⏱️ 23.08.2025):
	```
	pip install pytest-sugar
	```
- [Conda](https://anaconda.org/conda-forge/pytest-sugar) (📥 500K · ⏱️ 24.08.2025):
	```
...
- [GitHub](https://github.com/airspeed-velocity/asv) (👨‍💻 96 · 🔀 200 · 📥 2.1K · 📦 1.6K · 📋 680 - 24% open · ⏱️ 13.04.2026):
...
<details><summary><b><a href="https://github.com/tarpas/pytest-testmon">pytest-testmon</a></b> (🥉27 ·  ⭐ 970) - Selects tests affected by changed files. Executes the right.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/tarpas/pytest-testmon) (👨‍💻 29 · 🔀 74 · 📦 1.6K · 📋 180 - 20% open · ⏱️ 01.12.2025):
	...
	```
- [PyPi](https://pypi.org/project/pytest-testmon) (📥 2.4M / month · 📦 59 · ⏱️ 01.12.2025):
	```
...
<details><summary><b><a href="https://github.com/Erotemic/xdoctest">xdoctest</a></b> (🥉27 ·  ⭐ 220) - A rewrite of Pythons builtin doctest module (with pytest plugin.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Erotemic/xdoctest) (👨‍💻 13 · 🔀 18 · 📥 280 · 📋 61 - 40% open · ⏱️ 12.04.2026):
...
- [GitHub](https://github.com/pytest-dev/pytest-randomly) (👨‍💻 20 · 🔀 34 · 📋 76 - 11% open · ⏱️ 14.04.2026):

	```
	git clone https://github.com/pytest-dev/pytest-randomly
	```
- [PyPi](https://pypi.org/project/pytest-randomly) (📥 5.9M / month · 📦 770 · ⏱️ 12.09.2025):
	```
...
- [GitHub](https://github.com/gabrielcnr/pytest-datadir) (👨‍💻 16 · 🔀 25 · 📥 89 · 📦 2.2K · 📋 23 - 13% open · ⏱️ 16.03.2026):

	```
	git clone https://github.com/gabrielcnr/pytest-datadir
	```
- [PyPi](https://pypi.org/project/pytest-datadir) (📥 1.4M / month · 📦 270 · ⏱️ 30.07.2025):
	```
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 490 · 🔀 2K · 📥 750K · 📦 88K · 📋 5.6K - 5% open · ⏱️ 12.04.2026):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 8.1M / month · 📦 1.7K · ⏱️ 14.02.2026):
	```
...
- [GitHub](https://github.com/Nuitka/Nuitka) (👨‍💻 210 · 🔀 770 · 📦 3.7K · 📋 2.8K - 7% open · ⏱️ 11.04.2026):

	```
	git clone https://github.com/Nuitka/Nuitka
	```
- [PyPi](https://pypi.org/project/nuitka) (📥 1.6M / month · 📦 210 · ⏱️ 10.04.2026):
	```
	pip install nuitka
	```
- [Conda](https://anaconda.org/conda-forge/nuitka) (📥 2.9M · ⏱️ 10.04.2026):
	```
...
- [GitHub](https://github.com/pex-tool/pex) (👨‍💻 130 · 🔀 310 · 📥 360K · 📋 1.2K - 4% open · ⏱️ 15.04.2026):
	...
	```
- [PyPi](https://pypi.org/project/pex) (📥 4.7M / month · 📦 64 · ⏱️ 15.04.2026):
	```
	pip install pex
	```
</details>
...
- [GitHub](https://github.com/beeware/briefcase) (👨‍💻 200 · 🔀 480 · 📥 1.1K · 📦 860 · 📋 1K - 17% open · ⏱️ 15.04.2026):

	```
	git clone https://github.com/beeware/briefcase
	```
- [PyPi](https://pypi.org/project/briefcase) (📥 55K / month · 📦 45 · ⏱️ 09.03.2026):
	```
...
- [GitHub](https://github.com/marcelotduarte/cx_Freeze) (👨‍💻 120 · 🔀 240 · 📋 1.1K - 4% open · ⏱️ 14.04.2026):

	```
	git clone https://github.com/marcelotduarte/cx_Freeze
	```
- [PyPi](https://pypi.org/project/cx_freeze) (📥 160K / month · 📦 140 · ⏱️ 13.04.2026):
	```
...
- [GitHub](https://github.com/ronaldoussoren/py2app) (👨‍💻 31 · 🔀 44 · 📦 5.6K · 📋 540 - 41% open · ⏱️ 25.01.2026):

	```
	git clone https://github.com/ronaldoussoren/py2app
	```
- [PyPi](https://pypi.org/project/py2app) (📥 70K / month · 📦 42 · ⏱️ 13.02.2026):
	```
	pip install py2app
	```
</details>
...
- [GitHub](https://github.com/conda/constructor) (👨‍💻 79 · 🔀 180 · 📥 290 · 📦 27 · 📋 450 - 9% open · ⏱️ 16.04.2026):

	```
	git clone https://github.com/conda/constructor
	```
- [Conda](https://anaconda.org/anaconda/constructor) (📥 31K · ⏱️ 16.04.2026):
	```
...
- [GitHub](https://github.com/py2exe/py2exe) (👨‍💻 24 · 🔀 110 · 📥 25K · 📦 2.2K · 📋 190 - 12% open · ⏱️ 15.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/py2exe) (📥 12K / month · 📦 11 · ⏱️ 16.07.2025):
	```
	pip install py2exe
	```
</details>
...
- [GitHub](https://github.com/SCons/scons) (👨‍💻 170 · 🔀 340 · 📥 2K · 📦 4.2K · 📋 3.5K - 18% open · ⏱️ 12.04.2026):
...
- [GitHub](https://github.com/pypa/wheel) (👨‍💻 88 · 🔀 170 · 📦 390K · 📋 420 - 3% open · ⏱️ 06.04.2026):
...
- [GitHub](https://github.com/pyinvoke/invoke) (👨‍💻 63 · 🔀 390 · 📦 33K · 📋 860 - 51% open · ⏱️ 07.04.2026):
	...
	```
- [PyPi](https://pypi.org/project/invoke) (📥 71M / month · 📦 1.4K · ⏱️ 07.04.2026):
	```
	pip install invoke
	```
...
- [GitHub](https://github.com/pypa/twine) (👨‍💻 130 · 🔀 320 · 📥 130 · 📦 140K · 📋 560 - 10% open · ⏱️ 07.04.2026):
...
- [GitHub](https://github.com/buildbot/buildbot) (👨‍💻 900 · 🔀 1.6K · 📥 110K · 📦 410 · 📋 1.9K - 41% open · ⏱️ 31.03.2026):
	...
	```
- [PyPi](https://pypi.org/project/buildbot) (📥 48K / month · 📦 20 · ⏱️ 12.05.2025):
	```
...
- [GitHub](https://github.com/pypa/flit) (👨‍💻 82 · 🔀 150 · 📦 2.7K · 📋 440 - 29% open · ⏱️ 15.03.2026):
	...
	```
- [PyPi](https://pypi.org/project/flit) (📥 13M / month · 📦 930 · ⏱️ 25.03.2025):
	```
	pip install flit
	```
- [Conda](https://anaconda.org/conda-forge/flit) (📥 380K · ⏱️ 22.04.2025):
	```
	conda install -c conda-forge flit
	```
</details>
<details><summary><b><a href="https://github.com/pybuilder/pybuilder">pybuilder</a></b> (🥉29 ·  ⭐ 2K) - Software build automation tool for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/pybuilder/pybuilder) (👨‍💻 40 · 🔀 270 · 📋 530 - 19% open · ⏱️ 02.04.2026):
	...
	```
- [PyPi](https://pypi.org/project/pybuilder) (📥 61K / month · 📦 6 · ⏱️ 02.04.2026):
	```
...
- [GitHub](https://github.com/ml-tooling/universal-build) (👨‍💻 5 · 🔀 8 · 📥 23 · 📋 4 - 25% open · ⏱️ 15.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/universal-build) (📥 250 / month · 📦 7 · ⏱️ 16.11.2021):
	```
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 230 · 🔀 1.5K · 📦 780K · 📋 2K - 18% open · ⏱️ 14.04.2026):
...
- [PyPi](https://pypi.org/project/psutil) (📥 310M / month · 📦 20K · ⏱️ 28.01.2026):
	...
	pip install psutil
	```
- [Conda](https://anaconda.org/conda-forge/psutil) (📥 60M · ⏱️ 29.01.2026):
	```
...
- [GitHub](https://github.com/bloomberg/memray) (👨‍💻 65 · 🔀 440 · 📦 2.1K · 📋 270 - 18% open · ⏱️ 08.04.2026):

	```
	git clone https://github.com/bloomberg/memray
	```
- [PyPi](https://pypi.org/project/memray) (📥 16M / month · 📦 150 · ⏱️ 08.04.2026):
	```
	pip install memray
	```
- [Conda](https://anaconda.org/conda-forge/memray) (📥 640K · ⏱️ 08.04.2026):
	```
...
- [GitHub](https://github.com/plasma-umass/scalene) (👨‍💻 61 · 🔀 430 · 📦 1K · 📋 520 - 29% open · ⏱️ 06.04.2026):

	```
	git clone https://github.com/plasma-umass/scalene
	```
- [PyPi](https://pypi.org/project/scalene) (📥 360K / month · 📦 66 · ⏱️ 22.03.2026):
	```
	pip install scalene
	```
</details>
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 53 · 🔀 500 · 📥 53K · 📦 8.2K · 📋 450 - 49% open · ⏱️ 18.08.2025):

	```
	git clone https://github.com/benfred/py-spy
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 19M / month · 📦 110 · ⏱️ 31.07.2025):
	```
	pip install py-spy
	```
...
- [GitHub](https://github.com/pyutils/line_profiler) (👨‍💻 54 · 🔀 130 · 📥 2.2K · 📋 140 - 36% open · ⏱️ 15.04.2026):
...
- [PyPi](https://pypi.org/project/line_profiler) (📥 2.5M / month · 📦 400 · ⏱️ 23.02.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/line_profiler) (📥 5M · ⏱️ 24.02.2026):
	```
...
- [GitHub](https://github.com/pympler/pympler) (👨‍💻 31 · 🔀 89 · 📋 120 - 51% open · ⏱️ 07.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/pympler) (📥 5.5M / month · 📦 260 · ⏱️ 28.06.2024):
	```
	pip install pympler
	```
- [Conda](https://anaconda.org/conda-forge/pympler) (📥 690K · ⏱️ 22.04.2025):
	```
...
- [GitHub](https://github.com/berkerpeksag/astor) (👨‍💻 35 · 🔀 110 · 📋 130 - 24% open · ⏱️ 17.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/astor) (📥 22M / month · 📦 620 · ⏱️ 10.12.2019):
	```
	pip install astor
	```
...
<details><summary><b><a href="https://github.com/alexmojaki/executing">executing</a></b> (🥉26 ·  ⭐ 390 · 💤) - Get information about what a Python frame is currently doing,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/alexmojaki/executing) (👨‍💻 11 · 🔀 39 · 📋 53 - 35% open · ⏱️ 31.08.2025):

	```
	git clone https://github.com/alexmojaki/executing
	```
- [PyPi](https://pypi.org/project/executing) (📥 120M / month · 📦 800 · ⏱️ 01.09.2025):
	```
...
- [PyPi](https://pypi.org/project/asteval) (📥 4M / month · 📦 190 · ⏱️ 17.12.2025):
	...
	pip install asteval
	```
- [Conda](https://anaconda.org/conda-forge/asteval) (📥 910K · ⏱️ 18.12.2025):
	```
...
- [GitHub](https://github.com/pre-commit/pre-commit) (👨‍💻 170 · 🔀 930 · 📥 5.6M · 📦 270K · 📋 2.3K - 1% open · ⏱️ 14.04.2026):

	```
	git clone https://github.com/pre-commit/pre-commit
	```
- [PyPi](https://pypi.org/project/pre-commit) (📥 120M / month · 📦 26K · ⏱️ 16.12.2025):
	```
	pip install pre-commit
	```
- [Conda](https://anaconda.org/conda-forge/pre-commit) (📥 9.4M · ⏱️ 17.12.2025):
	```
