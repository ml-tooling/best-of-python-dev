...
- [GitHub](https://github.com/python/mypy) (👨‍💻 530 · 🔀 2K · 📦 56K · 📋 7.2K - 28% open · ⏱️ 17.01.2022):

	```
	git clone https://github.com/python/mypy
	```
- [PyPi](https://pypi.org/project/mypy) (📥 6.3M / month · 📦 5.4K · ⏱️ 07.01.2022):
	```
	pip install mypy
	```
...
- [GitHub](https://github.com/PyCQA/flake8) (👨‍💻 160 · 🔀 190 · 📦 220K · 📋 1.4K - 2% open · ⏱️ 11.01.2022):
...
- [GitHub](https://github.com/PyCQA/pylint) (👨‍💻 440 · 🔀 800 · 📋 3.9K - 19% open · ⏱️ 17.01.2022):

	```
	git clone https://github.com/PyCQA/pylint
	```
- [PyPi](https://pypi.org/project/pylint) (📥 7.3M / month · 📦 21K · ⏱️ 03.12.2021):
	```
	pip install pylint
	```
...
- [GitHub](https://github.com/PyCQA/pycodestyle) (👨‍💻 130 · 🔀 610 · 📦 180K · 📋 670 - 16% open · ⏱️ 03.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pycodestyle) (📥 15M / month · 📦 11K · ⏱️ 11.10.2021):
	```
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 160 · 🔀 320 · 📦 930 · 📋 990 - 8% open · ⏱️ 12.01.2022):

	```
	git clone https://github.com/wemake-services/wemake-python-styleguide
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 63K / month · 📦 24 · ⏱️ 13.12.2021):
	```
	pip install wemake-python-styleguide
	```
</details>
<details><summary><b><a href="https://github.com/microsoft/pyright">pyright</a></b> (🥈34 ·  ⭐ 7.6K) - Static type checker for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/microsoft/pyright) (👨‍💻 69 · 🔀 410 · 📦 180 · 📋 2.3K - 0% open · ⏱️ 17.01.2022):

	```
	git clone https://github.com/Microsoft/pyright
	```
- [npm](https://www.npmjs.com/package/pyright) (📥 200K / month · 📦 3 · ⏱️ 16.01.2022):
	```
	npm install pyright
	```
</details>
...
- [GitHub](https://github.com/PyCQA/pyflakes) (👨‍💻 79 · 🔀 160 · 📦 110K · 📋 450 - 18% open · ⏱️ 24.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyflakes) (📥 11M / month · 📦 14K · ⏱️ 06.10.2021):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 71 · 🔀 230 · 📋 480 - 20% open · ⏱️ 13.01.2022):

	```
	git clone https://github.com/google/pytype
	```
- [PyPi](https://pypi.org/project/pytype) (📥 120K / month · 📦 88 · ⏱️ 13.01.2022):
	```
	pip install pytype
	```
...
- [GitHub](https://github.com/PyCQA/pylint-django) (👨‍💻 62 · 🔀 100 · 📥 200 · 📦 16K · 📋 190 - 16% open · ⏱️ 08.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pylint-django) (📥 500K / month · 📦 1.2K · ⏱️ 02.01.2022):
	```
...
- [GitHub](https://github.com/PyCQA/pydocstyle) (👨‍💻 77 · 🔀 150 · 📥 56 · 📦 22K · 📋 280 - 29% open · ⏱️ 30.12.2021):

	```
	git clone https://github.com/PyCQA/pydocstyle
	```
- [PyPi](https://pypi.org/project/pydocstyle) (📥 1.5M / month · 📦 2.4K · ⏱️ 17.05.2021):
	```
...
- [PyPi](https://pypi.org/project/parso) (📥 18M / month · 📦 5.9K · ⏱️ 30.11.2021):
	...
	pip install parso
	```
- [Conda](https://anaconda.org/conda-forge/parso) (📥 6.1M · ⏱️ 01.12.2021):
	```
...
- [GitHub](https://github.com/PyCQA/flake8-bugbear) (👨‍💻 47 · 🔀 55 · 📦 6.3K · 📋 110 - 37% open · ⏱️ 12.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/flake8-bugbear) (📥 850K / month · 📦 880 · ⏱️ 12.01.2022):
	```
...
- [GitHub](https://github.com/coala/coala) (👨‍💻 480 · 🔀 1.4K · 📥 150 · 📦 10 · 📋 3.2K - 26% open · ⏱️ 11.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/coala-bears) (📥 3.6K / month · 📦 100 · ⏱️ 10.11.2017):
	```
...
- [GitHub](https://github.com/klen/pylama) (👨‍💻 46 · 🔀 88 · 📦 3.2K · 📋 130 - 29% open · ⏱️ 10.01.2022):

	```
	git clone https://github.com/klen/pylama
	```
- [PyPi](https://pypi.org/project/pylama) (📥 78K / month · 📦 590 · ⏱️ 10.01.2022):
	```
	pip install pylama
	```
</details>
...
- [GitHub](https://github.com/dropbox/mypy-protobuf) (👨‍💻 31 · 🔀 64 · 📋 98 - 4% open · ⏱️ 10.01.2022):

	```
	git clone https://github.com/dropbox/mypy-protobuf
	```
- [PyPi](https://pypi.org/project/mypy-protobuf) (📥 890K / month · 📦 49 · ⏱️ 24.12.2021):
	```
	pip install mypy-protobuf
	```
- [Conda](https://anaconda.org/conda-forge/mypy-protobuf) (📥 18K · ⏱️ 24.12.2021):
	```
...
- [GitHub](https://github.com/terrencepreilly/darglint) (👨‍💻 22 · 🔀 36 · 📦 1.5K · 📋 140 - 33% open · ⏱️ 18.10.2021):

	```
	git clone https://github.com/terrencepreilly/darglint
	```
- [PyPi](https://pypi.org/project/darglint) (📥 190K / month · 📦 53 · ⏱️ 18.10.2021):
	```
...
- [GitHub](https://github.com/adamchainz/flake8-comprehensions) (👨‍💻 12 · 🔀 16 · 📋 42 - 19% open · ⏱️ 11.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/flake8-comprehensions) (📥 440K / month · 📦 530 · ⏱️ 10.01.2022):
	```
...
- [GitHub](https://github.com/zheller/flake8-quotes) (👨‍💻 30 · 🔀 33 · 📦 4.2K · 📋 43 - 6% open · ⏱️ 19.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-quotes) (📥 380K / month · 📦 820 · ⏱️ 15.12.2021):
	```
...
- [GitHub](https://github.com/gforcada/flake8-isort) (👨‍💻 30 · 🔀 40 · 📦 4.5K · 📋 53 - 24% open · ⏱️ 03.12.2021):

	```
	git clone https://github.com/gforcada/flake8-isort
	```
- [PyPi](https://pypi.org/project/flake8-isort) (📥 420K / month · 📦 590 · ⏱️ 14.10.2021):
	```
...
- [GitHub](https://github.com/wemake-services/flake8-eradicate) (👨‍💻 13 · 🔀 7 · 📋 28 - 3% open · ⏱️ 10.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/flake8-eradicate) (📥 200K / month · 📦 65 · ⏱️ 19.10.2021):
	```
	pip install flake8-eradicate
	```
- [Conda](https://anaconda.org/conda-forge/flake8-eradicate) (📥 950 · ⏱️ 19.10.2021):
	```
...
- [GitHub](https://github.com/beartype/beartype) (👨‍💻 9 · 🔀 18 · 📋 64 - 15% open · ⏱️ 15.01.2022):

	```
	git clone https://github.com/beartype/beartype
	```
- [PyPi](https://pypi.org/project/beartype) (📥 37K / month · 📦 23 · ⏱️ 06.11.2021):
	```
...
- [GitHub](https://github.com/PyCQA/flake8-commas) (👨‍💻 12 · 🔀 23 · 📋 31 - 16% open · ⏱️ 13.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-commas) (📥 200K / month · 📦 330 · ⏱️ 13.10.2021):
	```
...
- [GitHub](https://github.com/andreoliwa/nitpick) (👨‍💻 13 · 🔀 13 · 📥 4 · 📋 95 - 31% open · ⏱️ 15.01.2022):

	```
	git clone https://github.com/andreoliwa/nitpick
	```
- [PyPi](https://pypi.org/project/nitpick) (📥 9.5K / month · 📦 3 · ⏱️ 15.01.2022):
	```
	pip install nitpick
	```
</details>
...
- [GitHub](https://github.com/predictive-analytics-lab/data-science-types) (👨‍💻 44 · 🔀 57 · 📦 160 · 📋 62 - 62% open · ⏱️ 16.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/data-science-types) (📥 28K / month · 📦 8 · ⏱️ 16.02.2021):
	```
...
- [GitHub](https://github.com/Instagram/Fixit) (👨‍💻 29 · 🔀 41 · 📦 14 · 📋 57 - 56% open · ⏱️ 07.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/fixit) (📥 5.8K / month · 📦 2 · ⏱️ 30.07.2021):
	```
	pip install fixit
	```
</details>
...
- [GitHub](https://github.com/peterjc/flake8-black) (👨‍💻 5 · 🔀 8 · 📦 1.7K · 📋 21 - 33% open · ⏱️ 27.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-black) (📥 190K / month · 📦 120 · ⏱️ 16.07.2021):
	```
...
- [GitHub](https://github.com/gforcada/flake8-builtins) (👨‍💻 15 · 🔀 18 · 📦 3.2K · 📋 34 - 5% open · ⏱️ 20.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-builtins) (📥 310K / month · 📦 300 · ⏱️ 14.05.2020):
	```
...
- [GitHub](https://github.com/life4/flakehell) (👨‍💻 16 · 🔀 33 · 📥 57 · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/flakehell) (📥 29K / month · 📦 12 · ⏱️ 11.01.2021):
	```
...
- [GitHub](https://github.com/jschaf/pylint-flask) (👨‍💻 7 · 🔀 9 · 📦 5.6K · 📋 10 - 50% open · ⏱️ 10.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pylint-flask) (📥 150K / month · 📦 360 · ⏱️ 30.01.2019):
	```
...
- [GitHub](https://github.com/justinabrahms/imhotep) (👨‍💻 16 · 🔀 37 · 📦 9 · 📋 46 - 50% open · ⏱️ 01.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/imhotep) (📥 55 / month · 📦 5 · ⏱️ 18.09.2016):
	```
	pip install imhotep
	```
</details>
...
- [GitHub](https://github.com/psf/black) (👨‍💻 300 · 🔀 1.5K · 📥 20K · 📦 110K · 📋 1.8K - 19% open · ⏱️ 17.01.2022):

	```
	git clone https://github.com/psf/black
	```
- [PyPi](https://pypi.org/project/black) (📥 8.5M / month · 📦 6.5K · ⏱️ 05.12.2021):
	```
	pip install black
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 250 · 🔀 430 · 📦 210K · 📋 1K - 3% open · ⏱️ 07.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/isort) (📥 13M / month · 📦 14K · ⏱️ 09.11.2021):
	```
	pip install isort
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 140 · 🔀 840 · 📦 28K · 📋 730 - 46% open · ⏱️ 11.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/yapf) (📥 1.3M / month · 📦 2.1K · ⏱️ 26.12.2021):
	```
	pip install yapf
	```
...
- [GitHub](https://github.com/hhatto/autopep8) (👨‍💻 51 · 🔀 250 · 📦 100K · 📋 430 - 21% open · ⏱️ 30.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/autopep8) (📥 2.1M / month · 📦 5.6K · ⏱️ 24.10.2021):
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 68 · 🔀 150 · 📦 34K · 📋 230 - 30% open · ⏱️ 20.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/rope) (📥 460K / month · 📦 1.6K · ⏱️ 15.12.2021):
	```
	pip install rope
	```
...
- [GitHub](https://github.com/asottile/pyupgrade) (👨‍💻 22 · 🔀 91 · 📋 260 - 3% open · ⏱️ 15.01.2022):

	```
	git clone https://github.com/asottile/pyupgrade
	```
- [PyPi](https://pypi.org/project/pyupgrade) (📥 170K / month · 📦 34 · ⏱️ 01.01.2022):
	```
...
- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 30 · 🔀 93 · 📦 1.4K · 📋 150 - 9% open · ⏱️ 03.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/vulture) (📥 170K / month · 📦 220 · ⏱️ 16.01.2021):
	```
	pip install vulture
	```
...
- [GitHub](https://github.com/PyCQA/redbaron) (👨‍💻 34 · 🔀 68 · 📦 340 · 📋 130 - 63% open · ⏱️ 09.12.2021):

	```
	git clone https://github.com/pycqa/redbaron
	```
- [PyPi](https://pypi.org/project/redbaron) (📥 22K / month · 📦 120 · ⏱️ 17.03.2019):
	```
...
- [GitHub](https://github.com/PyCQA/baron) (👨‍💻 33 · 🔀 52 · 📦 190 · 📋 75 - 61% open · ⏱️ 09.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/baron) (📥 22K / month · 📦 59 · ⏱️ 09.12.2021):
	```
	pip install baron
	```
</details>
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 37 · 🔀 130 · 📦 160 · 📋 150 - 24% open · ⏱️ 15.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/monkeytype) (📥 22K / month · 📦 23 · ⏱️ 21.05.2021):
	```
...
- [GitHub](https://github.com/asottile/add-trailing-comma) (👨‍💻 9 · 🔀 14 · 📋 38 - 2% open · ⏱️ 15.01.2022):

	```
	git clone https://github.com/asottile/add-trailing-comma
	```
- [PyPi](https://pypi.org/project/add-trailing-comma) (📥 16K / month · 📦 11 · ⏱️ 20.11.2021):
	```
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 17 · 🔀 54 · 📦 66 · 📋 59 - 44% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyannotate) (📥 2.3K / month · 📦 18 · ⏱️ 16.09.2019):
	```
...
- [GitHub](https://github.com/hakancelik96/unimport) (👨‍💻 13 · 🔀 13 · 📦 18 · 📋 76 - 13% open · ⏱️ 12.01.2022):

	```
	git clone https://github.com/hakancelik96/unimport
	```
- [PyPi](https://pypi.org/project/unimport) (📥 3.2K / month · ⏱️ 14.09.2021):
	```
...
- [GitHub](https://github.com/ilevkivskyi/com2ann) (👨‍💻 4 · 🔀 7 · 📦 7 · 📋 20 - 25% open · ⏱️ 21.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/com2ann) (📥 32K / month · 📦 1 · ⏱️ 21.08.2021):
	```
	pip install com2ann
	```
</details>
...
- <b><a href="https://github.com/myint/unify">unify</a></b> (🥉18 ·  ⭐ 65 · 💀) - Modifies strings to all use the same quote where possible. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/PyCQA/bandit) (👨‍💻 140 · 🔀 390 · 📥 140 · 📦 10K · 📋 560 - 33% open · ⏱️ 13.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/bandit) (📥 1.5M / month · 📦 1.5K · ⏱️ 12.11.2021):
	```
	pip install bandit
	```
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.6K · 📋 4.6K - 1% open · ⏱️ 17.01.2022):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 5.3K / month · 📦 6 · ⏱️ 03.01.2022):
	```
	pip install sqlmap
	```
</details>
...
- [GitHub](https://github.com/Yelp/detect-secrets) (👨‍💻 54 · 🔀 240 · 📋 240 - 34% open · ⏱️ 17.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/detect-secrets) (📥 200K / month · 📦 23 · ⏱️ 14.04.2021):
	```
...
- [GitHub](https://github.com/pyupio/safety) (👨‍💻 35 · 🔀 100 · 📥 120K · 📦 3.3K · 📋 120 - 36% open · ⏱️ 28.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/safety) (📥 580K / month · 📦 320 · ⏱️ 15.01.2021):
	```
	pip install safety
	```
...
- [GitHub](https://github.com/landscapeio/dodgy) (👨‍💻 14 · 🔀 19 · 📦 1.5K · 📋 12 - 75% open · ⏱️ 21.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/dodgy) (📥 140K / month · 📦 280 · ⏱️ 31.12.2019):
	```
	pip install dodgy
	```
...
- [PyPi](https://pypi.org/project/dlint) (📥 77K / month · 📦 29 · ⏱️ 27.10.2021):
	...
	pip install dlint
	```
- [Conda](https://anaconda.org/conda-forge/dlint) (📥 85 · ⏱️ 09.11.2021):
	```
...
- [GitHub](https://github.com/pypa/pipenv) (👨‍💻 400 · 🔀 1.7K · 📦 24K · 📋 3.6K - 15% open · ⏱️ 14.01.2022):

	```
	git clone https://github.com/pypa/pipenv
	```
- [PyPi](https://pypi.org/project/pipenv) (📥 3.5M / month · 📦 1.2K · ⏱️ 08.01.2022):
	```
	pip install pipenv
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 360 · 🔀 2.3K · 📋 1.4K - 2% open · ⏱️ 17.01.2022):
...
- [GitHub](https://github.com/pypa/pip) (👨‍💻 650 · 🔀 2.4K · 📦 70K · 📋 6.1K - 15% open · ⏱️ 14.01.2022):

	```
	git clone https://github.com/pypa/pip
	```
- [PyPi](https://pypi.org/project/pip) (📥 72M / month · 📦 10K · ⏱️ 22.10.2021):
	```
	pip install pip
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 320 · 🔀 1.5K · 📥 10M · 📋 3.6K - 34% open · ⏱️ 17.01.2022):

	```
	git clone https://github.com/python-poetry/poetry
	```
- [PyPi](https://pypi.org/project/poetry) (📥 3.8M / month · 📦 110 · ⏱️ 28.11.2021):
	```
	pip install poetry
	```
...
- [GitHub](https://github.com/conda/conda) (👨‍💻 380 · 🔀 1.1K · 📋 8.3K - 22% open · ⏱️ 13.01.2022):

	```
	git clone https://github.com/conda/conda
	```
- [PyPi](https://pypi.org/project/conda) (📥 69K / month · 📦 1.1K · ⏱️ 22.04.2017):
	```
	pip install conda
	```
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 160 · 🔀 480 · 📋 800 - 16% open · ⏱️ 12.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 3.1M / month · 📦 1.8K · ⏱️ 12.10.2021):
	```
...
- [GitHub](https://github.com/bndr/pipreqs) (👨‍💻 51 · 🔀 270 · 📦 8.5K · 📋 190 - 52% open · ⏱️ 23.10.2021):
...
- [GitHub](https://github.com/pypa/pipx) (👨‍💻 71 · 🔀 210 · 📋 450 - 22% open · ⏱️ 04.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pipx) (📥 67K / month · 📦 6 · ⏱️ 04.01.2022):
	```
	pip install pipx
	```
- [Conda](https://anaconda.org/conda-forge/pipx) (📥 82 · ⏱️ 04.01.2022):
	```
...
- [GitHub](https://github.com/mamba-org/mamba) (👨‍💻 66 · 🔀 140 · 📋 690 - 29% open · ⏱️ 14.01.2022):
...
- [GitHub](https://github.com/dephell/dephell) (👨‍💻 37 · 🔀 110 · 📥 170 · 📦 340 · 📋 270 - 40% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/dephell) (📥 4.6K / month · 📦 12 · ⏱️ 28.04.2020):
	```
	pip install dephell
	```
</details>
...
- [GitHub](https://github.com/David-OConnor/pyflow) (👨‍💻 28 · 🔀 40 · 📥 3.8K · 📋 110 - 38% open · ⏱️ 04.12.2021):
...
- [GitHub](https://github.com/jaraco/pip-run) (👨‍💻 11 · 🔀 10 · 📋 43 - 6% open · ⏱️ 08.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pip-run) (📥 6.7K / month · 📦 1 · ⏱️ 08.01.2022):
	```
	pip install pip-run
	```
</details>
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 78 · 🔀 140 · 📋 300 - 19% open · ⏱️ 17.01.2022):

	```
	git clone https://github.com/PyCQA/prospector
	```
- [PyPi](https://pypi.org/project/prospector) (📥 390K / month · 📦 660 · ⏱️ 17.01.2022):
	```
...
- [GitHub](https://github.com/rubik/radon) (👨‍💻 49 · 🔀 97 · 📦 2.2K · 📋 160 - 13% open · ⏱️ 08.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/radon) (📥 210K / month · 📦 600 · ⏱️ 15.12.2021):
	```
	pip install radon
	```
...
- [GitHub](https://github.com/PyCQA/mccabe) (👨‍💻 21 · 🔀 42 · 📦 240K · 📋 40 - 15% open · ⏱️ 02.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/mccabe) (📥 14M / month · 📦 16K · ⏱️ 26.01.2017):
	```
	pip install mccabe
	```
...
- [GitHub](https://github.com/tonybaloney/wily) (👨‍💻 16 · 🔀 45 · 📋 80 - 35% open · ⏱️ 01.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/wily) (📥 12K / month · 📦 9 · ⏱️ 01.07.2021):
	```
	pip install wily
	```
</details>
...
- [GitHub](https://github.com/rubik/xenon) (👨‍💻 8 · 🔀 16 · 📦 290 · 📋 32 - 21% open · ⏱️ 03.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/xenon) (📥 43K / month · 📦 69 · ⏱️ 03.09.2021):
	```
	pip install xenon
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1.1K · 📥 8.2K · 📦 240K · 📋 870 - 37% open · ⏱️ 20.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/tqdm) (📥 26M / month · 📦 21K · ⏱️ 15.12.2021):
	```
	pip install tqdm
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 120 · 🔀 260 · 📥 4.5K · 📦 17K · 📋 600 - 12% open · ⏱️ 12.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/sentry-sdk) (📥 10M / month · 📦 940 · ⏱️ 10.01.2022):
	```
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 30 · 🔀 470 · 📦 13K · 📋 510 - 18% open · ⏱️ 09.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/loguru) (📥 1.8M / month · 📦 1.1K · ⏱️ 20.09.2020):
	```
	pip install loguru
	```
...
- [GitHub](https://github.com/madzak/python-json-logger) (👨‍💻 46 · 🔀 170 · 📦 20K · 📋 70 - 34% open · ⏱️ 27.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-json-logger) (📥 3.8M / month · 📦 690 · ⏱️ 27.07.2021):
	```
...
- [GitHub](https://github.com/WoLpH/python-progressbar) (👨‍💻 40 · 🔀 100 · 📥 1.6K · 📦 14K · 📋 200 - 5% open · ⏱️ 05.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/progressbar2) (📥 4M / month · 📦 1.5K · ⏱️ 05.01.2022):
	```
...
- [GitHub](https://github.com/astanin/python-tabulate) (👨‍💻 68 · 🔀 86 · 📦 60K · 📋 110 - 45% open · ⏱️ 07.01.2022):
...
- [GitHub](https://github.com/borntyping/python-colorlog) (👨‍💻 30 · 🔀 76 · 📦 13K · ⏱️ 08.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/colorlog) (📥 4.6M / month · 📦 2.4K · ⏱️ 08.11.2021):
	```
...
- [GitHub](https://github.com/xolox/python-coloredlogs) (👨‍💻 16 · 🔀 37 · 📦 10K · 📋 74 - 33% open · ⏱️ 11.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/coloredlogs) (📥 1.7M / month · 📦 1.7K · ⏱️ 11.06.2021):
	```
	pip install coloredlogs
	```
- [Conda](https://anaconda.org/anaconda/coloredlogs) (📥 3.6K · ⏱️ 14.01.2022):
	```
...
- [GitHub](https://github.com/shobrook/rebound) (👨‍💻 16 · 🔀 360 · 📥 180 · 📦 22 · 📋 58 - 34% open · ⏱️ 04.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/rebound) (📥 2.3K / month · 📦 16 · ⏱️ 13.01.2022):
	```
	pip install rebound
	```
- [Conda](https://anaconda.org/conda-forge/rebound) (📥 170K · ⏱️ 14.01.2022):
	```
	conda install -c conda-forge rebound
	```
</details>
<details><summary><b><a href="https://github.com/rsalmei/alive-progress">alive-progress</a></b> (🥉24 ·  ⭐ 3K · 📉) - A new kind of Progress Bar, with real-time throughput, ETA,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 1 · 🔀 130 · 📦 550 · 📋 97 - 25% open · ⏱️ 06.11.2021):

	```
	git clone https://github.com/rsalmei/alive-progress
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 20K / month · 📦 49 · ⏱️ 19.10.2021):
	```
...
- [GitHub](https://github.com/Qix-/better-exceptions) (👨‍💻 15 · 🔀 200 · 📋 70 - 41% open · ⏱️ 19.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/better-exceptions) (📥 24K / month · 📦 58 · ⏱️ 29.01.2021):
	```
...
- [PyPi](https://pypi.org/project/pretty_errors) (📥 22K / month · 📦 39 · ⏱️ 24.11.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pretty_errors) (📥 3.5K · ⏱️ 27.11.2021):
	```
...
- [GitHub](https://github.com/cknd/stackprinter) (👨‍💻 6 · 🔀 33 · 📦 86 · 📋 26 - 42% open · ⏱️ 01.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/stackprinter) (📥 310K / month · 📦 20 · ⏱️ 31.10.2020):
	```
	pip install stackprinter
	```
- [Conda](https://anaconda.org/conda-forge/stackprinter) (📥 2.9K · ⏱️ 31.10.2020):
	```
...
- [PyPi](https://pypi.org/project/python-devtools) (📥 380 / month · 📦 1 · ⏱️ 21.08.2017):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-devtools) (📥 1.4K · ⏱️ 29.09.2021):
	```
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (👨‍💻 710 · 🔀 1.6K · 📦 180K · 📋 5.9K - 16% open · ⏱️ 17.01.2022):

	```
	git clone https://github.com/sphinx-doc/sphinx
	```
- [PyPi](https://pypi.org/project/sphinx) (📥 3.7M / month · 📦 59K · ⏱️ 16.01.2022):
	```
	pip install sphinx
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs) (👨‍💻 210 · 🔀 1.8K · 📦 18K · 📋 1.6K - 6% open · ⏱️ 08.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/mkdocs) (📥 610K / month · 📦 3.5K · ⏱️ 15.12.2021):
	```
	pip install mkdocs
	```
...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 140 · 🔀 2K · 📦 11K · 📋 1.3K - 0% open · ⏱️ 16.01.2022):

	```
	git clone https://github.com/squidfunk/mkdocs-material
	```
- [PyPi](https://pypi.org/project/mkdocs-material) (📥 620K / month · 📦 1.1K · ⏱️ 16.01.2022):
	```
...
<details><summary><b><a href="https://github.com/readthedocs/sphinx_rtd_theme">sphinx_rtd_theme</a></b> (🥈35 ·  ⭐ 3.9K · 📈) - Sphinx theme for readthedocs.org. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.sphinx-doc.org/en/master/_static/favicon.svg" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/readthedocs/sphinx_rtd_theme) (👨‍💻 110 · 🔀 1.6K · 📦 16 · 📋 740 - 26% open · ⏱️ 19.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/sphinx_rtd_theme) (📥 1.6M / month · 📦 12K · ⏱️ 05.10.2018):
	```
...
- [GitHub](https://github.com/numpy/numpydoc) (👨‍💻 70 · 🔀 6.4K · 📦 30K · 📋 160 - 36% open · ⏱️ 10.01.2022):
...
- [PyPi](https://pypi.org/project/numpydoc) (📥 210K / month · 📦 4.3K · ⏱️ 01.07.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/numpydoc) (📥 910K · ⏱️ 01.10.2020):
	```
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 33 · 🔀 120 · 📦 490 · 📋 210 - 3% open · ⏱️ 17.01.2022):

	```
	git clone https://github.com/mitmproxy/pdoc
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 92K / month · 📦 180 · ⏱️ 14.01.2022):
	```
	pip install pdoc
	```
</details>
...
- [GitHub](https://github.com/bitprophet/alabaster) (👨‍💻 28 · 🔀 180 · 📦 57K · 📋 140 - 60% open · ⏱️ 24.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/alabaster) (📥 3.3M / month · 📦 7.7K · ⏱️ 03.10.2018):
	```
...
- [GitHub](https://github.com/michaeljones/breathe) (👨‍💻 99 · 🔀 150 · 📥 180 · 📦 5.7K · 📋 480 - 25% open · ⏱️ 28.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/breathe) (📥 160K / month · 📦 1K · ⏱️ 14.09.2021):
	```
	pip install breathe
	```
...
- [GitHub](https://github.com/tox-dev/sphinx-autodoc-typehints) (👨‍💻 34 · 🔀 76 · 📋 130 - 16% open · ⏱️ 11.01.2022):

	```
	git clone https://github.com/tox-dev/sphinx-autodoc-typehints
	```
- [PyPi](https://pypi.org/project/sphinx-autodoc-typehints) (📥 310K / month · 📦 1.3K · ⏱️ 11.01.2022):
	```
...
- [GitHub](https://github.com/pdoc3/pdoc) (👨‍💻 56 · 🔀 120 · 📦 1.2K · 📋 270 - 31% open · ⏱️ 24.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/pdoc3) (📥 140K / month · 📦 120 · ⏱️ 03.08.2021):
	```
	pip install pdoc3
	```
...
- [GitHub](https://github.com/mkdocstrings/mkdocstrings) (👨‍💻 26 · 🔀 59 · 📋 220 - 25% open · ⏱️ 28.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/mkdocstrings) (📥 88K / month · 📦 140 · ⏱️ 27.12.2021):
	```
...
- [GitHub](https://github.com/ryan-roemer/sphinx-bootstrap-theme) (👨‍💻 38 · 🔀 210 · 📋 140 - 40% open · ⏱️ 02.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/sphinx-bootstrap-theme) (📥 290K / month · 📦 590 · ⏱️ 12.09.2021):
	```
...
- [GitHub](https://github.com/econchick/interrogate) (👨‍💻 12 · 🔀 26 · 📦 1.3K · 📋 31 - 25% open · ⏱️ 27.12.2021):

	```
	git clone https://github.com/econchick/interrogate
	```
- [PyPi](https://pypi.org/project/interrogate) (📥 61K / month · 📦 35 · ⏱️ 10.09.2021):
	```
...
- [GitHub](https://github.com/executablebooks/sphinx-autobuild) (👨‍💻 17 · 🔀 51 · 📋 58 - 24% open · ⏱️ 14.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/sphinx-autobuild) (📥 170K / month · 📦 2.6K · ⏱️ 14.03.2021):
	```
...
- [GitHub](https://github.com/bitprophet/releases) (👨‍💻 10 · 🔀 36 · 📦 410 · 📋 76 - 43% open · ⏱️ 24.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/releases) (📥 11K / month · 📦 360 · ⏱️ 11.01.2020):
	```
...
<details><summary><b><a href="https://github.com/lukasgeiter/mkdocs-awesome-pages-plugin">mkdocs-awesome-pages-plugin</a></b> (🥉21 ·  ⭐ 210) - An MkDocs plugin that simplifies configuring page.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-pages-plugin) (👨‍💻 3 · 🔀 20 · 📋 47 - 17% open · ⏱️ 27.12.2021):

	```
	git clone https://github.com/lukasgeiter/mkdocs-awesome-pages-plugin
	```
- [PyPi](https://pypi.org/project/mkdocs-awesome-pages-plugin) (📥 33K / month · 📦 60 · ⏱️ 22.11.2021):
	```
...
- [GitHub](https://github.com/orzih/mkdocs-with-pdf) (👨‍💻 6 · 🔀 23 · 📦 93 · 📋 67 - 44% open · ⏱️ 14.10.2021):
...
- [GitHub](https://github.com/timothycrosley/portray) (👨‍💻 16 · 🔀 58 · 📋 52 - 42% open · ⏱️ 13.06.2021):

	```
	git clone https://github.com/timothycrosley/portray
	```
- [PyPi](https://pypi.org/project/portray) (📥 3.6K / month · 📦 17 · ⏱️ 13.06.2021):
	```
	pip install portray
	```
</details>
...
- [GitHub](https://github.com/ml-tooling/lazydocs) (👨‍💻 7 · 🔀 17 · 📦 57 · 📋 11 - 63% open · ⏱️ 20.08.2021):

	```
	git clone https://github.com/ml-tooling/lazydocs
	```
- [PyPi](https://pypi.org/project/lazydocs) (📥 1.5K / month · 📦 12 · ⏱️ 27.07.2021):
	```
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 81 · 🔀 190 · 📦 2.8K · 📋 290 - 48% open · ⏱️ 16.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pudb) (📥 140K / month · 📦 730 · ⏱️ 07.01.2022):
	```
	pip install pudb
	```
...
- [GitHub](https://github.com/cool-RR/PySnooper) (👨‍💻 26 · 🔀 920 · 📦 540 · 📋 110 - 15% open · ⏱️ 14.01.2022):

	```
	git clone https://github.com/cool-RR/PySnooper
	```
- [PyPi](https://pypi.org/project/pysnooper) (📥 160K / month · 📦 48 · ⏱️ 14.01.2022):
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 82 · 🔀 410 · 📦 2.9K · 📋 180 - 32% open · ⏱️ 13.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 610K / month · 📦 520 · ⏱️ 27.10.2020):
	```
...
- [GitHub](https://github.com/cs01/gdbgui) (👨‍💻 39 · 🔀 480 · 📥 6.6K · 📦 130 · 📋 280 - 42% open · ⏱️ 16.01.2022):

	```
	git clone https://github.com/cs01/gdbgui
	```
- [PyPi](https://pypi.org/project/gdbgui) (📥 85K / month · 📦 2 · ⏱️ 06.09.2021):
	```
	pip install gdbgui
	```
</details>
...
- [GitHub](https://github.com/agronholm/typeguard) (👨‍💻 19 · 🔀 69 · 📋 180 - 16% open · ⏱️ 10.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/typeguard) (📥 10M / month · 📦 300 · ⏱️ 10.12.2021):
	```
...
- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 40 · 🔀 46 · 📦 2.5K · 📋 180 - 35% open · ⏱️ 27.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pdbpp) (📥 160K / month · 📦 590 · ⏱️ 09.07.2021):
	```
	pip install pdbpp
	```
...
- [GitHub](https://github.com/gruns/icecream) (👨‍💻 16 · 🔀 120 · 📋 86 - 30% open · ⏱️ 31.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/icecream) (📥 100K / month · 📦 30 · ⏱️ 22.06.2021):
	```
...
<details><summary><b><a href="https://github.com/alexmojaki/snoop">snoop</a></b> (🥉24 ·  ⭐ 680) - A powerful set of Python debugging tools, based on PySnooper. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/alexmojaki/snoop) (👨‍💻 21 · 🔀 24 · 📋 39 - 46% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/snoop) (📥 15K / month · 📦 12 · ⏱️ 11.11.2021):
	```
	pip install snoop
	```
- [Conda](https://anaconda.org/conda-forge/snoop) (📥 190 · ⏱️ 11.11.2021):
	```
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 36 · 📦 78 · 📋 87 - 42% open · ⏱️ 15.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/hunter) (📥 6K / month · 📦 21 · ⏱️ 15.12.2021):
	```
	pip install hunter
	```
- [Conda](https://anaconda.org/conda-forge/hunter) (📥 3K · ⏱️ 16.12.2021):
	```
...
- [GitHub](https://github.com/alexmojaki/birdseye) (👨‍💻 10 · 🔀 70 · 📋 50 - 36% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/birdseye) (📥 1.3K / month · 📦 3 · ⏱️ 11.11.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest) (👨‍💻 760 · 🔀 1.9K · 📦 430K · 📋 4.8K - 15% open · ⏱️ 16.01.2022):

	```
	git clone https://github.com/pytest-dev/pytest
	```
- [PyPi](https://pypi.org/project/pytest) (📥 27M / month · 📦 80K · ⏱️ 07.12.2021):
	```
	pip install pytest
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 150 · 🔀 1.8K · 📥 510 · 📦 4.8K · 📋 3.7K - 5% open · ⏱️ 16.01.2022):

	```
	git clone https://github.com/robotframework/robotframework
	```
- [PyPi](https://pypi.org/project/robotframework) (📥 700K / month · 📦 1K · ⏱️ 15.12.2021):
	```
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 260 · 🔀 480 · 📦 11K · 📋 1.2K - 4% open · ⏱️ 17.01.2022):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 1.7M / month · 📦 1.9K · ⏱️ 17.01.2022):
	```
	pip install hypothesis
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 5.2M · ⏱️ 08.01.2022):
	```
...
- [GitHub](https://github.com/tox-dev/tox) (👨‍💻 250 · 🔀 390 · 📦 53K · 📋 1.4K - 9% open · ⏱️ 13.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/tox) (📥 3.4M / month · 📦 20K · ⏱️ 04.01.2022):
	```
	pip install tox
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-cov) (👨‍💻 74 · 🔀 160 · 📦 110K · 📋 310 - 35% open · ⏱️ 21.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-cov) (📥 8.6M / month · 📦 28K · ⏱️ 04.10.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-xdist) (👨‍💻 77 · 🔀 160 · 📋 460 - 44% open · ⏱️ 11.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytest-xdist) (📥 4M / month · 📦 4.5K · ⏱️ 10.12.2021):
	```
...
- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 800 · 📦 12K · 📋 540 - 63% open · ⏱️ 14.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyautogui) (📥 460K / month · 📦 540 · ⏱️ 07.07.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-mock) (👨‍💻 54 · 🔀 100 · 📦 22K · 📋 110 - 12% open · ⏱️ 10.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytest-mock) (📥 4.1M / month · 📦 4.2K · ⏱️ 06.05.2021):
	```
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 280 · 📥 190 · 📋 300 - 1% open · ⏱️ 17.01.2022):

	```
	git clone https://github.com/lk-geimfari/mimesis
	```
- [PyPi](https://pypi.org/project/mimesis) (📥 86K / month · 📦 57 · ⏱️ 11.12.2021):
	```
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 4.5K · ⏱️ 15.07.2020):
	```
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 97 · 🔀 220 · 📋 260 - 34% open · ⏱️ 25.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/freezegun) (📥 2.7M / month · 📦 4.4K · ⏱️ 20.01.2021):
	```
...
- [GitHub](https://github.com/microsoft/playwright-python) (👨‍💻 23 · 🔀 500 · 📦 690 · 📋 550 - 4% open · ⏱️ 13.01.2022):
...
<details><summary><b><a href="https://github.com/pytest-dev/pytest-asyncio">pytest-asyncio</a></b> (🥈31 ·  ⭐ 860) - Pytest support for asyncio. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pytest-dev/pytest-asyncio) (👨‍💻 36 · 🔀 97 · 📋 180 - 18% open · ⏱️ 17.01.2022):

	```
	git clone https://github.com/pytest-dev/pytest-asyncio
	```
- [PyPi](https://pypi.org/project/pytest-asyncio) (📥 1.8M / month · 📦 1.8K · ⏱️ 17.01.2022):
	```
	pip install pytest-asyncio
	```
- [Conda](https://anaconda.org/conda-forge/pytest-asyncio) (📥 760K · ⏱️ 13.01.2022):
	```
...
- [GitHub](https://github.com/TheKevJames/coveralls-python) (👨‍💻 63 · 🔀 180 · 📦 20K · 📋 150 - 3% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/coveralls) (📥 400K / month · 📦 9.2K · ⏱️ 11.11.2021):
	```
	pip install coveralls
	```
- [Conda](https://anaconda.org/conda-forge/coveralls) (📥 600K · ⏱️ 12.11.2021):
	```
...
- [GitHub](https://github.com/hamcrest/PyHamcrest) (👨‍💻 37 · 🔀 91 · 📋 69 - 27% open · ⏱️ 27.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyhamcrest) (📥 770K / month · 📦 1.8K · ⏱️ 12.12.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-html) (👨‍💻 43 · 🔀 180 · 📦 15K · 📋 280 - 34% open · ⏱️ 17.01.2022):
...
- [GitHub](https://github.com/pytest-dev/pytest-bdd) (👨‍💻 45 · 🔀 160 · 📋 300 - 50% open · ⏱️ 15.01.2022):

	```
	git clone https://github.com/pytest-dev/pytest-bdd
	```
- [PyPi](https://pypi.org/project/pytest-bdd) (📥 180K / month · 📦 170 · ⏱️ 25.10.2021):
	```
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 71 · 🔀 130 · 📦 4.4K · 📋 260 - 21% open · ⏱️ 03.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/nose2) (📥 360K / month · 📦 1.1K · ⏱️ 27.01.2021):
	```
	pip install nose2
	```
...
- [GitHub](https://github.com/theacodes/nox) (👨‍💻 65 · 🔀 100 · 📋 260 - 11% open · ⏱️ 12.01.2022):

	```
	git clone https://github.com/theacodes/nox
	```
- [PyPi](https://pypi.org/project/nox) (📥 620K / month · 📦 140 · ⏱️ 07.01.2022):
	```
	pip install nox
	```
...
- [GitHub](https://github.com/datadriventests/ddt) (👨‍💻 36 · 🔀 100 · 📦 3.9K · 📋 53 - 28% open · ⏱️ 04.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/ddt) (📥 190K / month · 📦 1.3K · ⏱️ 04.10.2021):
	```
	pip install ddt
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-testinfra) (👨‍💻 110 · 🔀 280 · 📋 320 - 36% open · ⏱️ 07.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-testinfra) (📥 110K / month · 📦 4 · ⏱️ 07.12.2021):
	```
	pip install pytest-testinfra
	```
- [Conda](https://anaconda.org/conda-forge/pytest-testinfra) (📥 2.3K · ⏱️ 12.12.2021):
	```
...
- [GitHub](https://github.com/ionelmc/pytest-benchmark) (👨‍💻 34 · 🔀 92 · 📦 2.5K · 📋 160 - 50% open · ⏱️ 14.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-benchmark) (📥 280K / month · 📦 560 · ⏱️ 17.04.2021):
	```
...
- [GitHub](https://github.com/airspeed-velocity/asv) (👨‍💻 55 · 🔀 130 · 📦 220 · 📋 420 - 27% open · ⏱️ 15.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/asv) (📥 25K / month · 📦 63 · ⏱️ 16.05.2020):
	```
	pip install asv
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-randomly) (👨‍💻 16 · 🔀 22 · 📋 48 - 12% open · ⏱️ 15.01.2022):

	```
	git clone https://github.com/pytest-dev/pytest-randomly
	```
- [PyPi](https://pypi.org/project/pytest-randomly) (📥 310K / month · 📦 180 · ⏱️ 10.01.2022):
	```
	pip install pytest-randomly
	```
- [Conda](https://anaconda.org/conda-forge/pytest-randomly) (📥 12K · ⏱️ 10.01.2022):
	```
	conda install -c conda-forge pytest-randomly
	```
</details>
<details><summary><b><a href="https://github.com/dbader/pytest-mypy">pytest-mypy</a></b> (🥉25 ·  ⭐ 200 · 💤) - Mypy static type checker plugin for Pytest. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/dbader/pytest-mypy) (👨‍💻 15 · 🔀 33 · 📦 1.4K · 📋 48 - 18% open · ⏱️ 16.06.2021):

	```
	git clone https://github.com/dbader/pytest-mypy
	```
- [PyPi](https://pypi.org/project/pytest-mypy) (📥 410K / month · 📦 280 · ⏱️ 21.03.2021):
	```
...
<details><summary><b><a href="https://github.com/man-group/pytest-plugins">pytest-plugins</a></b> (🥉24 ·  ⭐ 400 · 📈) - A grab-bag of nifty pytest plugins. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/man-group/pytest-plugins) (👨‍💻 57 · 🔀 60 · 📋 100 - 43% open · ⏱️ 19.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-virtualenv) (📥 7.3K / month · 📦 63 · ⏱️ 28.05.2019):
	```
...
- [GitHub](https://github.com/Erotemic/xdoctest) (👨‍💻 7 · 🔀 7 · 📦 2K · 📋 37 - 45% open · ⏱️ 20.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/xdoctest) (📥 90K / month · 📦 62 · ⏱️ 06.10.2021):
	```
	pip install xdoctest
	```
- [Conda](https://anaconda.org/conda-forge/xdoctest) (📥 11K · ⏱️ 10.08.2021):
	```
...
- [GitHub](https://github.com/tarpas/pytest-testmon) (👨‍💻 16 · 🔀 29 · 📋 120 - 24% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-testmon) (📥 90K / month · 📦 54 · ⏱️ 22.10.2021):
	```
...
- [GitHub](https://github.com/TvoroG/pytest-lazy-fixture) (👨‍💻 8 · 🔀 15 · 📦 520 · 📋 35 - 42% open · ⏱️ 17.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-lazy-fixture) (📥 220K / month · 📦 54 · ⏱️ 01.02.2020):
	```
...
- [GitHub](https://github.com/avast/pytest-docker) (👨‍💻 11 · 🔀 43 · 📥 83 · 📋 33 - 51% open · ⏱️ 14.06.2021):

	```
	git clone https://github.com/avast/pytest-docker
	```
- [PyPi](https://pypi.org/project/pytest-docker) (📥 49K / month · 📦 23 · ⏱️ 14.06.2021):
	```
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 420 · 🔀 1.8K · 📥 720K · 📋 4.4K - 7% open · ⏱️ 16.01.2022):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 560K / month · 📦 130 · ⏱️ 12.01.2022):
	```
...
- [GitHub](https://github.com/pypa/packaging) (👨‍💻 73 · 🔀 180 · 📥 220 · 📦 300K · 📋 230 - 28% open · ⏱️ 15.01.2022):

	```
	git clone https://github.com/pypa/packaging
	```
- [PyPi](https://pypi.org/project/packaging) (📥 81M / month · 📦 17K · ⏱️ 18.11.2021):
	```
...
- [GitHub](https://github.com/Nuitka/Nuitka) (👨‍💻 110 · 🔀 360 · 📋 1.2K - 15% open · ⏱️ 17.01.2022):

	```
	git clone https://github.com/Nuitka/Nuitka
	```
- [PyPi](https://pypi.org/project/nuitka) (📥 21K / month · 📦 35 · ⏱️ 16.01.2022):
	```
	pip install nuitka
	```
...
- [GitHub](https://github.com/pantsbuild/pex) (👨‍💻 100 · 🔀 210 · 📥 570K · 📋 780 - 18% open · ⏱️ 11.01.2022):

	```
	git clone https://github.com/pantsbuild/pex
	```
- [PyPi](https://pypi.org/project/pex) (📥 140K / month · 📦 130 · ⏱️ 11.01.2022):
	```
	pip install pex
	```
</details>
...
- [GitHub](https://github.com/marcelotduarte/cx_Freeze) (👨‍💻 93 · 🔀 170 · 📋 720 - 8% open · ⏱️ 17.01.2022):

	```
	git clone https://github.com/marcelotduarte/cx_Freeze
	```
- [PyPi](https://pypi.org/project/cx_freeze) (📥 45K / month · 📦 150 · ⏱️ 16.12.2017):
	```
	pip install cx_freeze
	```
- [Conda](https://anaconda.org/conda-forge/cx_freeze) (📥 110K · ⏱️ 14.01.2022):
	```
...
- [GitHub](https://github.com/beeware/briefcase) (👨‍💻 88 · 🔀 220 · 📋 370 - 30% open · ⏱️ 11.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/briefcase) (📥 3.4K / month · 📦 16 · ⏱️ 06.03.2021):
	```
...
- [GitHub](https://github.com/py2exe/py2exe) (👨‍💻 14 · 🔀 44 · 📥 7.3K · 📦 1.4K · 📋 97 - 5% open · ⏱️ 16.11.2021):

	```
	git clone https://github.com/py2exe/py2exe
	```
- [PyPi](https://pypi.org/project/py2exe) (📥 20K / month · 📦 180 · ⏱️ 15.12.2021):
	```
	pip install py2exe
	```
</details>
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 34 · 🔀 75 · 📥 170 · 📋 100 - 32% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/linkedin/shiv
	```
- [PyPi](https://pypi.org/project/shiv) (📥 4.7K / month · 📦 12 · ⏱️ 18.11.2021):
	```
	pip install shiv
	```
</details>
...
- [GitHub](https://github.com/pypa/setuptools) (👨‍💻 480 · 🔀 810 · 📥 110 · 📦 130K · 📋 1.9K - 24% open · ⏱️ 17.01.2022):
...
- [GitHub](https://github.com/buildbot/buildbot) (👨‍💻 810 · 🔀 1.6K · 📥 19K · 📦 260 · 📋 1.4K - 45% open · ⏱️ 17.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/buildbot) (📥 57K / month · 📦 460 · ⏱️ 16.10.2021):
	```
...
- [GitHub](https://github.com/pypa/twine) (👨‍💻 100 · 🔀 250 · 📦 52K · 📋 390 - 9% open · ⏱️ 31.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/twine) (📥 2M / month · 📦 12K · ⏱️ 07.12.2021):
	```
	pip install twine
	```
...
- [GitHub](https://github.com/pypa/wheel) (👨‍💻 64 · 🔀 100 · 📋 330 - 8% open · ⏱️ 11.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/wheel) (📥 98M / month · 📦 35K · ⏱️ 22.12.2021):
	```
	pip install wheel
	```
...
- [GitHub](https://github.com/pydoit/doit) (👨‍💻 62 · 🔀 140 · 📦 850 · 📋 260 - 24% open · ⏱️ 16.01.2022):

	```
	git clone https://github.com/pydoit/doit
	```
- [PyPi](https://pypi.org/project/doit) (📥 130K / month · 📦 280 · ⏱️ 12.01.2022):
	```
	pip install doit
	```
...
- [GitHub](https://github.com/SCons/scons) (👨‍💻 140 · 🔀 250 · 📥 390 · 📋 3.3K - 19% open · ⏱️ 16.01.2022):
...
- [GitHub](https://github.com/pypa/flit) (👨‍💻 50 · 🔀 91 · 📋 300 - 33% open · ⏱️ 10.01.2022):

	```
	git clone https://github.com/pypa/flit
	```
- [PyPi](https://pypi.org/project/flit) (📥 220K / month · 📦 200 · ⏱️ 27.12.2021):
	```
	pip install flit
	```
...
- [GitHub](https://github.com/pybuilder/pybuilder) (👨‍💻 36 · 🔀 240 · 📋 500 - 18% open · ⏱️ 12.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pybuilder) (📥 15K / month · 📦 60 · ⏱️ 12.01.2022):
	```
	pip install pybuilder
	```
- [Conda](https://anaconda.org/conda-forge/pybuilder) (📥 8.8K · ⏱️ 12.01.2022):
	```
...
- [GitHub](https://github.com/nicolargo/glances) (👨‍💻 150 · 🔀 1.3K · 📥 710 · 📦 370 · 📋 1.4K - 14% open · ⏱️ 15.01.2022):
...
- [GitHub](https://github.com/joerick/pyinstrument) (👨‍💻 38 · 🔀 160 · 📦 480 · 📋 95 - 15% open · ⏱️ 17.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyinstrument) (📥 200K / month · 📦 97 · ⏱️ 14.11.2021):
	```
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 29 · 🔀 280 · 📥 7.4K · 📋 240 - 29% open · ⏱️ 17.01.2022):

	```
	git clone https://github.com/benfred/py-spy
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 440K / month · 📦 35 · ⏱️ 13.11.2021):
	```
	pip install py-spy
	```
- [Conda](https://anaconda.org/conda-forge/py-spy) (📥 220K · ⏱️ 18.12.2021):
	```
	conda install -c conda-forge py-spy
	```
- [Cargo](https://crates.io/crates/py-spy) (📥 20K / month · ⏱️ 13.11.2021):
	```
...
- [GitHub](https://github.com/plasma-umass/scalene) (👨‍💻 24 · 🔀 170 · 📦 77 · 📋 170 - 22% open · ⏱️ 15.01.2022):

	```
	git clone https://github.com/plasma-umass/scalene
	```
- [PyPi](https://pypi.org/project/scalene) (📥 4.8K / month · 📦 3 · ⏱️ 12.01.2022):
	```
	pip install scalene
	```
</details>
...
- [GitHub](https://github.com/python-diamond/Diamond) (👨‍💻 360 · 🔀 590 · 📦 72 · 📋 370 - 63% open · ⏱️ 15.01.2022):
...
- [GitHub](https://github.com/pyutils/line_profiler) (👨‍💻 27 · 🔀 250 · 📋 51 - 56% open · ⏱️ 06.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/line_profiler) (📥 100K / month · 📦 350 · ⏱️ 20.12.2017):
	```
...
- [GitHub](https://github.com/pythonprofilers/memory_profiler) (👨‍💻 91 · 🔀 330 · 📋 220 - 51% open · ⏱️ 17.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 390K / month · 📦 270 · ⏱️ 16.08.2018):
	```
...
<details><summary><b><a href="https://github.com/pympler/pympler">pympler</a></b> (🥈28 ·  ⭐ 860) - Development tool to measure, monitor and analyze the memory behavior.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [PyPi](https://pypi.org/project/bpytop) (📥 10K / month · 📦 1 · ⏱️ 22.12.2021):
	...
	pip install bpytop
	```
- [Conda](https://anaconda.org/conda-forge/bpytop) (📥 3.6K · ⏱️ 22.12.2021):
	```
...
- [GitHub](https://github.com/sumerc/yappi) (👨‍💻 27 · 🔀 53 · 📦 510 · 📋 55 - 30% open · ⏱️ 08.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/yappi) (📥 970K / month · 📦 340 · ⏱️ 15.12.2021):
	```
	pip install yappi
	```
...
- [GitHub](https://github.com/nvdv/vprof) (👨‍💻 17 · 🔀 170 · 📦 88 · 📋 82 - 31% open · ⏱️ 20.02.2021):
...
- [PyPi](https://pypi.org/project/heartrate) (📥 860 / month · 📦 3 · ⏱️ 13.11.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/heartrate) (📥 400 · ⏱️ 13.11.2021):
	```
...
- [GitHub](https://github.com/python/typed_ast) (👨‍💻 24 · 🔀 51 · 📋 89 - 6% open · ⏱️ 01.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/typed_ast) (📥 9.7M / month · 📦 5.5K · ⏱️ 03.12.2021):
	```
	pip install typed_ast
	```
- [Conda](https://anaconda.org/conda-forge/typed-ast) (📥 3.3M · ⏱️ 05.12.2021):
	```
...
- [GitHub](https://github.com/berkerpeksag/astor) (👨‍💻 31 · 🔀 84 · 📋 110 - 31% open · ⏱️ 27.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/astor) (📥 4.9M / month · 📦 2.1K · ⏱️ 10.12.2019):
	```
	pip install astor
	```
...
- [GitHub](https://github.com/newville/asteval) (👨‍💻 19 · 🔀 32 · 📦 710 · 📋 56 - 17% open · ⏱️ 16.01.2022):

	```
	git clone https://github.com/newville/asteval
	```
- [PyPi](https://pypi.org/project/asteval) (📥 120K / month · 📦 160 · ⏱️ 16.01.2022):
	```
	pip install asteval
	```
...
- [GitHub](https://github.com/pre-commit/pre-commit) (👨‍💻 130 · 🔀 520 · 📥 26K · 📋 1.3K - 1% open · ⏱️ 16.01.2022):

	```
	git clone https://github.com/pre-commit/pre-commit
	```
- [PyPi](https://pypi.org/project/pre-commit) (📥 3M / month · 📦 2.7K · ⏱️ 30.11.2021):
	```
