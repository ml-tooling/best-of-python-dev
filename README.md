...
- [GitHub](https://github.com/python/mypy) (👨‍💻 500 · 🔀 1.9K · 📦 48K · 📋 6.9K - 28% open · ⏱️ 27.10.2021):
...
- [PyPi](https://pypi.org/project/mypy) (📦 6.1K · ⏱️ 22.06.2021):
	...
	pip install mypy
	```
- [Conda](https://anaconda.org/conda-forge/mypy) (📥 1.4M · ⏱️ 23.06.2021):
	```
...
- [GitHub](https://github.com/PyCQA/flake8) (👨‍💻 160 · 🔀 170 · 📦 200K · 📋 1.3K - 2% open · ⏱️ 18.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8) (📥 13M / month · 📦 71K · ⏱️ 11.10.2021):
	```
	pip install flake8
	```
- [Conda](https://anaconda.org/conda-forge/flake8) (📥 3.2M · ⏱️ 12.10.2021):
	```
...
- [GitHub](https://github.com/PyCQA/pyflakes) (👨‍💻 78 · 🔀 160 · 📦 100K · 📋 440 - 18% open · ⏱️ 06.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyflakes) (📥 13M / month · 📦 26K · ⏱️ 06.10.2021):
	```
...
- [GitHub](https://github.com/PyCQA/pycodestyle) (👨‍💻 130 · 🔀 610 · 📦 170K · 📋 660 - 17% open · ⏱️ 13.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pycodestyle) (📥 18M / month · 📦 21K · ⏱️ 11.10.2021):
	```
...
- [GitHub](https://github.com/openstack/hacking) (👨‍💻 180 · 🔀 66 · ⏱️ 07.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/hacking) (📥 470K / month · 📦 8.7K · ⏱️ 21.04.2021):
	```
	pip install hacking
	```
</details>
...
- [GitHub](https://github.com/PyCQA/pylint) (👨‍💻 420 · 🔀 760 · 📋 3.7K - 19% open · ⏱️ 27.10.2021):
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 69 · 🔀 220 · 📋 450 - 21% open · ⏱️ 25.10.2021):

	```
	git clone https://github.com/google/pytype
	```
- [PyPi](https://pypi.org/project/pytype) (📥 130K / month · 📦 88 · ⏱️ 25.10.2021):
	```
	pip install pytype
	```
...
- [GitHub](https://github.com/PyCQA/flake8-bugbear) (👨‍💻 42 · 🔀 52 · 📦 5.4K · 📋 100 - 42% open · ⏱️ 13.10.2021):
...
- [PyPi](https://pypi.org/project/flake8-bugbear) (📦 1K · ⏱️ 29.09.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flake8-bugbear) (📥 480K · ⏱️ 29.09.2021):
	```
...
- [GitHub](https://github.com/terrencepreilly/darglint) (👨‍💻 22 · 🔀 29 · 📦 1K · 📋 140 - 32% open · ⏱️ 18.10.2021):

	```
	git clone https://github.com/terrencepreilly/darglint
	```
- [PyPi](https://pypi.org/project/darglint) (📥 190K / month · 📦 20 · ⏱️ 18.10.2021):
	```
...
- [GitHub](https://github.com/gforcada/flake8-isort) (👨‍💻 29 · 🔀 40 · 📦 3.9K · 📋 53 - 24% open · ⏱️ 15.10.2021):

	```
	git clone https://github.com/gforcada/flake8-isort
	```
- [PyPi](https://pypi.org/project/flake8-isort) (📥 520K / month · 📦 930 · ⏱️ 14.10.2021):
	```
...
- [GitHub](https://github.com/microsoft/pyright) (👨‍💻 63 · 🔀 380 · 📦 130 · 📋 2K - 0% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/Microsoft/pyright
	```
- [NPM](https://www.npmjs.com/package/pyright) (📥 140K / month · 📦 4 · ⏱️ 27.10.2021):
	```
	npm install pyright
	```
</details>
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 180 · 🔀 350 · 📋 280 - 26% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/facebook/pyre-check
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 22K / month · 📦 46 · ⏱️ 16.09.2021):
	```
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 160 · 🔀 300 · 📦 750 · 📋 990 - 9% open · ⏱️ 25.10.2021):
...
- [GitHub](https://github.com/dropbox/mypy-protobuf) (👨‍💻 28 · 🔀 62 · 📋 93 - 5% open · ⏱️ 12.10.2021):
...
- [GitHub](https://github.com/wemake-services/flake8-eradicate) (👨‍💻 13 · 🔀 7 · 📋 28 - 3% open · ⏱️ 19.10.2021):
...
<details><summary><b><a href="https://github.com/gforcada/flake8-builtins">flake8-builtins</a></b> (🥉23 ·  ⭐ 72) - Check for python builtins being used as variables or.. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code> <code><img src="https://cdn.iconscout.com/icon/free/png-256/8-eight-digital-number-numerical-numbers-36025.png" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://github.com/coala/coala">coala</a></b> (🥉22 ·  ⭐ 3.3K · 📉) - coala provides a unified command-line interface for linting and.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/Instagram/Fixit) (👨‍💻 27 · 🔀 39 · 📦 11 · 📋 57 - 56% open · ⏱️ 05.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/fixit) (📥 5.4K / month · ⏱️ 30.07.2021):
	```
	pip install fixit
	```
</details>
...
- [GitHub](https://github.com/life4/flakehell) (👨‍💻 15 · 🔀 32 · 📥 57 · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/flakehell) (📥 44K / month · ⏱️ 11.01.2021):
	```
...
- [GitHub](https://github.com/justinabrahms/imhotep) (👨‍💻 16 · 🔀 37 · 📦 7 · 📋 46 - 50% open · ⏱️ 01.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/imhotep) (📥 31 / month · 📦 4 · ⏱️ 18.09.2016):
	```
	pip install imhotep
	```
</details>
...
- [GitHub](https://github.com/andreoliwa/nitpick) (👨‍💻 11 · 🔀 12 · 📥 4 · 📋 89 - 37% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/andreoliwa/nitpick
	```
- [PyPi](https://pypi.org/project/nitpick) (📥 7.1K / month · ⏱️ 27.10.2021):
	```
	pip install nitpick
	```
</details>
...
- [GitHub](https://github.com/deppen8/pandas-vet) (👨‍💻 10 · 🔀 14 · 📥 39 · 📦 51 · 📋 50 - 42% open · ⏱️ 03.03.2021):
...
<details><summary><b><a href="https://github.com/beartype/beartype">beartype</a></b> (🥉17 ·  ⭐ 480) - Unbearably fast O(1) runtime type-checking in pure Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/beartype/beartype) (👨‍💻 8 · 🔀 12 · 📋 48 - 22% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/beartype/beartype
	```
- [PyPi](https://pypi.org/project/beartype) (📥 31K / month · ⏱️ 22.10.2021):
	```
	pip install beartype
	```
- [Conda](https://anaconda.org/conda-forge/beartype) (📥 8K · ⏱️ 22.10.2021):
	```
...
- [GitHub](https://github.com/hchasestevens/bellybutton) (👨‍💻 5 · 🔀 11 · 📦 11 · 📋 14 - 57% open · ⏱️ 15.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/bellybutton) (📥 6.7K / month · ⏱️ 27.11.2020):
	```
...
- [GitHub](https://github.com/lyft/linty_fresh) (👨‍💻 17 · 🔀 21 · 📋 9 - 88% open · ⏱️ 30.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/linty-fresh) (📥 5 / month · ⏱️ 12.12.2018):
	```
...
- [GitHub](https://github.com/hhatto/autopep8) (👨‍💻 51 · 🔀 250 · 📦 94K · 📋 430 - 21% open · ⏱️ 24.10.2021):
...
- [GitHub](https://github.com/psf/black) (👨‍💻 270 · 🔀 1.5K · 📥 18K · 📦 91K · 📋 1.7K - 20% open · ⏱️ 27.10.2021):
...
- [PyPi](https://pypi.org/project/jedi) (📥 23M / month · 📦 16K · ⏱️ 25.12.2020):
	...
	pip install jedi
	```
- [Conda](https://anaconda.org/conda-forge/jedi) (📥 6.6M · ⏱️ 29.06.2021):
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 66 · 🔀 140 · 📦 32K · 📋 230 - 31% open · ⏱️ 18.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/rope) (📥 530K / month · 📦 2.9K · ⏱️ 18.10.2021):
	```
	pip install rope
	```
...
<details><summary><b><a href="https://github.com/myint/autoflake">autoflake</a></b> (🥈26 ·  ⭐ 440 · 💤) - Removes unused imports and unused variables as reported by pyflakes. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/asottile/pyupgrade) (👨‍💻 21 · 🔀 80 · 📋 240 - 3% open · ⏱️ 25.10.2021):
...
- [GitHub](https://github.com/asottile/add-trailing-comma) (👨‍💻 9 · 🔀 14 · 📋 35 - 2% open · ⏱️ 23.10.2021):

	```
	git clone https://github.com/asottile/add-trailing-comma
	```
- [PyPi](https://pypi.org/project/add-trailing-comma) (📥 10K / month · 📦 14 · ⏱️ 19.10.2021):
	```
...
- [GitHub](https://github.com/hakancelik96/unimport) (👨‍💻 13 · 🔀 13 · 📦 14 · 📋 76 - 13% open · ⏱️ 14.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/unimport) (📥 5.5K / month · ⏱️ 14.09.2021):
	```
...
- [GitHub](https://github.com/ilevkivskyi/com2ann) (👨‍💻 4 · 🔀 7 · 📦 6 · 📋 20 - 25% open · ⏱️ 21.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/com2ann) (📥 2.4K / month · ⏱️ 21.08.2021):
	```
	pip install com2ann
	```
</details>
...
- [GitHub](https://github.com/PyCQA/bandit) (👨‍💻 130 · 🔀 360 · 📥 120 · 📦 8.6K · 📋 550 - 32% open · ⏱️ 24.10.2021):
...
- [PyPi](https://pypi.org/project/bandit) (📦 2.4K · ⏱️ 13.12.2020):
	...
	pip install bandit
	```
- [Conda](https://anaconda.org/conda-forge/bandit) (📥 93K · ⏱️ 16.09.2021):
	```
...
- [GitHub](https://github.com/pyupio/safety) (👨‍💻 35 · 🔀 96 · 📥 92K · 📦 2.8K · 📋 120 - 40% open · ⏱️ 28.04.2021):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.5K · 📋 4.5K - 1% open · ⏱️ 26.10.2021):
...
<details><summary><b><a href="https://github.com/landscapeio/dodgy">dodgy</a></b> (🥉19 ·  ⭐ 94 · 💤) - Looks at Python code to search for things which look dodgy such as.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/dlint-py/dlint">dlint</a></b> (🥉16 ·  ⭐ 76) - Dlint is a tool for encouraging best coding practices and helping ensure.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/pypa/pipenv) (👨‍💻 390 · 🔀 1.6K · 📦 22K · 📋 3.5K - 16% open · ⏱️ 28.10.2021):
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 220 · 🔀 910 · 📋 1.2K - 5% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/pypa/virtualenv
	```
- [PyPi](https://pypi.org/project/virtualenv) (📦 34K · ⏱️ 23.10.2021):
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 340 · 🔀 2.2K · 📋 1.4K - 2% open · ⏱️ 27.10.2021):
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 290 · 🔀 1.4K · 📥 8.9M · 📋 3.4K - 37% open · ⏱️ 10.10.2021):

	```
	git clone https://github.com/python-poetry/poetry
	```
- [PyPi](https://pypi.org/project/poetry) (📥 3.9M / month · 📦 64 · ⏱️ 04.10.2021):
	```
	pip install poetry
	```
...
- [GitHub](https://github.com/pypa/pip) (👨‍💻 640 · 🔀 2.4K · 📦 62K · 📋 6K - 15% open · ⏱️ 24.10.2021):
...
- [PyPi](https://pypi.org/project/pip) (📦 19K · ⏱️ 22.10.2021):
	...
	pip install pip
	```
- [Conda](https://anaconda.org/conda-forge/pip) (📥 26M · ⏱️ 22.10.2021):
	```
...
- [GitHub](https://github.com/conda/conda) (👨‍💻 370 · 🔀 1.1K · 📋 8.2K - 25% open · ⏱️ 20.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/conda) (📥 73K / month · 📦 2.1K · ⏱️ 22.04.2017):
	```
	pip install conda
	```
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 160 · 🔀 470 · 📋 770 - 15% open · ⏱️ 27.10.2021):
...
<details><summary><b><a href="https://github.com/bndr/pipreqs">pipreqs</a></b> (🥉27 ·  ⭐ 3.7K) - pipreqs - Generate pip requirements.txt file based on imports of any.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/bndr/pipreqs) (👨‍💻 51 · 🔀 250 · 📦 7.2K · 📋 180 - 50% open · ⏱️ 23.10.2021):
...
- [GitHub](https://github.com/mamba-org/mamba) (👨‍💻 62 · 🔀 120 · 📋 630 - 32% open · ⏱️ 26.10.2021):
...
- [GitHub](https://github.com/David-OConnor/pyflow) (👨‍💻 25 · 🔀 33 · 📥 3.5K · 📋 110 - 39% open · ⏱️ 25.10.2021):

	```
	git clone https://github.com/David-OConnor/pyflow
	```
- [PyPi](https://pypi.org/project/pyflow) (📥 130 / month · ⏱️ 02.07.2021):
	```
	pip install pyflow
	```
</details>
...
- [GitHub](https://github.com/jaraco/pip-run) (👨‍💻 11 · 🔀 10 · 📋 41 - 7% open · ⏱️ 02.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pip-run) (📥 9.9K / month · ⏱️ 02.10.2021):
	```
	pip install pip-run
	```
</details>
...
- [Conda](https://anaconda.org/conda-forge/tqdm) (📥 8.3M · ⏱️ 20.09.2021):
	...
	```
- [Docker Hub](https://hub.docker.com/r/tqdm/tqdm) (📥 3.9K · ⭐ 2 · ⏱️ 23.10.2021):
	```
...
- [PyPi](https://pypi.org/project/python-json-logger) (📥 4.2M / month · 📦 920 · ⏱️ 27.07.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-json-logger) (📥 950K · ⏱️ 12.10.2020):
	```
...
- [GitHub](https://github.com/astanin/python-tabulate) (👨‍💻 67 · 🔀 80 · 📦 54K · 📋 110 - 44% open · ⏱️ 04.03.2021):
...
<details><summary><b><a href="https://github.com/Delgan/loguru">loguru</a></b> (🥈29 ·  ⭐ 10K) - Python logging made (stupidly) simple. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 30 · 🔀 450 · 📦 11K · 📋 470 - 15% open · ⏱️ 09.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/loguru) (📦 340 · ⏱️ 20.09.2020):
	```
	pip install loguru
	```
...
- [GitHub](https://github.com/hynek/structlog) (👨‍💻 76 · 🔀 140 · 📦 3.8K · 📋 200 - 15% open · ⏱️ 23.10.2021):
...
- [GitHub](https://github.com/xolox/python-coloredlogs) (👨‍💻 16 · 🔀 36 · 📦 9.3K · 📋 74 - 33% open · ⏱️ 11.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/coloredlogs) (📥 2.1M / month · 📦 2.1K · ⏱️ 11.06.2021):
	```
	pip install coloredlogs
	```
</details>
<details><summary><b><a href="https://github.com/WoLpH/python-progressbar">progressbar2</a></b> (🥉26 ·  ⭐ 730) - Progressbar 2 - A progress bar for Python 2 and Python 3 - pip.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/WoLpH/python-progressbar) (👨‍💻 41 · 🔀 100 · 📥 1.6K · 📦 13K · 📋 190 - 3% open · ⏱️ 15.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/progressbar2) (📦 2.2K · ⏱️ 15.10.2021):
	```
...
- [GitHub](https://github.com/liiight/notifiers) (👨‍💻 16 · 🔀 78 · 📦 180 · 📋 92 - 41% open · ⏱️ 22.09.2021):
...
- [PyPi](https://pypi.org/project/wasabi) (📦 410 · ⏱️ 31.01.2021):
	...
	pip install wasabi
	```
- [Conda](https://anaconda.org/conda-forge/wasabi) (📥 450K · ⏱️ 01.02.2021):
	```
...
- [GitHub](https://github.com/shobrook/rebound) (👨‍💻 16 · 🔀 340 · 📥 180 · 📦 21 · 📋 58 - 34% open · ⏱️ 04.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/rebound) (📥 1.7K / month · 📦 14 · ⏱️ 29.09.2021):
	```
	pip install rebound
	```
...
- [GitHub](https://github.com/cknd/stackprinter) (👨‍💻 6 · 🔀 33 · 📦 78 · 📋 26 - 42% open · ⏱️ 01.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/stackprinter) (📥 160K / month · 📦 4 · ⏱️ 31.10.2020):
	```
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 1 · 🔀 110 · 📦 460 · 📋 91 - 27% open · ⏱️ 28.10.2021):
...
- [GitHub](https://github.com/samuelcolvin/python-devtools) (👨‍💻 7 · 🔀 15 · 📦 460 · 📋 36 - 5% open · ⏱️ 08.09.2021):
...
- <b><a href="https://github.com/skorokithakis/tbvaccine">tbvaccine</a></b> (🥉13 ·  ⭐ 360 · 💀) - A small utility to pretty-print Python tracebacks. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
</details>
<br>
...
- [GitHub](https://github.com/mkdocs/mkdocs) (👨‍💻 200 · 🔀 1.8K · 📦 16K · 📋 1.6K - 6% open · ⏱️ 26.10.2021):
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (👨‍💻 690 · 🔀 1.6K · 📦 160K · 📋 5.7K - 15% open · ⏱️ 27.10.2021):
...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 130 · 🔀 1.8K · 📦 9.3K · 📋 1.2K - 1% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/squidfunk/mkdocs-material
	```
- [PyPi](https://pypi.org/project/mkdocs-material) (📥 710K / month · 📦 1.5K · ⏱️ 27.10.2021):
	```
	pip install mkdocs-material
	```
- [Conda](https://anaconda.org/conda-forge/mkdocs-material) (📥 70K · ⏱️ 28.10.2021):
	```
...
- [GitHub](https://github.com/numpy/numpydoc) (👨‍💻 67 · 🔀 6K · 📦 28K · 📋 160 - 37% open · ⏱️ 25.10.2021):
...
- [GitHub](https://github.com/pdoc3/pdoc) (👨‍💻 56 · 🔀 120 · 📦 1.1K · 📋 270 - 32% open · ⏱️ 24.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/pdoc3) (📥 200K / month · 📦 90 · ⏱️ 03.08.2021):
	```
	pip install pdoc3
	```
</details>
...
- [GitHub](https://github.com/econchick/interrogate) (👨‍💻 11 · 🔀 22 · 📦 990 · 📋 31 - 25% open · ⏱️ 10.09.2021):
...
- [PyPi](https://pypi.org/project/sphinx-autobuild) (📥 190K / month · 📦 4.7K · ⏱️ 14.03.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sphinx-autobuild) (📥 76K · ⏱️ 14.03.2021):
	```
...
- [GitHub](https://github.com/mkdocstrings/mkdocstrings) (👨‍💻 24 · 🔀 52 · 📋 200 - 23% open · ⏱️ 10.10.2021):

	```
	git clone https://github.com/mkdocstrings/mkdocstrings
	```
- [PyPi](https://pypi.org/project/mkdocstrings) (📥 100K / month · ⏱️ 04.10.2021):
	```
	pip install mkdocstrings
	```
- [Conda](https://anaconda.org/conda-forge/mkdocstrings) (📥 9.4K · ⏱️ 04.10.2021):
	```
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-pages-plugin) (👨‍💻 3 · 🔀 20 · 📦 520 · 📋 47 - 23% open · ⏱️ 19.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/mkdocs-awesome-pages-plugin) (📥 47K / month · 📦 90 · ⏱️ 19.10.2021):
	```
...
- [GitHub](https://github.com/asottile/blacken-docs) (👨‍💻 12 · 🔀 18 · 📋 35 - 5% open · ⏱️ 25.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/blacken-docs) (📥 7.9K / month · 📦 22 · ⏱️ 27.08.2021):
	```
...
- [GitHub](https://github.com/clayrisser/sphinx-markdown-builder) (👨‍💻 16 · 🔀 29 · 📦 190 · 📋 34 - 52% open · ⏱️ 07.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/sphinx-markdown-builder) (📥 26K / month · 📦 42 · ⏱️ 23.12.2019):
	```
	pip install sphinx-markdown-builder
	```
</details>
<details><summary><b><a href="https://github.com/orzih/mkdocs-with-pdf">mkdocs-with-pdf</a></b> (🥉21 ·  ⭐ 96) - Generate a single PDF file from MkDocs repository. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/orzih/mkdocs-with-pdf) (👨‍💻 6 · 🔀 16 · 📦 67 · 📋 62 - 41% open · ⏱️ 14.10.2021):
...
<details><summary><b><a href="https://github.com/mitmproxy/pdoc">pdoc</a></b> (🥉19 ·  ⭐ 1.1K) - API Documentation for Python Projects. <code><a href="http://bit.ly/3rvuUlR">Unlicense</a></code></summary>

- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 31 · 🔀 120 · 📦 440 · 📋 190 - 4% open · ⏱️ 09.10.2021):
...
- [GitHub](https://github.com/timothycrosley/portray) (👨‍💻 16 · 🔀 58 · 📋 50 - 42% open · ⏱️ 13.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/portray) (📥 8.2K / month · 📦 8 · ⏱️ 13.06.2021):
	```
	pip install portray
	```
</details>
<details><summary><b><a href="https://github.com/ml-tooling/lazydocs">lazydocs</a></b> (🥉17 ·  ⭐ 45) - Generate markdown API documentation from Google-style Python docstring... <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ml-tooling/lazydocs) (👨‍💻 7 · 🔀 11 · 📦 46 · 📋 5 - 40% open · ⏱️ 20.08.2021):

	```
	git clone https://github.com/ml-tooling/lazydocs
	```
- [PyPi](https://pypi.org/project/lazydocs) (📥 980 / month · ⏱️ 27.07.2021):
	```
...
- [GitHub](https://github.com/cool-RR/PySnooper) (👨‍💻 26 · 🔀 910 · 📦 500 · 📋 110 - 16% open · ⏱️ 11.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/pysnooper) (📥 83K / month · 📦 46 · ⏱️ 11.09.2021):
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 79 · 🔀 400 · 📦 2.6K · 📋 170 - 32% open · ⏱️ 25.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 720K / month · 📦 880 · ⏱️ 27.10.2020):
	```
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 78 · 🔀 180 · 📦 2.6K · 📋 280 - 48% open · ⏱️ 22.10.2021):

	```
	git clone https://github.com/inducer/pudb
	```
- [PyPi](https://pypi.org/project/pudb) (📥 160K / month · 📦 1.4K · ⏱️ 08.05.2021):
	```
	pip install pudb
	```
...
<details><summary><b><a href="https://github.com/pdbpp/pdbpp">pdbpp</a></b> (🥈27 ·  ⭐ 820) - pdb++, a drop-in replacement for pdb (the Python debugger). <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 40 · 🔀 46 · 📦 2.3K · 📋 180 - 35% open · ⏱️ 28.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/pdbpp) (📥 200K / month · 📦 1K · ⏱️ 09.07.2021):
	```
	pip install pdbpp
	```
...
- [GitHub](https://github.com/cs01/gdbgui) (👨‍💻 38 · 🔀 480 · 📥 5.6K · 📦 120 · 📋 280 - 40% open · ⏱️ 06.09.2021):

	```
	git clone https://github.com/cs01/gdbgui
	```
- [PyPi](https://pypi.org/project/gdbgui) (📥 130K / month · 📦 2 · ⏱️ 06.09.2021):
	```
	pip install gdbgui
	```
</details>
<details><summary><b><a href="https://github.com/agronholm/typeguard">typeguard</a></b> (🥉26 ·  ⭐ 740) - Run-time type checker for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/agronholm/typeguard) (👨‍💻 18 · 🔀 64 · 📋 170 - 19% open · ⏱️ 11.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/typeguard) (📥 16M / month · 📦 160 · ⏱️ 10.10.2021):
	```
	pip install typeguard
	```
- [Conda](https://anaconda.org/conda-forge/typeguard) (📥 59K · ⏱️ 11.10.2021):
	```
	conda install -c conda-forge typeguard
	```
</details>
<details><summary><b><a href="https://github.com/gruns/icecream">icecream</a></b> (🥉23 ·  ⭐ 5.5K) - Never use print() to debug again. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/gruns/icecream) (👨‍💻 16 · 🔀 110 · 📋 82 - 31% open · ⏱️ 31.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/icecream) (📥 100K / month · 📦 6 · ⏱️ 22.06.2021):
	```
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 35 · 📦 68 · 📋 87 - 42% open · ⏱️ 13.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/hunter) (📥 6.2K / month · 📦 34 · ⏱️ 23.06.2021):
	```
	pip install hunter
	```
</details>
...
<details><summary><b><a href="https://github.com/alexmojaki/snoop">snoop</a></b> (🥉20 ·  ⭐ 640) - A powerful set of Python debugging tools, based on PySnooper. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/alexmojaki/birdseye">Birdseye</a></b> (🥉17 ·  ⭐ 1.4K) - Graphical Python debugger which lets you easily view the values of all.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/alexmojaki/birdseye) (👨‍💻 10 · 🔀 68 · 📋 50 - 36% open · ⏱️ 01.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/birdseye) (⏱️ 01.08.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest) (👨‍💻 750 · 🔀 1.8K · 📦 390K · 📋 4.7K - 15% open · ⏱️ 28.10.2021):
...
- [PyPi](https://pypi.org/project/pytest) (📥 32M / month · 📦 130K · ⏱️ 30.08.2021):
	...
	pip install pytest
	```
- [Conda](https://anaconda.org/conda-forge/pytest) (📥 10M · ⏱️ 31.08.2021):
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 150 · 🔀 1.8K · 📥 510 · 📦 4.4K · 📋 3.7K - 6% open · ⏱️ 21.10.2021):

	```
	git clone https://github.com/robotframework/robotframework
	```
- [PyPi](https://pypi.org/project/robotframework) (📥 830K / month · 📦 1.4K · ⏱️ 15.10.2021):
	```
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 250 · 🔀 480 · 📦 10K · 📋 1.2K - 5% open · ⏱️ 25.10.2021):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 2.3M / month · 📦 2.6K · ⏱️ 23.10.2021):
	```
...
<details><summary><b><a href="https://github.com/pytest-dev/pytest-xdist">pytest-xdist</a></b> (🥈32 ·  ⭐ 780) - pytest plugin for distributed testing and loop-on-failures.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/pytest-dev/pytest-xdist) (👨‍💻 75 · 🔀 160 · 📦 23K · 📋 450 - 45% open · ⏱️ 11.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-xdist) (📥 4.9M / month · 📦 7.3K · ⏱️ 21.09.2021):
	```
...
- [GitHub](https://github.com/TheKevJames/coveralls-python) (👨‍💻 59 · 🔀 180 · 📦 19K · 📋 140 - 5% open · ⏱️ 08.10.2021):

	```
	git clone https://github.com/TheKevJames/coveralls-python
	```
- [PyPi](https://pypi.org/project/coveralls) (📥 470K / month · 📦 17K · ⏱️ 20.07.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-asyncio) (👨‍💻 26 · 🔀 89 · 📦 17K · 📋 180 - 43% open · ⏱️ 15.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-asyncio) (📥 2.4M / month · 📦 2K · ⏱️ 15.10.2021):
	```
...
- [GitHub](https://github.com/microsoft/playwright-python) (👨‍💻 21 · 🔀 460 · 📦 480 · 📋 480 - 4% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/microsoft/playwright-python
	```
- [PyPi](https://pypi.org/project/playwright) (📥 120K / month · ⏱️ 21.10.2021):
	```
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 270 · 📥 180 · 📋 300 - 1% open · ⏱️ 24.10.2021):
...
- [GitHub](https://github.com/Teemu/pytest-sugar) (👨‍💻 36 · 🔀 55 · 📦 8.4K · 📋 100 - 33% open · ⏱️ 24.10.2020):
...
- [PyPi](https://pypi.org/project/pytest-sugar) (📥 550K / month · 📦 4.6K · ⏱️ 06.07.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-sugar) (📥 120K · ⏱️ 18.09.2020):
	```
	conda install -c conda-forge pytest-sugar
	```
</details>
<details><summary><b><a href="https://github.com/pytest-dev/pytest-bdd">pytest-bdd</a></b> (🥉25 ·  ⭐ 890) - BDD library for the py.test runner. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/pytest-dev/pytest-bdd) (👨‍💻 44 · 🔀 150 · 📋 260 - 48% open · ⏱️ 25.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-bdd) (📦 270 · ⏱️ 25.10.2021):
	```
...
- [GitHub](https://github.com/airspeed-velocity/asv) (👨‍💻 55 · 🔀 130 · 📦 200 · 📋 410 - 26% open · ⏱️ 15.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/asv) (📥 28K / month · 📦 88 · ⏱️ 16.05.2020):
	```
	pip install asv
	```
...
- [GitHub](https://github.com/hamcrest/PyHamcrest) (👨‍💻 35 · 🔀 88 · 📋 65 - 24% open · ⏱️ 10.10.2021):
...
<details><summary><b><a href="https://github.com/ionelmc/pytest-benchmark">pytest-benchmark</a></b> (🥉24 ·  ⭐ 810) - py.test fixture for benchmarking code. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [PyPi](https://pypi.org/project/pytest-benchmark) (📦 730 · ⏱️ 17.04.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-benchmark) (📥 950K · ⏱️ 18.04.2021):
	```
...
- [GitHub](https://github.com/dbader/pytest-mypy) (👨‍💻 15 · 🔀 32 · 📦 1.3K · 📋 46 - 19% open · ⏱️ 16.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-mypy) (📥 390K / month · 📦 270 · ⏱️ 21.03.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-randomly) (👨‍💻 16 · 🔀 21 · 📋 45 - 11% open · ⏱️ 23.10.2021):
...
- [GitHub](https://github.com/Erotemic/xdoctest) (👨‍💻 6 · 🔀 6 · 📦 1.6K · 📋 37 - 45% open · ⏱️ 06.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/xdoctest) (📥 93K / month · 📦 52 · ⏱️ 06.10.2021):
	```
...
- [GitHub](https://github.com/TvoroG/pytest-lazy-fixture) (👨‍💻 8 · 🔀 15 · 📦 450 · 📋 35 - 42% open · ⏱️ 09.07.2021):

	```
	git clone https://github.com/tvorog/pytest-lazy-fixture
	```
- [PyPi](https://pypi.org/project/pytest-lazy-fixture) (📥 270K / month · 📦 62 · ⏱️ 01.02.2020):
	```
...
- <b><a href="https://github.com/nose-devs/nose">nose</a></b> (🥈29 ·  ⭐ 1.3K · 💀) - nose is nicer testing for python. <code><a href="https://tldrlegal.com/search?q=LGPL-2.1%2B">❗️LGPL-2.1+</a></code>
...
- [GitHub](https://github.com/pypa/packaging) (👨‍💻 71 · 🔀 160 · 📥 160 · 📦 260K · 📋 210 - 25% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/pypa/packaging
	```
- [PyPi](https://pypi.org/project/packaging) (📥 78M / month · 📦 29K · ⏱️ 03.07.2021):
	```
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 410 · 🔀 1.7K · 📥 720K · 📋 4.3K - 7% open · ⏱️ 26.10.2021):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 580K / month · ⏱️ 07.08.2021):
	```
...
- [GitHub](https://github.com/Nuitka/Nuitka) (👨‍💻 100 · 🔀 340 · 📋 1K - 21% open · ⏱️ 26.10.2021):

	```
	git clone https://github.com/Nuitka/Nuitka
	```
- [PyPi](https://pypi.org/project/nuitka) (📥 27K / month · 📦 54 · ⏱️ 24.10.2021):
	```
	pip install nuitka
	```
...
- [GitHub](https://github.com/pantsbuild/pex) (👨‍💻 100 · 🔀 210 · 📥 450K · 📋 740 - 19% open · ⏱️ 14.10.2021):
...
- [PyPi](https://pypi.org/project/cx_freeze) (📥 49K / month · 📦 150 · ⏱️ 16.12.2017):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cx_freeze) (📥 97K · ⏱️ 01.10.2021):
	```
...
<details><summary><b><a href="https://github.com/beeware/briefcase">briefcase</a></b> (🥉21 ·  ⭐ 1.2K) - Tools to support converting a Python project into a standalone.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/beeware/briefcase) (👨‍💻 86 · 🔀 200 · 📋 350 - 28% open · ⏱️ 26.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/briefcase) (📦 24 · ⏱️ 06.03.2021):
	```
...
- [GitHub](https://github.com/indygreg/PyOxidizer) (👨‍💻 37 · 🔀 130 · 📥 1K · 📋 400 - 60% open · ⏱️ 28.10.2021):
...
- [GitHub](https://github.com/pypa/setuptools) (👨‍💻 460 · 🔀 770 · 📥 110 · 📦 120K · 📋 1.8K - 28% open · ⏱️ 22.10.2021):

	```
	git clone https://github.com/pypa/setuptools
	```
- [PyPi](https://pypi.org/project/setuptools) (📥 140M / month · 📦 58K · ⏱️ 22.10.2021):
	```
	pip install setuptools
	```
- [Conda](https://anaconda.org/conda-forge/setuptools) (📥 28M · ⏱️ 06.10.2021):
	```
...
- [GitHub](https://github.com/pyinvoke/invoke) (👨‍💻 56 · 🔀 300 · 📦 9.1K · 📋 690 - 48% open · ⏱️ 16.10.2021):
...
- [PyPi](https://pypi.org/project/invoke) (📥 2M / month · 📦 4.6K · ⏱️ 09.07.2021):
	...
	pip install invoke
	```
- [Conda](https://anaconda.org/conda-forge/invoke) (📥 450K · ⏱️ 10.07.2021):
	```
...
- [GitHub](https://github.com/buildbot/buildbot) (👨‍💻 800 · 🔀 1.6K · 📥 17K · 📦 260 · 📋 1.4K - 45% open · ⏱️ 27.10.2021):
...
- [GitHub](https://github.com/pypa/twine) (👨‍💻 100 · 🔀 240 · 📦 48K · 📋 390 - 11% open · ⏱️ 10.10.2021):
...
- [GitHub](https://github.com/SCons/scons) (👨‍💻 140 · 🔀 240 · 📥 380 · 📋 3.3K - 19% open · ⏱️ 27.10.2021):
...
- [GitHub](https://github.com/takluyver/flit) (👨‍💻 46 · 🔀 82 · 📋 280 - 34% open · ⏱️ 24.10.2021):

	```
	git clone https://github.com/takluyver/flit
	```
- [PyPi](https://pypi.org/project/flit) (📥 230K / month · 📦 230 · ⏱️ 10.10.2021):
	```
	pip install flit
	```
- [Conda](https://anaconda.org/conda-forge/flit) (📥 96K · ⏱️ 12.10.2021):
	```
...
- [GitHub](https://github.com/pybuilder/pybuilder) (👨‍💻 36 · 🔀 240 · 📋 500 - 17% open · ⏱️ 24.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pybuilder) (📥 17K / month · 📦 110 · ⏱️ 24.10.2021):
	```
...
- [GitHub](https://github.com/ml-tooling/universal-build) (👨‍💻 4 · 🔀 5 · 📥 16 · 📦 6 · ⏱️ 25.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/universal-build) (📥 230 / month · ⏱️ 12.12.2020):
	```
...
<details><summary><b><a href="https://github.com/giampaolo/psutil">psutil</a></b> (🥇34 ·  ⭐ 7.8K) - Cross-platform lib for process and system monitoring in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 170 · 🔀 1.1K · 📦 120K · 📋 1.5K - 13% open · ⏱️ 25.10.2021):
...
<details><summary><b><a href="https://github.com/nicolargo/glances">Glances</a></b> (🥇28 ·  ⭐ 19K) - Glances an Eye on your system. A top/htop alternative for.. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/nicolargo/glances) (👨‍💻 150 · 🔀 1.2K · 📥 640 · 📦 340 · 📋 1.4K - 14% open · ⏱️ 08.10.2021):

	```
	git clone https://github.com/nicolargo/glances
	```
- [PyPi](https://pypi.org/project/glances) (📦 50 · ⏱️ 21.08.2021):
	```
	pip install glances
	```
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 29 · 🔀 270 · 📥 6.8K · 📋 230 - 30% open · ⏱️ 21.10.2021):
...
<details><summary><b><a href="https://github.com/sumerc/yappi">Yappi</a></b> (🥇28 ·  ⭐ 730) - Yet Another Python Profiler, but this time thread&coroutine&greenlet aware. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/sumerc/yappi) (👨‍💻 26 · 🔀 50 · 📦 490 · 📋 51 - 31% open · ⏱️ 05.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/yappi) (📥 790K / month · 📦 640 · ⏱️ 05.10.2021):
	```
	pip install yappi
	```
...
<details><summary><b><a href="https://github.com/pympler/pympler">pympler</a></b> (🥈26 ·  ⭐ 820) - Development tool to measure, monitor and analyze the memory behavior.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/pympler/pympler) (👨‍💻 29 · 🔀 68 · 📋 83 - 42% open · ⏱️ 23.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pympler) (📥 580K / month · 📦 480 · ⏱️ 14.10.2020):
	```
	pip install pympler
	```
...
- [GitHub](https://github.com/joerick/pyinstrument) (👨‍💻 33 · 🔀 150 · 📦 390 · 📋 87 - 17% open · ⏱️ 26.10.2021):
...
- [PyPi](https://pypi.org/project/pyinstrument) (📥 250K / month · 📦 140 · ⏱️ 03.10.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyinstrument) (📥 86K · ⏱️ 05.10.2021):
	```
...
<details><summary><b><a href="https://github.com/plasma-umass/scalene">Scalene</a></b> (🥉23 ·  ⭐ 4.6K) - Scalene: a high-performance, high-precision CPU, GPU, and memory.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/plasma-umass/scalene) (👨‍💻 23 · 🔀 160 · 📦 70 · 📋 150 - 24% open · ⏱️ 28.10.2021):
...
- [GitHub](https://github.com/csurfer/pyheat) (👨‍💻 5 · 🔀 29 · 📦 32 · 📋 12 - 25% open · ⏱️ 18.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/py-heat) (📥 2.4K / month · 📦 10 · ⏱️ 06.12.2018):
	```
	pip install py-heat
	```
</details>
...
- [GitHub](https://github.com/pre-commit/pre-commit) (👨‍💻 130 · 🔀 500 · 📥 16K · 📋 1.3K - 1% open · ⏱️ 25.10.2021):
...
- [PyPi](https://pypi.org/project/pre-commit) (📥 3.9M / month · 📦 2.1K · ⏱️ 03.09.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pre-commit) (📥 790K · ⏱️ 03.09.2021):
	```
