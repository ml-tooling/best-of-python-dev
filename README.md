...
- [GitHub](https://github.com/python/mypy) (👨‍💻 510 · 🔀 1.9K · 📦 51K · 📋 7K - 28% open · ⏱️ 25.11.2021):
...
- [GitHub](https://github.com/PyCQA/flake8) (👨‍💻 160 · 🔀 180 · 📦 210K · 📋 1.3K - 2% open · ⏱️ 23.11.2021):
...
- [GitHub](https://github.com/PyCQA/pycodestyle) (👨‍💻 130 · 🔀 610 · 📦 170K · 📋 660 - 16% open · ⏱️ 23.11.2021):
...
- [GitHub](https://github.com/PyCQA/pylint) (👨‍💻 430 · 🔀 760 · 📋 3.8K - 19% open · ⏱️ 25.11.2021):

	```
	git clone https://github.com/PyCQA/pylint
	```
- [PyPi](https://pypi.org/project/pylint) (📥 9.2M / month · 📦 38K · ⏱️ 16.09.2021):
	```
	pip install pylint
	```
...
- [PyPi](https://pypi.org/project/parso) (📥 18M / month · 📦 11K · ⏱️ 30.03.2021):
	...
	pip install parso
	```
- [Conda](https://anaconda.org/conda-forge/parso) (📥 5.7M · ⏱️ 31.03.2021):
	```
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 160 · 🔀 310 · 📦 820 · 📋 990 - 9% open · ⏱️ 23.11.2021):
...
- [PyPi](https://pypi.org/project/pydocstyle) (📥 2M / month · 📦 3.9K · ⏱️ 17.05.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pydocstyle) (📥 470K · ⏱️ 18.05.2021):
	```
...
- [GitHub](https://github.com/PyCQA/flake8-bugbear) (👨‍💻 43 · 🔀 54 · 📦 5.8K · 📋 110 - 42% open · ⏱️ 22.11.2021):
...
- [GitHub](https://github.com/openstack/hacking) (👨‍💻 180 · 🔀 66 · ⏱️ 07.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/hacking) (📥 570K / month · 📦 8.7K · ⏱️ 21.04.2021):
	```
	pip install hacking
	```
</details>
...
- [GitHub](https://github.com/PyCQA/pylint-django) (👨‍💻 60 · 🔀 100 · 📥 200 · 📦 16K · 📋 180 - 18% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pylint-django) (📥 670K / month · 📦 2.2K · ⏱️ 09.04.2021):
	```
...
- [GitHub](https://github.com/coala/coala) (👨‍💻 480 · 🔀 1.4K · 📥 150 · 📦 10 · 📋 3.2K - 26% open · ⏱️ 11.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/coala-bears) (📥 5.4K / month · 📦 210 · ⏱️ 10.11.2017):
	```
...
- [GitHub](https://github.com/terrencepreilly/darglint) (👨‍💻 22 · 🔀 32 · 📦 1.2K · 📋 140 - 33% open · ⏱️ 18.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/darglint) (📥 250K / month · 📦 20 · ⏱️ 18.10.2021):
	```
...
- [GitHub](https://github.com/zheller/flake8-quotes) (👨‍💻 30 · 🔀 34 · 📦 3.9K · 📋 43 - 6% open · ⏱️ 19.10.2021):
...
<details><summary><b><a href="https://github.com/klen/pylama">pylama</a></b> (🥈26 ·  ⭐ 820 · 📈) - Code audit tool for python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/klen/pylama) (👨‍💻 41 · 🔀 79 · 📦 2.8K · 📋 120 - 57% open · ⏱️ 24.11.2021):

	```
	git clone https://github.com/klen/pylama
	```
- [PyPi](https://pypi.org/project/pylama) (📥 86K / month · 📦 1K · ⏱️ 10.04.2019):
	```
	pip install pylama
	```
</details>
...
- [GitHub](https://github.com/microsoft/pyright) (👨‍💻 65 · 🔀 390 · 📦 160 · 📋 2.1K - 0% open · ⏱️ 25.11.2021):

	```
	git clone https://github.com/Microsoft/pyright
	```
- [NPM](https://www.npmjs.com/package/pyright) (📥 170K / month · 📦 4 · ⏱️ 25.11.2021):
	```
	npm install pyright
	```
</details>
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 180 · 🔀 370 · 📋 280 - 27% open · ⏱️ 25.11.2021):

	```
	git clone https://github.com/facebook/pyre-check
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 30K / month · 📦 46 · ⏱️ 29.10.2021):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 70 · 🔀 220 · 📋 460 - 21% open · ⏱️ 24.11.2021):

	```
	git clone https://github.com/google/pytype
	```
- [PyPi](https://pypi.org/project/pytype) (📥 150K / month · 📦 88 · ⏱️ 24.11.2021):
	```
	pip install pytype
	```
...
- [GitHub](https://github.com/PyCQA/flake8-commas) (👨‍💻 12 · 🔀 23 · 📋 31 - 16% open · ⏱️ 13.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-commas) (📥 240K / month · 📦 550 · ⏱️ 13.10.2021):
	```
...
- [GitHub](https://github.com/dropbox/mypy-protobuf) (👨‍💻 30 · 🔀 62 · 📋 96 - 5% open · ⏱️ 20.11.2021):
...
- [GitHub](https://github.com/adamchainz/flake8-comprehensions) (👨‍💻 12 · 🔀 15 · 📋 40 - 17% open · ⏱️ 25.11.2021):

	```
	git clone https://github.com/adamchainz/flake8-comprehensions
	```
- [PyPi](https://pypi.org/project/flake8-comprehensions) (📥 570K / month · 📦 710 · ⏱️ 11.10.2021):
	```
...
- [GitHub](https://github.com/peterjc/flake8-black) (👨‍💻 5 · 🔀 8 · 📦 1.5K · 📋 21 - 33% open · ⏱️ 22.11.2021):
...
- [GitHub](https://github.com/predictive-analytics-lab/data-science-types) (👨‍💻 44 · 🔀 57 · 📦 140 · 📋 62 - 62% open · ⏱️ 16.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/data-science-types) (📥 49K / month · ⏱️ 16.02.2021):
	```
...
- [GitHub](https://github.com/Instagram/Fixit) (👨‍💻 29 · 🔀 41 · 📦 12 · 📋 57 - 56% open · ⏱️ 20.11.2021):

	```
	git clone https://github.com/Instagram/Fixit
	```
- [PyPi](https://pypi.org/project/fixit) (📥 4.8K / month · ⏱️ 30.07.2021):
	```
	pip install fixit
	```
</details>
...
- [GitHub](https://github.com/andreoliwa/nitpick) (👨‍💻 13 · 🔀 13 · 📥 4 · 📋 89 - 35% open · ⏱️ 23.11.2021):

	```
	git clone https://github.com/andreoliwa/nitpick
	```
- [PyPi](https://pypi.org/project/nitpick) (📥 13K / month · ⏱️ 08.11.2021):
	```
	pip install nitpick
	```
</details>
...
<details><summary><b><a href="https://github.com/beartype/beartype">beartype</a></b> (🥉17 ·  ⭐ 920) - Unbearably fast O(1) runtime type-checking in pure Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/beartype/beartype) (👨‍💻 9 · 🔀 17 · 📋 54 - 22% open · ⏱️ 24.11.2021):

	```
	git clone https://github.com/beartype/beartype
	```
- [PyPi](https://pypi.org/project/beartype) (📥 47K / month · ⏱️ 06.11.2021):
	```
	pip install beartype
	```
- [Conda](https://anaconda.org/conda-forge/beartype) (📥 8.6K · ⏱️ 06.11.2021):
	```
...
- [GitHub](https://github.com/hchasestevens/bellybutton) (👨‍💻 5 · 🔀 11 · 📦 13 · 📋 14 - 57% open · ⏱️ 15.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/bellybutton) (📥 6.1K / month · ⏱️ 27.11.2020):
	```
...
- [GitHub](https://github.com/lyft/linty_fresh) (👨‍💻 17 · 🔀 21 · 📋 9 - 88% open · ⏱️ 30.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/linty-fresh) (📥 33 / month · ⏱️ 12.12.2018):
	```
...
- [GitHub](https://github.com/psf/black) (👨‍💻 280 · 🔀 1.5K · 📥 18K · 📦 97K · 📋 1.7K - 20% open · ⏱️ 25.11.2021):
...
- [GitHub](https://github.com/hhatto/autopep8) (👨‍💻 51 · 🔀 250 · 📦 97K · 📋 430 - 21% open · ⏱️ 30.10.2021):
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 250 · 🔀 430 · 📦 210K · 📋 1K - 3% open · ⏱️ 25.11.2021):
...
- [GitHub](https://github.com/myint/docformatter) (👨‍💻 15 · 🔀 32 · 📦 760 · 📋 49 - 55% open · ⏱️ 27.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/docformatter) (📥 89K / month · 📦 110 · ⏱️ 27.12.2020):
	```
...
- [PyPi](https://pypi.org/project/jedi) (📥 18M / month · 📦 16K · ⏱️ 17.11.2021):
	...
	pip install jedi
	```
- [Conda](https://anaconda.org/conda-forge/jedi) (📥 7M · ⏱️ 17.11.2021):
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 67 · 🔀 150 · 📦 33K · 📋 230 - 31% open · ⏱️ 22.11.2021):

	```
	git clone https://github.com/python-rope/rope
	```
- [PyPi](https://pypi.org/project/rope) (📥 540K / month · 📦 2.9K · ⏱️ 22.11.2021):
	```
	pip install rope
	```
...
- [GitHub](https://github.com/myint/autoflake) (👨‍💻 17 · 🔀 49 · 📦 3.3K · 📋 66 - 50% open · ⏱️ 27.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/autoflake) (📥 600K / month · 📦 580 · ⏱️ 04.08.2019):
	```
...
- [GitHub](https://github.com/asottile/pyupgrade) (👨‍💻 21 · 🔀 85 · 📋 250 - 4% open · ⏱️ 23.11.2021):

	```
	git clone https://github.com/asottile/pyupgrade
	```
- [PyPi](https://pypi.org/project/pyupgrade) (📥 120K / month · 📦 10 · ⏱️ 16.11.2021):
	```
...
- [GitHub](https://github.com/asottile/add-trailing-comma) (👨‍💻 9 · 🔀 14 · 📋 36 - 2% open · ⏱️ 23.11.2021):

	```
	git clone https://github.com/asottile/add-trailing-comma
	```
- [PyPi](https://pypi.org/project/add-trailing-comma) (📥 16K / month · 📦 14 · ⏱️ 20.11.2021):
	```
...
- [GitHub](https://github.com/hakancelik96/unimport) (👨‍💻 13 · 🔀 13 · 📦 15 · 📋 76 - 13% open · ⏱️ 14.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/unimport) (📥 3.8K / month · ⏱️ 14.09.2021):
	```
...
<details><summary><b><a href="https://github.com/elmotec/massedit">massedit</a></b> (🥉17 ·  ⭐ 94 · 💤) - Programmatically edit text files with Python. Useful for source to.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- <b><a href="https://github.com/myint/unify">unify</a></b> (🥉20 ·  ⭐ 63 · 💀) - Modifies strings to all use the same quote where possible. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/PyCQA/bandit) (👨‍💻 140 · 🔀 380 · 📥 120 · 📦 9.2K · 📋 560 - 33% open · ⏱️ 13.11.2021):
...
- [PyPi](https://pypi.org/project/bandit) (📥 2.1M / month · 📦 2.4K · ⏱️ 12.11.2021):
	...
	pip install bandit
	```
- [Conda](https://anaconda.org/conda-forge/bandit) (📥 98K · ⏱️ 13.11.2021):
	```
	conda install -c conda-forge bandit
	```
</details>
<details><summary><b><a href="https://github.com/pyupio/safety">safety</a></b> (🥈28 ·  ⭐ 1.2K · 💤) - Safety checks your installed dependencies for known security.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pyupio/safety) (👨‍💻 35 · 🔀 98 · 📥 99K · 📦 3.1K · 📋 120 - 38% open · ⏱️ 28.04.2021):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.6K · 📋 4.5K - 1% open · ⏱️ 19.11.2021):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 5.9K / month · 📦 8 · ⏱️ 01.11.2021):
	```
	pip install sqlmap
	```
</details>
...
<details><summary><b><a href="https://github.com/dlint-py/dlint">dlint</a></b> (🥉21 ·  ⭐ 78) - Dlint is a tool for encouraging best coding practices and helping ensure.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/dlint-py/dlint) (👨‍💻 8 · 🔀 6 · 📋 33 - 57% open · ⏱️ 27.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/dlint) (📥 96K / month · 📦 18 · ⏱️ 27.10.2021):
	```
	pip install dlint
	```
</details>
...
- [GitHub](https://github.com/pypa/pipenv) (👨‍💻 400 · 🔀 1.7K · 📦 23K · 📋 3.5K - 16% open · ⏱️ 24.11.2021):

	```
	git clone https://github.com/pypa/pipenv
	```
- [PyPi](https://pypi.org/project/pipenv) (📥 4.1M / month · 📦 2.3K · ⏱️ 23.11.2021):
	```
	pip install pipenv
	```
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 220 · 🔀 910 · 📋 1.2K - 5% open · ⏱️ 01.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/virtualenv) (📥 23M / month · 📦 34K · ⏱️ 01.11.2021):
	```
...
- [GitHub](https://github.com/pypa/pip) (👨‍💻 650 · 🔀 2.4K · 📦 65K · 📋 6K - 15% open · ⏱️ 25.11.2021):

	```
	git clone https://github.com/pypa/pip
	```
- [PyPi](https://pypi.org/project/pip) (📥 89M / month · 📦 19K · ⏱️ 22.10.2021):
	```
	pip install pip
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 320 · 🔀 1.4K · 📥 9.4M · 📋 3.5K - 37% open · ⏱️ 23.11.2021):
...
- [GitHub](https://github.com/conda/conda) (👨‍💻 370 · 🔀 1.1K · 📋 8.2K - 22% open · ⏱️ 22.11.2021):

	```
	git clone https://github.com/conda/conda
	```
- [PyPi](https://pypi.org/project/conda) (📥 70K / month · 📦 2.1K · ⏱️ 22.04.2017):
	```
	pip install conda
	```
- [Conda](https://anaconda.org/conda-forge/conda) (📥 23M · ⏱️ 23.11.2021):
	```
...
- [GitHub](https://github.com/bndr/pipreqs) (👨‍💻 51 · 🔀 250 · 📦 7.7K · 📋 180 - 50% open · ⏱️ 23.10.2021):
...
- [GitHub](https://github.com/dephell/dephell) (👨‍💻 37 · 🔀 100 · 📥 160 · 📦 320 · 📋 270 - 40% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/dephell) (📥 10K / month · 📦 8 · ⏱️ 28.04.2020):
	```
	pip install dephell
	```
</details>
...
- [GitHub](https://github.com/pypa/pipx) (👨‍💻 65 · 🔀 190 · 📋 430 - 21% open · ⏱️ 24.11.2021):
...
- [GitHub](https://github.com/mamba-org/mamba) (👨‍💻 62 · 🔀 130 · 📋 650 - 29% open · ⏱️ 25.11.2021):

	```
	git clone https://github.com/mamba-org/mamba
	```
- [Conda](https://anaconda.org/conda-forge/mamba) (📥 1.6M · ⏱️ 25.11.2021):
	```
...
- [GitHub](https://github.com/David-OConnor/pyflow) (👨‍💻 27 · 🔀 35 · 📥 3.6K · 📋 110 - 38% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/David-OConnor/pyflow
	```
- [PyPi](https://pypi.org/project/pyflow) (📥 190 / month · ⏱️ 02.07.2021):
	```
	pip install pyflow
	```
</details>
...
- [GitHub](https://github.com/jaraco/pip-run) (👨‍💻 11 · 🔀 10 · 📋 42 - 7% open · ⏱️ 20.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pip-run) (📥 7.8K / month · ⏱️ 20.11.2021):
	```
	pip install pip-run
	```
</details>
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 78 · 🔀 140 · 📋 280 - 18% open · ⏱️ 22.11.2021):
...
- [GitHub](https://github.com/rubik/radon) (👨‍💻 49 · 🔀 97 · 📦 2.1K · 📋 160 - 12% open · ⏱️ 08.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/radon) (📥 430K / month · 📦 1.1K · ⏱️ 08.08.2021):
	```
	pip install radon
	```
...
- [GitHub](https://github.com/rubik/xenon) (👨‍💻 8 · 🔀 16 · 📦 270 · 📋 31 - 19% open · ⏱️ 03.09.2021):

	```
	git clone https://github.com/rubik/xenon
	```
- [PyPi](https://pypi.org/project/xenon) (📥 63K / month · 📦 120 · ⏱️ 03.09.2021):
	```
	pip install xenon
	```
...
- [GitHub](https://github.com/tonybaloney/wily) (👨‍💻 16 · 🔀 45 · 📋 80 - 35% open · ⏱️ 01.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/wily) (📥 9.1K / month · 📦 16 · ⏱️ 01.07.2021):
	```
	pip install wily
	```
</details>
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1K · 📥 8K · 📦 230K · 📋 870 - 37% open · ⏱️ 20.09.2021):
...
- [GitHub](https://github.com/willmcgugan/rich) (👨‍💻 140 · 🔀 1K · 📦 8.7K · 📋 600 - 5% open · ⏱️ 20.11.2021):

	```
	git clone https://github.com/willmcgugan/rich
	```
- [PyPi](https://pypi.org/project/rich) (📥 2.6M / month · ⏱️ 24.11.2021):
	```
	pip install rich
	```
...
- [GitHub](https://github.com/astanin/python-tabulate) (👨‍💻 67 · 🔀 82 · 📦 56K · 📋 110 - 44% open · ⏱️ 04.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/tabulate) (📥 31M / month · 📦 8.1K · ⏱️ 22.02.2021):
	```
...
- [GitHub](https://github.com/WoLpH/python-progressbar) (👨‍💻 40 · 🔀 100 · 📥 1.6K · 📦 13K · 📋 190 - 3% open · ⏱️ 15.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/progressbar2) (📥 2.4M / month · 📦 2.2K · ⏱️ 15.10.2021):
	```
...
- [GitHub](https://github.com/borntyping/python-colorlog) (👨‍💻 30 · 🔀 76 · 📦 12K · 📋 70 - 1% open · ⏱️ 08.11.2021):

	```
	git clone https://github.com/borntyping/python-colorlog
	```
- [PyPi](https://pypi.org/project/colorlog) (📥 5.1M / month · 📦 3.7K · ⏱️ 08.11.2021):
	```
...
<details><summary><b><a href="https://github.com/hynek/structlog">structlog</a></b> (🥉27 ·  ⭐ 1.8K) - Structured Logging for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/hynek/structlog) (👨‍💻 81 · 🔀 150 · 📋 200 - 12% open · ⏱️ 25.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/structlog) (📥 2.5M / month · 📦 1.2K · ⏱️ 20.11.2021):
	```
...
<details><summary><b><a href="https://github.com/ines/wasabi">wasabi</a></b> (🥉25 ·  ⭐ 310 · 💤) - A lightweight console printing and formatting toolkit. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/ines/wasabi) (👨‍💻 4 · 🔀 18 · 📦 15K · 📋 6 - 50% open · ⏱️ 31.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/wasabi) (📥 3.2M / month · 📦 410 · ⏱️ 31.01.2021):
	```
	pip install wasabi
	```
- [Conda](https://anaconda.org/conda-forge/wasabi) (📥 500K · ⏱️ 01.02.2021):
	```
...
- [GitHub](https://github.com/cknd/stackprinter) (👨‍💻 6 · 🔀 33 · 📦 82 · 📋 26 - 42% open · ⏱️ 01.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/stackprinter) (📥 420K / month · 📦 4 · ⏱️ 31.10.2020):
	```
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 1 · 🔀 120 · 📦 480 · 📋 91 - 27% open · ⏱️ 06.11.2021):

	```
	git clone https://github.com/rsalmei/alive-progress
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 25K / month · ⏱️ 19.10.2021):
	```
...
<details><summary><b><a href="https://github.com/onelivesleft/PrettyErrors">PrettyErrors</a></b> (🥉20 ·  ⭐ 2.3K) - Prettify Python exception output to make it legible. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/onelivesleft/PrettyErrors) (👨‍💻 5 · 🔀 67 · 📋 35 - 2% open · ⏱️ 24.11.2021):

	```
	git clone https://github.com/onelivesleft/PrettyErrors
	```
- [PyPi](https://pypi.org/project/pretty_errors) (📥 17K / month · ⏱️ 24.11.2021):
	```
	pip install pretty_errors
	```
</details>
<details><summary><b><a href="https://github.com/samuelcolvin/python-devtools">python-devtools</a></b> (🥉20 ·  ⭐ 440) - Dev tools for python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/samuelcolvin/python-devtools) (👨‍💻 7 · 🔀 15 · 📦 490 · 📋 36 - 5% open · ⏱️ 08.09.2021):
...
<details><summary><b><a href="https://github.com/sphinx-doc/sphinx">sphinx</a></b> (🥇38 ·  ⭐ 4.3K) - Main repository for the Sphinx documentation builder. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://www.sphinx-doc.org/en/master/_static/favicon.svg" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/sphinx-doc/sphinx) (👨‍💻 690 · 🔀 1.6K · 📦 170K · 📋 5.8K - 16% open · ⏱️ 23.11.2021):
...
- [GitHub](https://github.com/mkdocs/mkdocs) (👨‍💻 210 · 🔀 1.8K · 📦 16K · 📋 1.6K - 6% open · ⏱️ 20.11.2021):
...
<details><summary><b><a href="https://github.com/squidfunk/mkdocs-material">mkdocs-material</a></b> (🥈32 ·  ⭐ 8.1K) - Technical documentation that just works. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 140 · 🔀 1.9K · 📦 9.8K · 📋 1.2K - 1% open · ⏱️ 24.11.2021):

	```
	git clone https://github.com/squidfunk/mkdocs-material
	```
- [PyPi](https://pypi.org/project/mkdocs-material) (📥 730K / month · 📦 1.5K · ⏱️ 21.11.2021):
	```
	pip install mkdocs-material
	```
- [Conda](https://anaconda.org/conda-forge/mkdocs-material) (📥 73K · ⏱️ 30.10.2021):
	```
...
- [GitHub](https://github.com/numpy/numpydoc) (👨‍💻 68 · 🔀 6.2K · 📦 29K · 📋 160 - 37% open · ⏱️ 05.11.2021):
...
- [PyPi](https://pypi.org/project/numpydoc) (📥 250K / month · 📦 7.3K · ⏱️ 01.07.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/numpydoc) (📥 880K · ⏱️ 01.10.2020):
	```
...
- [GitHub](https://github.com/michaeljones/breathe) (👨‍💻 98 · 🔀 140 · 📥 150 · 📦 5.4K · 📋 480 - 25% open · ⏱️ 20.11.2021):
...
- [GitHub](https://github.com/ryan-roemer/sphinx-bootstrap-theme) (👨‍💻 38 · 🔀 210 · 📋 140 - 40% open · ⏱️ 02.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/sphinx-bootstrap-theme) (📥 63K / month · 📦 980 · ⏱️ 12.09.2021):
	```
...
- [GitHub](https://github.com/agronholm/sphinx-autodoc-typehints) (👨‍💻 30 · 🔀 71 · 📋 130 - 44% open · ⏱️ 08.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/sphinx-autodoc-typehints) (📥 340K / month · 📦 1.4K · ⏱️ 12.10.2020):
	```
...
- [GitHub](https://github.com/econchick/interrogate) (👨‍💻 11 · 🔀 24 · 📦 1.1K · 📋 31 - 25% open · ⏱️ 10.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/interrogate) (📥 86K / month · ⏱️ 10.09.2021):
	```
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 32 · 🔀 120 · 📦 450 · 📋 190 - 3% open · ⏱️ 24.11.2021):

	```
	git clone https://github.com/mitmproxy/pdoc
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 95K / month · 📦 290 · ⏱️ 29.10.2021):
	```
	pip install pdoc
	```
</details>
...
- [GitHub](https://github.com/bitprophet/releases) (👨‍💻 10 · 🔀 36 · 📦 390 · 📋 76 - 43% open · ⏱️ 24.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/releases) (📥 9.6K / month · 📦 710 · ⏱️ 11.01.2020):
	```
...
- [PyPi](https://pypi.org/project/sphinx-autobuild) (📥 210K / month · 📦 4.7K · ⏱️ 14.03.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sphinx-autobuild) (📥 78K · ⏱️ 14.03.2021):
	```
	conda install -c conda-forge sphinx-autobuild
	```
</details>
<details><summary><b><a href="https://github.com/mkdocstrings/mkdocstrings">mkdocstrings</a></b> (🥉22 ·  ⭐ 540) - Automatic documentation from sources, for MkDocs. <code><a href="http://bit.ly/3hkKRql">ISC</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/mkdocstrings/mkdocstrings) (👨‍💻 25 · 🔀 58 · 📋 210 - 24% open · ⏱️ 31.10.2021):

	```
	git clone https://github.com/mkdocstrings/mkdocstrings
	```
- [PyPi](https://pypi.org/project/mkdocstrings) (📥 90K / month · ⏱️ 04.10.2021):
	```
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-pages-plugin) (👨‍💻 3 · 🔀 20 · 📦 560 · 📋 45 - 15% open · ⏱️ 22.11.2021):

	```
	git clone https://github.com/lukasgeiter/mkdocs-awesome-pages-plugin
	```
- [PyPi](https://pypi.org/project/mkdocs-awesome-pages-plugin) (📥 44K / month · 📦 90 · ⏱️ 22.11.2021):
	```
...
- [GitHub](https://github.com/asottile/blacken-docs) (👨‍💻 13 · 🔀 20 · 📋 37 - 8% open · ⏱️ 23.11.2021):

	```
	git clone https://github.com/asottile/blacken-docs
	```
- [PyPi](https://pypi.org/project/blacken-docs) (📥 14K / month · 📦 22 · ⏱️ 19.11.2021):
	```
...
- [GitHub](https://github.com/orzih/mkdocs-with-pdf) (👨‍💻 6 · 🔀 19 · 📦 75 · 📋 63 - 41% open · ⏱️ 14.10.2021):
...
- [GitHub](https://github.com/timothycrosley/portray) (👨‍💻 16 · 🔀 58 · 📋 50 - 42% open · ⏱️ 13.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/portray) (📥 6.6K / month · 📦 8 · ⏱️ 13.06.2021):
	```
	pip install portray
	```
</details>
<details><summary><b><a href="https://github.com/ml-tooling/lazydocs">lazydocs</a></b> (🥉16 ·  ⭐ 50 · 📉) - Generate markdown API documentation from Google-style Python.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ml-tooling/lazydocs) (👨‍💻 7 · 🔀 12 · 📦 53 · 📋 6 - 50% open · ⏱️ 20.08.2021):

	```
	git clone https://github.com/ml-tooling/lazydocs
	```
- [PyPi](https://pypi.org/project/lazydocs) (📥 910 / month · ⏱️ 27.07.2021):
	```
...
- <b><a href="https://github.com/timvink/mkdocs-print-site-plugin">mkdocs-print-site-plugin</a></b> (🥉19 ·  ⭐ 28) - MkDocs Plugin that adds an additional page that.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/cool-RR/PySnooper) (👨‍💻 26 · 🔀 920 · 📦 520 · 📋 110 - 16% open · ⏱️ 11.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/pysnooper) (📥 90K / month · 📦 46 · ⏱️ 11.09.2021):
	```
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 80 · 🔀 190 · 📦 2.7K · 📋 290 - 48% open · ⏱️ 01.11.2021):
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 80 · 🔀 400 · 📦 2.7K · 📋 170 - 31% open · ⏱️ 17.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 770K / month · 📦 880 · ⏱️ 27.10.2020):
	```
...
- [GitHub](https://github.com/cs01/gdbgui) (👨‍💻 38 · 🔀 480 · 📥 6K · 📦 120 · 📋 280 - 40% open · ⏱️ 06.09.2021):
...
- [GitHub](https://github.com/agronholm/typeguard) (👨‍💻 18 · 🔀 67 · 📋 170 - 18% open · ⏱️ 22.11.2021):

	```
	git clone https://github.com/agronholm/typeguard
	```
- [PyPi](https://pypi.org/project/typeguard) (📥 9.7M / month · 📦 160 · ⏱️ 22.11.2021):
	```
	pip install typeguard
	```
- [Conda](https://anaconda.org/conda-forge/typeguard) (📥 64K · ⏱️ 11.10.2021):
	```
	conda install -c conda-forge typeguard
	```
</details>
<details><summary><b><a href="https://github.com/gruns/icecream">icecream</a></b> (🥉23 ·  ⭐ 5.6K) - Never use print() to debug again. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/alexmojaki/snoop) (👨‍💻 21 · 🔀 24 · 📋 37 - 48% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/snoop) (📥 27K / month · 📦 8 · ⏱️ 11.11.2021):
	```
	pip install snoop
	```
</details>
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 35 · 📦 71 · 📋 87 - 42% open · ⏱️ 13.10.2021):

	```
	git clone https://github.com/ionelmc/python-hunter
	```
- [PyPi](https://pypi.org/project/hunter) (📥 7K / month · 📦 34 · ⏱️ 23.06.2021):
	```
	pip install hunter
	```
</details>
...
- [GitHub](https://github.com/alexmojaki/birdseye) (👨‍💻 10 · 🔀 70 · 📋 50 - 36% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/birdseye) (📥 1.3K / month · ⏱️ 11.11.2021):
	```
...
<details><summary><b><a href="https://github.com/pytest-dev/pytest">pytest</a></b> (🥇36 ·  ⭐ 8K) - The pytest framework makes it easy to write small tests, yet scales to.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pytest-dev/pytest) (👨‍💻 750 · 🔀 1.9K · 📦 400K · 📋 4.7K - 15% open · ⏱️ 25.11.2021):
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 150 · 🔀 1.8K · 📥 510 · 📦 4.6K · 📋 3.7K - 6% open · ⏱️ 24.11.2021):
...
- [GitHub](https://github.com/tox-dev/tox) (👨‍💻 250 · 🔀 380 · 📦 51K · 📋 1.3K - 10% open · ⏱️ 11.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/tox) (📥 3.6M / month · 📦 36K · ⏱️ 16.09.2021):
	```
	pip install tox
	```
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 250 · 🔀 480 · 📦 11K · 📋 1.2K - 5% open · ⏱️ 22.11.2021):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 2.3M / month · 📦 2.6K · ⏱️ 22.11.2021):
	```
...
<details><summary><b><a href="https://github.com/asweigart/pyautogui">pyautogui</a></b> (🥈31 ·  ⭐ 5.8K) - A cross-platform GUI automation Python module for human beings. Used.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/pytest-dev/pytest-asyncio) (👨‍💻 26 · 🔀 89 · 📦 18K · 📋 180 - 43% open · ⏱️ 15.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-asyncio) (📥 7.3M / month · 📦 2K · ⏱️ 15.10.2021):
	```
	pip install pytest-asyncio
	```
- [Conda](https://anaconda.org/conda-forge/pytest-asyncio) (📥 690K · ⏱️ 18.10.2021):
	```
	conda install -c conda-forge pytest-asyncio
	```
</details>
<details><summary><b><a href="https://github.com/pytest-dev/pytest-xdist">pytest-xdist</a></b> (🥈31 ·  ⭐ 800) - pytest plugin for distributed testing and loop-on-failures.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 280 · 📥 180 · 📋 300 - 1% open · ⏱️ 24.11.2021):

	```
	git clone https://github.com/lk-geimfari/mimesis
	```
- [PyPi](https://pypi.org/project/mimesis) (📥 84K / month · 📦 84 · ⏱️ 05.11.2021):
	```
	pip install mimesis
	```
</details>
...
- [GitHub](https://github.com/microsoft/playwright-python) (👨‍💻 21 · 🔀 470 · 📦 550 · 📋 510 - 4% open · ⏱️ 22.11.2021):

	```
	git clone https://github.com/microsoft/playwright-python
	```
- [PyPi](https://pypi.org/project/playwright) (📥 150K / month · ⏱️ 20.11.2021):
	```
...
- [GitHub](https://github.com/ionelmc/pytest-benchmark) (👨‍💻 34 · 🔀 86 · 📦 2.3K · 📋 150 - 49% open · ⏱️ 14.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-benchmark) (📥 440K / month · 📦 730 · ⏱️ 17.04.2021):
	```
...
- [GitHub](https://github.com/airspeed-velocity/asv) (👨‍💻 55 · 🔀 130 · 📦 200 · 📋 410 - 27% open · ⏱️ 15.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/asv) (📥 30K / month · 📦 88 · ⏱️ 16.05.2020):
	```
	pip install asv
	```
...
- [GitHub](https://github.com/hamcrest/PyHamcrest) (👨‍💻 36 · 🔀 87 · 📋 65 - 24% open · ⏱️ 22.11.2021):

	```
	git clone https://github.com/hamcrest/PyHamcrest
	```
- [PyPi](https://pypi.org/project/pyhamcrest) (📥 920K / month · 📦 3.4K · ⏱️ 02.03.2020):
	```
...
- [GitHub](https://github.com/xiaocong/uiautomator) (👨‍💻 13 · 🔀 590 · 📦 200 · 📋 290 - 59% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/uiautomator) (📥 30K / month · 📦 120 · ⏱️ 16.11.2020):
	```
...
- [GitHub](https://github.com/theacodes/nox) (👨‍💻 63 · 🔀 100 · 📋 240 - 15% open · ⏱️ 19.11.2021):
...
- [GitHub](https://github.com/tarpas/pytest-testmon) (👨‍💻 16 · 🔀 29 · 📋 120 - 24% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-testmon) (📥 95K / month · 📦 98 · ⏱️ 22.10.2021):
	```
...
<details><summary><b><a href="https://github.com/pytest-dev/pytest-randomly">pytest-randomly</a></b> (🥉23 ·  ⭐ 380) - Pytest plugin to randomly order tests and control random.seed. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pytest-dev/pytest-randomly) (👨‍💻 16 · 🔀 22 · 📋 46 - 10% open · ⏱️ 25.11.2021):
...
- [GitHub](https://github.com/TvoroG/pytest-lazy-fixture) (👨‍💻 8 · 🔀 15 · 📦 480 · 📋 35 - 42% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/tvorog/pytest-lazy-fixture
	```
- [PyPi](https://pypi.org/project/pytest-lazy-fixture) (📥 240K / month · 📦 62 · ⏱️ 01.02.2020):
	```
...
- [GitHub](https://github.com/Erotemic/xdoctest) (👨‍💻 6 · 🔀 7 · 📦 1.7K · 📋 37 - 45% open · ⏱️ 06.10.2021):
...
- [GitHub](https://github.com/pypa/packaging) (👨‍💻 72 · 🔀 180 · 📥 180 · 📦 280K · 📋 230 - 28% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/pypa/packaging
	```
- [PyPi](https://pypi.org/project/packaging) (📥 84M / month · 📦 29K · ⏱️ 18.11.2021):
	```
...
- [GitHub](https://github.com/Nuitka/Nuitka) (👨‍💻 100 · 🔀 340 · 📋 1.1K - 20% open · ⏱️ 25.11.2021):
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 420 · 🔀 1.7K · 📥 720K · 📋 4.3K - 7% open · ⏱️ 17.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 660K / month · ⏱️ 10.11.2021):
	```
...
- [GitHub](https://github.com/pantsbuild/pex) (👨‍💻 100 · 🔀 210 · 📥 490K · 📋 760 - 18% open · ⏱️ 25.11.2021):

	```
	git clone https://github.com/pantsbuild/pex
	```
- [PyPi](https://pypi.org/project/pex) (📥 160K / month · 📦 230 · ⏱️ 25.11.2021):
	```
	pip install pex
	```
</details>
...
- [GitHub](https://github.com/py2exe/py2exe) (👨‍💻 14 · 🔀 42 · 📥 6.6K · 📦 1.3K · 📋 91 - 5% open · ⏱️ 16.11.2021):
...
- [GitHub](https://github.com/marcelotduarte/cx_Freeze) (👨‍💻 93 · 🔀 170 · 📋 700 - 9% open · ⏱️ 23.11.2021):
...
- [PyPi](https://pypi.org/project/cx_freeze) (📥 54K / month · 📦 150 · ⏱️ 16.12.2017):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cx_freeze) (📥 100K · ⏱️ 23.11.2021):
	```
...
- [GitHub](https://github.com/takluyver/pynsist) (👨‍💻 28 · 🔀 100 · 📋 160 - 15% open · ⏱️ 24.11.2021):
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 34 · 🔀 75 · 📥 150 · 📋 100 - 33% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/linkedin/shiv
	```
- [PyPi](https://pypi.org/project/shiv) (📥 6.9K / month · 📦 10 · ⏱️ 18.11.2021):
	```
	pip install shiv
	```
</details>
...
- [GitHub](https://github.com/conda/constructor) (👨‍💻 47 · 🔀 130 · 📥 220 · 📦 11 · 📋 250 - 22% open · ⏱️ 19.11.2021):
	...
	```
- [Conda](https://anaconda.org/anaconda/constructor) (📥 4.8K · ⏱️ 01.04.2021):
	```
...
- [GitHub](https://github.com/indygreg/PyOxidizer) (👨‍💻 37 · 🔀 130 · 📥 1.2K · 📋 400 - 60% open · ⏱️ 22.11.2021):
...
<details><summary><b><a href="https://github.com/pypa/setuptools">setuptools</a></b> (🥇35 ·  ⭐ 1.5K · 📈) - Official project repository for the Setuptools build system. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pypa/setuptools) (👨‍💻 470 · 🔀 790 · 📥 110 · 📦 130K · 📋 1.9K - 28% open · ⏱️ 22.11.2021):

	```
	git clone https://github.com/pypa/setuptools
	```
- [PyPi](https://pypi.org/project/setuptools) (📥 190M / month · 📦 58K · ⏱️ 19.11.2021):
	```
	pip install setuptools
	```
- [Conda](https://anaconda.org/conda-forge/setuptools) (📥 30M · ⏱️ 19.11.2021):
	```
...
- [GitHub](https://github.com/pyinvoke/invoke) (👨‍💻 56 · 🔀 290 · 📦 9.5K · 📋 700 - 47% open · ⏱️ 16.10.2021):
...
- [GitHub](https://github.com/buildbot/buildbot) (👨‍💻 800 · 🔀 1.6K · 📥 18K · 📦 260 · 📋 1.4K - 45% open · ⏱️ 19.11.2021):

	```
	git clone https://github.com/buildbot/buildbot
	```
- [PyPi](https://pypi.org/project/buildbot) (📥 55K / month · 📦 890 · ⏱️ 16.10.2021):
	```
...
- [GitHub](https://github.com/pypa/twine) (👨‍💻 100 · 🔀 250 · 📦 50K · 📋 390 - 9% open · ⏱️ 23.11.2021):

	```
	git clone https://github.com/pypa/twine
	```
- [PyPi](https://pypi.org/project/twine) (📥 2.6M / month · 📦 18K · ⏱️ 10.11.2021):
	```
	pip install twine
	```
...
- [GitHub](https://github.com/pypa/wheel) (👨‍💻 62 · 🔀 100 · 📋 330 - 9% open · ⏱️ 07.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/wheel) (📥 96M / month · 📦 63K · ⏱️ 09.08.2021):
	```
	pip install wheel
	```
...
- [GitHub](https://github.com/SCons/scons) (👨‍💻 140 · 🔀 250 · 📥 380 · 📋 3.3K - 19% open · ⏱️ 24.11.2021):
...
- [GitHub](https://github.com/pydoit/doit) (👨‍💻 60 · 🔀 140 · 📦 820 · 📋 260 - 24% open · ⏱️ 19.11.2021):

	```
	git clone https://github.com/pydoit/doit
	```
- [PyPi](https://pypi.org/project/doit) (📥 250K / month · 📦 470 · ⏱️ 04.09.2020):
	```
	pip install doit
	```
- [Conda](https://anaconda.org/conda-forge/doit) (📥 69K · ⏱️ 19.11.2021):
	```
...
- [GitHub](https://github.com/takluyver/flit) (👨‍💻 48 · 🔀 86 · 📋 280 - 32% open · ⏱️ 23.11.2021):

	```
	git clone https://github.com/takluyver/flit
	```
- [PyPi](https://pypi.org/project/flit) (📥 380K / month · 📦 230 · ⏱️ 23.11.2021):
	```
	pip install flit
	```
- [Conda](https://anaconda.org/conda-forge/flit) (📥 98K · ⏱️ 23.11.2021):
	```
...
- [GitHub](https://github.com/pypa/setuptools_scm) (👨‍💻 92 · 🔀 150 · 📋 370 - 22% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/setuptools_scm) (📥 16M / month · 📦 690 · ⏱️ 09.08.2018):
	```
	pip install setuptools_scm
	```
- [Conda](https://anaconda.org/conda-forge/setuptools_scm) (📥 820K · ⏱️ 11.09.2021):
	```
...
- [GitHub](https://github.com/ml-tooling/universal-build) (👨‍💻 4 · 🔀 5 · 📥 16 · 📦 7 · ⏱️ 17.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/universal-build) (📥 540 / month · ⏱️ 12.12.2020):
	```
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 170 · 🔀 1.2K · 📦 120K · 📋 1.5K - 13% open · ⏱️ 25.11.2021):
...
<details><summary><b><a href="https://github.com/nicolargo/glances">Glances</a></b> (🥇31 ·  ⭐ 20K) - Glances an Eye on your system. A top/htop alternative for.. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/nicolargo/glances) (👨‍💻 150 · 🔀 1.3K · 📥 710 · 📦 350 · 📋 1.4K - 14% open · ⏱️ 22.11.2021):

	```
	git clone https://github.com/nicolargo/glances
	```
- [PyPi](https://pypi.org/project/glances) (📥 190K / month · 📦 50 · ⏱️ 22.11.2021):
	```
	pip install glances
	```
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 29 · 🔀 280 · 📥 7.1K · 📋 240 - 30% open · ⏱️ 20.11.2021):
...
<details><summary><b><a href="https://github.com/sumerc/yappi">Yappi</a></b> (🥈28 ·  ⭐ 750) - Yet Another Python Profiler, but this time thread&coroutine&greenlet aware. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sumerc/yappi) (👨‍💻 27 · 🔀 51 · 📦 490 · 📋 54 - 29% open · ⏱️ 10.11.2021):

	```
	git clone https://github.com/sumerc/yappi
	```
- [PyPi](https://pypi.org/project/yappi) (📥 940K / month · 📦 640 · ⏱️ 05.10.2021):
	```
	pip install yappi
	```
- [Conda](https://anaconda.org/conda-forge/yappi) (📥 94K · ⏱️ 07.11.2021):
	```
...
- [GitHub](https://github.com/pythonprofilers/memory_profiler) (👨‍💻 90 · 🔀 320 · 📋 210 - 50% open · ⏱️ 06.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 430K / month · 📦 530 · ⏱️ 16.08.2018):
	```
...
- [GitHub](https://github.com/plasma-umass/scalene) (👨‍💻 23 · 🔀 160 · 📦 73 · 📋 150 - 24% open · ⏱️ 24.11.2021):
...
- [GitHub](https://github.com/joerick/pyinstrument) (👨‍💻 36 · 🔀 150 · 📦 420 · 📋 92 - 14% open · ⏱️ 14.11.2021):
...
- [GitHub](https://github.com/pyutils/line_profiler) (👨‍💻 27 · 🔀 250 · 📋 49 - 59% open · ⏱️ 27.09.2021):
...
- [GitHub](https://github.com/pympler/pympler) (👨‍💻 29 · 🔀 68 · 📋 83 - 42% open · ⏱️ 23.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pympler) (📥 690K / month · 📦 480 · ⏱️ 14.10.2020):
	```
	pip install pympler
	```
...
- [GitHub](https://github.com/nvdv/vprof) (👨‍💻 17 · 🔀 170 · 📦 85 · 📋 81 - 30% open · ⏱️ 20.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/vprof) (📥 3.6K / month · 📦 18 · ⏱️ 29.02.2020):
	```
	pip install vprof
	```
</details>
...
<details><summary><b><a href="https://github.com/csurfer/pyheat">pyheat</a></b> (🥉19 ·  ⭐ 690) - pprofile + matplotlib = Python program profiled as an awesome heatmap!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/csurfer/pyheat) (👨‍💻 5 · 🔀 38 · 📦 32 · 📋 12 - 25% open · ⏱️ 18.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/py-heat) (📥 3.6K / month · 📦 10 · ⏱️ 06.12.2018):
	```
	pip install py-heat
	```
</details>
...
- [GitHub](https://github.com/serge-sans-paille/gast) (👨‍💻 10 · 🔀 24 · 📦 71K · 📋 26 - 3% open · ⏱️ 13.11.2021):
...
- [GitHub](https://github.com/newville/asteval) (👨‍💻 19 · 🔀 32 · 📦 680 · 📋 52 - 11% open · ⏱️ 25.09.2021):
...
<details><summary><b><a href="https://github.com/pre-commit/pre-commit">pre-commit</a></b> (🥇32 ·  ⭐ 6.9K) - A framework for managing and maintaining multi-language pre-commit.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pre-commit/pre-commit) (👨‍💻 130 · 🔀 500 · 📥 20K · 📋 1.3K - 1% open · ⏱️ 23.11.2021):
...
- [PyPi](https://pypi.org/project/pre-commit) (📥 3.9M / month · 📦 2.1K · ⏱️ 03.09.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pre-commit) (📥 850K · ⏱️ 04.11.2021):
	```
