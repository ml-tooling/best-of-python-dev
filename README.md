...
- [GitHub](https://github.com/python/mypy) (👨‍💻 460 · 🔀 1.7K · 📦 33K · 📋 6.3K - 27% open · ⏱️ 06.05.2021):
...
- [PyPi](https://pypi.org/project/mypy) (📥 6.6M / month · 📦 6.1K · ⏱️ 19.02.2021):
	...
	pip install mypy
	```
- [Conda](https://anaconda.org/conda-forge/mypy) (📥 890K · ⏱️ 02.04.2021):
	```
...
- [GitHub](https://github.com/PyCQA/flake8) (👨‍💻 150 · 🔀 180 · 📦 160K · 📋 1.3K - 2% open · ⏱️ 03.05.2021):
...
- [PyPi](https://pypi.org/project/flake8) (📥 12M / month · 📦 71K · ⏱️ 14.03.2021):
	...
	pip install flake8
	```
- [Conda](https://anaconda.org/conda-forge/flake8) (📥 2.4M · ⏱️ 16.04.2021):
	```
...
- [GitHub](https://github.com/PyCQA/pycodestyle) (👨‍💻 120 · 🔀 600 · 📦 140K · 📋 640 - 17% open · ⏱️ 03.05.2021):
...
- [GitHub](https://github.com/PyCQA/pylint) (👨‍💻 380 · 🔀 700 · 📋 3.4K - 20% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 160 · 🔀 310 · 📋 260 - 25% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/facebook/pyre-check
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 18K / month · 📦 46 · ⏱️ 04.05.2021):
	```
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 140 · 🔀 270 · 📦 320 · 📋 950 - 8% open · ⏱️ 05.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 67K / month · 📦 14 · ⏱️ 27.02.2021):
	```
...
- [GitHub](https://github.com/openstack/hacking) (👨‍💻 180 · 🔀 66 · ⏱️ 03.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/hacking) (📥 440K / month · 📦 8.7K · ⏱️ 21.04.2021):
	```
	pip install hacking
	```
</details>
...
- [GitHub](https://github.com/microsoft/pyright) (👨‍💻 55 · 🔀 320 · 📦 72 · 📋 1.5K - 0% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/Microsoft/pyright
	```
- [NPM](https://www.npmjs.com/package/pyright) (📥 74K / month · 📦 4 · ⏱️ 04.05.2021):
	```
	npm install pyright
	```
</details>
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 61 · 🔀 190 · 📋 410 - 23% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/google/pytype
	```
- [PyPi](https://pypi.org/project/pytype) (📥 120K / month · 📦 88 · ⏱️ 04.05.2021):
	```
	pip install pytype
	```
...
- [GitHub](https://github.com/dropbox/mypy-protobuf) (👨‍💻 27 · 🔀 53 · 📦 220 · 📋 70 - 17% open · ⏱️ 25.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/mypy-protobuf) (📥 580K / month · 📦 24 · ⏱️ 04.02.2021):
	```
...
- [GitHub](https://github.com/zheller/flake8-quotes) (👨‍💻 28 · 🔀 33 · 📦 3K · 📋 42 - 7% open · ⏱️ 12.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/flake8-quotes) (📥 530K / month · 📦 1.4K · ⏱️ 12.05.2020):
	```
	pip install flake8-quotes
	```
- [Conda](https://anaconda.org/conda-forge/flake8-quotes) (📥 440K · ⏱️ 13.05.2020):
	```
...
- [GitHub](https://github.com/adamchainz/flake8-comprehensions) (👨‍💻 10 · 🔀 13 · 📋 37 - 18% open · ⏱️ 03.05.2021):

	```
	git clone https://github.com/adamchainz/flake8-comprehensions
	```
- [PyPi](https://pypi.org/project/flake8-comprehensions) (📥 520K / month · 📦 710 · ⏱️ 18.03.2021):
	```
...
- [GitHub](https://github.com/wemake-services/flake8-eradicate) (👨‍💻 9 · 🔀 6 · 📋 26 - 7% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/Instagram/Fixit) (👨‍💻 25 · 🔀 36 · 📦 5 · 📋 46 - 54% open · ⏱️ 28.04.2021):
...
- [GitHub](https://github.com/peterjc/flake8-black) (👨‍💻 4 · 🔀 7 · 📦 700 · 📋 17 - 23% open · ⏱️ 15.04.2021):
...
- [PyPi](https://pypi.org/project/flake8-black) (📥 190K / month · 📦 36 · ⏱️ 25.07.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flake8-black) (📥 93K · ⏱️ 25.07.2020):
	```
...
- [GitHub](https://github.com/ambv/flake8-mypy) (👨‍💻 8 · 🔀 15 · 📦 680 · 📋 22 - 86% open · ⏱️ 19.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/flake8-mypy) (📥 44K / month · 📦 200 · ⏱️ 31.08.2017):
	```
...
- [GitHub](https://github.com/andreoliwa/nitpick) (👨‍💻 9 · 🔀 9 · 📥 3 · 📋 84 - 36% open · ⏱️ 03.05.2021):
...
- [GitHub](https://github.com/deppen8/pandas-vet) (👨‍💻 10 · 🔀 14 · 📥 33 · 📦 36 · 📋 49 - 42% open · ⏱️ 03.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pandas-vet) (📥 7.1K / month · ⏱️ 01.02.2020):
	```
...
<details><summary><b><a href="https://github.com/beartype/beartype">beartype</a></b> (🥉17 ·  ⭐ 240) - Unbearably fast O(1) runtime type-checking in pure Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/beartype/beartype) (👨‍💻 4 · 🔀 7 · 📋 25 - 16% open · ⏱️ 06.05.2021):
...
- [PyPi](https://pypi.org/project/beartype) (📥 8.8K / month · ⏱️ 04.03.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/beartype) (📥 3.8K · ⏱️ 04.03.2021):
	```
...
- [GitHub](https://github.com/psf/black) (👨‍💻 240 · 🔀 1.3K · 📥 14K · 📦 56K · 📋 1.5K - 25% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/psf/black
	```
- [PyPi](https://pypi.org/project/black) (📥 6.7M / month · 📦 6.2K · ⏱️ 04.05.2021):
	```
	pip install black
	```
...
- [GitHub](https://github.com/hhatto/autopep8) (👨‍💻 50 · 🔀 240 · 📦 74K · 📋 420 - 20% open · ⏱️ 30.04.2021):
...
- [PyPi](https://pypi.org/project/jedi) (📥 14M / month · 📦 16K · ⏱️ 25.12.2020):
	...
	pip install jedi
	```
- [Conda](https://anaconda.org/conda-forge/jedi) (📥 4.8M · ⏱️ 14.01.2021):
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 63 · 🔀 120 · 📦 28K · 📋 190 - 39% open · ⏱️ 18.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/rope) (📥 360K / month · 📦 2.9K · ⏱️ 07.10.2020):
	```
	pip install rope
	```
...
<details><summary><b><a href="https://github.com/jendrikseipp/vulture">vulture</a></b> (🥈27 ·  ⭐ 1.5K · 📈) - Find dead Python code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 28 · 🔀 71 · 📦 900 · 📋 140 - 8% open · ⏱️ 29.04.2021):
...
- [GitHub](https://github.com/myint/autoflake) (👨‍💻 17 · 🔀 41 · 📦 2.1K · 📋 56 - 42% open · ⏱️ 27.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/autoflake) (📥 930K / month · 📦 580 · ⏱️ 04.08.2019):
	```
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 36 · 🔀 130 · 📦 120 · 📋 140 - 25% open · ⏱️ 23.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/monkeytype) (📥 41K / month · 📦 34 · ⏱️ 18.05.2020):
	```
...
- [GitHub](https://github.com/facebookincubator/Bowler) (👨‍💻 26 · 🔀 85 · 📋 80 - 57% open · ⏱️ 21.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/bowler) (📥 54K / month · 📦 10 · ⏱️ 17.09.2020):
	```
	pip install bowler
	```
...
- [GitHub](https://github.com/asottile/pyupgrade) (👨‍💻 15 · 🔀 62 · 📋 180 - 10% open · ⏱️ 03.05.2021):

	```
	git clone https://github.com/asottile/pyupgrade
	```
- [PyPi](https://pypi.org/project/pyupgrade) (📥 110K / month · 📦 10 · ⏱️ 01.05.2021):
	```
	pip install pyupgrade
	```
- [Conda](https://anaconda.org/conda-forge/pyupgrade) (📥 200K · ⏱️ 01.05.2021):
	```
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 16 · 🔀 46 · 📦 58 · 📋 58 - 43% open · ⏱️ 19.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyannotate) (📥 4.7K / month · 📦 26 · ⏱️ 16.09.2019):
	```
...
- [GitHub](https://github.com/asottile/add-trailing-comma) (👨‍💻 9 · 🔀 13 · 📋 34 - 2% open · ⏱️ 03.05.2021):

	```
	git clone https://github.com/asottile/add-trailing-comma
	```
- [PyPi](https://pypi.org/project/add-trailing-comma) (📥 8.6K / month · 📦 14 · ⏱️ 24.01.2021):
	```
...
- [GitHub](https://github.com/hakancelik96/unimport) (👨‍💻 11 · 🔀 16 · 📦 5 · 📋 71 - 12% open · ⏱️ 28.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/unimport) (📥 4K / month · ⏱️ 10.03.2021):
	```
...
- [GitHub](https://github.com/ilevkivskyi/com2ann) (👨‍💻 3 · 🔀 4 · 📦 2 · 📋 18 - 22% open · ⏱️ 07.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/com2ann) (📥 720 / month · ⏱️ 17.06.2019):
	```
	pip install com2ann
	```
</details>
...
- [GitHub](https://github.com/PyCQA/bandit) (👨‍💻 130 · 🔀 320 · 📥 46 · 📦 6.5K · 📋 530 - 31% open · ⏱️ 12.04.2021):
...
- [PyPi](https://pypi.org/project/bandit) (📥 1.4M / month · 📦 2.4K · ⏱️ 13.12.2020):
	...
	pip install bandit
	```
- [Conda](https://anaconda.org/conda-forge/bandit) (📥 62K · ⏱️ 10.03.2021):
	```
...
- [GitHub](https://github.com/pyupio/safety) (👨‍💻 35 · 🔀 82 · 📥 43K · 📦 1.8K · 📋 110 - 39% open · ⏱️ 28.04.2021):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.2K · 📋 4.3K - 1% open · ⏱️ 01.05.2021):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 6.3K / month · 📦 8 · ⏱️ 01.05.2021):
	```
	pip install sqlmap
	```
</details>
...
- <b><a href="https://github.com/dashingsoft/pyarmor">pyarmor</a></b> (🥉25 ·  ⭐ 930) - A tool used to obfuscate python scripts, bind obfuscated scripts.. <code><a href="https://tldrlegal.com/search?q=SGI-B-2.0">❗️SGI-B-2.0</a></code>
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 320 · 🔀 2K · 📋 1.3K - 20% open · ⏱️ 06.05.2021):
...
- <b><a href="https://github.com/pyenv/pyenv-virtualenv">pyenv-virtualenv</a></b> (🥉18 ·  ⭐ 4.3K · 💀) - a pyenv plugin to manage virtualenv (a.k.a. python-.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/pypa/pip) (👨‍💻 600 · 🔀 2.2K · 📦 49K · 📋 5.7K - 16% open · ⏱️ 01.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pip) (📥 89M / month · 📦 19K · ⏱️ 30.04.2021):
	```
	pip install pip
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 280 · 🔀 1.2K · 📥 6.2M · 📋 2.9K - 36% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/conda/conda) (👨‍💻 350 · 🔀 1K · 📋 7.9K - 24% open · ⏱️ 30.04.2021):
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 150 · 🔀 430 · 📋 730 - 16% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/bndr/pipreqs) (👨‍💻 50 · 🔀 220 · 📦 5K · 📋 160 - 50% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/mamba-org/mamba) (👨‍💻 47 · 🔀 84 · 📦 310 · 📋 430 - 28% open · ⏱️ 03.05.2021):

	```
	git clone https://github.com/mamba-org/mamba
	```
- [Conda](https://anaconda.org/conda-forge/mamba) (📥 760K · ⏱️ 03.05.2021):
	```
...
- [GitHub](https://github.com/pipxproject/pipx) (👨‍💻 55 · 🔀 160 · 📋 380 - 18% open · ⏱️ 30.04.2021):
...
<details><summary><b><a href="https://github.com/David-OConnor/pyflow">pyflow</a></b> (🥉17 ·  ⭐ 740 · 📉) - An installation and dependency system for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/David-OConnor/pyflow) (👨‍💻 21 · 🔀 26 · 📥 3K · 📋 84 - 52% open · ⏱️ 21.02.2021):
...
- [GitHub](https://github.com/jaraco/pip-run) (👨‍💻 9 · 🔀 10 · 📋 41 - 9% open · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pip-run) (📥 4.2K / month · ⏱️ 21.02.2021):
	```
	pip install pip-run
	```
</details>
...
- [GitHub](https://github.com/rubik/radon) (👨‍💻 43 · 🔀 92 · 📦 1.7K · 📋 150 - 13% open · ⏱️ 09.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/radon) (📥 290K / month · 📦 1.1K · ⏱️ 09.03.2021):
	```
	pip install radon
	```
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 67 · 🔀 120 · 📦 2.2K · 📋 260 - 19% open · ⏱️ 21.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/prospector) (📥 460K / month · 📦 1.1K · ⏱️ 21.10.2020):
	```
...
- [GitHub](https://github.com/rubik/xenon) (👨‍💻 7 · 🔀 14 · 📦 200 · 📋 29 - 20% open · ⏱️ 16.09.2020):
	...
	```
- [PyPi](https://pypi.org/project/xenon) (📥 50K / month · 📦 120 · ⏱️ 16.09.2020):
	```
	pip install xenon
	```
...
<details><summary><b><a href="https://github.com/tonybaloney/wily">wily</a></b> (🥉19 ·  ⭐ 720) - A Python application for tracking, reporting on timing and complexity in.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/tonybaloney/wily) (👨‍💻 15 · 🔀 43 · 📋 76 - 36% open · ⏱️ 02.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/wily) (📥 7.9K / month · 📦 8 · ⏱️ 02.09.2020):
	```
	pip install wily
	```
</details>
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 98 · 🔀 940 · 📥 7.8K · 📦 170K · 📋 790 - 35% open · ⏱️ 23.04.2021):

	```
	git clone https://github.com/tqdm/tqdm
	```
- [PyPi](https://pypi.org/project/tqdm) (📥 22M / month · 📦 26K · ⏱️ 06.04.2021):
	```
	pip install tqdm
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 94 · 🔀 200 · 📥 4.4K · 📦 11K · 📋 510 - 27% open · ⏱️ 06.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/sentry-sdk) (📥 7.8M / month · 📦 990 · ⏱️ 18.02.2021):
	```
	pip install sentry-sdk
	```
- [Conda](https://anaconda.org/conda-forge/sentry-sdk) (📥 79K · ⏱️ 18.02.2021):
	```
...
- [PyPi](https://pypi.org/project/tabulate) (📥 16M / month · 📦 8.1K · ⏱️ 22.02.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tabulate) (📥 990K · ⏱️ 22.02.2021):
	```
...
- [GitHub](https://github.com/hynek/structlog) (👨‍💻 72 · 🔀 140 · 📦 3.2K · 📋 180 - 18% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/madzak/python-json-logger) (👨‍💻 43 · 🔀 140 · 📦 15K · 📋 62 - 27% open · ⏱️ 12.10.2020):
...
- [PyPi](https://pypi.org/project/python-json-logger) (📥 3M / month · 📦 920 · ⏱️ 12.10.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-json-logger) (📥 630K · ⏱️ 12.10.2020):
	```
...
- [GitHub](https://github.com/borntyping/python-colorlog) (👨‍💻 29 · 🔀 72 · 📦 9.6K · 📋 62 - 1% open · ⏱️ 14.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/colorlog) (📥 4.4M / month · 📦 3.7K · ⏱️ 13.04.2021):
	```
...
- [GitHub](https://github.com/WoLpH/python-progressbar) (👨‍💻 38 · 🔀 91 · 📥 1.6K · 📦 8.9K · 📋 190 - 4% open · ⏱️ 15.03.2021):

	```
	git clone https://github.com/WoLpH/python-progressbar
	```
- [PyPi](https://pypi.org/project/progressbar2) (📥 930K / month · 📦 2.2K · ⏱️ 09.09.2020):
	```
...
- [GitHub](https://github.com/xolox/python-coloredlogs) (👨‍💻 16 · 🔀 36 · 📦 7.5K · 📋 72 - 31% open · ⏱️ 10.12.2020):
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 1 · 🔀 88 · 📦 280 · 📋 58 - 29% open · ⏱️ 08.01.2021):
...
- [GitHub](https://github.com/cknd/stackprinter) (👨‍💻 6 · 🔀 31 · 📦 53 · 📋 22 - 40% open · ⏱️ 01.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/stackprinter) (📥 80K / month · 📦 4 · ⏱️ 31.10.2020):
	```
...
- [GitHub](https://github.com/shobrook/rebound) (👨‍💻 16 · 🔀 330 · 📥 160 · 📦 19 · 📋 58 - 34% open · ⏱️ 04.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/rebound) (📥 2.2K / month · 📦 14 · ⏱️ 21.04.2021):
	```
	pip install rebound
	```
...
- [GitHub](https://github.com/onelivesleft/PrettyErrors) (👨‍💻 4 · 🔀 64 · 📋 29 - 3% open · ⏱️ 02.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pretty_errors) (📥 18K / month · ⏱️ 02.05.2021):
	```
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (👨‍💻 640 · 🔀 1.4K · 📦 140K · 📋 5.4K - 14% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/sphinx-doc/sphinx
	```
- [PyPi](https://pypi.org/project/sphinx) (📥 4.4M / month · 📦 100K · ⏱️ 29.04.2021):
	```
	pip install sphinx
	```
- [Conda](https://anaconda.org/conda-forge/sphinx) (📥 3.2M · ⏱️ 11.04.2021):
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs) (👨‍💻 190 · 🔀 1.7K · 📦 12K · 📋 1.5K - 9% open · ⏱️ 03.05.2021):
...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 120 · 🔀 1.5K · 📦 6.4K · 📋 1K - 0% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/squidfunk/mkdocs-material
	```
- [PyPi](https://pypi.org/project/mkdocs-material) (📥 460K / month · 📦 1.5K · ⏱️ 18.04.2021):
	```
	pip install mkdocs-material
	```
- [Conda](https://anaconda.org/conda-forge/mkdocs-material) (📥 40K · ⏱️ 24.04.2021):
	```
...
- [GitHub](https://github.com/readthedocs/sphinx_rtd_theme) (👨‍💻 100 · 🔀 1.5K · 📦 16 · 📋 650 - 25% open · ⏱️ 01.05.2021):
...
- [GitHub](https://github.com/michaeljones/breathe) (👨‍💻 94 · 🔀 140 · 📥 32 · 📦 4.4K · 📋 430 - 22% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/michaeljones/breathe
	```
- [PyPi](https://pypi.org/project/breathe) (📥 93K / month · 📦 2K · ⏱️ 30.04.2021):
	```
	pip install breathe
	```
- [Conda](https://anaconda.org/conda-forge/breathe) (📥 190K · ⏱️ 01.05.2021):
	```
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 29 · 🔀 100 · 📦 310 · 📋 160 - 1% open · ⏱️ 30.04.2021):

	```
	git clone https://github.com/mitmproxy/pdoc
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 50K / month · 📦 290 · ⏱️ 30.04.2021):
	```
	pip install pdoc
	```
</details>
...
- [GitHub](https://github.com/econchick/interrogate) (👨‍💻 8 · 🔀 18 · 📦 510 · 📋 27 - 40% open · ⏱️ 03.11.2020):

	```
	git clone https://github.com/econchick/interrogate
	```
- [PyPi](https://pypi.org/project/interrogate) (📥 66K / month · ⏱️ 03.11.2020):
	```
...
- [GitHub](https://github.com/mkdocstrings/mkdocstrings) (👨‍💻 19 · 🔀 42 · 📋 170 - 25% open · ⏱️ 03.05.2021):

	```
	git clone https://github.com/pawamoy/mkdocstrings
	```
- [PyPi](https://pypi.org/project/mkdocstrings) (📥 47K / month · ⏱️ 28.02.2021):
	```
...
- [GitHub](https://github.com/asottile/blacken-docs) (👨‍💻 12 · 🔀 17 · 📋 27 - 7% open · ⏱️ 03.05.2021):
...
- [GitHub](https://github.com/clayrisser/sphinx-markdown-builder) (👨‍💻 16 · 🔀 28 · 📦 130 · 📋 34 - 52% open · ⏱️ 07.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/sphinx-markdown-builder) (📥 11K / month · 📦 42 · ⏱️ 23.12.2019):
	```
	pip install sphinx-markdown-builder
	```
</details>
<details><summary><b><a href="https://github.com/orzih/mkdocs-with-pdf">mkdocs-with-pdf</a></b> (🥉19 ·  ⭐ 56) - Generate a single PDF file from MkDocs repository. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/orzih/mkdocs-with-pdf) (👨‍💻 5 · 🔀 8 · 📦 19 · 📋 39 - 28% open · ⏱️ 08.04.2021):

	```
	git clone https://github.com/orzih/mkdocs-with-pdf
	```
- [PyPi](https://pypi.org/project/mkdocs-with-pdf) (📥 3.8K / month · ⏱️ 11.01.2021):
	```
...
- [GitHub](https://github.com/timothycrosley/portray) (👨‍💻 15 · 🔀 55 · 📋 47 - 40% open · ⏱️ 07.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/portray) (📥 7.3K / month · 📦 8 · ⏱️ 02.04.2021):
	```
	pip install portray
	```
</details>
<details><summary><b><a href="https://github.com/ml-tooling/lazydocs">lazydocs</a></b> (🥉15 ·  ⭐ 19 · 🐣) - Generate markdown API documentation from Google-style Python.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/ml-tooling/lazydocs) (👨‍💻 4 · 🔀 3 · 📦 20 · ⏱️ 15.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/lazydocs) (📥 330 / month · ⏱️ 15.03.2021):
	```
...
- <b><a href="https://github.com/timvink/mkdocs-print-site-plugin">mkdocs-print-site-plugin</a></b> (🥉15 ·  ⭐ 16) - MkDocs Plugin allowing your visitors to *File Print.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
- [GitHub](https://github.com/cool-RR/PySnooper) (👨‍💻 25 · 🔀 890 · 📦 380 · 📋 110 - 16% open · ⏱️ 04.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/pysnooper) (📥 78K / month · 📦 46 · ⏱️ 14.09.2020):
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 75 · 🔀 390 · 📦 2.1K · 📋 160 - 32% open · ⏱️ 18.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 760K / month · 📦 880 · ⏱️ 27.10.2020):
	```
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 74 · 🔀 170 · 📦 2.3K · 📋 270 - 51% open · ⏱️ 29.04.2021):

	```
	git clone https://github.com/inducer/pudb
	```
- [PyPi](https://pypi.org/project/pudb) (📥 640K / month · 📦 1.4K · ⏱️ 21.12.2020):
	```
	pip install pudb
	```
...
- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 39 · 🔀 41 · 📦 2K · 📋 160 - 33% open · ⏱️ 30.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/pdbpp) (📥 220K / month · 📦 1K · ⏱️ 04.10.2019):
	```
	pip install pdbpp
	```
...
- [GitHub](https://github.com/cs01/gdbgui) (👨‍💻 35 · 🔀 460 · 📥 3.4K · 📦 86 · 📋 260 - 41% open · ⏱️ 21.12.2020):

	```
	git clone https://github.com/cs01/gdbgui
	```
- [PyPi](https://pypi.org/project/gdbgui) (📥 86K / month · 📦 2 · ⏱️ 21.12.2020):
	```
	pip install gdbgui
	```
</details>
...
- [GitHub](https://github.com/agronholm/typeguard) (👨‍💻 17 · 🔀 57 · 📋 150 - 23% open · ⏱️ 01.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/typeguard) (📥 1.8M / month · 📦 160 · ⏱️ 01.04.2021):
	```
...
- [GitHub](https://github.com/gruns/icecream) (👨‍💻 13 · 🔀 88 · 📋 66 - 27% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/gruns/icecream
	```
- [PyPi](https://pypi.org/project/icecream) (📥 48K / month · 📦 6 · ⏱️ 27.01.2021):
	```
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 8 · 🔀 31 · 📦 59 · 📋 81 - 43% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/ionelmc/python-hunter
	```
- [PyPi](https://pypi.org/project/hunter) (📥 6.3K / month · 📦 34 · ⏱️ 04.05.2021):
	```
	pip install hunter
	```
</details>
<details><summary><b><a href="https://github.com/alexmojaki/snoop">snoop</a></b> (🥉22 ·  ⭐ 530) - A powerful set of Python debugging tools, based on PySnooper. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/alexmojaki/snoop) (👨‍💻 20 · 🔀 19 · 📦 35 · 📋 27 - 40% open · ⏱️ 26.03.2021):
...
- [GitHub](https://github.com/pytest-dev/pytest) (👨‍💻 720 · 🔀 1.7K · 📦 310K · 📋 4.5K - 14% open · ⏱️ 05.05.2021):
...
- [PyPi](https://pypi.org/project/pytest) (📥 28M / month · 📦 130K · ⏱️ 04.05.2021):
	...
	pip install pytest
	```
- [Conda](https://anaconda.org/conda-forge/pytest) (📥 7.6M · ⏱️ 04.05.2021):
	```
...
- [GitHub](https://github.com/tox-dev/tox) (👨‍💻 240 · 🔀 370 · 📦 44K · 📋 1.2K - 11% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 140 · 🔀 1.6K · 📥 500 · 📦 3.7K · 📋 3.5K - 5% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/robotframework/robotframework
	```
- [PyPi](https://pypi.org/project/robotframework) (📥 740K / month · 📦 1.4K · ⏱️ 08.04.2021):
	```
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 250 · 🔀 460 · 📦 8.5K · 📋 1.1K - 4% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/pytest-dev/pytest-cov) (👨‍💻 63 · 🔀 140 · 📦 85K · 📋 290 - 33% open · ⏱️ 24.03.2021):

	```
	git clone https://github.com/pytest-dev/pytest-cov
	```
- [PyPi](https://pypi.org/project/pytest-cov) (📥 9.9M / month · 📦 43K · ⏱️ 20.01.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-xdist) (👨‍💻 73 · 🔀 150 · 📦 18K · 📋 420 - 45% open · ⏱️ 04.05.2021):
...
- [GitHub](https://github.com/TheKevJames/coveralls-python) (👨‍💻 55 · 🔀 170 · 📦 17K · 📋 140 - 3% open · ⏱️ 03.05.2021):
...
- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 50 · 🔀 690 · 📦 7.5K · 📋 460 - 64% open · ⏱️ 18.04.2021):
...
- [GitHub](https://github.com/pytest-dev/pytest-html) (👨‍💻 43 · 🔀 160 · 📦 9.7K · 📋 250 - 28% open · ⏱️ 23.01.2021):
...
- [GitHub](https://github.com/pytest-dev/pytest-mock) (👨‍💻 53 · 🔀 92 · 📦 16K · 📋 96 - 11% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/pytest-dev/pytest-mock
	```
- [PyPi](https://pypi.org/project/pytest-mock) (📥 3.9M / month · 📦 6.2K · ⏱️ 24.04.2021):
	```
	pip install pytest-mock
	```
- [Conda](https://anaconda.org/conda-forge/pytest-mock) (📥 880K · ⏱️ 11.01.2021):
	```
...
- [PyPi](https://pypi.org/project/pytest-asyncio) (📥 1.7M / month · 📦 2K · ⏱️ 21.04.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-asyncio) (📥 400K · ⏱️ 06.04.2021):
	```
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 270 · 📥 160 · 📋 280 - 2% open · ⏱️ 30.04.2021):
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 71 · 🔀 130 · 📦 3.7K · 📋 250 - 21% open · ⏱️ 10.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/nose2) (📥 310K / month · 📦 1.9K · ⏱️ 27.01.2021):
	```
	pip install nose2
	```
...
- [PyPi](https://pypi.org/project/pytest-benchmark) (📥 330K / month · 📦 730 · ⏱️ 17.04.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-benchmark) (📥 510K · ⏱️ 18.04.2021):
	```
...
- [GitHub](https://github.com/CleanCut/green) (👨‍💻 37 · 🔀 74 · 📦 580 · 📋 160 - 1% open · ⏱️ 28.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/green) (📥 15K / month · 📦 360 · ⏱️ 28.04.2021):
	```
	pip install green
	```
...
- [PyPi](https://pypi.org/project/pytest-mypy) (📥 310K / month · 📦 270 · ⏱️ 21.03.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-mypy) (📥 8.9K · ⏱️ 24.11.2020):
	```
	conda install -c conda-forge pytest-mypy
	```
</details>
<details><summary><b><a href="https://github.com/microsoft/playwright-python">playwright-python</a></b> (🥉25 ·  ⭐ 4.5K) - Python version of the Playwright testing and automation.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/microsoft/playwright-python) (👨‍💻 19 · 🔀 370 · 📦 190 · 📋 310 - 5% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/microsoft/playwright-python
	```
- [PyPi](https://pypi.org/project/playwright) (📥 47K / month · ⏱️ 10.03.2021):
	```
...
- [PyPi](https://pypi.org/project/asv) (📥 14K / month · 📦 88 · ⏱️ 16.05.2020):
	...
	pip install asv
	```
- [Conda](https://anaconda.org/conda-forge/asv) (📥 400K · ⏱️ 16.02.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-testinfra) (👨‍💻 100 · 🔀 270 · 📋 310 - 36% open · ⏱️ 18.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytest-testinfra) (📥 94K / month · ⏱️ 18.03.2021):
	```
...
- [GitHub](https://github.com/theacodes/nox) (👨‍💻 57 · 🔀 88 · 📦 520 · 📋 220 - 22% open · ⏱️ 24.04.2021):
...
- [PyPi](https://pypi.org/project/nox) (📥 290K / month · 📦 56 · ⏱️ 01.01.2021):
	...
	pip install nox
	```
- [Conda](https://anaconda.org/conda-forge/nox) (📥 26K · ⏱️ 06.01.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-randomly) (👨‍💻 15 · 🔀 22 · 📋 41 - 17% open · ⏱️ 03.05.2021):

	```
	git clone https://github.com/pytest-dev/pytest-randomly
	```
- [PyPi](https://pypi.org/project/pytest-randomly) (📥 590K / month · 📦 210 · ⏱️ 11.04.2021):
	```
	pip install pytest-randomly
	```
</details>
<details><summary><b><a href="https://github.com/Erotemic/xdoctest">xdoctest</a></b> (🥉24 ·  ⭐ 94) - A rewrite of Python's builtin doctest module (with pytest plugin.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Erotemic/xdoctest) (👨‍💻 5 · 🔀 5 · 📦 920 · 📋 32 - 50% open · ⏱️ 19.02.2021):

	```
	git clone https://github.com/Erotemic/xdoctest
	```
- [PyPi](https://pypi.org/project/xdoctest) (📥 71K / month · 📦 52 · ⏱️ 29.01.2021):
	```
...
- [GitHub](https://github.com/avast/pytest-docker) (👨‍💻 9 · 🔀 34 · 📥 66 · 📋 29 - 55% open · ⏱️ 22.09.2020):
	...
	```
- [PyPi](https://pypi.org/project/pytest-docker) (📥 21K / month · 📦 28 · ⏱️ 22.09.2020):
	```
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 400 · 🔀 1.6K · 📥 700K · 📦 17K · 📋 4.1K - 8% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/pypa/packaging) (👨‍💻 68 · 🔀 140 · 📥 77 · 📦 200K · 📋 200 - 27% open · ⏱️ 03.05.2021):
...
- [PyPi](https://pypi.org/project/packaging) (📥 54M / month · 📦 29K · ⏱️ 29.01.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/packaging) (📥 7.2M · ⏱️ 04.02.2021):
	```
...
- [GitHub](https://github.com/Nuitka/Nuitka) (👨‍💻 93 · 🔀 280 · 📋 900 - 20% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/Nuitka/Nuitka
	```
- [PyPi](https://pypi.org/project/nuitka) (📥 22K / month · 📦 54 · ⏱️ 04.05.2021):
	```
	pip install nuitka
	```
- [Conda](https://anaconda.org/conda-forge/nuitka) (📥 270K · ⏱️ 04.05.2021):
	```
...
- [GitHub](https://github.com/py2exe/py2exe) (👨‍💻 14 · 🔀 35 · 📥 9K · 📦 1.1K · 📋 72 - 6% open · ⏱️ 24.04.2021):

	```
	git clone https://github.com/py2exe/py2exe
	```
- [PyPi](https://pypi.org/project/py2exe) (📥 41K / month · 📦 350 · ⏱️ 24.04.2021):
	```
	pip install py2exe
	```
</details>
...
- [GitHub](https://github.com/ronaldoussoren/py2app) (👨‍💻 24 · 🔀 7 · 📦 3.7K · 📋 340 - 42% open · ⏱️ 06.04.2021):

	```
	git clone https://github.com/ronaldoussoren/py2app
	```
- [PyPi](https://pypi.org/project/py2app) (📥 21K / month · 📦 1.6K · ⏱️ 06.04.2021):
	```
	pip install py2app
	```
</details>
...
- [GitHub](https://github.com/marcelotduarte/cx_Freeze) (👨‍💻 90 · 🔀 150 · 📋 640 - 8% open · ⏱️ 06.05.2021):
...
- [PyPi](https://pypi.org/project/cx_freeze) (📥 39K / month · 📦 150 · ⏱️ 16.12.2017):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cx_freeze) (📥 66K · ⏱️ 17.04.2021):
	```
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 32 · 🔀 69 · 📥 120 · 📋 84 - 32% open · ⏱️ 30.04.2021):

	```
	git clone https://github.com/linkedin/shiv
	```
- [PyPi](https://pypi.org/project/shiv) (📥 6.5K / month · 📦 10 · ⏱️ 30.04.2021):
	```
	pip install shiv
	```
</details>
...
- [GitHub](https://github.com/conda/constructor) (👨‍💻 44 · 🔀 120 · 📥 220 · 📦 9 · 📋 230 - 17% open · ⏱️ 01.04.2021):
	...
	```
- [Conda](https://anaconda.org/anaconda/constructor) (📥 3.9K · ⏱️ 01.04.2021):
	```
...
- [GitHub](https://github.com/indygreg/PyOxidizer) (👨‍💻 34 · 🔀 110 · 📥 66 · 📋 340 - 59% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/pypa/setuptools) (👨‍💻 440 · 🔀 720 · 📥 100 · 📦 100K · 📋 1.8K - 29% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/pyinvoke/invoke) (👨‍💻 54 · 🔀 280 · 📦 7.6K · 📋 660 - 45% open · ⏱️ 31.12.2020):
...
- [GitHub](https://github.com/buildbot/buildbot) (👨‍💻 790 · 🔀 1.5K · 📥 15K · 📦 250 · 📋 1.3K - 48% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/SCons/scons) (👨‍💻 130 · 🔀 210 · 📥 350 · 📋 3.3K - 20% open · ⏱️ 04.05.2021):
...
- [GitHub](https://github.com/pydoit/doit) (👨‍💻 56 · 🔀 130 · 📦 690 · 📋 260 - 25% open · ⏱️ 03.05.2021):
...
- [PyPi](https://pypi.org/project/doit) (📥 140K / month · 📦 470 · ⏱️ 04.09.2020):
	...
	pip install doit
	```
- [Conda](https://anaconda.org/conda-forge/doit) (📥 51K · ⏱️ 11.10.2020):
	```
...
- [GitHub](https://github.com/pybuilder/pybuilder) (👨‍💻 35 · 🔀 230 · 📋 480 - 18% open · ⏱️ 18.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/pybuilder) (📥 18K / month · 📦 110 · ⏱️ 05.05.2021):
	```
...
- [GitHub](https://github.com/pypa/setuptools_scm) (👨‍💻 84 · 🔀 140 · 📋 330 - 20% open · ⏱️ 03.05.2021):
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 160 · 🔀 1.1K · 📦 84K · 📋 1.5K - 12% open · ⏱️ 03.05.2021):
...
- [GitHub](https://github.com/nicolargo/glances) (👨‍💻 140 · 🔀 1.2K · 📥 430 · 📦 290 · 📋 1.4K - 14% open · ⏱️ 02.05.2021):

	```
	git clone https://github.com/nicolargo/glances
	```
- [PyPi](https://pypi.org/project/glances) (📥 83K / month · 📦 50 · ⏱️ 02.05.2021):
	```
	pip install glances
	```
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 25 · 🔀 250 · 📥 5K · 📦 770 · 📋 200 - 30% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/benfred/py-spy
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 520K / month · 📦 50 · ⏱️ 22.03.2021):
	```
	pip install py-spy
	```
</details>
...
- [GitHub](https://github.com/pyutils/line_profiler) (👨‍💻 23 · 🔀 250 · 📋 41 - 73% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/pyutils/line_profiler
	```
- [PyPi](https://pypi.org/project/line_profiler) (📥 420K / month · 📦 690 · ⏱️ 20.12.2017):
	```
...
- [GitHub](https://github.com/joerick/pyinstrument) (👨‍💻 27 · 🔀 100 · 📦 250 · 📋 79 - 24% open · ⏱️ 03.05.2021):
...
<details><summary><b><a href="https://github.com/sumerc/yappi">Yappi</a></b> (🥉26 ·  ⭐ 620 · 📉) - Yet Another Python Profiler, but this time thread&coroutine&greenlet.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/yappi) (📥 210K / month · 📦 640 · ⏱️ 27.11.2020):
	...
	pip install yappi
	```
- [Conda](https://anaconda.org/conda-forge/yappi) (📥 75K · ⏱️ 28.11.2020):
	```
...
- [GitHub](https://github.com/pympler/pympler) (👨‍💻 26 · 🔀 67 · 📋 78 - 41% open · ⏱️ 15.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/pympler) (📥 300K / month · 📦 480 · ⏱️ 14.10.2020):
	```
	pip install pympler
	```
...
- [GitHub](https://github.com/aristocratos/bpytop) (👨‍💻 28 · 🔀 240 · 📋 230 - 15% open · ⏱️ 02.05.2021):
...
- [GitHub](https://github.com/plasma-umass/scalene) (👨‍💻 18 · 🔀 140 · 📦 36 · 📋 93 - 16% open · ⏱️ 28.04.2021):

	```
	git clone https://github.com/emeryberger/scalene
	```
- [PyPi](https://pypi.org/project/scalene) (📥 3.9K / month · ⏱️ 27.04.2021):
	```
	pip install scalene
	```
</details>
...
- [GitHub](https://github.com/serge-sans-paille/gast) (👨‍💻 10 · 🔀 22 · 📦 54K · 📋 25 - 16% open · ⏱️ 26.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/gast) (📥 7.2M / month · 📦 3.4K · ⏱️ 07.08.2020):
	```
	pip install gast
	```
...
- [GitHub](https://github.com/pre-commit/pre-commit) (👨‍💻 120 · 🔀 430 · 📥 4.8K · 📋 1.1K - 2% open · ⏱️ 06.05.2021):
...
- [PyPi](https://pypi.org/project/pre-commit) (📥 3.1M / month · 📦 2.1K · ⏱️ 06.04.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pre-commit) (📥 510K · ⏱️ 17.04.2021):
	```
