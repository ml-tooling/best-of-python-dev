...
- [GitHub](https://github.com/python/mypy) (👨‍💻 540 · 🔀 2K · 📦 64K · 📋 7.3K - 28% open · ⏱️ 09.03.2022):

	```
	git clone https://github.com/python/mypy
	```
- [PyPi](https://pypi.org/project/mypy) (📥 9.8M / month · 📦 5.4K · ⏱️ 07.01.2022):
	```
	pip install mypy
	```
...
- [GitHub](https://github.com/PyCQA/flake8) (👨‍💻 160 · 🔀 190 · 📦 240K · 📋 1.4K - 2% open · ⏱️ 10.02.2022):
...
- [PyPi](https://pypi.org/project/flake8) (📥 15M / month · 📦 41K · ⏱️ 11.10.2021):
	...
	pip install flake8
	```
- [Conda](https://anaconda.org/conda-forge/flake8) (📥 3.7M · ⏱️ 08.03.2022):
	```
...
- [GitHub](https://github.com/PyCQA/pylint) (👨‍💻 440 · 🔀 800 · 📋 4K - 19% open · ⏱️ 10.03.2022):

	```
	git clone https://github.com/PyCQA/pylint
	```
- [PyPi](https://pypi.org/project/pylint) (📥 10M / month · 📦 21K · ⏱️ 03.12.2021):
	```
	pip install pylint
	```
- [Conda](https://anaconda.org/conda-forge/pylint) (📥 2.6M · ⏱️ 03.12.2021):
	```
...
- [GitHub](https://github.com/PyCQA/pycodestyle) (👨‍💻 130 · 🔀 610 · 📦 200K · 📋 670 - 16% open · ⏱️ 24.02.2022):

	```
	git clone https://github.com/PyCQA/pycodestyle
	```
- [PyPi](https://pypi.org/project/pycodestyle) (📥 22M / month · 📦 11K · ⏱️ 11.10.2021):
	```
	pip install pycodestyle
	```
- [Conda](https://anaconda.org/conda-forge/pycodestyle) (📥 3.9M · ⏱️ 11.10.2021):
	```
...
- [GitHub](https://github.com/PyCQA/pyflakes) (👨‍💻 80 · 🔀 160 · 📦 120K · 📋 460 - 18% open · ⏱️ 13.02.2022):
...
- [PyPi](https://pypi.org/project/pyflakes) (📥 16M / month · 📦 14K · ⏱️ 06.10.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyflakes) (📥 3.7M · ⏱️ 07.10.2021):
	```
	conda install -c conda-forge pyflakes
	```
</details>
<details><summary><b><a href="https://github.com/microsoft/pyright">pyright</a></b> (🥈35 ·  ⭐ 7.7K) - Static type checker for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/microsoft/pyright) (👨‍💻 73 · 🔀 430 · 📦 220 · 📋 2.6K - 0% open · ⏱️ 10.03.2022):

	```
	git clone https://github.com/Microsoft/pyright
	```
- [npm](https://www.npmjs.com/package/pyright) (📥 360K / month · 📦 3 · ⏱️ 09.03.2022):
	```
	npm install pyright
	```
</details>
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 160 · 🔀 320 · 📦 1.1K · 📋 1K - 7% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/wemake-services/wemake-python-styleguide
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 110K / month · 📦 24 · ⏱️ 13.12.2021):
	```
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 190 · 🔀 380 · 📋 310 - 30% open · ⏱️ 10.03.2022):

	```
	git clone https://github.com/facebook/pyre-check
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 40K / month · 📦 32 · ⏱️ 11.01.2022):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 73 · 🔀 230 · 📋 500 - 20% open · ⏱️ 08.03.2022):

	```
	git clone https://github.com/google/pytype
	```
- [PyPi](https://pypi.org/project/pytype) (📥 150K / month · 📦 90 · ⏱️ 08.03.2022):
	```
	pip install pytype
	```
- [Conda](https://anaconda.org/conda-forge/pytype) (📥 68K · ⏱️ 09.03.2022):
	```
	conda install -c conda-forge pytype
	```
</details>
<details><summary><b><a href="https://github.com/PyCQA/pylint-django">pylint-django</a></b> (🥈32 ·  ⭐ 500) - Pylint plugin for improving code analysis for when.. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code> <code><img src="https://www.pylint.org/ico/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PyCQA/pylint-django) (👨‍💻 64 · 🔀 110 · 📥 210 · 📦 17K · 📋 190 - 17% open · ⏱️ 18.02.2022):

	```
	git clone https://github.com/PyCQA/pylint-django
	```
- [PyPi](https://pypi.org/project/pylint-django) (📥 760K / month · 📦 1.2K · ⏱️ 18.02.2022):
	```
...
- [GitHub](https://github.com/davidhalter/parso) (👨‍💻 44 · 🔀 82 · 📦 180K · 📋 100 - 6% open · ⏱️ 14.02.2022):
...
- [PyPi](https://pypi.org/project/parso) (📥 14M / month · 📦 5.9K · ⏱️ 30.11.2021):
	...
	pip install parso
	```
- [Conda](https://anaconda.org/conda-forge/parso) (📥 6.6M · ⏱️ 01.12.2021):
	```
	conda install -c conda-forge parso
	```
</details>
<details><summary><b><a href="https://github.com/PyCQA/pydocstyle">pydocstyle</a></b> (🥈31 ·  ⭐ 860) - docstring style checker. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/PyCQA/pydocstyle) (👨‍💻 79 · 🔀 160 · 📥 56 · 📦 24K · 📋 290 - 29% open · ⏱️ 23.02.2022):
...
- [PyPi](https://pypi.org/project/pydocstyle) (📥 2.1M / month · 📦 2.4K · ⏱️ 17.05.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pydocstyle) (📥 550K · ⏱️ 18.05.2021):
	```
...
<details><summary><b><a href="https://github.com/klen/pylama">pylama</a></b> (🥈29 ·  ⭐ 860) - Code audit tool for python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/klen/pylama) (👨‍💻 46 · 🔀 88 · 📦 3.4K · 📋 130 - 28% open · ⏱️ 05.03.2022):
...
<details><summary><b><a href="https://github.com/PyCQA/flake8-bugbear">flake8-bugbear</a></b> (🥈29 ·  ⭐ 700) - A plugin for Flake8 finding likely bugs and design problems.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://cdn.iconscout.com/icon/free/png-256/8-eight-digital-number-numerical-numbers-36025.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PyCQA/flake8-bugbear) (👨‍💻 49 · 🔀 56 · 📦 7.2K · 📋 120 - 36% open · ⏱️ 28.02.2022):
...
- [GitHub](https://github.com/nipunn1313/mypy-protobuf) (👨‍💻 32 · 🔀 64 · 📋 100 - 5% open · ⏱️ 23.02.2022):
...
- [PyPi](https://pypi.org/project/mypy-protobuf) (📥 800K / month · 📦 50 · ⏱️ 23.01.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/mypy-protobuf) (📥 26K · ⏱️ 24.01.2022):
	```
...
- [GitHub](https://github.com/terrencepreilly/darglint) (👨‍💻 22 · 🔀 37 · 📦 1.9K · 📋 140 - 34% open · ⏱️ 18.10.2021):

	```
	git clone https://github.com/terrencepreilly/darglint
	```
- [PyPi](https://pypi.org/project/darglint) (📥 300K / month · 📦 53 · ⏱️ 18.10.2021):
	```
	pip install darglint
	```
- [Conda](https://anaconda.org/conda-forge/darglint) (📥 31K · ⏱️ 05.11.2021):
	```
...
- [GitHub](https://github.com/adamchainz/flake8-comprehensions) (👨‍💻 12 · 🔀 16 · 📋 42 - 19% open · ⏱️ 05.03.2022):

	```
	git clone https://github.com/adamchainz/flake8-comprehensions
	```
- [PyPi](https://pypi.org/project/flake8-comprehensions) (📥 650K / month · 📦 530 · ⏱️ 10.01.2022):
	```
	pip install flake8-comprehensions
	```
- [Conda](https://anaconda.org/conda-forge/flake8-comprehensions) (📥 510K · ⏱️ 10.01.2022):
	```
...
- [GitHub](https://github.com/zheller/flake8-quotes) (👨‍💻 30 · 🔀 33 · 📦 4.5K · 📋 43 - 6% open · ⏱️ 19.10.2021):

	```
	git clone https://github.com/zheller/flake8-quotes
	```
- [PyPi](https://pypi.org/project/flake8-quotes) (📥 600K / month · 📦 820 · ⏱️ 15.12.2021):
	```
...
- [GitHub](https://github.com/gforcada/flake8-isort) (👨‍💻 31 · 🔀 41 · 📦 5K · 📋 54 - 24% open · ⏱️ 19.01.2022):

	```
	git clone https://github.com/gforcada/flake8-isort
	```
- [PyPi](https://pypi.org/project/flake8-isort) (📥 630K / month · 📦 590 · ⏱️ 14.10.2021):
	```
...
- [GitHub](https://github.com/beartype/beartype) (👨‍💻 9 · 🔀 22 · 📋 83 - 14% open · ⏱️ 10.03.2022):

	```
	git clone https://github.com/beartype/beartype
	```
- [PyPi](https://pypi.org/project/beartype) (📥 82K / month · 📦 30 · ⏱️ 22.02.2022):
	```
	pip install beartype
	```
- [Conda](https://anaconda.org/conda-forge/beartype) (📥 11K · ⏱️ 23.02.2022):
	```
...
- [GitHub](https://github.com/mgedmin/check-manifest) (👨‍💻 20 · 🔀 32 · 📦 7.2K · 📋 90 - 20% open · ⏱️ 24.02.2022):

	```
	git clone https://github.com/mgedmin/check-manifest
	```
- [PyPi](https://pypi.org/project/check-manifest) (📥 170K / month · 📦 2.5K · ⏱️ 22.09.2021):
	```
	pip install check-manifest
	```
- [Conda](https://anaconda.org/conda-forge/check-manifest) (📥 39K · ⏱️ 22.09.2021):
	```
...
- [GitHub](https://github.com/wemake-services/flake8-eradicate) (👨‍💻 13 · 🔀 6 · 📋 28 - 3% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/wemake-services/flake8-eradicate
	```
- [PyPi](https://pypi.org/project/flake8-eradicate) (📥 320K / month · 📦 65 · ⏱️ 19.10.2021):
	```
...
- [GitHub](https://github.com/PyCQA/flake8-commas) (👨‍💻 12 · 🔀 23 · 📦 2.6K · 📋 31 - 16% open · ⏱️ 13.10.2021):

	```
	git clone https://github.com/PyCQA/flake8-commas
	```
- [PyPi](https://pypi.org/project/flake8-commas) (📥 290K / month · 📦 330 · ⏱️ 13.10.2021):
	```
	pip install flake8-commas
	```
</details>
<details><summary><b><a href="https://github.com/peterjc/flake8-black">flake8-black</a></b> (🥉24 ·  ⭐ 110 · 📈) - flake8 plugin to run black for checking Python coding style. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://cdn.iconscout.com/icon/free/png-256/8-eight-digital-number-numerical-numbers-36025.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/peterjc/flake8-black) (👨‍💻 8 · 🔀 9 · 📦 1.9K · 📋 24 - 12% open · ⏱️ 28.02.2022):
...
- [PyPi](https://pypi.org/project/flake8-black) (📥 490K / month · 📦 150 · ⏱️ 25.02.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flake8-black) (📥 210K · ⏱️ 25.02.2022):
	```
...
- [GitHub](https://github.com/Instagram/Fixit) (👨‍💻 29 · 🔀 42 · 📦 15 · 📋 57 - 56% open · ⏱️ 07.01.2022):
...
<details><summary><b><a href="https://github.com/andreoliwa/nitpick">nitpick</a></b> (🥉22 ·  ⭐ 230) - Enforce the same settings on multiple projects. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://cdn.iconscout.com/icon/free/png-256/8-eight-digital-number-numerical-numbers-36025.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/andreoliwa/nitpick) (👨‍💻 13 · 🔀 13 · 📥 4 · 📋 95 - 31% open · ⏱️ 07.03.2022):

	```
	git clone https://github.com/andreoliwa/nitpick
	```
- [PyPi](https://pypi.org/project/nitpick) (📥 11K / month · 📦 3 · ⏱️ 15.01.2022):
	```
	pip install nitpick
	```
</details>
...
- [GitHub](https://github.com/deppen8/pandas-vet) (👨‍💻 12 · 🔀 15 · 📥 41 · 📦 70 · 📋 49 - 38% open · ⏱️ 09.02.2022):

	```
	git clone https://github.com/deppen8/pandas-vet
	```
- [PyPi](https://pypi.org/project/pandas-vet) (📥 9.2K / month · 📦 9 · ⏱️ 09.02.2022):
	```
	pip install pandas-vet
	```
- [Conda](https://anaconda.org/conda-forge/pandas-vet) (📥 8.3K · ⏱️ 10.02.2022):
	```
	conda install -c conda-forge pandas-vet
	```
</details>
<details><summary><b><a href="https://github.com/gforcada/flake8-builtins">flake8-builtins</a></b> (🥉21 ·  ⭐ 79) - Check for python builtins being used as variables or.. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code> <code><img src="https://cdn.iconscout.com/icon/free/png-256/8-eight-digital-number-numerical-numbers-36025.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/gforcada/flake8-builtins) (👨‍💻 15 · 🔀 18 · 📦 3.4K · 📋 36 - 11% open · ⏱️ 20.09.2021):

	```
	git clone https://github.com/gforcada/flake8-builtins
	```
- [PyPi](https://pypi.org/project/flake8-builtins) (📥 450K / month · 📦 300 · ⏱️ 14.05.2020):
	```
...
- [GitHub](https://github.com/justinabrahms/imhotep) (👨‍💻 16 · 🔀 36 · 📦 9 · 📋 45 - 44% open · ⏱️ 20.02.2022):

	```
	git clone https://github.com/justinabrahms/imhotep
	```
- [PyPi](https://pypi.org/project/imhotep) (📥 230 / month · 📦 5 · ⏱️ 20.02.2022):
	```
	pip install imhotep
	```
</details>
<details><summary><b><a href="https://github.com/tylerwince/flake8-bandit">flake8-bandit</a></b> (🥉20 ·  ⭐ 75) - Automated security testing using bandit and flake8. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://cdn.iconscout.com/icon/free/png-256/8-eight-digital-number-numerical-numbers-36025.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tylerwince/flake8-bandit) (👨‍💻 7 · 🔀 19 · 📋 14 - 28% open · ⏱️ 08.03.2022):

	```
	git clone https://github.com/tylerwince/flake8-bandit
	```
- [PyPi](https://pypi.org/project/flake8-bandit) (📥 480K / month · 📦 96 · ⏱️ 08.10.2019):
	```
...
- [GitHub](https://github.com/jschaf/pylint-flask) (👨‍💻 7 · 🔀 9 · 📦 5.8K · 📋 10 - 50% open · ⏱️ 10.03.2021):
...
- [GitHub](https://github.com/hchasestevens/bellybutton) (👨‍💻 5 · 🔀 11 · 📦 17 · 📋 14 - 57% open · ⏱️ 15.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/bellybutton) (📥 6.1K / month · 📦 1 · ⏱️ 27.11.2020):
	```
...
- <b><a href="https://github.com/predictive-analytics-lab/data-science-types">data-science-types</a></b> (🥉22 ·  ⭐ 190 · 💀) - Mypy stubs, i.e., type information, for numpy, pandas.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- <b><a href="https://github.com/lyft/linty_fresh">linty_fresh</a></b> (🥉14 ·  ⭐ 180 · 💀) - Surface lint errors during code review. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://cdn.iconscout.com/icon/free/png-256/8-eight-digital-number-numerical-numbers-36025.png" style="display:inline;" width="13" height="13"></code> <code>mypy</code>
</details>
<br>
...
<details><summary><b><a href="https://github.com/psf/black">black</a></b> (🥇44 ·  ⭐ 26K) - The uncompromising Python code formatter. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/psf/black) (👨‍💻 310 · 🔀 1.6K · 📥 21K · 📦 130K · 📋 1.9K - 17% open · ⏱️ 08.03.2022):

	```
	git clone https://github.com/psf/black
	```
- [PyPi](https://pypi.org/project/black) (📥 14M / month · 📦 6.9K · ⏱️ 29.01.2022):
	```
	pip install black
	```
- [Conda](https://anaconda.org/conda-forge/black) (📥 3.3M · ⏱️ 31.01.2022):
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 140 · 🔀 840 · 📦 30K · 📋 740 - 46% open · ⏱️ 01.03.2022):
...
- [PyPi](https://pypi.org/project/yapf) (📥 1.8M / month · 📦 2.1K · ⏱️ 26.12.2021):
	...
	pip install yapf
	```
- [Conda](https://anaconda.org/conda-forge/yapf) (📥 940K · ⏱️ 06.01.2022):
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 250 · 🔀 440 · 📦 230K · 📋 1.1K - 4% open · ⏱️ 07.01.2022):

	```
	git clone https://github.com/PyCQA/isort
	```
- [PyPi](https://pypi.org/project/isort) (📥 19M / month · 📦 14K · ⏱️ 09.11.2021):
	```
	pip install isort
	```
...
- [GitHub](https://github.com/hhatto/autopep8) (👨‍💻 52 · 🔀 260 · 📦 110K · 📋 430 - 21% open · ⏱️ 02.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/autopep8) (📥 2.8M / month · 📦 5.6K · ⏱️ 24.10.2021):
	```
	pip install autopep8
	```
- [Conda](https://anaconda.org/conda-forge/autopep8) (📥 620K · ⏱️ 26.10.2021):
	```
	conda install -c conda-forge autopep8
	```
</details>
<details><summary><b><a href="https://github.com/PyCQA/docformatter">docformatter</a></b> (🥉24 ·  ⭐ 260) - Formats docstrings to follow PEP 257. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/PyCQA/docformatter) (👨‍💻 16 · 🔀 36 · 📦 860 · 📋 49 - 55% open · ⏱️ 11.02.2022):
...
- [PyPi](https://pypi.org/project/docformatter) (📥 120K / month · 📦 89 · ⏱️ 27.12.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/docformatter) (📥 15K · ⏱️ 29.12.2020):
	```
...
- [GitHub](https://github.com/davidhalter/jedi) (👨‍💻 150 · 🔀 460 · 📦 180K · 📋 1.3K - 2% open · ⏱️ 25.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/jedi) (📥 14M / month · 📦 8.3K · ⏱️ 17.11.2021):
	```
	pip install jedi
	```
- [Conda](https://anaconda.org/conda-forge/jedi) (📥 7.9M · ⏱️ 17.11.2021):
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 68 · 🔀 150 · 📦 35K · 📋 230 - 30% open · ⏱️ 27.02.2022):

	```
	git clone https://github.com/python-rope/rope
	```
- [PyPi](https://pypi.org/project/rope) (📥 630K / month · 📦 1.6K · ⏱️ 27.02.2022):
	```
	pip install rope
	```
- [Conda](https://anaconda.org/conda-forge/rope) (📥 640K · ⏱️ 27.02.2022):
	```
	conda install -c conda-forge rope
	```
</details>
<details><summary><b><a href="https://github.com/asottile/pyupgrade">pyupgrade</a></b> (🥈28 ·  ⭐ 1.4K) - A tool (and pre-commit hook) to automatically upgrade syntax for newer.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/asottile/pyupgrade) (👨‍💻 22 · 🔀 96 · 📋 270 - 3% open · ⏱️ 31.01.2022):

	```
	git clone https://github.com/asottile/pyupgrade
	```
- [PyPi](https://pypi.org/project/pyupgrade) (📥 220K / month · 📦 34 · ⏱️ 01.01.2022):
	```
	pip install pyupgrade
	```
- [Conda](https://anaconda.org/conda-forge/pyupgrade) (📥 320K · ⏱️ 01.01.2022):
	```
	conda install -c conda-forge pyupgrade
	```
</details>
<details><summary><b><a href="https://github.com/Instagram/MonkeyType">MonkeyType</a></b> (🥈27 ·  ⭐ 3.7K · 📈) - A Python library that generates static type annotations by.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 38 · 🔀 130 · 📦 170 · 📋 150 - 25% open · ⏱️ 04.03.2022):
...
- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 30 · 🔀 96 · 📦 1.5K · 📋 160 - 10% open · ⏱️ 03.01.2022):
...
- [GitHub](https://github.com/PyCQA/redbaron) (👨‍💻 34 · 🔀 70 · 📦 360 · 📋 130 - 63% open · ⏱️ 09.12.2021):
...
- [GitHub](https://github.com/facebookincubator/Bowler) (👨‍💻 27 · 🔀 90 · 📋 80 - 57% open · ⏱️ 04.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/bowler) (📥 29K / month · 📦 7 · ⏱️ 17.09.2020):
	```
	pip install bowler
	```
...
<details><summary><b><a href="https://github.com/asottile/add-trailing-comma">add-trailing-comma</a></b> (🥉22 ·  ⭐ 220) - A tool (and pre-commit hook) to automatically add trailing.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/asottile/add-trailing-comma) (👨‍💻 9 · 🔀 18 · 📋 41 - 2% open · ⏱️ 31.01.2022):
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 17 · 🔀 54 · 📦 68 · 📋 59 - 44% open · ⏱️ 12.10.2021):
...
- [GitHub](https://github.com/hakancelik96/unimport) (👨‍💻 13 · 🔀 12 · 📦 19 · 📋 77 - 11% open · ⏱️ 09.03.2022):

	```
	git clone https://github.com/hakancelik96/unimport
	```
- [PyPi](https://pypi.org/project/unimport) (📥 5.7K / month · ⏱️ 09.03.2022):
	```
	pip install unimport
	```
</details>
<details><summary><b><a href="https://github.com/ambv/retype">retype</a></b> (🥉15 ·  ⭐ 120) - Re-apply type annotations from .pyi stubs to your codebase. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/ilevkivskyi/com2ann">com2ann</a></b> (🥉14 ·  ⭐ 110 · 💤) - Tool for translation type comments to type annotations in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/PyCQA/bandit">bandit</a></b> (🥇36 ·  ⭐ 3.9K) - Bandit is a tool designed to find common security issues in Python.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/PyCQA/bandit) (👨‍💻 150 · 🔀 410 · 📥 190 · 📦 11K · 📋 580 - 30% open · ⏱️ 09.03.2022):
...
- [PyPi](https://pypi.org/project/bandit) (📥 2.5M / month · 📦 1.5K · ⏱️ 04.03.2022):
	...
	pip install bandit
	```
- [Conda](https://anaconda.org/conda-forge/bandit) (📥 110K · ⏱️ 05.03.2022):
	```
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.6K · 📋 4.6K - 1% open · ⏱️ 07.03.2022):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 7.4K / month · 📦 6 · ⏱️ 02.03.2022):
	```
	pip install sqlmap
	```
</details>
...
- [GitHub](https://github.com/Yelp/detect-secrets) (👨‍💻 56 · 🔀 270 · 📋 250 - 35% open · ⏱️ 16.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/detect-secrets) (📥 330K / month · 📦 23 · ⏱️ 16.02.2022):
	```
...
- [GitHub](https://github.com/pyupio/safety) (👨‍💻 35 · 🔀 100 · 📥 130K · 📦 3.7K · 📋 120 - 36% open · ⏱️ 28.04.2021):

	```
	git clone https://github.com/pyupio/safety
	```
- [PyPi](https://pypi.org/project/safety) (📥 890K / month · 📦 320 · ⏱️ 15.01.2021):
	```
	pip install safety
	```
...
<details><summary><b><a href="https://github.com/dlint-py/dlint">dlint</a></b> (🥉19 ·  ⭐ 86) - Dlint is a tool for encouraging best coding practices and helping ensure.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/dlint-py/dlint) (👨‍💻 8 · 🔀 6 · 📋 34 - 58% open · ⏱️ 16.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/dlint) (📥 74K / month · 📦 43 · ⏱️ 27.10.2021):
	```
	pip install dlint
	```
- [Conda](https://anaconda.org/conda-forge/dlint) (📥 120 · ⏱️ 09.11.2021):
	```
...
- [GitHub](https://github.com/pypa/pipenv) (👨‍💻 410 · 🔀 1.7K · 📦 25K · 📋 3.6K - 15% open · ⏱️ 09.03.2022):

	```
	git clone https://github.com/pypa/pipenv
	```
- [PyPi](https://pypi.org/project/pipenv) (📥 4.5M / month · 📦 1.2K · ⏱️ 08.01.2022):
	```
	pip install pipenv
	```
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 220 · 🔀 930 · 📋 1.2K - 5% open · ⏱️ 07.03.2022):

	```
	git clone https://github.com/pypa/virtualenv
	```
- [PyPi](https://pypi.org/project/virtualenv) (📥 27M / month · 📦 18K · ⏱️ 07.03.2022):
	```
	pip install virtualenv
	```
- [Conda](https://anaconda.org/conda-forge/virtualenv) (📥 1.6M · ⏱️ 07.03.2022):
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 360 · 🔀 2.3K · 📋 1.4K - 2% open · ⏱️ 09.03.2022):

	```
	git clone https://github.com/pyenv/pyenv
	```
- [PyPi](https://pypi.org/project/pyenv) (📥 7.3K / month · 📦 1 · ⏱️ 12.01.2019):
	```
	pip install pyenv
	```
</details>
...
- [GitHub](https://github.com/spotify/dh-virtualenv) (👨‍💻 58 · 🔀 160 · 📋 200 - 12% open · ⏱️ 10.11.2021):
...
- [GitHub](https://github.com/pyenv/pyenv-installer) (👨‍💻 33 · 🔀 330 · 📋 69 - 7% open · ⏱️ 27.08.2021):
...
<details><summary><b><a href="https://github.com/pypa/pip">pip</a></b> (🥇45 ·  ⭐ 7.8K · 📉) - The Python package installer. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pypa/pip) (👨‍💻 660 · 🔀 2.6K · 📦 75K · 📋 6.2K - 15% open · ⏱️ 10.03.2022):

	```
	git clone https://github.com/pypa/pip
	```
- [PyPi](https://pypi.org/project/pip) (📥 100M / month · 📦 11K · ⏱️ 07.03.2022):
	```
	pip install pip
	```
- [Conda](https://anaconda.org/conda-forge/pip) (📥 32M · ⏱️ 07.03.2022):
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 330 · 🔀 1.5K · 📥 11M · 📋 3.7K - 34% open · ⏱️ 09.03.2022):

	```
	git clone https://github.com/python-poetry/poetry
	```
- [PyPi](https://pypi.org/project/poetry) (📥 5.6M / month · 📦 120 · ⏱️ 10.02.2022):
	```
	pip install poetry
	```
...
<details><summary><b><a href="https://github.com/conda/conda">conda</a></b> (🥈39 ·  ⭐ 4.6K · 📉) - OS-agnostic, system-level binary package manager and ecosystem. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/conda/conda) (👨‍💻 380 · 🔀 1.1K · 📋 8.5K - 21% open · ⏱️ 08.03.2022):

	```
	git clone https://github.com/conda/conda
	```
- [PyPi](https://pypi.org/project/conda) (📥 65K / month · 📦 1.1K · ⏱️ 22.04.2017):
	```
	pip install conda
	```
- [Conda](https://anaconda.org/conda-forge/conda) (📥 25M · ⏱️ 10.03.2022):
	```
	conda install -c conda-forge conda
	```
</details>
<details><summary><b><a href="https://github.com/jazzband/pip-tools">pip-tools</a></b> (🥈36 ·  ⭐ 5.7K) - A set of tools to keep your pinned Python dependencies fresh. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 160 · 🔀 490 · 📋 820 - 17% open · ⏱️ 08.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 4.8M / month · 📦 1.8K · ⏱️ 08.02.2022):
	```
	pip install pip-tools
	```
- [Conda](https://anaconda.org/conda-forge/pip-tools) (📥 25K · ⏱️ 08.02.2022):
	```
...
- [GitHub](https://github.com/bndr/pipreqs) (👨‍💻 51 · 🔀 280 · 📦 9.3K · 📋 190 - 52% open · ⏱️ 23.10.2021):
...
<details><summary><b><a href="https://github.com/pypa/pipx">pipx</a></b> (🥉28 ·  ⭐ 4.7K) - Install and Run Python Applications in Isolated Environments. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pypa/pipx) (👨‍💻 75 · 🔀 210 · 📋 460 - 23% open · ⏱️ 25.02.2022):

	```
	git clone https://github.com/pypa/pipx
	```
- [PyPi](https://pypi.org/project/pipx) (📥 170K / month · 📦 6 · ⏱️ 04.01.2022):
	```
	pip install pipx
	```
- [Conda](https://anaconda.org/conda-forge/pipx) (📥 220 · ⏱️ 04.01.2022):
	```
	conda install -c conda-forge pipx
	```
</details>
<details><summary><b><a href="https://github.com/mamba-org/mamba">mamba</a></b> (🥉28 ·  ⭐ 2.8K) - The Fast Cross-Platform Package Manager. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/mamba-org/mamba) (👨‍💻 73 · 🔀 150 · 📋 800 - 30% open · ⏱️ 10.03.2022):

	```
	git clone https://github.com/mamba-org/mamba
	```
- [Conda](https://anaconda.org/conda-forge/mamba) (📥 2.2M · ⏱️ 01.03.2022):
	```
	conda install -c conda-forge mamba
	```
</details>
<details><summary><b><a href="https://github.com/David-OConnor/pyflow">pyflow</a></b> (🥉18 ·  ⭐ 1K) - An installation and dependency system for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/David-OConnor/pyflow) (👨‍💻 28 · 🔀 40 · 📥 4K · 📋 120 - 40% open · ⏱️ 07.03.2022):

	```
	git clone https://github.com/David-OConnor/pyflow
	```
- [PyPi](https://pypi.org/project/pyflow) (📥 410 / month · 📦 1 · ⏱️ 02.07.2021):
	```
	pip install pyflow
	```
</details>
...
- [GitHub](https://github.com/jaraco/pip-run) (👨‍💻 11 · 🔀 10 · 📋 43 - 6% open · ⏱️ 23.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pip-run) (📥 16K / month · 📦 2 · ⏱️ 23.01.2022):
	```
	pip install pip-run
	```
</details>
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 78 · 🔀 150 · 📋 300 - 11% open · ⏱️ 09.03.2022):

	```
	git clone https://github.com/PyCQA/prospector
	```
- [PyPi](https://pypi.org/project/prospector) (📥 260K / month · 📦 670 · ⏱️ 04.03.2022):
	```
...
- [GitHub](https://github.com/PyCQA/mccabe) (👨‍💻 21 · 🔀 43 · 📦 250K · 📋 43 - 16% open · ⏱️ 24.01.2022):

	```
	git clone https://github.com/PyCQA/mccabe
	```
- [PyPi](https://pypi.org/project/mccabe) (📥 21M / month · 📦 16K · ⏱️ 24.01.2022):
	```
	pip install mccabe
	```
- [Conda](https://anaconda.org/conda-forge/mccabe) (📥 4M · ⏱️ 24.01.2022):
	```
...
- [GitHub](https://github.com/rubik/xenon) (👨‍💻 9 · 🔀 17 · 📦 310 · 📋 33 - 18% open · ⏱️ 24.02.2022):

	```
	git clone https://github.com/rubik/xenon
	```
- [PyPi](https://pypi.org/project/xenon) (📥 66K / month · 📦 69 · ⏱️ 24.02.2022):
	```
	pip install xenon
	```
...
- [GitHub](https://github.com/tonybaloney/wily) (👨‍💻 18 · 🔀 46 · 📋 81 - 34% open · ⏱️ 18.02.2022):

	```
	git clone https://github.com/tonybaloney/wily
	```
- [PyPi](https://pypi.org/project/wily) (📥 31K / month · 📦 9 · ⏱️ 01.07.2021):
	```
	pip install wily
	```
</details>
...
<details><summary><b><a href="https://github.com/tqdm/tqdm">tqdm</a></b> (🥇41 ·  ⭐ 21K · 📈) - A Fast, Extensible Progress Bar for Python and CLI. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1.1K · 📥 8.4K · 📦 260K · 📋 880 - 38% open · ⏱️ 28.02.2022):

	```
	git clone https://github.com/tqdm/tqdm
	```
- [PyPi](https://pypi.org/project/tqdm) (📥 36M / month · 📦 21K · ⏱️ 28.02.2022):
	```
	pip install tqdm
	```
- [Conda](https://anaconda.org/conda-forge/tqdm) (📥 10M · ⏱️ 28.02.2022):
	```
	conda install -c conda-forge tqdm
	```
- [Docker Hub](https://hub.docker.com/r/tqdm/tqdm) (📥 4K · ⭐ 2 · ⏱️ 28.02.2022):
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 120 · 🔀 280 · 📥 4.5K · 📦 19K · 📋 640 - 23% open · ⏱️ 09.03.2022):

	```
	git clone https://github.com/getsentry/sentry-python
	```
- [PyPi](https://pypi.org/project/sentry-sdk) (📥 14M / month · 📦 960 · ⏱️ 08.03.2022):
	```
...
<details><summary><b><a href="https://github.com/Delgan/loguru">loguru</a></b> (🥈36 ·  ⭐ 11K) - Python logging made (stupidly) simple. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 34 · 🔀 490 · 📦 15K · 📋 550 - 19% open · ⏱️ 08.03.2022):

	```
	git clone https://github.com/Delgan/loguru
	```
- [PyPi](https://pypi.org/project/loguru) (📥 3.3M / month · 📦 1.3K · ⏱️ 20.09.2020):
	```
	pip install loguru
	```
- [Conda](https://anaconda.org/conda-forge/loguru) (📥 390K · ⏱️ 02.11.2021):
	```
...
- [GitHub](https://github.com/hynek/structlog) (👨‍💻 85 · 🔀 150 · 📋 210 - 12% open · ⏱️ 10.03.2022):

	```
	git clone https://github.com/hynek/structlog
	```
- [PyPi](https://pypi.org/project/structlog) (📥 4.1M / month · 📦 900 · ⏱️ 16.12.2021):
	```
	pip install structlog
	```
- [Conda](https://anaconda.org/conda-forge/structlog) (📥 170K · ⏱️ 06.01.2022):
	```
...
- [GitHub](https://github.com/madzak/python-json-logger) (👨‍💻 50 · 🔀 170 · 📦 22K · 📋 74 - 36% open · ⏱️ 06.02.2022):

	```
	git clone https://github.com/madzak/python-json-logger
	```
- [PyPi](https://pypi.org/project/python-json-logger) (📥 5.7M / month · 📦 690 · ⏱️ 27.07.2021):
	```
...
- [GitHub](https://github.com/WoLpH/python-progressbar) (👨‍💻 40 · 🔀 100 · 📥 1.7K · 📦 16K · 📋 200 - 6% open · ⏱️ 05.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/progressbar2) (📥 6M / month · 📦 1.5K · ⏱️ 05.01.2022):
	```
	pip install progressbar2
	```
- [Conda](https://anaconda.org/conda-forge/progressbar2) (📥 410K · ⏱️ 01.02.2022):
	```
...
- [GitHub](https://github.com/astanin/python-tabulate) (👨‍💻 68 · 🔀 95 · 📦 66K · 📋 110 - 47% open · ⏱️ 07.01.2022):
...
- [PyPi](https://pypi.org/project/tabulate) (📥 33M / month · 📦 6.3K · ⏱️ 22.02.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tabulate) (📥 1.9M · ⏱️ 22.02.2021):
	```
...
- [GitHub](https://github.com/borntyping/python-colorlog) (👨‍💻 30 · 🔀 76 · 📦 14K · ⏱️ 08.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/colorlog) (📥 6.3M / month · 📦 2.4K · ⏱️ 08.11.2021):
	```
	pip install colorlog
	```
- [Conda](https://anaconda.org/conda-forge/colorlog) (📥 640K · ⏱️ 09.11.2021):
	```
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 4 · 🔀 130 · 📦 670 · 📋 110 - 17% open · ⏱️ 26.02.2022):

	```
	git clone https://github.com/rsalmei/alive-progress
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 36K / month · 📦 66 · ⏱️ 11.02.2022):
	```
...
- [GitHub](https://github.com/liiight/notifiers) (👨‍💻 18 · 🔀 83 · 📋 91 - 31% open · ⏱️ 18.02.2022):
...
- [GitHub](https://github.com/xolox/python-coloredlogs) (👨‍💻 16 · 🔀 38 · 📦 11K · 📋 74 - 33% open · ⏱️ 11.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/coloredlogs) (📥 2.7M / month · 📦 1.7K · ⏱️ 11.06.2021):
	```
	pip install coloredlogs
	```
- [Conda](https://anaconda.org/anaconda/coloredlogs) (📥 3.7K · ⏱️ 05.03.2022):
	```
	conda install -c anaconda coloredlogs
	```
</details>
<details><summary><b><a href="https://github.com/ines/wasabi">wasabi</a></b> (🥉26 ·  ⭐ 320 · 📉) - A lightweight console printing and formatting toolkit. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ines/wasabi) (👨‍💻 7 · 🔀 20 · 📦 17K · 📋 7 - 57% open · ⏱️ 06.12.2021):

	```
	git clone https://github.com/ines/wasabi
	```
- [PyPi](https://pypi.org/project/wasabi) (📥 3.9M / month · 📦 270 · ⏱️ 06.12.2021):
	```
	pip install wasabi
	```
- [Conda](https://anaconda.org/conda-forge/wasabi) (📥 590K · ⏱️ 07.12.2021):
	```
...
- [GitHub](https://github.com/shobrook/rebound) (👨‍💻 16 · 🔀 360 · 📥 180 · 📦 22 · 📋 58 - 34% open · ⏱️ 16.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/rebound) (📥 3.2K / month · 📦 16 · ⏱️ 26.01.2022):
	```
	pip install rebound
	```
...
- [GitHub](https://github.com/onelivesleft/PrettyErrors) (👨‍💻 5 · 🔀 74 · 📋 41 - 7% open · ⏱️ 24.11.2021):
...
- [PyPi](https://pypi.org/project/pretty_errors) (📥 22K / month · 📦 39 · ⏱️ 24.11.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pretty_errors) (📥 3.7K · ⏱️ 27.11.2021):
	```
	conda install -c conda-forge pretty_errors
	```
</details>
<details><summary><b><a href="https://github.com/samuelcolvin/python-devtools">python-devtools</a></b> (🥉19 ·  ⭐ 480) - Dev tools for python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/samuelcolvin/python-devtools) (👨‍💻 7 · 🔀 20 · 📦 590 · 📋 39 - 12% open · ⏱️ 08.09.2021):
...
- [PyPi](https://pypi.org/project/python-devtools) (📥 510 / month · 📦 1 · ⏱️ 21.08.2017):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-devtools) (📥 1.8K · ⏱️ 29.09.2021):
	```
...
- <b><a href="https://github.com/jazzband/prettytable">prettytable</a></b> (🥉28 ·  ⭐ 700) - Display tabular data in a visually appealing ASCII table.. <code><a href="https://tldrlegal.com/search?q=BSD-1-Clause">❗️BSD-1-Clause</a></code>
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (👨‍💻 710 · 🔀 1.6K · 📦 190K · 📋 5.9K - 16% open · ⏱️ 06.03.2022):

	```
	git clone https://github.com/sphinx-doc/sphinx
	```
- [PyPi](https://pypi.org/project/sphinx) (📥 5.1M / month · 📦 59K · ⏱️ 16.01.2022):
	```
	pip install sphinx
	```
- [Conda](https://anaconda.org/conda-forge/sphinx) (📥 4.8M · ⏱️ 20.01.2022):
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs) (👨‍💻 210 · 🔀 1.9K · 📦 19K · 📋 1.6K - 7% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/mkdocs/mkdocs
	```
- [PyPi](https://pypi.org/project/mkdocs) (📥 890K / month · 📦 3.5K · ⏱️ 15.12.2021):
	```
	pip install mkdocs
	```
- [Conda](https://anaconda.org/conda-forge/mkdocs) (📥 170K · ⏱️ 13.10.2021):
	```
	conda install -c conda-forge mkdocs
	```
</details>
<details><summary><b><a href="https://github.com/squidfunk/mkdocs-material">mkdocs-material</a></b> (🥇40 ·  ⭐ 9K) - Technical documentation that just works. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 150 · 🔀 2.1K · 📦 12K · 📋 1.3K - 0% open · ⏱️ 08.03.2022):

	```
	git clone https://github.com/squidfunk/mkdocs-material
	```
- [PyPi](https://pypi.org/project/mkdocs-material) (📥 1.1M / month · 📦 1.1K · ⏱️ 06.03.2022):
	```
	pip install mkdocs-material
	```
- [Conda](https://anaconda.org/conda-forge/mkdocs-material) (📥 83K · ⏱️ 06.03.2022):
	```
...
- [GitHub](https://github.com/numpy/numpydoc) (👨‍💻 70 · 🔀 6.7K · 📦 31K · 📋 170 - 35% open · ⏱️ 26.01.2022):

	```
	git clone https://github.com/numpy/numpydoc
	```
- [PyPi](https://pypi.org/project/numpydoc) (📥 290K / month · 📦 4.3K · ⏱️ 24.01.2022):
	```
	pip install numpydoc
	```
- [Conda](https://anaconda.org/conda-forge/numpydoc) (📥 960K · ⏱️ 24.01.2022):
	```
...
- [GitHub](https://github.com/michaeljones/breathe) (👨‍💻 100 · 🔀 160 · 📥 270 · 📦 6.1K · 📋 500 - 23% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/michaeljones/breathe
	```
- [PyPi](https://pypi.org/project/breathe) (📥 210K / month · 📦 1K · ⏱️ 14.02.2022):
	```
	pip install breathe
	```
- [Conda](https://anaconda.org/conda-forge/breathe) (📥 280K · ⏱️ 14.02.2022):
	```
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 34 · 🔀 130 · 📦 560 · 📋 230 - 3% open · ⏱️ 08.03.2022):

	```
	git clone https://github.com/mitmproxy/pdoc
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 100K / month · 📦 190 · ⏱️ 08.03.2022):
	```
	pip install pdoc
	```
</details>
...
- [GitHub](https://github.com/bitprophet/alabaster) (👨‍💻 28 · 🔀 180 · 📦 60K · 📋 140 - 61% open · ⏱️ 24.09.2021):

	```
	git clone https://github.com/bitprophet/alabaster
	```
- [PyPi](https://pypi.org/project/alabaster) (📥 4.6M / month · 📦 7.7K · ⏱️ 03.10.2018):
	```
	pip install alabaster
	```
- [Conda](https://anaconda.org/conda-forge/alabaster) (📥 3.6M · ⏱️ 03.10.2018):
	```
...
- [GitHub](https://github.com/tox-dev/sphinx-autodoc-typehints) (👨‍💻 38 · 🔀 79 · 📋 130 - 16% open · ⏱️ 11.02.2022):

	```
	git clone https://github.com/tox-dev/sphinx-autodoc-typehints
	```
- [PyPi](https://pypi.org/project/sphinx-autodoc-typehints) (📥 500K / month · 📦 1.3K · ⏱️ 11.02.2022):
	```
...
<details><summary><b><a href="https://github.com/mkdocstrings/mkdocstrings">mkdocstrings</a></b> (🥈28 ·  ⭐ 640) - Automatic documentation from sources, for MkDocs. <code><a href="http://bit.ly/3hkKRql">ISC</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/mkdocstrings/mkdocstrings) (👨‍💻 29 · 🔀 66 · 📋 230 - 16% open · ⏱️ 01.03.2022):

	```
	git clone https://github.com/mkdocstrings/mkdocstrings
	```
- [PyPi](https://pypi.org/project/mkdocstrings) (📥 170K / month · 📦 180 · ⏱️ 01.03.2022):
	```
	pip install mkdocstrings
	```
- [Conda](https://anaconda.org/conda-forge/mkdocstrings) (📥 13K · ⏱️ 05.03.2022):
	```
...
- [GitHub](https://github.com/pdoc3/pdoc) (👨‍💻 57 · 🔀 120 · 📦 1.4K · 📋 280 - 31% open · ⏱️ 03.02.2022):
...
- [PyPi](https://pypi.org/project/pdoc3) (📥 270K / month · 📦 120 · ⏱️ 03.08.2021):
	...
	pip install pdoc3
	```
- [Conda](https://anaconda.org/anaconda/pdoc3) (📥 560 · ⏱️ 30.11.2020):
	```
...
- [GitHub](https://github.com/executablebooks/sphinx-autobuild) (👨‍💻 17 · 🔀 51 · 📋 58 - 24% open · ⏱️ 14.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/sphinx-autobuild) (📥 260K / month · 📦 2.6K · ⏱️ 14.03.2021):
	```
	pip install sphinx-autobuild
	```
- [Conda](https://anaconda.org/conda-forge/sphinx-autobuild) (📥 85K · ⏱️ 14.03.2021):
	```
	conda install -c conda-forge sphinx-autobuild
	```
</details>
<details><summary><b><a href="https://github.com/econchick/interrogate">interrogate</a></b> (🥉24 ·  ⭐ 340) - Explain yourself! Interrogate a codebase for docstring coverage. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/econchick/interrogate) (👨‍💻 12 · 🔀 27 · 📦 1.4K · 📋 32 - 25% open · ⏱️ 27.12.2021):
...
- [GitHub](https://github.com/asottile/blacken-docs) (👨‍💻 14 · 🔀 23 · 📋 44 - 6% open · ⏱️ 31.01.2022):

	```
	git clone https://github.com/asottile/blacken-docs
	```
- [PyPi](https://pypi.org/project/blacken-docs) (📥 23K / month · 📦 17 · ⏱️ 30.01.2022):
	```
...
- [GitHub](https://github.com/zhaoterryy/mkdocs-pdf-export-plugin) (👨‍💻 11 · 🔀 34 · 📦 220 · 📋 86 - 47% open · ⏱️ 05.10.2021):
...
<details><summary><b><a href="https://github.com/lukasgeiter/mkdocs-awesome-pages-plugin">mkdocs-awesome-pages-plugin</a></b> (🥉23 ·  ⭐ 220) - An MkDocs plugin that simplifies configuring page.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-pages-plugin) (👨‍💻 4 · 🔀 23 · 📋 49 - 16% open · ⏱️ 12.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/mkdocs-awesome-pages-plugin) (📥 62K / month · 📦 64 · ⏱️ 12.02.2022):
	```
...
- [GitHub](https://github.com/orzih/mkdocs-with-pdf) (👨‍💻 6 · 🔀 27 · 📦 110 · 📋 72 - 45% open · ⏱️ 14.10.2021):
...
- [GitHub](https://github.com/timothycrosley/portray) (👨‍💻 16 · 🔀 59 · 📋 55 - 43% open · ⏱️ 13.06.2021):
...
- [GitHub](https://github.com/clayrisser/sphinx-markdown-builder) (👨‍💻 17 · 🔀 32 · 📦 220 · 📋 37 - 56% open · ⏱️ 08.01.2022):

	```
	git clone https://github.com/clayrisser/sphinx-markdown-builder
	```
- [PyPi](https://pypi.org/project/sphinx-markdown-builder) (📥 36K / month · 📦 52 · ⏱️ 08.01.2022):
	```
	pip install sphinx-markdown-builder
	```
</details>
<details><summary><b><a href="https://github.com/ml-tooling/lazydocs">lazydocs</a></b> (🥉17 ·  ⭐ 76 · 💤) - Generate markdown API documentation from Google-style Python.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ml-tooling/lazydocs) (👨‍💻 7 · 🔀 21 · 📦 62 · 📋 13 - 46% open · ⏱️ 20.08.2021):

	```
	git clone https://github.com/ml-tooling/lazydocs
	```
- [PyPi](https://pypi.org/project/lazydocs) (📥 2.7K / month · 📦 12 · ⏱️ 27.07.2021):
	```
...
- <b><a href="https://github.com/timvink/mkdocs-print-site-plugin">mkdocs-print-site-plugin</a></b> (🥉19 ·  ⭐ 37) - MkDocs Plugin that adds an additional page that.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 83 · 🔀 190 · 📦 2.9K · 📋 290 - 47% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/inducer/pudb
	```
- [PyPi](https://pypi.org/project/pudb) (📥 210K / month · 📦 730 · ⏱️ 07.01.2022):
	```
	pip install pudb
	```
...
- [GitHub](https://github.com/cool-RR/PySnooper) (👨‍💻 26 · 🔀 920 · 📦 600 · 📋 110 - 15% open · ⏱️ 14.01.2022):
...
- [GitHub](https://github.com/gotcha/ipdb) (👨‍💻 49 · 🔀 130 · 📦 31K · 📋 170 - 33% open · ⏱️ 30.12.2021):
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 82 · 🔀 440 · 📦 3.1K · 📋 180 - 33% open · ⏱️ 14.02.2022):
...
- [PyPi](https://pypi.org/project/pyelftools) (📥 1M / month · 📦 520 · ⏱️ 03.02.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyelftools) (📥 83K · ⏱️ 11.02.2022):
	```
	conda install -c conda-forge pyelftools
	```
</details>
<details><summary><b><a href="https://github.com/agronholm/typeguard">typeguard</a></b> (🥈28 ·  ⭐ 800) - Run-time type checker for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/agronholm/typeguard) (👨‍💻 19 · 🔀 69 · 📋 190 - 20% open · ⏱️ 10.12.2021):

	```
	git clone https://github.com/agronholm/typeguard
	```
- [PyPi](https://pypi.org/project/typeguard) (📥 3.7M / month · 📦 300 · ⏱️ 10.12.2021):
	```
	pip install typeguard
	```
- [Conda](https://anaconda.org/conda-forge/typeguard) (📥 77K · ⏱️ 11.10.2021):
	```
...
- [GitHub](https://github.com/cs01/gdbgui) (👨‍💻 39 · 🔀 480 · 📥 7.3K · 📦 150 · 📋 280 - 42% open · ⏱️ 16.01.2022):
...
- [GitHub](https://github.com/gruns/icecream) (👨‍💻 18 · 🔀 120 · 📋 89 - 31% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/gruns/icecream
	```
- [PyPi](https://pypi.org/project/icecream) (📥 180K / month · 📦 51 · ⏱️ 15.02.2022):
	```
	pip install icecream
	```
- [Conda](https://anaconda.org/conda-forge/icecream) (📥 2.1K · ⏱️ 16.02.2022):
	```
	conda install -c conda-forge icecream
	```
</details>
<details><summary><b><a href="https://github.com/pdbpp/pdbpp">pdbpp</a></b> (🥉25 ·  ⭐ 870) - pdb++, a drop-in replacement for pdb (the Python debugger). <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [PyPi](https://pypi.org/project/pdbpp) (📥 250K / month · 📦 590 · ⏱️ 09.07.2021):
	...
	pip install pdbpp
	```
- [Conda](https://anaconda.org/conda-forge/pdbpp) (📥 70K · ⏱️ 11.07.2021):
	```
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 38 · 📦 79 · 📋 87 - 42% open · ⏱️ 15.12.2021):
...
- [PyPi](https://pypi.org/project/hunter) (📥 17K / month · 📦 21 · ⏱️ 15.12.2021):
	...
	pip install hunter
	```
- [Conda](https://anaconda.org/conda-forge/hunter) (📥 3.8K · ⏱️ 16.12.2021):
	```
	conda install -c conda-forge hunter
	```
</details>
<details><summary><b><a href="https://github.com/alexmojaki/snoop">snoop</a></b> (🥉22 ·  ⭐ 710) - A powerful set of Python debugging tools, based on PySnooper. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/alexmojaki/snoop) (👨‍💻 21 · 🔀 24 · 📋 39 - 46% open · ⏱️ 26.02.2022):

	```
	git clone https://github.com/alexmojaki/snoop
	```
- [PyPi](https://pypi.org/project/snoop) (📥 21K / month · 📦 12 · ⏱️ 11.11.2021):
	```
	pip install snoop
	```
- [Conda](https://anaconda.org/conda-forge/snoop) (📥 240 · ⏱️ 11.11.2021):
	```
...
- [GitHub](https://github.com/alexmojaki/birdseye) (👨‍💻 10 · 🔀 70 · 📋 50 - 36% open · ⏱️ 26.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/birdseye) (📥 3K / month · 📦 3 · ⏱️ 11.11.2021):
	```
...
- [GitHub](https://github.com/ionelmc/python-manhole) (👨‍💻 11 · 🔀 17 · 📦 85 · 📋 21 - 28% open · ⏱️ 02.02.2022):
...
- [PyPi](https://pypi.org/project/manhole) (📥 14K / month · 📦 38 · ⏱️ 08.04.2021):
	...
	pip install manhole
	```
- [Conda](https://anaconda.org/conda-forge/manhole) (📥 2K · ⏱️ 07.11.2021):
	```
...
<details><summary><b><a href="https://github.com/pytest-dev/pytest">pytest</a></b> (🥇48 ·  ⭐ 8.5K) - The pytest framework makes it easy to write small tests, yet scales.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pytest-dev/pytest) (👨‍💻 770 · 🔀 2K · 📦 460K · 📋 4.9K - 15% open · ⏱️ 07.03.2022):

	```
	git clone https://github.com/pytest-dev/pytest
	```
- [PyPi](https://pypi.org/project/pytest) (📥 38M / month · 📦 81K · ⏱️ 11.02.2022):
	```
	pip install pytest
	```
- [Conda](https://anaconda.org/conda-forge/pytest) (📥 12M · ⏱️ 11.02.2022):
	```
	conda install -c conda-forge pytest
	```
</details>
<details><summary><b><a href="https://github.com/robotframework/robotframework">robotframework</a></b> (🥇42 ·  ⭐ 6.8K) - Generic automation framework for acceptance testing and RPA. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 160 · 🔀 1.9K · 📥 520 · 📦 5K · 📋 3.8K - 5% open · ⏱️ 10.03.2022):

	```
	git clone https://github.com/robotframework/robotframework
	```
- [PyPi](https://pypi.org/project/robotframework) (📥 950K / month · 📦 1K · ⏱️ 11.02.2022):
	```
	pip install robotframework
	```
- [Conda](https://anaconda.org/conda-forge/robotframework) (📥 72K · ⏱️ 15.12.2021):
	```
	conda install -c conda-forge robotframework
	```
</details>
<details><summary><b><a href="https://github.com/HypothesisWorks/hypothesis">hypothesis</a></b> (🥇38 ·  ⭐ 5.7K · 📉) - Hypothesis is a powerful, flexible, and easy to use library.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 260 · 🔀 480 · 📦 12K · 📋 1.2K - 4% open · ⏱️ 07.03.2022):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 2.6M / month · 📦 1.9K · ⏱️ 07.03.2022):
	```
	pip install hypothesis
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 5.3M · ⏱️ 08.03.2022):
	```
...
- [GitHub](https://github.com/tox-dev/tox) (👨‍💻 260 · 🔀 400 · 📦 55K · 📋 1.3K - 3% open · ⏱️ 03.03.2022):
...
- [GitHub](https://github.com/pytest-dev/pytest-cov) (👨‍💻 74 · 🔀 170 · 📦 120K · 📋 320 - 34% open · ⏱️ 02.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytest-cov) (📥 13M / month · 📦 28K · ⏱️ 04.10.2021):
	```
	pip install pytest-cov
	```
- [Conda](https://anaconda.org/conda-forge/pytest-cov) (📥 4.7M · ⏱️ 04.10.2021):
	```
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 98 · 🔀 220 · 📋 270 - 37% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/spulec/freezegun
	```
- [PyPi](https://pypi.org/project/freezegun) (📥 4.5M / month · 📦 4.4K · ⏱️ 03.03.2022):
	```
	pip install freezegun
	```
- [Conda](https://anaconda.org/conda-forge/freezegun) (📥 320K · ⏱️ 03.03.2022):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-mock) (👨‍💻 55 · 🔀 100 · 📦 24K · 📋 110 - 11% open · ⏱️ 10.02.2022):

	```
	git clone https://github.com/pytest-dev/pytest-mock
	```
- [PyPi](https://pypi.org/project/pytest-mock) (📥 5.6M / month · 📦 4.2K · ⏱️ 28.01.2022):
	```
...
<details><summary><b><a href="https://github.com/pytest-dev/pytest-xdist">pytest-xdist</a></b> (🥈34 ·  ⭐ 860) - pytest plugin for distributed testing and loop-on-failures.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pytest-dev/pytest-xdist) (👨‍💻 80 · 🔀 160 · 📋 460 - 44% open · ⏱️ 10.03.2022):

	```
	git clone https://github.com/pytest-dev/pytest-xdist
	```
- [PyPi](https://pypi.org/project/pytest-xdist) (📥 5.4M / month · 📦 4.5K · ⏱️ 10.12.2021):
	```
...
<details><summary><b><a href="https://github.com/asweigart/pyautogui">pyautogui</a></b> (🥈33 ·  ⭐ 6.3K) - A cross-platform GUI automation Python module for human beings. Used.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 850 · 📦 13K · 📋 570 - 64% open · ⏱️ 14.09.2021):

	```
	git clone https://github.com/asweigart/pyautogui
	```
- [PyPi](https://pypi.org/project/pyautogui) (📥 510K / month · 📦 560 · ⏱️ 07.07.2021):
	```
...
<details><summary><b><a href="https://github.com/microsoft/playwright-python">playwright-python</a></b> (🥈32 ·  ⭐ 5.9K) - Python version of the Playwright testing and automation.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/microsoft/playwright-python) (👨‍💻 24 · 🔀 520 · 📦 890 · 📋 600 - 4% open · ⏱️ 08.03.2022):

	```
	git clone https://github.com/microsoft/playwright-python
	```
- [PyPi](https://pypi.org/project/playwright) (📥 230K / month · 📦 48 · ⏱️ 25.02.2022):
	```
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 280 · 📥 200 · 📋 300 - 1% open · ⏱️ 07.03.2022):
...
- [PyPi](https://pypi.org/project/mimesis) (📥 110K / month · 📦 58 · ⏱️ 25.01.2022):
	...
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 5.9K · ⏱️ 15.07.2020):
	```
	conda install -c conda-forge mimesis
	```
</details>
<details><summary><b><a href="https://github.com/pytest-dev/pytest-asyncio">pytest-asyncio</a></b> (🥈32 ·  ⭐ 900) - Pytest support for asyncio. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pytest-dev/pytest-asyncio) (👨‍💻 37 · 🔀 99 · 📥 14 · 📋 200 - 17% open · ⏱️ 08.03.2022):

	```
	git clone https://github.com/pytest-dev/pytest-asyncio
	```
- [PyPi](https://pypi.org/project/pytest-asyncio) (📥 3.2M / month · 📦 1.9K · ⏱️ 03.03.2022):
	```
	pip install pytest-asyncio
	```
- [Conda](https://anaconda.org/conda-forge/pytest-asyncio) (📥 840K · ⏱️ 03.03.2022):
	```
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 73 · 🔀 140 · 📦 4.6K · 📋 250 - 19% open · ⏱️ 13.02.2022):

	```
	git clone https://github.com/nose-devs/nose2
	```
- [PyPi](https://pypi.org/project/nose2) (📥 400K / month · 📦 1.1K · ⏱️ 13.02.2022):
	```
	pip install nose2
	```
- [Conda](https://anaconda.org/conda-forge/nose2) (📥 45K · ⏱️ 02.02.2020):
	```
	conda install -c conda-forge nose2
	```
</details>
<details><summary><b><a href="https://github.com/pytest-dev/pytest-html">pytest-html</a></b> (🥈31 ·  ⭐ 470) - Plugin for generating HTML reports for pytest results. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pytest-dev/pytest-html) (👨‍💻 43 · 🔀 180 · 📦 18K · 📋 280 - 36% open · ⏱️ 04.02.2022):
...
<details><summary><b><a href="https://github.com/pytest-dev/pytest-bdd">pytest-bdd</a></b> (🥈30 ·  ⭐ 970) - BDD library for the py.test runner. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/pytest-dev/pytest-bdd) (👨‍💻 46 · 🔀 170 · 📋 290 - 46% open · ⏱️ 09.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytest-bdd) (📥 320K / month · 📦 170 · ⏱️ 25.10.2021):
	```
	pip install pytest-bdd
	```
- [Conda](https://anaconda.org/conda-forge/pytest-bdd) (📥 44K · ⏱️ 03.02.2020):
	```
	conda install -c conda-forge pytest-bdd
	```
</details>
<details><summary><b><a href="https://github.com/hamcrest/PyHamcrest">PyHamcrest</a></b> (🥈30 ·  ⭐ 610) - Hamcrest matchers for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/hamcrest/PyHamcrest) (👨‍💻 38 · 🔀 91 · 📋 69 - 27% open · ⏱️ 03.03.2022):
...
- [GitHub](https://github.com/TheKevJames/coveralls-python) (👨‍💻 63 · 🔀 180 · 📦 21K · 📋 150 - 3% open · ⏱️ 07.03.2022):
...
- [PyPi](https://pypi.org/project/coveralls) (📥 580K / month · 📦 9.2K · ⏱️ 11.11.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/coveralls) (📥 630K · ⏱️ 12.11.2021):
	```
...
- [GitHub](https://github.com/CleanCut/green) (👨‍💻 37 · 🔀 74 · 📦 650 · 📋 170 - 1% open · ⏱️ 20.01.2022):
...
- [PyPi](https://pypi.org/project/green) (📥 16K / month · 📦 210 · ⏱️ 20.01.2022):
	...
	pip install green
	```
- [Conda](https://anaconda.org/conda-forge/green) (📥 92K · ⏱️ 12.11.2020):
	```
	conda install -c conda-forge green
	```
</details>
<details><summary><b><a href="https://github.com/theacodes/nox">nox</a></b> (🥉28 ·  ⭐ 730) - Flexible test automation for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/theacodes/nox) (👨‍💻 69 · 🔀 110 · 📋 270 - 10% open · ⏱️ 02.03.2022):
...
- [PyPi](https://pypi.org/project/nox) (📥 1M / month · 📦 150 · ⏱️ 07.01.2022):
	...
	pip install nox
	```
- [Conda](https://anaconda.org/conda-forge/nox) (📥 55K · ⏱️ 13.01.2022):
	```
	conda install -c conda-forge nox
	```
</details>
<details><summary><b><a href="https://github.com/airspeed-velocity/asv">asv</a></b> (🥉28 ·  ⭐ 640) - Airspeed Velocity: A simple Python benchmarking tool with web-based reporting. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/airspeed-velocity/asv) (👨‍💻 63 · 🔀 140 · 📋 460 - 29% open · ⏱️ 09.03.2022):

	```
	git clone https://github.com/airspeed-velocity/asv
	```
- [PyPi](https://pypi.org/project/asv) (📥 23K / month · 📦 63 · ⏱️ 06.02.2022):
	```
	pip install asv
	```
...
- [GitHub](https://github.com/dbader/pytest-mypy) (👨‍💻 16 · 🔀 33 · 📦 1.6K · 📋 49 - 16% open · ⏱️ 07.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytest-mypy) (📥 820K / month · 📦 390 · ⏱️ 07.02.2022):
	```
	pip install pytest-mypy
	```
- [Conda](https://anaconda.org/conda-forge/pytest-mypy) (📥 21K · ⏱️ 24.11.2020):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-testinfra) (👨‍💻 110 · 🔀 290 · 📋 320 - 36% open · ⏱️ 02.03.2022):
...
- [PyPi](https://pypi.org/project/pytest-testinfra) (📥 130K / month · 📦 5 · ⏱️ 10.02.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-testinfra) (📥 2.5K · ⏱️ 11.02.2022):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-randomly) (👨‍💻 16 · 🔀 22 · 📋 48 - 12% open · ⏱️ 05.03.2022):

	```
	git clone https://github.com/pytest-dev/pytest-randomly
	```
- [PyPi](https://pypi.org/project/pytest-randomly) (📥 440K / month · 📦 180 · ⏱️ 10.01.2022):
	```
	pip install pytest-randomly
	```
- [Conda](https://anaconda.org/conda-forge/pytest-randomly) (📥 21K · ⏱️ 10.01.2022):
	```
	conda install -c conda-forge pytest-randomly
	```
</details>
<details><summary><b><a href="https://github.com/ionelmc/pytest-benchmark">pytest-benchmark</a></b> (🥉25 ·  ⭐ 860) - py.test fixture for benchmarking code. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://github.com/tarpas/pytest-testmon">pytest-testmon</a></b> (🥉24 ·  ⭐ 520) - Selects tests affected by changed files. Continous.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tarpas/pytest-testmon) (👨‍💻 16 · 🔀 29 · 📋 120 - 23% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/tarpas/pytest-testmon
	```
- [PyPi](https://pypi.org/project/pytest-testmon) (📥 130K / month · 📦 54 · ⏱️ 01.03.2022):
	```
...
- [GitHub](https://github.com/Erotemic/xdoctest) (👨‍💻 7 · 🔀 7 · 📦 2.2K · 📋 38 - 47% open · ⏱️ 20.12.2021):

	```
	git clone https://github.com/Erotemic/xdoctest
	```
- [PyPi](https://pypi.org/project/xdoctest) (📥 120K / month · 📦 62 · ⏱️ 06.10.2021):
	```
	pip install xdoctest
	```
- [Conda](https://anaconda.org/conda-forge/xdoctest) (📥 19K · ⏱️ 10.08.2021):
	```
...
- [GitHub](https://github.com/TvoroG/pytest-lazy-fixture) (👨‍💻 9 · 🔀 18 · 📦 600 · 📋 35 - 42% open · ⏱️ 27.01.2022):
...
- [GitHub](https://github.com/avast/pytest-docker) (👨‍💻 11 · 🔀 47 · 📥 86 · 📋 34 - 52% open · ⏱️ 14.06.2021):

	```
	git clone https://github.com/avast/pytest-docker
	```
- [PyPi](https://pypi.org/project/pytest-docker) (📥 61K / month · 📦 23 · ⏱️ 14.06.2021):
	```
...
- [GitHub](https://github.com/gabrielcnr/pytest-datadir) (👨‍💻 7 · 🔀 17 · 📦 540 · 📋 16 - 31% open · ⏱️ 18.01.2022):
...
<details><summary><b><a href="https://github.com/pyinstaller/pyinstaller">pyinstaller</a></b> (🥇37 ·  ⭐ 8.9K) - Freeze (package) Python programs into stand-alone executables. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 420 · 🔀 1.8K · 📥 730K · 📋 4.5K - 7% open · ⏱️ 06.03.2022):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 780K / month · 📦 140 · ⏱️ 05.03.2022):
	```
	pip install pyinstaller
	```
- [Conda](https://anaconda.org/conda-forge/pyinstaller) (📥 290K · ⏱️ 06.03.2022):
	```
	conda install -c conda-forge pyinstaller
	```
</details>
<details><summary><b><a href="https://github.com/pypa/packaging">packaging</a></b> (🥇36 ·  ⭐ 380) - Core utilities for Python packages. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/pypa/packaging) (👨‍💻 77 · 🔀 180 · 📥 280 · 📦 330K · 📋 240 - 27% open · ⏱️ 05.03.2022):

	```
	git clone https://github.com/pypa/packaging
	```
- [PyPi](https://pypi.org/project/packaging) (📥 98M / month · 📦 17K · ⏱️ 18.11.2021):
	```
...
<details><summary><b><a href="https://github.com/Nuitka/Nuitka">Nuitka</a></b> (🥈32 ·  ⭐ 6.5K) - Nuitka is a Python compiler written in Python. Its fully compatible.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Nuitka/Nuitka) (👨‍💻 110 · 🔀 370 · 📋 1.2K - 14% open · ⏱️ 05.03.2022):

	```
	git clone https://github.com/Nuitka/Nuitka
	```
- [PyPi](https://pypi.org/project/nuitka) (📥 34K / month · 📦 36 · ⏱️ 02.03.2022):
	```
	pip install nuitka
	```
- [Conda](https://anaconda.org/conda-forge/nuitka) (📥 330K · ⏱️ 02.03.2022):
	```
...
- [GitHub](https://github.com/pantsbuild/pex) (👨‍💻 100 · 🔀 220 · 📥 680K · 📋 810 - 18% open · ⏱️ 07.03.2022):

	```
	git clone https://github.com/pantsbuild/pex
	```
- [PyPi](https://pypi.org/project/pex) (📥 260K / month · 📦 130 · ⏱️ 04.03.2022):
	```
	pip install pex
	```
</details>
...
- [GitHub](https://github.com/marcelotduarte/cx_Freeze) (👨‍💻 94 · 🔀 170 · 📋 730 - 8% open · ⏱️ 10.03.2022):
...
<details><summary><b><a href="https://github.com/beeware/briefcase">briefcase</a></b> (🥈28 ·  ⭐ 1.3K) - Tools to support converting a Python project into a standalone.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/beeware/briefcase) (👨‍💻 90 · 🔀 220 · 📋 380 - 30% open · ⏱️ 10.03.2022):
...
<details><summary><b><a href="https://github.com/indygreg/PyOxidizer">PyOxidizer</a></b> (🥉27 ·  ⭐ 3.5K) - A modern Python application packaging and distribution tool. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/indygreg/PyOxidizer) (👨‍💻 40 · 🔀 140 · 📥 1.8K · 📋 440 - 59% open · ⏱️ 08.03.2022):

	```
	git clone https://github.com/indygreg/PyOxidizer
	```
- [PyPi](https://pypi.org/project/pyoxidizer) (📥 2.8K / month · ⏱️ 08.03.2022):
	```
...
- [GitHub](https://github.com/ronaldoussoren/py2app) (👨‍💻 29 · 🔀 20 · 📦 4K · 📋 390 - 29% open · ⏱️ 08.03.2022):
...
<details><summary><b><a href="https://github.com/py2exe/py2exe">py2exe</a></b> (🥉24 ·  ⭐ 370) - A distutils extension to create standalone Windows programs from Python code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/py2exe/py2exe) (👨‍💻 14 · 🔀 48 · 📥 8.2K · 📦 1.4K · 📋 100 - 4% open · ⏱️ 13.02.2022):
...
- [GitHub](https://github.com/takluyver/pynsist) (👨‍💻 29 · 🔀 100 · 📋 160 - 15% open · ⏱️ 01.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pynsist) (📥 2.1K / month · 📦 47 · ⏱️ 28.03.2021):
	```
	pip install pynsist
	```
</details>
...
- [GitHub](https://github.com/conda/constructor) (👨‍💻 50 · 🔀 130 · 📥 230 · 📦 12 · 📋 260 - 22% open · ⏱️ 14.02.2022):

	```
	git clone https://github.com/conda/constructor
	```
- [Conda](https://anaconda.org/anaconda/constructor) (📥 5.3K · ⏱️ 05.03.2022):
	```
...
- [GitHub](https://github.com/facebookincubator/xar) (👨‍💻 32 · 🔀 47 · 📦 17 · 📋 29 - 27% open · ⏱️ 05.03.2022):
...
- <b><a href="https://github.com/google/subpar">subpar</a></b> (🥉13 ·  ⭐ 510 · 💀) - Subpar is a utility for creating self-contained python.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- [GitHub](https://github.com/pypa/setuptools) (👨‍💻 490 · 🔀 820 · 📥 120 · 📦 150K · 📋 2K - 24% open · ⏱️ 07.03.2022):

	```
	git clone https://github.com/pypa/setuptools
	```
- [PyPi](https://pypi.org/project/setuptools) (📥 210M / month · 📦 36K · ⏱️ 18.02.2022):
	```
	pip install setuptools
	```
- [Conda](https://anaconda.org/conda-forge/setuptools) (📥 34M · ⏱️ 18.02.2022):
	```
...
- [GitHub](https://github.com/buildbot/buildbot) (👨‍💻 810 · 🔀 1.6K · 📥 21K · 📦 270 · 📋 1.4K - 45% open · ⏱️ 07.03.2022):

	```
	git clone https://github.com/buildbot/buildbot
	```
- [PyPi](https://pypi.org/project/buildbot) (📥 62K / month · 📦 460 · ⏱️ 06.03.2022):
	```
	pip install buildbot
	```
- [Conda](https://anaconda.org/conda-forge/buildbot) (📥 50K · ⏱️ 07.03.2022):
	```
...
- [GitHub](https://github.com/pypa/twine) (👨‍💻 110 · 🔀 260 · 📦 58K · 📋 400 - 9% open · ⏱️ 28.02.2022):

	```
	git clone https://github.com/pypa/twine
	```
- [PyPi](https://pypi.org/project/twine) (📥 3.1M / month · 📦 12K · ⏱️ 02.02.2022):
	```
	pip install twine
	```
- [Conda](https://anaconda.org/conda-forge/twine) (📥 410K · ⏱️ 03.02.2022):
	```
	conda install -c conda-forge twine
	```
</details>
<details><summary><b><a href="https://github.com/pypa/wheel">wheel</a></b> (🥈35 ·  ⭐ 300) - The official binary distribution format for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pypa/wheel) (👨‍💻 64 · 🔀 100 · 📋 340 - 9% open · ⏱️ 31.01.2022):

	```
	git clone https://github.com/pypa/wheel
	```
- [PyPi](https://pypi.org/project/wheel) (📥 130M / month · 📦 35K · ⏱️ 22.12.2021):
	```
	pip install wheel
	```
- [Conda](https://anaconda.org/conda-forge/wheel) (📥 27M · ⏱️ 22.12.2021):
	```
	conda install -c conda-forge wheel
	```
</details>
<details><summary><b><a href="https://github.com/pypa/setuptools_scm">setuptools_scm</a></b> (🥈34 ·  ⭐ 550) - the blessed package to manage your versions by scm tags. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pypa/setuptools_scm) (👨‍💻 100 · 🔀 160 · 📋 380 - 20% open · ⏱️ 21.02.2022):
...
- [PyPi](https://pypi.org/project/setuptools_scm) (📥 15M / month · 📦 380 · ⏱️ 09.08.2018):
	...
	```
- [Conda](https://anaconda.org/conda-forge/setuptools_scm) (📥 900K · ⏱️ 19.01.2022):
	```
...
- [GitHub](https://github.com/pyinvoke/invoke) (👨‍💻 56 · 🔀 300 · 📦 11K · 📋 710 - 48% open · ⏱️ 16.10.2021):

	```
	git clone https://github.com/pyinvoke/invoke
	```
- [PyPi](https://pypi.org/project/invoke) (📥 2.5M / month · 📦 2.6K · ⏱️ 15.12.2021):
	```
	pip install invoke
	```
- [Conda](https://anaconda.org/conda-forge/invoke) (📥 530K · ⏱️ 10.07.2021):
	```
...
- [GitHub](https://github.com/SCons/scons) (👨‍💻 140 · 🔀 250 · 📥 420 · 📋 3.3K - 19% open · ⏱️ 08.03.2022):
...
- [GitHub](https://github.com/pydoit/doit) (👨‍💻 62 · 🔀 150 · 📦 890 · 📋 270 - 23% open · ⏱️ 10.03.2022):

	```
	git clone https://github.com/pydoit/doit
	```
- [PyPi](https://pypi.org/project/doit) (📥 300K / month · 📦 280 · ⏱️ 18.02.2022):
	```
	pip install doit
	```
- [Conda](https://anaconda.org/conda-forge/doit) (📥 78K · ⏱️ 24.02.2022):
	```
...
- [GitHub](https://github.com/pypa/flit) (👨‍💻 52 · 🔀 93 · 📋 320 - 34% open · ⏱️ 23.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/flit) (📥 130K / month · 📦 230 · ⏱️ 23.02.2022):
	```
	pip install flit
	```
- [Conda](https://anaconda.org/conda-forge/flit) (📥 100K · ⏱️ 23.02.2022):
	```
...
- [GitHub](https://github.com/pybuilder/pybuilder) (👨‍💻 36 · 🔀 240 · 📋 500 - 18% open · ⏱️ 24.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/pybuilder) (📥 19K / month · 📦 60 · ⏱️ 24.02.2022):
	```
	pip install pybuilder
	```
- [Conda](https://anaconda.org/conda-forge/pybuilder) (📥 9.4K · ⏱️ 23.02.2022):
	```
...
- [GitHub](https://github.com/paver/paver) (👨‍💻 45 · 🔀 78 · 📋 130 - 28% open · ⏱️ 21.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/paver) (📥 36K / month · 📦 960 · ⏱️ 31.12.2017):
	```
	pip install paver
	```
...
<details><summary><b><a href="https://github.com/ml-tooling/universal-build">universal-build</a></b> (🥉16 ·  ⭐ 16) - Universal build utilities for containerized build pipelines. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ml-tooling/universal-build) (👨‍💻 4 · 🔀 6 · 📥 16 · 📦 8 · ⏱️ 17.11.2021):

	```
	git clone https://github.com/ml-tooling/universal-build
	```
- [PyPi](https://pypi.org/project/universal-build) (📥 1.2K / month · 📦 5 · ⏱️ 12.12.2020):
	```
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 170 · 🔀 1.2K · 📦 140K · 📋 1.5K - 13% open · ⏱️ 25.02.2022):

	```
	git clone https://github.com/giampaolo/psutil
	```
- [PyPi](https://pypi.org/project/psutil) (📥 39M / month · 📦 15K · ⏱️ 29.12.2021):
	```
	pip install psutil
	```
- [Conda](https://anaconda.org/conda-forge/psutil) (📥 10M · ⏱️ 30.12.2021):
	```
...
- [GitHub](https://github.com/nicolargo/glances) (👨‍💻 150 · 🔀 1.3K · 📥 710 · 📦 400 · 📋 1.5K - 14% open · ⏱️ 06.03.2022):
...
<details><summary><b><a href="https://github.com/plasma-umass/scalene">Scalene</a></b> (🥈32 ·  ⭐ 5.4K) - Scalene: a high-performance, high-precision CPU, GPU, and memory.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/plasma-umass/scalene) (👨‍💻 28 · 🔀 180 · 📦 89 · 📋 200 - 23% open · ⏱️ 09.03.2022):

	```
	git clone https://github.com/plasma-umass/scalene
	```
- [PyPi](https://pypi.org/project/scalene) (📥 11K / month · 📦 3 · ⏱️ 11.02.2022):
	```
	pip install scalene
	```
</details>
<details><summary><b><a href="https://github.com/benfred/py-spy">py-spy</a></b> (🥈30 ·  ⭐ 8.2K) - Sampling profiler for Python programs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 29 · 🔀 280 · 📥 7.9K · 📋 240 - 29% open · ⏱️ 17.01.2022):

	```
	git clone https://github.com/benfred/py-spy
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 710K / month · 📦 35 · ⏱️ 13.11.2021):
	```
	pip install py-spy
	```
- [Conda](https://anaconda.org/conda-forge/py-spy) (📥 290K · ⏱️ 18.12.2021):
	```
	conda install -c conda-forge py-spy
	```
- [Cargo](https://crates.io/crates/py-spy) (📥 140 / month · ⏱️ 13.11.2021):
	```
...
- [GitHub](https://github.com/joerick/pyinstrument) (👨‍💻 38 · 🔀 170 · 📦 560 · 📋 96 - 16% open · ⏱️ 17.12.2021):
...
- [PyPi](https://pypi.org/project/pyinstrument) (📥 300K / month · 📦 97 · ⏱️ 14.11.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyinstrument) (📥 96K · ⏱️ 26.01.2022):
	```
...
- [GitHub](https://github.com/pyutils/line_profiler) (👨‍💻 29 · 🔀 250 · 📋 61 - 49% open · ⏱️ 21.02.2022):
...
- [GitHub](https://github.com/pythonprofilers/memory_profiler) (👨‍💻 94 · 🔀 330 · 📋 220 - 50% open · ⏱️ 23.02.2022):
...
- [GitHub](https://github.com/python-diamond/Diamond) (👨‍💻 370 · 🔀 590 · 📦 77 · 📋 370 - 62% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/python-diamond/Diamond
	```
- [PyPi](https://pypi.org/project/diamond) (📥 43K / month · 📦 32 · ⏱️ 25.11.2016):
	```
	pip install diamond
	```
</details>
<details><summary><b><a href="https://github.com/aristocratos/bpytop">Bpytop</a></b> (🥉27 ·  ⭐ 8.3K) - Linux/OSX/FreeBSD resource monitor. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/aristocratos/bpytop) (👨‍💻 35 · 🔀 330 · 📋 280 - 21% open · ⏱️ 06.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/bpytop) (📥 13K / month · 📦 1 · ⏱️ 22.12.2021):
	```
	pip install bpytop
	```
- [Conda](https://anaconda.org/conda-forge/bpytop) (📥 4K · ⏱️ 22.12.2021):
	```
	conda install -c conda-forge bpytop
	```
</details>
<details><summary><b><a href="https://github.com/pympler/pympler">pympler</a></b> (🥉27 ·  ⭐ 890) - Development tool to measure, monitor and analyze the memory behavior.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/sumerc/yappi">Yappi</a></b> (🥉27 ·  ⭐ 860) - Yet Another Python Profiler, but this time thread&coroutine&greenlet aware. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sumerc/yappi) (👨‍💻 26 · 🔀 52 · 📦 550 · 📋 55 - 30% open · ⏱️ 08.12.2021):

	```
	git clone https://github.com/sumerc/yappi
	```
- [PyPi](https://pypi.org/project/yappi) (📥 780K / month · 📦 340 · ⏱️ 15.12.2021):
	```
	pip install yappi
	```
...
- [GitHub](https://github.com/alexmojaki/heartrate) (👨‍💻 3 · 🔀 120 · 📦 38 · 📋 7 - 57% open · ⏱️ 13.11.2021):
...
- [PyPi](https://pypi.org/project/heartrate) (📥 700 / month · 📦 3 · ⏱️ 13.11.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/heartrate) (📥 470 · ⏱️ 13.11.2021):
	```
...
- [GitHub](https://github.com/csurfer/pyheat) (👨‍💻 5 · 🔀 41 · 📦 35 · 📋 14 - 35% open · ⏱️ 18.09.2021):

	```
	git clone https://github.com/csurfer/pyheat
	```
- [PyPi](https://pypi.org/project/py-heat) (📥 2.7K / month · 📦 6 · ⏱️ 06.12.2018):
	```
	pip install py-heat
	```
</details>
...
- <b><a href="https://github.com/fabianp/memory_profiler">memory_profiler</a></b> (🥉21 ·  ⭐ 70 · 💀) - Monitor Memory usage of Python code. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- [PyPi](https://pypi.org/project/typed_ast) (📥 13M / month · 📦 5.5K · ⏱️ 24.01.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/typed-ast) (📥 3.9M · ⏱️ 24.01.2022):
	```
...
- [GitHub](https://github.com/berkerpeksag/astor) (👨‍💻 31 · 🔀 85 · 📋 110 - 31% open · ⏱️ 27.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/astor) (📥 5.3M / month · 📦 2.1K · ⏱️ 10.12.2019):
	```
	pip install astor
	```
...
- [GitHub](https://github.com/serge-sans-paille/gast) (👨‍💻 10 · 🔀 25 · 📦 79K · 📋 28 - 3% open · ⏱️ 24.02.2022):
...
<details><summary><b><a href="https://github.com/pre-commit/pre-commit">pre-commit</a></b> (🥇39 ·  ⭐ 7.5K) - A framework for managing and maintaining multi-language pre-commit.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pre-commit/pre-commit) (👨‍💻 130 · 🔀 540 · 📥 38K · 📦 42K · 📋 1.4K - 1% open · ⏱️ 05.03.2022):

	```
	git clone https://github.com/pre-commit/pre-commit
	```
- [PyPi](https://pypi.org/project/pre-commit) (📥 4.5M / month · 📦 2.8K · ⏱️ 18.01.2022):
	```
