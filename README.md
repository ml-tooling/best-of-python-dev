...
- [GitHub](https://github.com/python/mypy) (👨‍💻 540 · 🔀 2K · 📦 60K · 📋 7.3K - 28% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/python/mypy
	```
- [PyPi](https://pypi.org/project/mypy) (📥 9.1M / month · 📦 5.4K · ⏱️ 07.01.2022):
	```
	pip install mypy
	```
...
- [GitHub](https://github.com/PyCQA/pylint) (👨‍💻 440 · 🔀 800 · 📋 4K - 19% open · ⏱️ 14.02.2022):
...
- [GitHub](https://github.com/microsoft/pyright) (👨‍💻 71 · 🔀 420 · 📦 200 · 📋 2.5K - 0% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/Microsoft/pyright
	```
- [npm](https://www.npmjs.com/package/pyright) (📥 300K / month · 📦 3 · ⏱️ 16.02.2022):
	```
	npm install pyright
	```
</details>
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 160 · 🔀 320 · 📦 1K · 📋 1K - 7% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/wemake-services/wemake-python-styleguide
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 96K / month · 📦 24 · ⏱️ 13.12.2021):
	```
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 190 · 🔀 380 · 📋 310 - 30% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/facebook/pyre-check
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 36K / month · 📦 32 · ⏱️ 11.01.2022):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 73 · 🔀 230 · 📋 490 - 20% open · ⏱️ 17.02.2022):
...
- [PyPi](https://pypi.org/project/pytype) (📥 140K / month · 📦 89 · ⏱️ 08.02.2022):
	...
	pip install pytype
	```
- [Conda](https://anaconda.org/conda-forge/pytype) (📥 67K · ⏱️ 16.02.2022):
	```
...
- [GitHub](https://github.com/PyCQA/pylint-django) (👨‍💻 63 · 🔀 110 · 📥 210 · 📦 16K · 📋 190 - 17% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/PyCQA/pylint-django
	```
- [PyPi](https://pypi.org/project/pylint-django) (📥 740K / month · 📦 1.2K · ⏱️ 16.02.2022):
	```
	pip install pylint-django
	```
- [Conda](https://anaconda.org/conda-forge/pylint-django) (📥 89K · ⏱️ 16.02.2022):
	```
...
- [GitHub](https://github.com/PyCQA/pydocstyle) (👨‍💻 77 · 🔀 150 · 📥 56 · 📦 23K · 📋 280 - 29% open · ⏱️ 30.12.2021):
...
- [PyPi](https://pypi.org/project/pydocstyle) (📥 2.1M / month · 📦 2.4K · ⏱️ 17.05.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pydocstyle) (📥 530K · ⏱️ 18.05.2021):
	```
...
<details><summary><b><a href="https://github.com/PyCQA/flake8-bugbear">flake8-bugbear</a></b> (🥈30 ·  ⭐ 690) - A plugin for Flake8 finding likely bugs and design problems.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://cdn.iconscout.com/icon/free/png-256/8-eight-digital-number-numerical-numbers-36025.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PyCQA/flake8-bugbear) (👨‍💻 48 · 🔀 55 · 📦 6.8K · 📋 110 - 36% open · ⏱️ 27.01.2022):
...
- [GitHub](https://github.com/nipunn1313/mypy-protobuf) (👨‍💻 32 · 🔀 64 · 📋 100 - 5% open · ⏱️ 14.02.2022):
...
- [PyPi](https://pypi.org/project/mypy-protobuf) (📥 790K / month · 📦 50 · ⏱️ 23.01.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/mypy-protobuf) (📥 23K · ⏱️ 24.01.2022):
	```
...
- [GitHub](https://github.com/openstack/hacking) (👨‍💻 180 · 🔀 66 · ⏱️ 10.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/hacking) (📥 480K / month · 📦 4.4K · ⏱️ 21.04.2021):
	```
	pip install hacking
	```
</details>
...
- [GitHub](https://github.com/terrencepreilly/darglint) (👨‍💻 22 · 🔀 37 · 📦 1.7K · 📋 140 - 33% open · ⏱️ 18.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/darglint) (📥 270K / month · 📦 53 · ⏱️ 18.10.2021):
	```
...
- [GitHub](https://github.com/beartype/beartype) (👨‍💻 9 · 🔀 21 · 📋 79 - 16% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/beartype/beartype
	```
- [PyPi](https://pypi.org/project/beartype) (📥 73K / month · 📦 29 · ⏱️ 09.02.2022):
	```
...
- [GitHub](https://github.com/mgedmin/check-manifest) (👨‍💻 20 · 🔀 31 · 📦 7.1K · 📋 89 - 19% open · ⏱️ 16.10.2021):
...
- [GitHub](https://github.com/wemake-services/flake8-eradicate) (👨‍💻 13 · 🔀 6 · 📋 28 - 3% open · ⏱️ 14.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/flake8-eradicate) (📥 300K / month · 📦 65 · ⏱️ 19.10.2021):
	```
...
- [GitHub](https://github.com/predictive-analytics-lab/data-science-types) (👨‍💻 44 · 🔀 57 · 📦 170 · 📋 62 - 62% open · ⏱️ 16.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/data-science-types) (📥 50K / month · 📦 8 · ⏱️ 16.02.2021):
	```
...
- [GitHub](https://github.com/peterjc/flake8-black) (👨‍💻 6 · 🔀 10 · 📦 1.8K · 📋 23 - 30% open · ⏱️ 04.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/flake8-black) (📥 450K / month · 📦 140 · ⏱️ 30.01.2022):
	```
...
- [GitHub](https://github.com/deppen8/pandas-vet) (👨‍💻 12 · 🔀 15 · 📥 39 · 📦 64 · 📋 49 - 38% open · ⏱️ 09.02.2022):

	```
	git clone https://github.com/deppen8/pandas-vet
	```
- [PyPi](https://pypi.org/project/pandas-vet) (📥 9K / month · 📦 9 · ⏱️ 09.02.2022):
	```
...
- [GitHub](https://github.com/gforcada/flake8-builtins) (👨‍💻 15 · 🔀 18 · 📦 3.3K · 📋 35 - 8% open · ⏱️ 20.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/flake8-builtins) (📥 430K / month · 📦 300 · ⏱️ 14.05.2020):
	```
...
- [GitHub](https://github.com/jschaf/pylint-flask) (👨‍💻 7 · 🔀 9 · 📦 5.7K · 📋 10 - 50% open · ⏱️ 10.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pylint-flask) (📥 250K / month · 📦 360 · ⏱️ 30.01.2019):
	```
...
- [GitHub](https://github.com/justinabrahms/imhotep) (👨‍💻 16 · 🔀 37 · 📦 9 · 📋 46 - 50% open · ⏱️ 01.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/imhotep) (📥 32 / month · 📦 5 · ⏱️ 18.09.2016):
	```
	pip install imhotep
	```
</details>
...
- [GitHub](https://github.com/psf/black) (👨‍💻 310 · 🔀 1.6K · 📥 20K · 📦 120K · 📋 1.8K - 16% open · ⏱️ 11.02.2022):
...
- [PyPi](https://pypi.org/project/black) (📥 15M / month · 📦 6.7K · ⏱️ 29.01.2022):
	...
	pip install black
	```
- [Conda](https://anaconda.org/conda-forge/black) (📥 3.1M · ⏱️ 31.01.2022):
	```
	conda install -c conda-forge black
	```
</details>
<details><summary><b><a href="https://github.com/PyCQA/isort">isort</a></b> (🥈39 ·  ⭐ 4.6K) - A Python utility / library to sort imports. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/PyCQA/docformatter) (👨‍💻 16 · 🔀 35 · 📦 840 · 📋 49 - 55% open · ⏱️ 11.02.2022):
...
- [PyPi](https://pypi.org/project/jedi) (📥 14M / month · 📦 8.3K · ⏱️ 17.11.2021):
	...
	pip install jedi
	```
- [Conda](https://anaconda.org/conda-forge/jedi) (📥 7.7M · ⏱️ 17.11.2021):
	```
...
- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 30 · 🔀 94 · 📦 1.4K · 📋 160 - 10% open · ⏱️ 03.01.2022):
...
- [GitHub](https://github.com/PyCQA/redbaron) (👨‍💻 34 · 🔀 70 · 📦 350 · 📋 130 - 63% open · ⏱️ 09.12.2021):
...
- [GitHub](https://github.com/PyCQA/baron) (👨‍💻 33 · 🔀 52 · 📦 200 · 📋 75 - 61% open · ⏱️ 09.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/baron) (📥 36K / month · 📦 59 · ⏱️ 09.12.2021):
	```
	pip install baron
	```
</details>
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 37 · 🔀 130 · 📦 160 · 📋 150 - 24% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/Instagram/MonkeyType
	```
- [PyPi](https://pypi.org/project/monkeytype) (📥 41K / month · 📦 23 · ⏱️ 21.05.2021):
	```
...
- [GitHub](https://github.com/hakancelik96/unimport) (👨‍💻 13 · 🔀 12 · 📦 18 · 📋 76 - 10% open · ⏱️ 01.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/unimport) (📥 5.1K / month · ⏱️ 29.01.2022):
	```
...
- [GitHub](https://github.com/ilevkivskyi/com2ann) (👨‍💻 4 · 🔀 7 · 📦 8 · 📋 20 - 25% open · ⏱️ 21.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/com2ann) (📥 4.8K / month · 📦 1 · ⏱️ 21.08.2021):
	```
	pip install com2ann
	```
</details>
...
- [GitHub](https://github.com/PyCQA/bandit) (👨‍💻 140 · 🔀 400 · 📥 160 · 📦 11K · 📋 590 - 32% open · ⏱️ 15.02.2022):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.6K · 📋 4.6K - 1% open · ⏱️ 14.02.2022):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 5.6K / month · 📦 6 · ⏱️ 10.02.2022):
	```
	pip install sqlmap
	```
</details>
...
- [GitHub](https://github.com/Yelp/detect-secrets) (👨‍💻 57 · 🔀 270 · 📋 250 - 36% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/Yelp/detect-secrets
	```
- [PyPi](https://pypi.org/project/detect-secrets) (📥 280K / month · 📦 23 · ⏱️ 16.02.2022):
	```
...
- [GitHub](https://github.com/pyupio/safety) (👨‍💻 35 · 🔀 100 · 📥 130K · 📦 3.5K · 📋 120 - 36% open · ⏱️ 28.04.2021):

	```
	git clone https://github.com/pyupio/safety
	```
- [PyPi](https://pypi.org/project/safety) (📥 870K / month · 📦 320 · ⏱️ 15.01.2021):
	```
	pip install safety
	```
...
<details><summary><b><a href="https://github.com/dlint-py/dlint">dlint</a></b> (🥉18 ·  ⭐ 84) - Dlint is a tool for encouraging best coding practices and helping ensure.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [PyPi](https://pypi.org/project/dlint) (📥 74K / month · 📦 29 · ⏱️ 27.10.2021):
	...
	pip install dlint
	```
- [Conda](https://anaconda.org/conda-forge/dlint) (📥 110 · ⏱️ 09.11.2021):
	```
...
- [GitHub](https://github.com/pypa/pipenv) (👨‍💻 410 · 🔀 1.7K · 📦 25K · 📋 3.6K - 15% open · ⏱️ 16.02.2022):
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 220 · 🔀 930 · 📋 1.2K - 5% open · ⏱️ 05.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/virtualenv) (📥 26M / month · 📦 18K · ⏱️ 05.02.2022):
	```
...
- [GitHub](https://github.com/pypa/pip) (👨‍💻 660 · 🔀 2.5K · 📦 72K · 📋 6.2K - 15% open · ⏱️ 03.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/pip) (📥 100M / month · 📦 11K · ⏱️ 03.02.2022):
	```
	pip install pip
	```
...
- [GitHub](https://github.com/conda/conda) (👨‍💻 380 · 🔀 1.1K · 📋 8.3K - 22% open · ⏱️ 16.02.2022):
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 330 · 🔀 1.5K · 📥 10M · 📋 3.7K - 34% open · ⏱️ 11.02.2022):
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 160 · 🔀 490 · 📋 820 - 17% open · ⏱️ 08.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 4.2M / month · 📦 1.8K · ⏱️ 08.02.2022):
	```
...
- [GitHub](https://github.com/bndr/pipreqs) (👨‍💻 51 · 🔀 280 · 📦 9K · 📋 190 - 52% open · ⏱️ 23.10.2021):
...
- [GitHub](https://github.com/pypa/pipx) (👨‍💻 75 · 🔀 210 · 📋 460 - 22% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/pypa/pipx
	```
- [PyPi](https://pypi.org/project/pipx) (📥 100K / month · 📦 6 · ⏱️ 04.01.2022):
	```
	pip install pipx
	```
- [Conda](https://anaconda.org/conda-forge/pipx) (📥 160 · ⏱️ 04.01.2022):
	```
	conda install -c conda-forge pipx
	```
</details>
<details><summary><b><a href="https://github.com/mamba-org/mamba">mamba</a></b> (🥉27 ·  ⭐ 2.8K) - The Fast Cross-Platform Package Manager. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/mamba-org/mamba) (👨‍💻 72 · 🔀 150 · 📋 770 - 28% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/mamba-org/mamba
	```
- [Conda](https://anaconda.org/conda-forge/mamba) (📥 2M · ⏱️ 14.02.2022):
	```
...
- [GitHub](https://github.com/David-OConnor/pyflow) (👨‍💻 28 · 🔀 41 · 📥 3.9K · 📋 120 - 39% open · ⏱️ 04.12.2021):
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 78 · 🔀 140 · 📋 300 - 19% open · ⏱️ 01.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/prospector) (📥 470K / month · 📦 660 · ⏱️ 17.01.2022):
	```
...
- [GitHub](https://github.com/rubik/xenon) (👨‍💻 8 · 🔀 16 · 📦 300 · 📋 33 - 24% open · ⏱️ 03.09.2021):

	```
	git clone https://github.com/rubik/xenon
	```
- [PyPi](https://pypi.org/project/xenon) (📥 64K / month · 📦 69 · ⏱️ 03.09.2021):
	```
	pip install xenon
	```
...
<details><summary><b><a href="https://github.com/tonybaloney/wily">wily</a></b> (🥉21 ·  ⭐ 860) - A Python application for tracking, reporting on timing and complexity in.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/tonybaloney/wily) (👨‍💻 17 · 🔀 46 · 📋 80 - 35% open · ⏱️ 09.02.2022):

	```
	git clone https://github.com/tonybaloney/wily
	```
- [PyPi](https://pypi.org/project/wily) (📥 26K / month · 📦 9 · ⏱️ 01.07.2021):
	```
	pip install wily
	```
</details>
...
- [PyPi](https://pypi.org/project/tqdm) (📥 34M / month · 📦 21K · ⏱️ 15.12.2021):
	...
	pip install tqdm
	```
- [Conda](https://anaconda.org/conda-forge/tqdm) (📥 9.8M · ⏱️ 20.09.2021):
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 120 · 🔀 270 · 📥 4.5K · 📦 18K · 📋 630 - 29% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/getsentry/sentry-python
	```
- [PyPi](https://pypi.org/project/sentry-sdk) (📥 13M / month · 📦 950 · ⏱️ 11.02.2022):
	```
	pip install sentry-sdk
	```
- [Conda](https://anaconda.org/conda-forge/sentry-sdk) (📥 130K · ⏱️ 11.02.2022):
	```
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 33 · 🔀 480 · 📦 14K · 📋 530 - 18% open · ⏱️ 30.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/loguru) (📥 2.7M / month · 📦 1.3K · ⏱️ 20.09.2020):
	```
	pip install loguru
	```
- [Conda](https://anaconda.org/conda-forge/loguru) (📥 370K · ⏱️ 02.11.2021):
	```
...
- [GitHub](https://github.com/madzak/python-json-logger) (👨‍💻 50 · 🔀 170 · 📦 21K · 📋 73 - 36% open · ⏱️ 06.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/python-json-logger) (📥 5.2M / month · 📦 690 · ⏱️ 27.07.2021):
	```
...
- [GitHub](https://github.com/astanin/python-tabulate) (👨‍💻 68 · 🔀 94 · 📦 64K · 📋 110 - 46% open · ⏱️ 07.01.2022):

	```
	git clone https://github.com/astanin/python-tabulate
	```
- [PyPi](https://pypi.org/project/tabulate) (📥 32M / month · 📦 6.3K · ⏱️ 22.02.2021):
	```
...
- [GitHub](https://github.com/borntyping/python-colorlog) (👨‍💻 30 · 🔀 76 · 📦 14K · ⏱️ 08.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/colorlog) (📥 6M / month · 📦 2.4K · ⏱️ 08.11.2021):
	```
	pip install colorlog
	```
- [Conda](https://anaconda.org/conda-forge/colorlog) (📥 550K · ⏱️ 09.11.2021):
	```
...
- [GitHub](https://github.com/ines/wasabi) (👨‍💻 7 · 🔀 20 · 📦 16K · 📋 7 - 57% open · ⏱️ 06.12.2021):

	```
	git clone https://github.com/ines/wasabi
	```
- [PyPi](https://pypi.org/project/wasabi) (📥 3.5M / month · 📦 270 · ⏱️ 06.12.2021):
	```
	pip install wasabi
	```
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 2 · 🔀 130 · 📦 610 · 📋 110 - 17% open · ⏱️ 11.02.2022):
...
- [GitHub](https://github.com/liiight/notifiers) (👨‍💻 17 · 🔀 82 · 📋 91 - 31% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/liiight/notifiers
	```
- [PyPi](https://pypi.org/project/notifiers) (📥 340K / month · 📦 17 · ⏱️ 10.02.2022):
	```
...
- [GitHub](https://github.com/xolox/python-coloredlogs) (👨‍💻 16 · 🔀 37 · 📦 10K · 📋 74 - 33% open · ⏱️ 11.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/coloredlogs) (📥 2.4M / month · 📦 1.7K · ⏱️ 11.06.2021):
	```
...
- [GitHub](https://github.com/shobrook/rebound) (👨‍💻 16 · 🔀 360 · 📥 180 · 📦 22 · 📋 58 - 34% open · ⏱️ 16.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/rebound) (📥 2K / month · 📦 16 · ⏱️ 26.01.2022):
	```
	pip install rebound
	```
...
- [GitHub](https://github.com/samuelcolvin/python-devtools) (👨‍💻 7 · 🔀 16 · 📦 560 · 📋 38 - 10% open · ⏱️ 08.09.2021):
...
- [GitHub](https://github.com/mkdocs/mkdocs) (👨‍💻 210 · 🔀 1.9K · 📦 19K · 📋 1.6K - 6% open · ⏱️ 27.01.2022):

	```
	git clone https://github.com/mkdocs/mkdocs
	```
- [PyPi](https://pypi.org/project/mkdocs) (📥 870K / month · 📦 3.5K · ⏱️ 15.12.2021):
	```
	pip install mkdocs
	```
...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 140 · 🔀 2K · 📦 11K · 📋 1.3K - 0% open · ⏱️ 13.02.2022):

	```
	git clone https://github.com/squidfunk/mkdocs-material
	```
- [PyPi](https://pypi.org/project/mkdocs-material) (📥 1M / month · 📦 1.1K · ⏱️ 10.02.2022):
	```
	pip install mkdocs-material
	```
- [Conda](https://anaconda.org/conda-forge/mkdocs-material) (📥 81K · ⏱️ 11.02.2022):
	```
...
- [PyPi](https://pypi.org/project/numpydoc) (📥 280K / month · 📦 4.3K · ⏱️ 24.01.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/numpydoc) (📥 940K · ⏱️ 24.01.2022):
	```
...
- [GitHub](https://github.com/michaeljones/breathe) (👨‍💻 100 · 🔀 160 · 📥 250 · 📦 5.9K · 📋 490 - 23% open · ⏱️ 14.02.2022):
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 34 · 🔀 130 · 📦 530 · 📋 220 - 3% open · ⏱️ 16.02.2022):
...
- [GitHub](https://github.com/tox-dev/sphinx-autodoc-typehints) (👨‍💻 38 · 🔀 79 · 📋 130 - 16% open · ⏱️ 11.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/sphinx-autodoc-typehints) (📥 550K / month · 📦 1.3K · ⏱️ 11.02.2022):
	```
...
<details><summary><b><a href="https://github.com/mkdocstrings/mkdocstrings">mkdocstrings</a></b> (🥈27 ·  ⭐ 620) - Automatic documentation from sources, for MkDocs. <code><a href="http://bit.ly/3hkKRql">ISC</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/mkdocstrings/mkdocstrings) (👨‍💻 26 · 🔀 63 · 📋 240 - 22% open · ⏱️ 07.02.2022):
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-pages-plugin) (👨‍💻 4 · 🔀 22 · 📋 49 - 16% open · ⏱️ 12.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/mkdocs-awesome-pages-plugin) (📥 55K / month · 📦 64 · ⏱️ 12.02.2022):
	```
...
- [GitHub](https://github.com/orzih/mkdocs-with-pdf) (👨‍💻 6 · 🔀 25 · 📦 100 · 📋 72 - 47% open · ⏱️ 14.10.2021):
...
- [GitHub](https://github.com/timothycrosley/portray) (👨‍💻 16 · 🔀 58 · 📋 54 - 42% open · ⏱️ 13.06.2021):
...
<details><summary><b><a href="https://github.com/ml-tooling/lazydocs">lazydocs</a></b> (🥉17 ·  ⭐ 74) - Generate markdown API documentation from Google-style Python docstring... <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- <b><a href="https://github.com/timvink/mkdocs-print-site-plugin">mkdocs-print-site-plugin</a></b> (🥉19 ·  ⭐ 33) - MkDocs Plugin that adds an additional page that.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://squidfunk.github.io/mkdocs-material/assets/favicon.png" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/cool-RR/PySnooper) (👨‍💻 26 · 🔀 920 · 📦 570 · 📋 110 - 15% open · ⏱️ 14.01.2022):

	```
	git clone https://github.com/cool-RR/PySnooper
	```
- [PyPi](https://pypi.org/project/pysnooper) (📥 180K / month · 📦 48 · ⏱️ 14.01.2022):
	```
...
- [GitHub](https://github.com/gotcha/ipdb) (👨‍💻 49 · 🔀 130 · 📦 30K · 📋 170 - 34% open · ⏱️ 30.12.2021):

	```
	git clone https://github.com/gotcha/ipdb
	```
- [PyPi](https://pypi.org/project/ipdb) (📥 2.3M / month · 📦 8.7K · ⏱️ 02.06.2021):
	```
	pip install ipdb
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 82 · 🔀 440 · 📦 3K · 📋 180 - 33% open · ⏱️ 14.02.2022):

	```
	git clone https://github.com/eliben/pyelftools
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 940K / month · 📦 520 · ⏱️ 03.02.2022):
	```
...
- [GitHub](https://github.com/cs01/gdbgui) (👨‍💻 39 · 🔀 480 · 📥 7K · 📦 140 · 📋 280 - 42% open · ⏱️ 16.01.2022):

	```
	git clone https://github.com/cs01/gdbgui
	```
- [PyPi](https://pypi.org/project/gdbgui) (📥 220K / month · 📦 2 · ⏱️ 06.09.2021):
	```
	pip install gdbgui
	```
</details>
...
- [PyPi](https://pypi.org/project/typeguard) (📥 4.4M / month · 📦 300 · ⏱️ 10.12.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/typeguard) (📥 74K · ⏱️ 11.10.2021):
	```
...
- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 40 · 🔀 46 · 📦 2.6K · 📋 180 - 35% open · ⏱️ 27.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pdbpp) (📥 530K / month · 📦 590 · ⏱️ 09.07.2021):
	```
	pip install pdbpp
	```
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 37 · 📦 78 · 📋 87 - 42% open · ⏱️ 15.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/hunter) (📥 8K / month · 📦 21 · ⏱️ 15.12.2021):
	```
	pip install hunter
	```
- [Conda](https://anaconda.org/conda-forge/hunter) (📥 3.5K · ⏱️ 16.12.2021):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest) (👨‍💻 770 · 🔀 2K · 📦 440K · 📋 4.9K - 15% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/pytest-dev/pytest
	```
- [PyPi](https://pypi.org/project/pytest) (📥 37M / month · 📦 81K · ⏱️ 11.02.2022):
	```
	pip install pytest
	```
- [Conda](https://anaconda.org/conda-forge/pytest) (📥 11M · ⏱️ 11.02.2022):
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 160 · 🔀 1.9K · 📥 520 · 📦 4.9K · 📋 3.8K - 5% open · ⏱️ 16.02.2022):
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 260 · 🔀 480 · 📦 11K · 📋 1.2K - 4% open · ⏱️ 13.02.2022):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 2.3M / month · 📦 1.9K · ⏱️ 13.02.2022):
	```
	pip install hypothesis
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 5.2M · ⏱️ 13.02.2022):
	```
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 97 · 🔀 220 · 📋 260 - 34% open · ⏱️ 25.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/freezegun) (📥 4.1M / month · 📦 4.4K · ⏱️ 20.01.2021):
	```
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 280 · 📥 190 · 📋 300 - 1% open · ⏱️ 16.02.2022):
...
- [PyPi](https://pypi.org/project/mimesis) (📥 120K / month · 📦 58 · ⏱️ 25.01.2022):
	...
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 5.4K · ⏱️ 15.07.2020):
	```
	conda install -c conda-forge mimesis
	```
</details>
<details><summary><b><a href="https://github.com/pytest-dev/pytest-asyncio">pytest-asyncio</a></b> (🥈32 ·  ⭐ 890) - Pytest support for asyncio. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pytest-dev/pytest-asyncio) (👨‍💻 37 · 🔀 97 · 📥 4 · 📋 190 - 16% open · ⏱️ 10.02.2022):

	```
	git clone https://github.com/pytest-dev/pytest-asyncio
	```
- [PyPi](https://pypi.org/project/pytest-asyncio) (📥 2.8M / month · 📦 1.8K · ⏱️ 10.02.2022):
	```
	pip install pytest-asyncio
	```
- [Conda](https://anaconda.org/conda-forge/pytest-asyncio) (📥 810K · ⏱️ 10.02.2022):
	```
...
- [GitHub](https://github.com/microsoft/playwright-python) (👨‍💻 24 · 🔀 520 · 📦 800 · 📋 580 - 4% open · ⏱️ 14.02.2022):
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 73 · 🔀 140 · 📦 4.5K · 📋 250 - 19% open · ⏱️ 13.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/nose2) (📥 390K / month · 📦 1.1K · ⏱️ 13.02.2022):
	```
	pip install nose2
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-bdd) (👨‍💻 45 · 🔀 170 · 📋 280 - 46% open · ⏱️ 15.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytest-bdd) (📥 300K / month · 📦 170 · ⏱️ 25.10.2021):
	```
...
<details><summary><b><a href="https://github.com/theacodes/nox">nox</a></b> (🥉28 ·  ⭐ 720) - Flexible test automation for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/theacodes/nox) (👨‍💻 67 · 🔀 110 · 📋 270 - 11% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/theacodes/nox
	```
- [PyPi](https://pypi.org/project/nox) (📥 960K / month · 📦 150 · ⏱️ 07.01.2022):
	```
	pip install nox
	```
- [Conda](https://anaconda.org/conda-forge/nox) (📥 47K · ⏱️ 13.01.2022):
	```
...
- [GitHub](https://github.com/airspeed-velocity/asv) (👨‍💻 59 · 🔀 140 · 📦 230 · 📋 440 - 29% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/airspeed-velocity/asv
	```
- [PyPi](https://pypi.org/project/asv) (📥 32K / month · 📦 63 · ⏱️ 06.02.2022):
	```
	pip install asv
	```
...
- [GitHub](https://github.com/dbader/pytest-mypy) (👨‍💻 16 · 🔀 33 · 📦 1.5K · 📋 49 - 16% open · ⏱️ 07.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytest-mypy) (📥 550K / month · 📦 390 · ⏱️ 07.02.2022):
	```
...
<details><summary><b><a href="https://github.com/ionelmc/pytest-benchmark">pytest-benchmark</a></b> (🥉26 ·  ⭐ 860 · 💤) - py.test fixture for benchmarking code. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [PyPi](https://pypi.org/project/pytest-randomly) (📥 440K / month · 📦 180 · ⏱️ 10.01.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-randomly) (📥 18K · ⏱️ 10.01.2022):
	```
...
- [GitHub](https://github.com/tarpas/pytest-testmon) (👨‍💻 16 · 🔀 29 · 📋 120 - 23% open · ⏱️ 08.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytest-testmon) (📥 130K / month · 📦 54 · ⏱️ 08.02.2022):
	```
...
- [GitHub](https://github.com/man-group/pytest-plugins) (👨‍💻 58 · 🔀 62 · 📋 100 - 43% open · ⏱️ 25.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytest-virtualenv) (📥 8.7K / month · 📦 63 · ⏱️ 28.05.2019):
	```
...
- [PyPi](https://pypi.org/project/xdoctest) (📥 120K / month · 📦 62 · ⏱️ 06.10.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/xdoctest) (📥 16K · ⏱️ 10.08.2021):
	```
...
- [GitHub](https://github.com/TvoroG/pytest-lazy-fixture) (👨‍💻 9 · 🔀 17 · 📦 560 · 📋 35 - 42% open · ⏱️ 27.01.2022):
...
- [GitHub](https://github.com/avast/pytest-docker) (👨‍💻 11 · 🔀 45 · 📥 86 · 📋 33 - 51% open · ⏱️ 14.06.2021):

	```
	git clone https://github.com/avast/pytest-docker
	```
- [PyPi](https://pypi.org/project/pytest-docker) (📥 63K / month · 📦 23 · ⏱️ 14.06.2021):
	```
...
- [GitHub](https://github.com/gabrielcnr/pytest-datadir) (👨‍💻 7 · 🔀 17 · 📦 510 · 📋 16 - 31% open · ⏱️ 18.01.2022):

	```
	git clone https://github.com/gabrielcnr/pytest-datadir
	```
- [PyPi](https://pypi.org/project/pytest-datadir) (📥 160K / month · 📦 71 · ⏱️ 22.10.2019):
	```
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 420 · 🔀 1.8K · 📥 720K · 📋 4.4K - 7% open · ⏱️ 14.02.2022):
...
- [GitHub](https://github.com/pypa/packaging) (👨‍💻 76 · 🔀 180 · 📥 260 · 📦 320K · 📋 240 - 28% open · ⏱️ 14.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/packaging) (📥 96M / month · 📦 17K · ⏱️ 18.11.2021):
	```
...
- [GitHub](https://github.com/Nuitka/Nuitka) (👨‍💻 110 · 🔀 360 · 📋 1.2K - 15% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/Nuitka/Nuitka
	```
- [PyPi](https://pypi.org/project/nuitka) (📥 30K / month · 📦 36 · ⏱️ 13.02.2022):
	```
	pip install nuitka
	```
- [Conda](https://anaconda.org/conda-forge/nuitka) (📥 330K · ⏱️ 13.02.2022):
	```
...
- [GitHub](https://github.com/pantsbuild/pex) (👨‍💻 100 · 🔀 220 · 📥 630K · 📋 800 - 18% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/pantsbuild/pex
	```
- [PyPi](https://pypi.org/project/pex) (📥 230K / month · 📦 130 · ⏱️ 17.02.2022):
	```
	pip install pex
	```
</details>
...
- [GitHub](https://github.com/marcelotduarte/cx_Freeze) (👨‍💻 94 · 🔀 170 · 📋 730 - 8% open · ⏱️ 15.02.2022):
...
- [GitHub](https://github.com/beeware/briefcase) (👨‍💻 89 · 🔀 220 · 📋 380 - 29% open · ⏱️ 10.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/briefcase) (📥 3.5K / month · 📦 16 · ⏱️ 06.03.2021):
	```
...
- [GitHub](https://github.com/indygreg/PyOxidizer) (👨‍💻 38 · 🔀 140 · 📥 1.7K · 📋 430 - 60% open · ⏱️ 31.01.2022):

	```
	git clone https://github.com/indygreg/PyOxidizer
	```
- [PyPi](https://pypi.org/project/pyoxidizer) (📥 1.4K / month · ⏱️ 26.10.2021):
	```
...
<details><summary><b><a href="https://github.com/py2exe/py2exe">py2exe</a></b> (🥉24 ·  ⭐ 360) - A distutils extension to create standalone Windows programs from Python code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/py2exe/py2exe) (👨‍💻 14 · 🔀 47 · 📥 7.9K · 📦 1.4K · 📋 100 - 4% open · ⏱️ 13.02.2022):
...
- [GitHub](https://github.com/pypa/setuptools) (👨‍💻 480 · 🔀 820 · 📥 120 · 📦 140K · 📋 2K - 24% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/pypa/setuptools
	```
- [PyPi](https://pypi.org/project/setuptools) (📥 190M / month · 📦 36K · ⏱️ 15.02.2022):
	```
	pip install setuptools
	```
- [Conda](https://anaconda.org/conda-forge/setuptools) (📥 33M · ⏱️ 16.02.2022):
	```
...
- [GitHub](https://github.com/buildbot/buildbot) (👨‍💻 810 · 🔀 1.6K · 📥 20K · 📦 270 · 📋 1.4K - 45% open · ⏱️ 12.02.2022):

	```
	git clone https://github.com/buildbot/buildbot
	```
- [PyPi](https://pypi.org/project/buildbot) (📥 59K / month · 📦 460 · ⏱️ 10.02.2022):
	```
...
- [GitHub](https://github.com/pypa/twine) (👨‍💻 100 · 🔀 260 · 📦 55K · 📋 400 - 9% open · ⏱️ 13.02.2022):
...
- [GitHub](https://github.com/pypa/setuptools_scm) (👨‍💻 100 · 🔀 160 · 📋 380 - 20% open · ⏱️ 16.02.2022):
...
- [GitHub](https://github.com/pydoit/doit) (👨‍💻 62 · 🔀 150 · 📦 870 · 📋 270 - 24% open · ⏱️ 17.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/doit) (📥 260K / month · 📦 280 · ⏱️ 12.01.2022):
	```
	pip install doit
	```
- [Conda](https://anaconda.org/conda-forge/doit) (📥 75K · ⏱️ 24.01.2022):
	```
...
- [GitHub](https://github.com/pypa/flit) (👨‍💻 51 · 🔀 91 · 📋 310 - 34% open · ⏱️ 20.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/flit) (📥 130K / month · 📦 200 · ⏱️ 27.12.2021):
	```
	pip install flit
	```
...
- [PyPi](https://pypi.org/project/pybuilder) (📥 18K / month · 📦 60 · ⏱️ 12.01.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pybuilder) (📥 9.1K · ⏱️ 12.01.2022):
	```
...
- [GitHub](https://github.com/paver/paver) (👨‍💻 45 · 🔀 78 · 📋 130 - 28% open · ⏱️ 21.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/paver) (📥 38K / month · 📦 960 · ⏱️ 31.12.2017):
	```
	pip install paver
	```
...
- [GitHub](https://github.com/ml-tooling/universal-build) (👨‍💻 4 · 🔀 6 · 📥 16 · 📦 7 · ⏱️ 17.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/universal-build) (📥 350 / month · 📦 5 · ⏱️ 12.12.2020):
	```
...
- [GitHub](https://github.com/nicolargo/glances) (👨‍💻 150 · 🔀 1.3K · 📥 710 · 📦 390 · 📋 1.4K - 14% open · ⏱️ 23.01.2022):
...
- [GitHub](https://github.com/plasma-umass/scalene) (👨‍💻 28 · 🔀 180 · 📦 87 · 📋 180 - 21% open · ⏱️ 16.02.2022):
...
<details><summary><b><a href="https://github.com/benfred/py-spy">py-spy</a></b> (🥈29 ·  ⭐ 8.1K) - Sampling profiler for Python programs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/py-spy) (📥 660K / month · 📦 35 · ⏱️ 13.11.2021):
	...
	pip install py-spy
	```
- [Conda](https://anaconda.org/conda-forge/py-spy) (📥 260K · ⏱️ 18.12.2021):
	```
	conda install -c conda-forge py-spy
	```
- [Cargo](https://crates.io/crates/py-spy) (📥 1.9K / month · ⏱️ 13.11.2021):
	```
...
- [GitHub](https://github.com/joerick/pyinstrument) (👨‍💻 38 · 🔀 170 · 📦 530 · 📋 96 - 16% open · ⏱️ 17.12.2021):

	```
	git clone https://github.com/joerick/pyinstrument
	```
- [PyPi](https://pypi.org/project/pyinstrument) (📥 400K / month · 📦 97 · ⏱️ 14.11.2021):
	```
...
- [GitHub](https://github.com/pythonprofilers/memory_profiler) (👨‍💻 94 · 🔀 330 · 📋 220 - 50% open · ⏱️ 14.02.2022):
...
- [GitHub](https://github.com/pyutils/line_profiler) (👨‍💻 28 · 🔀 250 · 📋 56 - 53% open · ⏱️ 08.02.2022):
...
<details><summary><b><a href="https://github.com/sumerc/yappi">Yappi</a></b> (🥉27 ·  ⭐ 840) - Yet Another Python Profiler, but this time thread&coroutine&greenlet aware. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sumerc/yappi) (👨‍💻 26 · 🔀 53 · 📦 530 · 📋 55 - 30% open · ⏱️ 08.12.2021):

	```
	git clone https://github.com/sumerc/yappi
	```
- [PyPi](https://pypi.org/project/yappi) (📥 890K / month · 📦 340 · ⏱️ 15.12.2021):
	```
	pip install yappi
	```
...
- [GitHub](https://github.com/nvdv/vprof) (👨‍💻 17 · 🔀 170 · 📦 90 · 📋 82 - 31% open · ⏱️ 20.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/vprof) (📥 7.1K / month · 📦 16 · ⏱️ 29.02.2020):
	```
	pip install vprof
	```
</details>
...
- [GitHub](https://github.com/alexmojaki/heartrate) (👨‍💻 3 · 🔀 120 · 📦 37 · 📋 7 - 57% open · ⏱️ 13.11.2021):

	```
	git clone https://github.com/alexmojaki/heartrate
	```
- [PyPi](https://pypi.org/project/heartrate) (📥 640 / month · 📦 3 · ⏱️ 13.11.2021):
	```
	pip install heartrate
	```
- [Conda](https://anaconda.org/conda-forge/heartrate) (📥 450 · ⏱️ 13.11.2021):
	```
...
- [GitHub](https://github.com/csurfer/pyheat) (👨‍💻 5 · 🔀 40 · 📦 34 · 📋 14 - 35% open · ⏱️ 18.09.2021):

	```
	git clone https://github.com/csurfer/pyheat
	```
- [PyPi](https://pypi.org/project/py-heat) (📥 3.2K / month · 📦 6 · ⏱️ 06.12.2018):
	```
	pip install py-heat
	```
</details>
...
- <b><a href="https://github.com/fabianp/memory_profiler">memory_profiler</a></b> (🥉22 ·  ⭐ 68 · 💀) - Monitor Memory usage of Python code. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- [PyPi](https://pypi.org/project/typed_ast) (📥 13M / month · 📦 5.5K · ⏱️ 24.01.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/typed-ast) (📥 3.6M · ⏱️ 24.01.2022):
	```
...
- [GitHub](https://github.com/serge-sans-paille/gast) (👨‍💻 10 · 🔀 26 · 📦 77K · 📋 26 - 3% open · ⏱️ 13.11.2021):
...
<details><summary><b><a href="https://github.com/pre-commit/pre-commit">pre-commit</a></b> (🥇39 ·  ⭐ 7.4K · 📈) - A framework for managing and maintaining multi-language pre-.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pre-commit/pre-commit) (👨‍💻 130 · 🔀 540 · 📥 32K · 📦 39K · 📋 1.4K - 1% open · ⏱️ 31.01.2022):
