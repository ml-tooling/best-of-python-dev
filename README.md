...
- [GitHub](https://github.com/python/mypy) (👨‍💻 550 · 🔀 2.1K · 📦 67K · 📋 7.6K - 29% open · ⏱️ 24.03.2022):

	```
	git clone https://github.com/python/mypy
	```
- [PyPi](https://pypi.org/project/mypy) (📥 10M / month · 📦 5.7K · ⏱️ 14.03.2022):
	```
	pip install mypy
	```
- [Conda](https://anaconda.org/conda-forge/mypy) (📥 1.7M · ⏱️ 16.03.2022):
	```
...
- [GitHub](https://github.com/PyCQA/flake8) (👨‍💻 160 · 🔀 190 · 📦 240K · 📋 1.4K - 2% open · ⏱️ 23.03.2022):
...
- [GitHub](https://github.com/PyCQA/pylint) (👨‍💻 440 · 🔀 800 · 📋 4K - 19% open · ⏱️ 24.03.2022):
...
- [GitHub](https://github.com/microsoft/pyright) (👨‍💻 73 · 🔀 430 · 📦 220 · 📋 2.6K - 0% open · ⏱️ 24.03.2022):

	```
	git clone https://github.com/Microsoft/pyright
	```
- [npm](https://www.npmjs.com/package/pyright) (📥 320K / month · 📦 3 · ⏱️ 23.03.2022):
	```
	npm install pyright
	```
</details>
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 160 · 🔀 330 · 📦 1.1K · 📋 1K - 8% open · ⏱️ 22.03.2022):
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 190 · 🔀 380 · 📋 310 - 30% open · ⏱️ 23.03.2022):
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 73 · 🔀 230 · 📋 500 - 20% open · ⏱️ 23.03.2022):

	```
	git clone https://github.com/google/pytype
	```
- [PyPi](https://pypi.org/project/pytype) (📥 140K / month · 📦 91 · ⏱️ 22.03.2022):
	```
	pip install pytype
	```
- [Conda](https://anaconda.org/conda-forge/pytype) (📥 68K · ⏱️ 22.03.2022):
	```
...
- [PyPi](https://pypi.org/project/pydocstyle) (📥 2.2M / month · 📦 2.4K · ⏱️ 17.05.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pydocstyle) (📥 570K · ⏱️ 18.05.2021):
	```
...
- [GitHub](https://github.com/PyCQA/pylint-django) (👨‍💻 64 · 🔀 110 · 📥 210 · 📦 17K · 📋 190 - 17% open · ⏱️ 18.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/pylint-django) (📥 770K / month · 📦 1.2K · ⏱️ 18.02.2022):
	```
...
- [PyPi](https://pypi.org/project/parso) (📥 15M / month · 📦 5.9K · ⏱️ 30.11.2021):
	...
	pip install parso
	```
- [Conda](https://anaconda.org/conda-forge/parso) (📥 6.7M · ⏱️ 01.12.2021):
	```
...
- [GitHub](https://github.com/PyCQA/flake8-bugbear) (👨‍💻 52 · 🔀 61 · 📦 7.4K · 📋 120 - 29% open · ⏱️ 23.03.2022):
...
- [PyPi](https://pypi.org/project/flake8-bugbear) (📥 1.4M / month · 📦 900 · ⏱️ 23.03.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flake8-bugbear) (📥 560K · ⏱️ 21.03.2022):
	```
...
- [GitHub](https://github.com/coala/coala) (👨‍💻 480 · 🔀 1.4K · 📥 150 · 📦 10 · 📋 3.2K - 26% open · ⏱️ 11.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/coala-bears) (📥 17K / month · 📦 100 · ⏱️ 10.11.2017):
	```
...
- [GitHub](https://github.com/klen/pylama) (👨‍💻 48 · 🔀 91 · 📦 3.5K · 📋 130 - 28% open · ⏱️ 11.03.2022):
...
- [GitHub](https://github.com/nipunn1313/mypy-protobuf) (👨‍💻 32 · 🔀 64 · 📋 100 - 5% open · ⏱️ 18.03.2022):
...
- [PyPi](https://pypi.org/project/mypy-protobuf) (📥 820K / month · 📦 50 · ⏱️ 23.01.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/mypy-protobuf) (📥 27K · ⏱️ 24.01.2022):
	```
...
- [GitHub](https://github.com/openstack/hacking) (👨‍💻 180 · 🔀 66 · ⏱️ 15.03.2022):
...
- [GitHub](https://github.com/terrencepreilly/darglint) (👨‍💻 22 · 🔀 37 · 📦 2K · 📋 140 - 34% open · ⏱️ 18.10.2021):
...
- [GitHub](https://github.com/gforcada/flake8-isort) (👨‍💻 32 · 🔀 44 · 📦 5.1K · 📋 52 - 21% open · ⏱️ 15.03.2022):
...
- [GitHub](https://github.com/adamchainz/flake8-comprehensions) (👨‍💻 12 · 🔀 16 · 📋 42 - 19% open · ⏱️ 21.03.2022):

	```
	git clone https://github.com/adamchainz/flake8-comprehensions
	```
- [PyPi](https://pypi.org/project/flake8-comprehensions) (📥 670K / month · 📦 530 · ⏱️ 10.01.2022):
	```
...
- [GitHub](https://github.com/zheller/flake8-quotes) (👨‍💻 30 · 🔀 33 · 📦 4.6K · 📋 43 - 6% open · ⏱️ 19.10.2021):

	```
	git clone https://github.com/zheller/flake8-quotes
	```
- [PyPi](https://pypi.org/project/flake8-quotes) (📥 620K / month · 📦 820 · ⏱️ 15.12.2021):
	```
...
- [GitHub](https://github.com/beartype/beartype) (👨‍💻 9 · 🔀 22 · 📋 88 - 15% open · ⏱️ 19.03.2022):
...
- [GitHub](https://github.com/wemake-services/flake8-eradicate) (👨‍💻 13 · 🔀 6 · 📋 28 - 3% open · ⏱️ 22.03.2022):

	```
	git clone https://github.com/wemake-services/flake8-eradicate
	```
- [PyPi](https://pypi.org/project/flake8-eradicate) (📥 330K / month · 📦 65 · ⏱️ 19.10.2021):
	```
...
- [GitHub](https://github.com/PyCQA/flake8-commas) (👨‍💻 12 · 🔀 23 · 📦 2.7K · 📋 31 - 16% open · ⏱️ 13.10.2021):
...
- [GitHub](https://github.com/peterjc/flake8-black) (👨‍💻 9 · 🔀 9 · 📦 2K · 📋 24 - 12% open · ⏱️ 18.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/flake8-black) (📥 550K / month · 📦 150 · ⏱️ 25.02.2022):
	```
...
<details><summary><b><a href="https://github.com/tylerwince/flake8-bandit">flake8-bandit</a></b> (🥉23 ·  ⭐ 75 · 📈) - Automated security testing using bandit and flake8. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://cdn.iconscout.com/icon/free/png-256/8-eight-digital-number-numerical-numbers-36025.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tylerwince/flake8-bandit) (👨‍💻 8 · 🔀 21 · 📋 16 - 37% open · ⏱️ 11.03.2022):

	```
	git clone https://github.com/tylerwince/flake8-bandit
	```
- [PyPi](https://pypi.org/project/flake8-bandit) (📥 540K / month · 📦 130 · ⏱️ 11.03.2022):
	```
...
- [GitHub](https://github.com/Instagram/Fixit) (👨‍💻 29 · 🔀 43 · 📦 16 · 📋 57 - 56% open · ⏱️ 07.01.2022):
...
- [GitHub](https://github.com/andreoliwa/nitpick) (👨‍💻 14 · 🔀 13 · 📥 4 · 📋 100 - 33% open · ⏱️ 22.03.2022):
...
<details><summary><b><a href="https://github.com/justinabrahms/imhotep">imhotep</a></b> (🥉21 ·  ⭐ 220 · 📈) - A static-analysis bot for Github. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/justinabrahms/imhotep) (👨‍💻 17 · 🔀 36 · 📦 9 · 📋 45 - 44% open · ⏱️ 16.03.2022):

	```
	git clone https://github.com/justinabrahms/imhotep
	```
- [PyPi](https://pypi.org/project/imhotep) (📥 160 / month · 📦 5 · ⏱️ 20.02.2022):
	```
	pip install imhotep
	```
</details>
<details><summary><b><a href="https://github.com/gforcada/flake8-builtins">flake8-builtins</a></b> (🥉21 ·  ⭐ 80) - Check for python builtins being used as variables or.. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code> <code><img src="https://cdn.iconscout.com/icon/free/png-256/8-eight-digital-number-numerical-numbers-36025.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/gforcada/flake8-builtins) (👨‍💻 15 · 🔀 18 · 📦 3.5K · 📋 36 - 11% open · ⏱️ 20.09.2021):

	```
	git clone https://github.com/gforcada/flake8-builtins
	```
- [PyPi](https://pypi.org/project/flake8-builtins) (📥 460K / month · 📦 300 · ⏱️ 14.05.2020):
	```
...
- [GitHub](https://github.com/deppen8/pandas-vet) (👨‍💻 12 · 🔀 15 · 📥 44 · 📦 71 · 📋 49 - 38% open · ⏱️ 09.02.2022):

	```
	git clone https://github.com/deppen8/pandas-vet
	```
- [PyPi](https://pypi.org/project/pandas-vet) (📥 7.8K / month · 📦 9 · ⏱️ 09.02.2022):
	```
	pip install pandas-vet
	```
- [Conda](https://anaconda.org/conda-forge/pandas-vet) (📥 8.5K · ⏱️ 10.02.2022):
	```
...
- [GitHub](https://github.com/psf/black) (👨‍💻 310 · 🔀 1.6K · 📥 21K · 📦 130K · 📋 1.9K - 16% open · ⏱️ 24.03.2022):

	```
	git clone https://github.com/psf/black
	```
- [PyPi](https://pypi.org/project/black) (📥 13M / month · 📦 6.9K · ⏱️ 29.01.2022):
	```
	pip install black
	```
- [Conda](https://anaconda.org/conda-forge/black) (📥 3.5M · ⏱️ 31.01.2022):
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 140 · 🔀 850 · 📦 30K · 📋 740 - 46% open · ⏱️ 01.03.2022):
...
- [PyPi](https://pypi.org/project/yapf) (📥 1.8M / month · 📦 2.1K · ⏱️ 26.12.2021):
	...
	pip install yapf
	```
- [Conda](https://anaconda.org/conda-forge/yapf) (📥 950K · ⏱️ 06.01.2022):
	```
...
- [PyPi](https://pypi.org/project/autopep8) (📥 2.8M / month · 📦 5.6K · ⏱️ 24.10.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/autopep8) (📥 630K · ⏱️ 26.10.2021):
	```
...
- [GitHub](https://github.com/PyCQA/docformatter) (👨‍💻 16 · 🔀 36 · 📦 890 · 📋 49 - 55% open · ⏱️ 11.02.2022):
...
- [PyPi](https://pypi.org/project/jedi) (📥 15M / month · 📦 8.3K · ⏱️ 17.11.2021):
	...
	pip install jedi
	```
- [Conda](https://anaconda.org/conda-forge/jedi) (📥 8.1M · ⏱️ 17.11.2021):
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 68 · 🔀 150 · 📦 35K · 📋 240 - 30% open · ⏱️ 16.03.2022):
...
- [GitHub](https://github.com/asottile/pyupgrade) (👨‍💻 22 · 🔀 100 · 📋 270 - 4% open · ⏱️ 22.03.2022):

	```
	git clone https://github.com/asottile/pyupgrade
	```
- [PyPi](https://pypi.org/project/pyupgrade) (📥 240K / month · 📦 41 · ⏱️ 13.03.2022):
	```
	pip install pyupgrade
	```
- [Conda](https://anaconda.org/conda-forge/pyupgrade) (📥 320K · ⏱️ 14.03.2022):
	```
...
- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 30 · 🔀 97 · 📦 1.5K · 📋 160 - 11% open · ⏱️ 03.01.2022):

	```
	git clone https://github.com/jendrikseipp/vulture
	```
- [PyPi](https://pypi.org/project/vulture) (📥 250K / month · 📦 220 · ⏱️ 16.01.2021):
	```
	pip install vulture
	```
...
- [GitHub](https://github.com/asottile/add-trailing-comma) (👨‍💻 9 · 🔀 18 · 📋 41 - 2% open · ⏱️ 22.03.2022):
...
- [GitHub](https://github.com/hakancelik96/unimport) (👨‍💻 13 · 🔀 12 · 📦 20 · 📋 79 - 13% open · ⏱️ 22.03.2022):
...
- <b><a href="https://github.com/myint/unify">unify</a></b> (🥉19 ·  ⭐ 68 · 💀) - Modifies strings to all use the same quote where possible. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/PyCQA/bandit) (👨‍💻 150 · 🔀 410 · 📥 220 · 📦 12K · 📋 580 - 30% open · ⏱️ 23.03.2022):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.6K · 📋 4.6K - 1% open · ⏱️ 21.03.2022):
...
- [GitHub](https://github.com/Yelp/detect-secrets) (👨‍💻 56 · 🔀 270 · 📋 250 - 35% open · ⏱️ 16.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/detect-secrets) (📥 350K / month · 📦 23 · ⏱️ 16.02.2022):
	```
...
- [GitHub](https://github.com/pyupio/safety) (👨‍💻 35 · 🔀 100 · 📥 130K · 📦 3.9K · 📋 120 - 36% open · ⏱️ 28.04.2021):

	```
	git clone https://github.com/pyupio/safety
	```
- [PyPi](https://pypi.org/project/safety) (📥 910K / month · 📦 320 · ⏱️ 15.01.2021):
	```
	pip install safety
	```
...
- [PyPi](https://pypi.org/project/dlint) (📥 81K / month · 📦 43 · ⏱️ 27.10.2021):
	...
	pip install dlint
	```
- [Conda](https://anaconda.org/conda-forge/dlint) (📥 140 · ⏱️ 09.11.2021):
	```
...
- [GitHub](https://github.com/pypa/pipenv) (👨‍💻 410 · 🔀 1.7K · 📦 26K · 📋 3.6K - 13% open · ⏱️ 23.03.2022):

	```
	git clone https://github.com/pypa/pipenv
	```
- [PyPi](https://pypi.org/project/pipenv) (📥 4.4M / month · 📦 1.2K · ⏱️ 23.03.2022):
	```
	pip install pipenv
	```
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 220 · 🔀 940 · 📋 1.2K - 5% open · ⏱️ 18.03.2022):

	```
	git clone https://github.com/pypa/virtualenv
	```
- [PyPi](https://pypi.org/project/virtualenv) (📥 27M / month · 📦 18K · ⏱️ 18.03.2022):
	```
	pip install virtualenv
	```
- [Conda](https://anaconda.org/conda-forge/virtualenv) (📥 1.6M · ⏱️ 18.03.2022):
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 360 · 🔀 2.3K · 📋 1.4K - 2% open · ⏱️ 24.03.2022):
...
- [GitHub](https://github.com/pyenv/pyenv-installer) (👨‍💻 34 · 🔀 330 · 📋 69 - 7% open · ⏱️ 18.03.2022):
...
- [GitHub](https://github.com/pypa/pip) (👨‍💻 660 · 🔀 2.6K · 📦 76K · 📋 6.3K - 15% open · ⏱️ 22.03.2022):

	```
	git clone https://github.com/pypa/pip
	```
- [PyPi](https://pypi.org/project/pip) (📥 99M / month · 📦 11K · ⏱️ 07.03.2022):
	```
	pip install pip
	```
- [Conda](https://anaconda.org/conda-forge/pip) (📥 33M · ⏱️ 07.03.2022):
	```
...
- [GitHub](https://github.com/conda/conda) (👨‍💻 380 · 🔀 1.1K · 📋 8.5K - 20% open · ⏱️ 24.03.2022):
...
- [PyPi](https://pypi.org/project/conda) (📥 65K / month · 📦 1.1K · ⏱️ 22.04.2017):
	...
	pip install conda
	```
- [Conda](https://anaconda.org/conda-forge/conda) (📥 25M · ⏱️ 16.03.2022):
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 330 · 🔀 1.6K · 📥 11M · 📋 3.8K - 34% open · ⏱️ 24.03.2022):

	```
	git clone https://github.com/python-poetry/poetry
	```
- [PyPi](https://pypi.org/project/poetry) (📥 5.7M / month · 📦 130 · ⏱️ 17.03.2022):
	```
	pip install poetry
	```
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 160 · 🔀 490 · 📋 830 - 17% open · ⏱️ 15.03.2022):

	```
	git clone https://github.com/jazzband/pip-tools
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 4.9M / month · 📦 1.8K · ⏱️ 08.02.2022):
	```
	pip install pip-tools
	```
- [Conda](https://anaconda.org/conda-forge/pip-tools) (📥 26K · ⏱️ 08.02.2022):
	```
...
- [GitHub](https://github.com/bndr/pipreqs) (👨‍💻 51 · 🔀 280 · 📦 9.5K · 📋 190 - 52% open · ⏱️ 23.10.2021):
...
- [GitHub](https://github.com/pypa/pipx) (👨‍💻 76 · 🔀 230 · 📋 470 - 23% open · ⏱️ 12.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/pipx) (📥 250K / month · 📦 7 · ⏱️ 04.01.2022):
	```
	pip install pipx
	```
- [Conda](https://anaconda.org/conda-forge/pipx) (📥 290 · ⏱️ 04.01.2022):
	```
	conda install -c conda-forge pipx
	```
</details>
<details><summary><b><a href="https://github.com/mamba-org/mamba">mamba</a></b> (🥉28 ·  ⭐ 2.9K) - The Fast Cross-Platform Package Manager. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/mamba-org/mamba) (👨‍💻 75 · 🔀 150 · 📋 800 - 30% open · ⏱️ 24.03.2022):
...
- [GitHub](https://github.com/David-OConnor/pyflow) (👨‍💻 28 · 🔀 40 · 📥 4K · 📋 120 - 40% open · ⏱️ 11.03.2022):
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 78 · 🔀 150 · 📋 310 - 11% open · ⏱️ 15.03.2022):
...
- [GitHub](https://github.com/PyCQA/mccabe) (👨‍💻 21 · 🔀 44 · 📦 250K · 📋 43 - 16% open · ⏱️ 24.01.2022):
...
- [PyPi](https://pypi.org/project/mccabe) (📥 21M / month · 📦 16K · ⏱️ 24.01.2022):
	...
	pip install mccabe
	```
- [Conda](https://anaconda.org/conda-forge/mccabe) (📥 4.1M · ⏱️ 24.01.2022):
	```
...
- [GitHub](https://github.com/tonybaloney/wily) (👨‍💻 18 · 🔀 46 · 📋 82 - 35% open · ⏱️ 18.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/wily) (📥 30K / month · 📦 9 · ⏱️ 01.07.2021):
	```
	pip install wily
	```
</details>
...
- [GitHub](https://github.com/Textualize/rich) (👨‍💻 160 · 🔀 1.2K · 📦 14K · 📋 730 - 5% open · ⏱️ 23.03.2022):

	```
	git clone https://github.com/Textualize/rich
	```
- [PyPi](https://pypi.org/project/rich) (📥 5M / month · 📦 1.6K · ⏱️ 22.03.2022):
	```
	pip install rich
	```
- [Conda](https://anaconda.org/conda-forge/rich) (📥 700K · ⏱️ 22.03.2022):
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1.1K · 📥 8.1K · 📦 260K · 📋 890 - 38% open · ⏱️ 23.03.2022):
...
- [PyPi](https://pypi.org/project/tqdm) (📥 37M / month · 📦 21K · ⏱️ 23.03.2022):
	...
	pip install tqdm
	```
- [Conda](https://anaconda.org/conda-forge/tqdm) (📥 10M · ⏱️ 24.03.2022):
	```
	conda install -c conda-forge tqdm
	```
- [Docker Hub](https://hub.docker.com/r/tqdm/tqdm) (📥 4K · ⭐ 2 · ⏱️ 24.03.2022):
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 120 · 🔀 280 · 📥 4.6K · 📦 19K · 📋 640 - 22% open · ⏱️ 22.03.2022):
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 34 · 🔀 500 · 📦 16K · 📋 560 - 20% open · ⏱️ 15.03.2022):

	```
	git clone https://github.com/Delgan/loguru
	```
- [PyPi](https://pypi.org/project/loguru) (📥 3.7M / month · 📦 1.3K · ⏱️ 20.09.2020):
	```
	pip install loguru
	```
- [Conda](https://anaconda.org/conda-forge/loguru) (📥 400K · ⏱️ 02.11.2021):
	```
...
- [GitHub](https://github.com/madzak/python-json-logger) (👨‍💻 50 · 🔀 170 · 📦 23K · 📋 75 - 37% open · ⏱️ 06.02.2022):

	```
	git clone https://github.com/madzak/python-json-logger
	```
- [PyPi](https://pypi.org/project/python-json-logger) (📥 5.8M / month · 📦 690 · ⏱️ 27.07.2021):
	```
...
- [GitHub](https://github.com/WoLpH/python-progressbar) (👨‍💻 40 · 🔀 100 · 📥 1.7K · 📦 16K · 📋 200 - 6% open · ⏱️ 05.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/progressbar2) (📥 6.4M / month · 📦 1.5K · ⏱️ 05.01.2022):
	```
...
- [GitHub](https://github.com/astanin/python-tabulate) (👨‍💻 68 · 🔀 99 · 📦 68K · 📋 120 - 48% open · ⏱️ 07.01.2022):
...
- [GitHub](https://github.com/borntyping/python-colorlog) (👨‍💻 30 · 🔀 76 · 📦 14K · ⏱️ 08.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/colorlog) (📥 6.5M / month · 📦 2.4K · ⏱️ 08.11.2021):
	```
	pip install colorlog
	```
- [Conda](https://anaconda.org/conda-forge/colorlog) (📥 720K · ⏱️ 09.11.2021):
	```
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 5 · 🔀 130 · 📦 700 · 📋 120 - 18% open · ⏱️ 22.03.2022):

	```
	git clone https://github.com/rsalmei/alive-progress
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 44K / month · 📦 75 · ⏱️ 22.03.2022):
	```
...
<details><summary><b><a href="https://github.com/ines/wasabi">wasabi</a></b> (🥉28 ·  ⭐ 330) - A lightweight console printing and formatting toolkit. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ines/wasabi) (👨‍💻 8 · 🔀 20 · 📦 17K · 📋 7 - 57% open · ⏱️ 22.03.2022):

	```
	git clone https://github.com/ines/wasabi
	```
- [PyPi](https://pypi.org/project/wasabi) (📥 4M / month · 📦 270 · ⏱️ 06.12.2021):
	```
	pip install wasabi
	```
- [Conda](https://anaconda.org/conda-forge/wasabi) (📥 600K · ⏱️ 07.12.2021):
	```
...
- [PyPi](https://pypi.org/project/coloredlogs) (📥 2.8M / month · 📦 1.7K · ⏱️ 11.06.2021):
	...
	```
- [Conda](https://anaconda.org/anaconda/coloredlogs) (📥 3.8K · ⏱️ 05.03.2022):
	```
...
- [GitHub](https://github.com/onelivesleft/PrettyErrors) (👨‍💻 5 · 🔀 75 · 📋 41 - 7% open · ⏱️ 24.11.2021):

	```
	git clone https://github.com/onelivesleft/PrettyErrors
	```
- [PyPi](https://pypi.org/project/pretty_errors) (📥 19K / month · 📦 39 · ⏱️ 24.11.2021):
	```
...
- [GitHub](https://github.com/samuelcolvin/python-devtools) (👨‍💻 7 · 🔀 20 · 📦 610 · 📋 39 - 12% open · ⏱️ 08.09.2021):

	```
	git clone https://github.com/samuelcolvin/python-devtools
	```
- [PyPi](https://pypi.org/project/python-devtools) (📥 700 / month · 📦 1 · ⏱️ 21.08.2017):
	```
	pip install python-devtools
	```
- [Conda](https://anaconda.org/conda-forge/python-devtools) (📥 1.9K · ⏱️ 29.09.2021):
	```
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (👨‍💻 710 · 🔀 1.6K · 📦 190K · 📋 5.9K - 16% open · ⏱️ 24.03.2022):
...
- [PyPi](https://pypi.org/project/sphinx) (📥 5.1M / month · 📦 59K · ⏱️ 16.01.2022):
	...
	pip install sphinx
	```
- [Conda](https://anaconda.org/conda-forge/sphinx) (📥 4.9M · ⏱️ 20.01.2022):
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs) (👨‍💻 210 · 🔀 2K · 📦 20K · 📋 1.7K - 8% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/mkdocs/mkdocs
	```
- [PyPi](https://pypi.org/project/mkdocs) (📥 900K / month · 📦 3.5K · ⏱️ 15.12.2021):
	```
	pip install mkdocs
	```
...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 150 · 🔀 2.1K · 📦 12K · 📋 1.3K - 0% open · ⏱️ 23.03.2022):

	```
	git clone https://github.com/squidfunk/mkdocs-material
	```
- [PyPi](https://pypi.org/project/mkdocs-material) (📥 1.1M / month · 📦 1.1K · ⏱️ 23.03.2022):
	```
	pip install mkdocs-material
	```
- [Conda](https://anaconda.org/conda-forge/mkdocs-material) (📥 85K · ⏱️ 23.03.2022):
	```
...
- [GitHub](https://github.com/numpy/numpydoc) (👨‍💻 70 · 🔀 6.7K · 📦 31K · 📋 170 - 35% open · ⏱️ 15.03.2022):

	```
	git clone https://github.com/numpy/numpydoc
	```
- [PyPi](https://pypi.org/project/numpydoc) (📥 300K / month · 📦 4.3K · ⏱️ 24.01.2022):
	```
	pip install numpydoc
	```
- [Conda](https://anaconda.org/conda-forge/numpydoc) (📥 980K · ⏱️ 24.01.2022):
	```
...
- [GitHub](https://github.com/michaeljones/breathe) (👨‍💻 100 · 🔀 160 · 📥 280 · 📦 6.2K · 📋 500 - 23% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/michaeljones/breathe
	```
- [PyPi](https://pypi.org/project/breathe) (📥 230K / month · 📦 1K · ⏱️ 14.02.2022):
	```
	pip install breathe
	```
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 35 · 🔀 130 · 📦 570 · 📋 240 - 3% open · ⏱️ 23.03.2022):
...
- [GitHub](https://github.com/tox-dev/sphinx-autodoc-typehints) (👨‍💻 39 · 🔀 81 · 📋 140 - 17% open · ⏱️ 18.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/sphinx-autodoc-typehints) (📥 480K / month · 📦 1.3K · ⏱️ 11.02.2022):
	```
...
- [GitHub](https://github.com/ryan-roemer/sphinx-bootstrap-theme) (👨‍💻 39 · 🔀 210 · 📋 140 - 39% open · ⏱️ 03.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/sphinx-bootstrap-theme) (📥 290K / month · 📦 600 · ⏱️ 03.02.2022):
	```
...
- [GitHub](https://github.com/mkdocstrings/mkdocstrings) (👨‍💻 29 · 🔀 67 · 📋 240 - 17% open · ⏱️ 01.03.2022):
...
- [GitHub](https://github.com/pdoc3/pdoc) (👨‍💻 57 · 🔀 120 · 📦 1.4K · 📋 280 - 30% open · ⏱️ 03.02.2022):
...
- [GitHub](https://github.com/executablebooks/sphinx-autobuild) (👨‍💻 17 · 🔀 52 · 📋 58 - 24% open · ⏱️ 14.03.2021):

	```
	git clone https://github.com/executablebooks/sphinx-autobuild
	```
- [PyPi](https://pypi.org/project/sphinx-autobuild) (📥 270K / month · 📦 2.6K · ⏱️ 14.03.2021):
	```
...
- [GitHub](https://github.com/asottile/blacken-docs) (👨‍💻 14 · 🔀 23 · 📋 44 - 6% open · ⏱️ 22.03.2022):
...
- [GitHub](https://github.com/zhaoterryy/mkdocs-pdf-export-plugin) (👨‍💻 11 · 🔀 35 · 📦 220 · 📋 86 - 47% open · ⏱️ 05.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/mkdocs-pdf-export-plugin) (📥 22K / month · 📦 4 · ⏱️ 05.10.2021):
	```
...
- [GitHub](https://github.com/orzih/mkdocs-with-pdf) (👨‍💻 6 · 🔀 29 · 📦 110 · 📋 72 - 45% open · ⏱️ 14.10.2021):
...
- [GitHub](https://github.com/timothycrosley/portray) (👨‍💻 16 · 🔀 60 · 📋 56 - 44% open · ⏱️ 13.06.2021):

	```
	git clone https://github.com/timothycrosley/portray
	```
- [PyPi](https://pypi.org/project/portray) (📥 5.6K / month · 📦 17 · ⏱️ 13.06.2021):
	```
	pip install portray
	```
</details>
...
- [GitHub](https://github.com/clayrisser/sphinx-markdown-builder) (👨‍💻 17 · 🔀 32 · 📦 220 · 📋 37 - 56% open · ⏱️ 08.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/sphinx-markdown-builder) (📥 46K / month · 📦 52 · ⏱️ 08.01.2022):
	```
...
- [GitHub](https://github.com/ml-tooling/lazydocs) (👨‍💻 7 · 🔀 21 · 📦 63 · 📋 13 - 30% open · ⏱️ 20.08.2021):
...
- [GitHub](https://github.com/cool-RR/PySnooper) (👨‍💻 26 · 🔀 920 · 📦 610 · 📋 120 - 16% open · ⏱️ 14.01.2022):
...
- [PyPi](https://pypi.org/project/typeguard) (📥 3.9M / month · 📦 300 · ⏱️ 10.12.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/typeguard) (📥 79K · ⏱️ 11.10.2021):
	```
...
- [GitHub](https://github.com/cs01/gdbgui) (👨‍💻 39 · 🔀 480 · 📥 7.5K · 📦 150 · 📋 290 - 42% open · ⏱️ 16.01.2022):
...
- [PyPi](https://pypi.org/project/icecream) (📥 200K / month · 📦 51 · ⏱️ 15.02.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/icecream) (📥 2.2K · ⏱️ 16.02.2022):
	```
...
- [GitHub](https://github.com/alexmojaki/snoop) (👨‍💻 21 · 🔀 25 · 📋 40 - 47% open · ⏱️ 26.02.2022):

	```
	git clone https://github.com/alexmojaki/snoop
	```
- [PyPi](https://pypi.org/project/snoop) (📥 23K / month · 📦 12 · ⏱️ 11.11.2021):
	```
	pip install snoop
	```
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 37 · 📦 81 · 📋 87 - 42% open · ⏱️ 15.12.2021):

	```
	git clone https://github.com/ionelmc/python-hunter
	```
- [PyPi](https://pypi.org/project/hunter) (📥 15K / month · 📦 21 · ⏱️ 15.12.2021):
	```
	pip install hunter
	```
...
- [GitHub](https://github.com/alexmojaki/birdseye) (👨‍💻 10 · 🔀 70 · 📋 50 - 36% open · ⏱️ 26.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/birdseye) (📥 3.8K / month · 📦 3 · ⏱️ 11.11.2021):
	```
...
- [GitHub](https://github.com/ionelmc/python-manhole) (👨‍💻 11 · 🔀 18 · 📦 88 · 📋 21 - 28% open · ⏱️ 02.02.2022):
...
- [GitHub](https://github.com/pytest-dev/pytest) (👨‍💻 780 · 🔀 2K · 📦 470K · 📋 4.9K - 15% open · ⏱️ 24.03.2022):

	```
	git clone https://github.com/pytest-dev/pytest
	```
- [PyPi](https://pypi.org/project/pytest) (📥 39M / month · 📦 81K · ⏱️ 17.03.2022):
	```
	pip install pytest
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 160 · 🔀 1.9K · 📥 520 · 📦 5.1K · 📋 3.8K - 5% open · ⏱️ 23.03.2022):

	```
	git clone https://github.com/robotframework/robotframework
	```
- [PyPi](https://pypi.org/project/robotframework) (📥 950K / month · 📦 1K · ⏱️ 23.03.2022):
	```
...
<details><summary><b><a href="https://github.com/HypothesisWorks/hypothesis">hypothesis</a></b> (🥇38 ·  ⭐ 5.8K · 📉) - Hypothesis is a powerful, flexible, and easy to use library.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 260 · 🔀 480 · 📦 12K · 📋 1.2K - 4% open · ⏱️ 21.03.2022):
...
- [PyPi](https://pypi.org/project/hypothesis) (📥 2.6M / month · 📦 1.9K · ⏱️ 07.03.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 5.3M · ⏱️ 17.03.2022):
	```
...
- [PyPi](https://pypi.org/project/pytest-cov) (📥 13M / month · 📦 28K · ⏱️ 04.10.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-cov) (📥 4.8M · ⏱️ 04.10.2021):
	```
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 100 · 🔀 220 · 📋 270 - 37% open · ⏱️ 18.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/freezegun) (📥 4.8M / month · 📦 4.4K · ⏱️ 18.03.2022):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-mock) (👨‍💻 55 · 🔀 100 · 📦 25K · 📋 110 - 11% open · ⏱️ 21.03.2022):
...
- [GitHub](https://github.com/pytest-dev/pytest-xdist) (👨‍💻 80 · 🔀 160 · 📋 460 - 44% open · ⏱️ 22.03.2022):

	```
	git clone https://github.com/pytest-dev/pytest-xdist
	```
- [PyPi](https://pypi.org/project/pytest-xdist) (📥 6.4M / month · 📦 4.5K · ⏱️ 10.12.2021):
	```
...
<details><summary><b><a href="https://github.com/pytest-dev/pytest-asyncio">pytest-asyncio</a></b> (🥈33 ·  ⭐ 910) - Pytest support for asyncio. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pytest-dev/pytest-asyncio) (👨‍💻 37 · 🔀 99 · 📥 18 · 📋 200 - 16% open · ⏱️ 15.03.2022):

	```
	git clone https://github.com/pytest-dev/pytest-asyncio
	```
- [PyPi](https://pypi.org/project/pytest-asyncio) (📥 3.4M / month · 📦 1.9K · ⏱️ 03.03.2022):
	```
	pip install pytest-asyncio
	```
- [Conda](https://anaconda.org/conda-forge/pytest-asyncio) (📥 870K · ⏱️ 03.03.2022):
	```
...
- [GitHub](https://github.com/microsoft/playwright-python) (👨‍💻 24 · 🔀 550 · 📦 940 · 📋 610 - 5% open · ⏱️ 15.03.2022):
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 280 · 📥 240 · 📋 300 - 1% open · ⏱️ 18.03.2022):
...
- [PyPi](https://pypi.org/project/mimesis) (📥 110K / month · 📦 58 · ⏱️ 25.01.2022):
	...
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 6.4K · ⏱️ 15.07.2020):
	```
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 73 · 🔀 140 · 📦 4.6K · 📋 250 - 19% open · ⏱️ 18.03.2022):
...
- [GitHub](https://github.com/pytest-dev/pytest-html) (👨‍💻 43 · 🔀 180 · 📦 19K · 📋 290 - 36% open · ⏱️ 04.02.2022):

	```
	git clone https://github.com/pytest-dev/pytest-html
	```
- [PyPi](https://pypi.org/project/pytest-html) (📥 1.8M / month · 📦 670 · ⏱️ 13.12.2020):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-bdd) (👨‍💻 46 · 🔀 170 · 📋 290 - 46% open · ⏱️ 09.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytest-bdd) (📥 340K / month · 📦 170 · ⏱️ 25.10.2021):
	```
...
<details><summary><b><a href="https://github.com/hamcrest/PyHamcrest">PyHamcrest</a></b> (🥉29 ·  ⭐ 610) - Hamcrest matchers for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/hamcrest/PyHamcrest) (👨‍💻 38 · 🔀 91 · 📋 69 - 27% open · ⏱️ 14.03.2022):
...
<details><summary><b><a href="https://github.com/wntrblm/nox">nox</a></b> (🥉28 ·  ⭐ 730) - Flexible test automation for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://docs.pytest.org/en/stable/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [PyPi](https://pypi.org/project/nox) (📥 1M / month · 📦 150 · ⏱️ 07.01.2022):
	...
	pip install nox
	```
- [Conda](https://anaconda.org/conda-forge/nox) (📥 67K · ⏱️ 13.01.2022):
	```
...
- [GitHub](https://github.com/airspeed-velocity/asv) (👨‍💻 67 · 🔀 140 · 📋 480 - 29% open · ⏱️ 23.03.2022):
...
- [PyPi](https://pypi.org/project/pytest-mypy) (📥 1M / month · 📦 390 · ⏱️ 07.02.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-mypy) (📥 22K · ⏱️ 24.11.2020):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-randomly) (👨‍💻 16 · 🔀 22 · 📋 48 - 12% open · ⏱️ 14.03.2022):
...
- [PyPi](https://pypi.org/project/pytest-randomly) (📥 440K / month · 📦 180 · ⏱️ 10.01.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-randomly) (📥 22K · ⏱️ 10.01.2022):
	```
...
- [GitHub](https://github.com/tarpas/pytest-testmon) (👨‍💻 16 · 🔀 30 · 📋 120 - 20% open · ⏱️ 11.03.2022):
...
<details><summary><b><a href="https://github.com/Erotemic/xdoctest">xdoctest</a></b> (🥉23 ·  ⭐ 140) - A rewrite of Pythons builtin doctest module (with pytest plugin.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Erotemic/xdoctest) (👨‍💻 7 · 🔀 8 · 📦 2.3K · 📋 38 - 47% open · ⏱️ 20.12.2021):
...
- [PyPi](https://pypi.org/project/xdoctest) (📥 110K / month · 📦 62 · ⏱️ 06.10.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/xdoctest) (📥 21K · ⏱️ 10.08.2021):
	```
...
- [GitHub](https://github.com/TvoroG/pytest-lazy-fixture) (👨‍💻 9 · 🔀 18 · 📦 620 · 📋 35 - 42% open · ⏱️ 27.01.2022):
...
- [GitHub](https://github.com/avast/pytest-docker) (👨‍💻 11 · 🔀 48 · 📥 86 · 📋 35 - 54% open · ⏱️ 14.06.2021):

	```
	git clone https://github.com/avast/pytest-docker
	```
- [PyPi](https://pypi.org/project/pytest-docker) (📥 60K / month · 📦 23 · ⏱️ 14.06.2021):
	```
...
- [GitHub](https://github.com/gabrielcnr/pytest-datadir) (👨‍💻 7 · 🔀 17 · 📦 550 · 📋 16 - 31% open · ⏱️ 18.01.2022):
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 420 · 🔀 1.8K · 📥 730K · 📋 4.5K - 7% open · ⏱️ 24.03.2022):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 770K / month · 📦 140 · ⏱️ 05.03.2022):
	```
...
- [GitHub](https://github.com/pypa/packaging) (👨‍💻 78 · 🔀 180 · 📥 300 · 📦 340K · 📋 240 - 27% open · ⏱️ 19.03.2022):

	```
	git clone https://github.com/pypa/packaging
	```
- [PyPi](https://pypi.org/project/packaging) (📥 99M / month · 📦 17K · ⏱️ 18.11.2021):
	```
...
- [GitHub](https://github.com/Nuitka/Nuitka) (👨‍💻 110 · 🔀 370 · 📋 1.3K - 15% open · ⏱️ 20.03.2022):

	```
	git clone https://github.com/Nuitka/Nuitka
	```
- [PyPi](https://pypi.org/project/nuitka) (📥 34K / month · 📦 36 · ⏱️ 19.03.2022):
	```
	pip install nuitka
	```
...
- [GitHub](https://github.com/pantsbuild/pex) (👨‍💻 100 · 🔀 220 · 📥 710K · 📋 820 - 17% open · ⏱️ 22.03.2022):

	```
	git clone https://github.com/pantsbuild/pex
	```
- [PyPi](https://pypi.org/project/pex) (📥 290K / month · 📦 130 · ⏱️ 22.03.2022):
	```
	pip install pex
	```
</details>
...
- [GitHub](https://github.com/marcelotduarte/cx_Freeze) (👨‍💻 94 · 🔀 170 · 📋 740 - 8% open · ⏱️ 22.03.2022):
...
- [PyPi](https://pypi.org/project/cx_freeze) (📥 60K / month · 📦 150 · ⏱️ 16.12.2017):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cx_freeze) (📥 120K · ⏱️ 24.01.2022):
	```
...
- [GitHub](https://github.com/beeware/briefcase) (👨‍💻 90 · 🔀 220 · 📋 390 - 30% open · ⏱️ 22.03.2022):
...
- [GitHub](https://github.com/indygreg/PyOxidizer) (👨‍💻 41 · 🔀 140 · 📥 2.1K · 📋 450 - 58% open · ⏱️ 23.03.2022):

	```
	git clone https://github.com/indygreg/PyOxidizer
	```
- [PyPi](https://pypi.org/project/pyoxidizer) (📥 3.4K / month · ⏱️ 08.03.2022):
	```
...
- [GitHub](https://github.com/ronaldoussoren/py2app) (👨‍💻 29 · 🔀 20 · 📦 4K · 📋 390 - 29% open · ⏱️ 08.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/py2app) (📥 14K / month · 📦 830 · ⏱️ 27.09.2021):
	```
	pip install py2app
	```
</details>
...
- [GitHub](https://github.com/takluyver/pynsist) (👨‍💻 29 · 🔀 110 · 📋 160 - 16% open · ⏱️ 21.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/pynsist) (📥 2.4K / month · 📦 47 · ⏱️ 21.03.2022):
	```
	pip install pynsist
	```
</details>
...
- [GitHub](https://github.com/conda/constructor) (👨‍💻 50 · 🔀 140 · 📥 230 · 📦 12 · 📋 270 - 24% open · ⏱️ 14.03.2022):
...
- [GitHub](https://github.com/pypa/setuptools) (👨‍💻 490 · 🔀 830 · 📥 120 · 📦 150K · 📋 2K - 24% open · ⏱️ 23.03.2022):

	```
	git clone https://github.com/pypa/setuptools
	```
- [PyPi](https://pypi.org/project/setuptools) (📥 180M / month · 📦 36K · ⏱️ 16.03.2022):
	```
	pip install setuptools
	```
- [Conda](https://anaconda.org/conda-forge/setuptools) (📥 35M · ⏱️ 17.03.2022):
	```
...
- [GitHub](https://github.com/buildbot/buildbot) (👨‍💻 810 · 🔀 1.6K · 📥 23K · 📦 270 · 📋 1.4K - 45% open · ⏱️ 18.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/buildbot) (📥 61K / month · 📦 460 · ⏱️ 06.03.2022):
	```
...
- [GitHub](https://github.com/pypa/twine) (👨‍💻 110 · 🔀 260 · 📦 59K · 📋 400 - 9% open · ⏱️ 16.03.2022):

	```
	git clone https://github.com/pypa/twine
	```
- [PyPi](https://pypi.org/project/twine) (📥 3.4M / month · 📦 12K · ⏱️ 02.02.2022):
	```
	pip install twine
	```
...
- [GitHub](https://github.com/pyinvoke/invoke) (👨‍💻 57 · 🔀 310 · 📦 11K · 📋 710 - 48% open · ⏱️ 19.03.2022):
...
<details><summary><b><a href="https://github.com/pypa/wheel">wheel</a></b> (🥈35 ·  ⭐ 310) - The official binary distribution format for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/pypa/setuptools_scm) (👨‍💻 100 · 🔀 160 · 📋 390 - 20% open · ⏱️ 21.02.2022):
...
- [GitHub](https://github.com/SCons/scons) (👨‍💻 140 · 🔀 250 · 📥 420 · 📋 3.3K - 19% open · ⏱️ 22.03.2022):
...
- [GitHub](https://github.com/pydoit/doit) (👨‍💻 62 · 🔀 150 · 📦 900 · 📋 270 - 23% open · ⏱️ 22.03.2022):
...
- [PyPi](https://pypi.org/project/doit) (📥 300K / month · 📦 280 · ⏱️ 18.02.2022):
	...
	pip install doit
	```
- [Conda](https://anaconda.org/conda-forge/doit) (📥 79K · ⏱️ 24.02.2022):
	```
...
- [GitHub](https://github.com/pybuilder/pybuilder) (👨‍💻 36 · 🔀 240 · 📋 500 - 18% open · ⏱️ 24.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/pybuilder) (📥 18K / month · 📦 60 · ⏱️ 24.02.2022):
	```
...
- [GitHub](https://github.com/ml-tooling/universal-build) (👨‍💻 4 · 🔀 6 · 📥 16 · 📦 9 · ⏱️ 17.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/universal-build) (📥 1K / month · 📦 5 · ⏱️ 12.12.2020):
	```
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 180 · 🔀 1.2K · 📦 150K · 📋 1.5K - 13% open · ⏱️ 18.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/psutil) (📥 41M / month · 📦 15K · ⏱️ 29.12.2021):
	```
	pip install psutil
	```
...
- [GitHub](https://github.com/plasma-umass/scalene) (👨‍💻 28 · 🔀 190 · 📦 94 · 📋 200 - 23% open · ⏱️ 13.03.2022):

	```
	git clone https://github.com/plasma-umass/scalene
	```
- [PyPi](https://pypi.org/project/scalene) (📥 10K / month · 📦 3 · ⏱️ 12.03.2022):
	```
	pip install scalene
	```
</details>
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 29 · 🔀 280 · 📥 8.1K · 📋 240 - 30% open · ⏱️ 17.01.2022):

	```
	git clone https://github.com/benfred/py-spy
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 810K / month · 📦 35 · ⏱️ 13.11.2021):
	```
	pip install py-spy
	```
- [Conda](https://anaconda.org/conda-forge/py-spy) (📥 300K · ⏱️ 18.12.2021):
	...
	```
- [Cargo](https://crates.io/crates/py-spy) (📥 300 / month · ⏱️ 13.11.2021):
	```
...
- [GitHub](https://github.com/pythonprofilers/memory_profiler) (👨‍💻 95 · 🔀 330 · 📋 220 - 50% open · ⏱️ 20.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 450K / month · 📦 270 · ⏱️ 16.08.2018):
	```
...
- [GitHub](https://github.com/joerick/pyinstrument) (👨‍💻 38 · 🔀 170 · 📦 580 · 📋 98 - 16% open · ⏱️ 17.12.2021):
...
- [PyPi](https://pypi.org/project/pyinstrument) (📥 310K / month · 📦 97 · ⏱️ 14.11.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyinstrument) (📥 97K · ⏱️ 26.01.2022):
	```
...
- [GitHub](https://github.com/python-diamond/Diamond) (👨‍💻 370 · 🔀 590 · 📦 82 · 📋 370 - 62% open · ⏱️ 11.03.2022):
...
- [PyPi](https://pypi.org/project/bpytop) (📥 11K / month · 📦 1 · ⏱️ 22.12.2021):
	...
	pip install bpytop
	```
- [Conda](https://anaconda.org/conda-forge/bpytop) (📥 4.1K · ⏱️ 22.12.2021):
	```
...
- [GitHub](https://github.com/sumerc/yappi) (👨‍💻 26 · 🔀 52 · 📦 560 · 📋 55 - 30% open · ⏱️ 08.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/yappi) (📥 800K / month · 📦 340 · ⏱️ 15.12.2021):
	```
	pip install yappi
	```
- [Conda](https://anaconda.org/conda-forge/yappi) (📥 98K · ⏱️ 07.11.2021):
	```
	conda install -c conda-forge yappi
	```
</details>
<details><summary><b><a href="https://github.com/pympler/pympler">pympler</a></b> (🥉26 ·  ⭐ 900) - Development tool to measure, monitor and analyze the memory behavior.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/alexmojaki/heartrate) (👨‍💻 3 · 🔀 120 · 📦 39 · 📋 7 - 57% open · ⏱️ 13.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/heartrate) (📥 940 / month · 📦 3 · ⏱️ 13.11.2021):
	```
...
- [GitHub](https://github.com/csurfer/pyheat) (👨‍💻 5 · 🔀 40 · 📦 36 · 📋 14 - 35% open · ⏱️ 18.09.2021):
...
- [PyPi](https://pypi.org/project/typed_ast) (📥 13M / month · 📦 5.5K · ⏱️ 24.01.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/typed-ast) (📥 4M · ⏱️ 24.01.2022):
	```
...
- [GitHub](https://github.com/serge-sans-paille/gast) (👨‍💻 10 · 🔀 25 · 📦 80K · 📋 28 - 3% open · ⏱️ 24.02.2022):
...
<details><summary><b><a href="https://github.com/pre-commit/pre-commit">pre-commit</a></b> (🥇39 ·  ⭐ 7.7K) - A framework for managing and maintaining multi-language pre-commit.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pre-commit/pre-commit) (👨‍💻 130 · 🔀 540 · 📥 42K · 📦 44K · 📋 1.4K - 1% open · ⏱️ 21.03.2022):

	```
	git clone https://github.com/pre-commit/pre-commit
	```
- [PyPi](https://pypi.org/project/pre-commit) (📥 4.7M / month · 📦 2.8K · ⏱️ 18.01.2022):
	```
